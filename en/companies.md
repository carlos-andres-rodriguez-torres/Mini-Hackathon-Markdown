---
description: "The Facultat d\\'Informàtica de Barcelona (FIB) creates
  development in order to help society with innovative initiatives and
  we have contributed significantly to develop Information Technologies
  of our country. The collaboration between industrial and FIB, allows
  to approach interests and to share projects, with an added value of:
  Ensuring that FIB students have a direct bond"
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Companies \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: The Facultat d\'Informàtica de Barcelona (FIB)
  creates development in order to help society with innovative
  initiatives and we have contributed significantly to develop
  Information Technologies of our
twitter:title: Companies
twitter:url: "https://www.fib.upc.edu/en/companies"
...
::: content
-   [Català](/ca/empresa "Empresa"){.language-link lang="ca"}
-   [English](/en/companies "Companies"){.language-link .active
    lang="en"}
...
:::: content
::: page_title_no_sub
# Companies {#companies .page_title}
:::
::::
::::::
:::::::
...
## Knowing the needs of companies helps to prepare more efficiently the professionals in the skills that society needs
...
:::::::: content
::::::: {#node-16554 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The Facultat d\'Informàtica de Barcelona (FIB) creates development in
order to help society with innovative initiatives and we have
contributed significantly to develop Information Technologies of our
country.

The collaboration between industrial and FIB, allows to approach
interests and to share projects, with an added value of:

-   Ensuring that FIB students have a direct bond with companies in the
    sector of information technologies that trust in us.
-   Training students for getting the skills that organizations need.
-   Building together research projects and innovation in our expertise
    areas.
-   Enabling access to nacional and European networks.
-   Building a social image of prestige through an alliance between
...
### Integration into the work world {#integration-into-the-work-world .box-title}

::: box-content
-   [Industrial Practices](/en/companies/industrial-practices): The aim
    of an industrial practice is to complete the training received at
    University with labour experience within business sector.
-   [FIB Visiona](/en/companies/fib-visiona){target="_blank"}: The FIB
    Visiona forum is run by students at FIB that links, between
    companies and their futur employees.
-   [Job Placements](/en/companies/job-placements)
-   [Training InLab
    Talent.](http://inlab.fib.upc.edu/en/talent-training-program){target="_blank"}
:::
:::::
::::::
...
### Training activities {#training-activities .box-title}

::: box-content
-   Industrial Serminars: Short seminars are held by professionals of
    first-level companies in the areas of Informatics,
...
::: box-content
-   The FIB participates in associations which promote projects and
    relationships between companies, such as the Cluster for Innovation.
-   Anual participation to
     [Festibity](http://www.festibity.com/){target="_blank"}, It is a
    major IT event organized by  [FIB
...
### Sponsorships and other patronage agreements {#sponsorships-and-other-patronage-agreements .box-title}

::: box-content
-   The sponsorship of computer classrooms:
    -   [Jedi Mobile Applications
        Lab](/en/companies/sponsorship/jedi-mobile-apps-lab).
