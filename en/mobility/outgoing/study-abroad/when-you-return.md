---
description: What do I have to do when I return? 1. Hand in all the
  required documentation You will have to answer an EU questionnaire
  online and do the final language knowledge test (only in the case of
  stays under the Erasmus program). Before the end of your stay you will
  receive an e-mail with the needed links. Until you hand in the
  attendance certificate and answer the EU
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: When you return \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: What do I have to do when I return? 1. Hand in all
  the required documentation You will have to answer an EU questionnaire
  online and do the final language knowledge test (only in the case of
  stays
twitter:title: When you return
twitter:url: "https://www.fib.upc.edu/en/mobility/outgoing/study-abroad/when-you-return"
    ...
    -   [Outgoing](/en/mobility/outgoing)
        ...
        -   [Study abroad](/en/mobility/outgoing/study-abroad)
            ...
            -   [Before you
                return](/en/mobility/outgoing/study-abroad/you-return)
            -   [When you
                return](/en/mobility/outgoing/study-abroad/when-you-return){.active}
        -   [Internship abroad](/en/mobility/outgoing/internship-abroad)
        -   [Other activities
            abroad](/en/mobility/outgoing/other-activities-abroad)
    -   [Double degrees](/en/mobility/double-degrees)
...
:::: content
::: page_title_no_sub
# When you return {#when-you-return .page_title}
:::
::::
::::::
:::::::
...
abroad](/en/mobility/outgoing/study-abroad) » When you return
:::
::::
::::::
:::::::
...
-   [When you
    return](/en/mobility/outgoing/study-abroad/when-you-return){.active-trail
    .active}
:::
::::
::::::
...
::::::::::: content
:::::::::: {#node-16613 .node .node-page .clearfix}
::::::::: content
...
You will have to answer **an EU questionnaire online** and do the
**final language knowledge test** (only in the case of stays under the
Erasmus program). Before the end of your stay you will receive an e-mail
with the needed links.

Until you hand in the attendance certificate and answer the EU
questionnaire, the procedure to do the second payment of the grant (or
grants) won\'t be initiated.
:::

::: {.alert .alert-info}
### 2. Hand in the bachelor\'s or master\'s thesis, if proceeds

If you have done your degree\'s thesis abroad, you will have to upload
the report to the Racó.
:::

::: {.alert .alert-info}
### 3. Wait for the credit recognition

The credit recognition will be made effective once you have handed in
**all** the documents previouly mentioned.

Bachelor students who do a mobility can recognise until 3 ECTS per
semester (6 if the stay is yearly) that correspond to a set of
university activity extension credits. The credit assignment will be
done according to the academic performance during the mobility and it
will be conditioned to the experience contribution of the student at the
appropiate regional Facebook group **[FIB Mobility
Experiences](https://www.facebook.com/groups/653240021536725/)**.

The assigned credits will be able to be recognised through the
**e-secretaria \> procedures \> credit recognition**, where you will
have to select and pay them to incorporate them into your record.
:::
::::::
:::::::
::::::::
...
:::::::::::::::::::::::: content
::::::::::::::::::::::: {.view .view-tel-fons-i-horaris .view-id-tel_fons_i_horaris .view-display-id-block_1 .view-dom-id-07635841856daa163f0200ae5bab1e4a}
:::::::::::::::::::::: view-content
