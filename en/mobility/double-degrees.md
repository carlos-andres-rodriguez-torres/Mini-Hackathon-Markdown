---
description: "A double degree allows you to obtain two university
  degrees: one at FIB and one at the university which whom we have a
  dual degree agreement. Most dual degree agreements involve at least
  one year of study abroad. Each double degree agreement sets the
  requirements you must meet to qualify for one of these places. What
  benefits receive the students who achieve a double degree?"
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Double degrees \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: "A double degree allows you to obtain two
  university degrees: one at FIB and one at the university which whom we
  have a dual degree agreement. Most dual degree agreements involve at
  least one year of"
twitter:title: Double degrees
twitter:url: "https://www.fib.upc.edu/en/mobility/double-degrees"
...
-   [Mobility](/en/mobility)
    ...
    -   [Outgoing](/en/mobility/outgoing)
        ...
        -   [Other activities
            abroad](/en/mobility/outgoing/other-activities-abroad)
    -   [Double degrees](/en/mobility/double-degrees){.active}
    -   [International
...
:::: content
::: page_title_no_sub
# Double degrees {#double-degrees .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Home](/en) » [Mobility](/en/mobility) » Double degrees
:::
::::
::::::
:::::::
...
-   [Incoming](/en/mobility/incoming)
-   [Outgoing](/en/mobility/outgoing)
-   [Double degrees](/en/mobility/double-degrees){.active-trail .active}
-   [International
    Partnerships](/en/mobility/international-partnerships)
:::
::::
...
:::::::: content
::::::: {#node-16551 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
A double degree allows you to obtain two university degrees: one at FIB
and one at the university which whom we have a dual degree agreement.
Most dual degree agreements involve at least one year of study abroad.

Each double degree agreement sets the requirements you must meet to
qualify for one of these places.

What benefits receive the students who achieve a double degree?

-   The formation they receive allows them to either reach a new
    specialization or further the one they already have.
-   They significantly increase the knowledge of the other country:
    language, culture, etc. since the mobility is longer (at least one
    year).
-   From a working standpoint, they are professionally accredited in two
    different countries which expands their possibilities of employment
    contracts.
-   There is an important personal growth: increasing adaptability, more
    open mind, etc.

If you want to do an international double degree, we will give you an
overview in the **[October 2024
presentation](/sites/fib/files/documents/mobilitat/presentacio-dti-fib-2024.pdf)**.
...
## Master in Informatics Engineering {#master-in-informatics-engineering .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_4 .view-dom-id-1301399d787fa8f9b3a47fbfc91222ad}
:::: view-content
::: item-list
...
-   #### [Université Clermont Auvergne](/en/mobility/double-degrees/universite-clermont-auvergne)
    ...
    height="15"}](/en/mobility/double-degrees/universite-clermont-auvergne)
    :::
    ::::
    :::::
    :::::::::
...
## Master in Innovation and Research in Informatics {#master-in-innovation-and-research-in-informatics .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_6 .view-dom-id-b441c0a45ce1e5924b2d2ba55a47a165}
:::: view-content
::: item-list
...
## Master in Artificial Intelligence {#master-in-artificial-intelligence .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_5 .view-dom-id-f5e59609d2816d47a36aad4607e5397d}
:::: view-content
::: item-list
-   #### [Escuela de Posgrado de la Pontificia Universidad Católica de Perú (PUCP)](/en/mobility/double-degrees/escuela-de-posgrado-de-la-pontificia-universidad-catolica-de-peru-pucp)
...
## Master in Data Science {#master-in-data-science .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_7 .view-dom-id-195de57839379b8945d7dc9e835ca481}
:::: view-content
::: item-list
