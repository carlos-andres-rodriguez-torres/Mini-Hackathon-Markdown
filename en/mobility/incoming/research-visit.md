---
description: \[icon class=\"fa fa-building\"\]\[/icon\] For students
  seeking to arrange a research visit at a UPC department, laboratory,
  institute or research group. \[icon class=\"fa fa-warning\"\]\[/icon\]
  The visit is not compatible with an academic visit for which the
  student is enrolled in courses at the UPC. \[icon class=\"fa
  fa-calendar\"\]\[/icon\] The period of the visit must not include the
  month
...
theme-color: "#ffffff"
title: Research Visit \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: \[icon class=\"fa fa-building\"\]\[/icon\] For
  students seeking to arrange a research visit at a UPC department,
  laboratory, institute or research group. \[icon class=\"fa
  fa-warning\"\]\[/icon\] The visit is
twitter:title: Research Visit
twitter:url: "https://www.fib.upc.edu/en/mobility/incoming/research-visit"
...
-   [Mobility](/en/mobility)
    -   [Incoming](/en/mobility/incoming)
        -   [Academic stays](/en/mobility/incoming/academic-stays)
        -   [Research
            Visit](/en/mobility/incoming/research-visit){.active}
...
:::: content
::: page_title_no_sub
# Research Visit {#research-visit .page_title}
:::
::::
::::::
:::::::
...
[Incoming](/en/mobility/incoming) » Research Visit
:::
::::
::::::
:::::::
...
-   [Academic stays](/en/mobility/incoming/academic-stays)
-   [Research Visit](/en/mobility/incoming/research-visit){.active-trail
    .active}
:::
::::
::::::
...
:::::::::::: content
::::::::::: {#node-19972 .node .node-page .clearfix}
:::::::::: content
::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::: field-items
::::::: {.field-item .even}
For students seeking to arrange a research visit at a UPC department,
laboratory, institute or research group. 

The visit is not compatible with an academic visit for which the student
is enrolled in courses at the UPC. 

The period of the visit must not include the month of August, when the
UPC is closed.

A bilateral agreement between the FIB and the home university of the
student applying for the research visit is not required.

These visits are not remunerated.

**Students cannot start the visit until the unit at the host university
has all the documents it requires.**

 

To apply for a research visit, the student must complete the following
steps:
...
group](/en/research) to ask for a letter of invitation.
:::

::: {.alert .alert-info}
### 2. Traineeship agreement

Fill in a traineeship agreement (Erasmus+ or other), which must be
negotiated with the professor at the host university. The agreement must
be signed by the student and the home university (3 original copies).
:::
...
liability. The UPC has an agreement with [On
Campus](https://oncampus.es/en/seguros/oncampus-estudia/), so that
students who come to do a research stay, if they do not have any
insurance, could hire this.
:::

::: {.alert .alert-info}
### 4. Being enrolled in your home university

Provide your enrolment form from your home university that proves that
you are a student during the period of the visit at the UPC.
:::
:::::::
::::::::
:::::::::
