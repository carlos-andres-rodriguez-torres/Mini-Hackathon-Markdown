---
description: The Department of Computer Architecture (DAC) at the
  Universitat Politècnica de Catalunya (UPC) carries out research and
  education in the areas of Computer Architecture, Computer Networks and
  Operating Systems. The research carried out by the DAC is organized in
  several research groups. Their scientific production is published in
...
theme-color: "#ffffff"
title: Computer Architecture \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: The Department of Computer Architecture (DAC) at
  the Universitat Politècnica de Catalunya (UPC) carries out research
  and education in the areas of Computer Architecture, Computer Networks
  and
twitter:title: Computer Architecture
twitter:url: "https://www.fib.upc.edu/en/research/departments/computer-architecture"
...
-   [Research](/en/research)
    -   [Departments](/en/research/departments)
        ...
        -   [Computer
            Architecture](/en/research/departments/computer-architecture){.active}
        -   [Computer
...
:::: content
::: page_title_no_sub
# Computer Architecture {#computer-architecture .page_title}
:::
::::
::::::
:::::::
...
[Departments](/en/research/departments) » Computer Architecture
:::
::::
::::::
:::::::
...
-   [Computer
    Architecture](/en/research/departments/computer-architecture){.active-trail
    .active}
...
:::: content
::: {#node-16585 .node .node-departament .clearfix}
The Department of Computer Architecture (DAC) at the Universitat
Politècnica de Catalunya (UPC) carries out research and education in the
areas of Computer Architecture, Computer Networks and Operating
Systems.\
The research carried out by the DAC is organized in several [research
groups](http://www.ac.upc.edu/en/research/research-groups){.internal-link
target="_self"}. Their scientific production is published in top
conferences and journals.

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/701)
...
directory.](https://directori.upc.edu/directori/dadesUE.jsp?id=701)
:::
::::
::::::
::::::::
