---
description: The Department of Physics (DFIS) of the Universitat
  Politècnica de Catalunya (UPC) was created in October 8, 2015, as a
  result of the merge of the former Departments of Applied Physics (DFA)
  and Physics and Nuclear Engineering (DFEN), with the addition of some
  professors in the field of aerospace engineering from the campuses of
  Castelldefels and Terrassa. DFIS brings together
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Physics \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: The Department of Physics (DFIS) of the Universitat
  Politècnica de Catalunya (UPC) was created in October 8, 2015, as a
  result of the merge of the former Departments of Applied Physics (DFA)
  and
twitter:title: Physics
twitter:url: "https://www.fib.upc.edu/en/research/departments/physics"
...
-   [Research](/en/research)
    -   [Departments](/en/research/departments)
        ...
        -   [Physics](/en/research/departments/physics){.active}
...
[Departments](/en/research/departments) » Physics
:::
::::
::::::
:::::::
...
-   [Management](/en/research/departments/management)
-   [Mathematics](/en/research/departments/mathematics)
-   [Physics](/en/research/departments/physics){.active-trail .active}
-   [Services and Information System
    Engineering](/en/research/departments/services-and-information-system-engineering)
-   [Statistics and Operations
    Research](/en/research/departments/statistics-and-operations-research)
...
:::: content
::: {#node-16597 .node .node-departament .clearfix}
The Department of Physics (DFIS) of the Universitat Politècnica de
Catalunya (UPC) was created in October 8, 2015, as a result of the merge
of the former Departments of Applied Physics (DFA) and Physics and
Nuclear Engineering (DFEN), with the addition of some professors in the
field of aerospace engineering from the campuses of Castelldefels and
Terrassa.\
\
DFIS brings together teaching and research staff from three specific
areas: **Physics, Nuclear Engineering and Aerospace Engineering**.\
\
The department conducts its research and technology transfer through its
[research groups](http://fisica.upc.edu/ca/recerca/grups-de-recerca).

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/748)
...
directory.](https://directori.upc.edu/directori/dadesUE.jsp?id=748)
:::
::::
::::::
::::::::
