---
description: "The Department of Automatic Control (ESAII) of the
  Universitat Politècnica de Catalunya (UPC) carries out research and
  teaching both in the foundations and in the applications of the
  following areas: Robotics Biomedical signals and systems Advanced
  control systems Computer Vision The department develops these research
  topics through its research groups."
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Automatic Control \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: "The Department of Automatic Control (ESAII) of the
  Universitat Politècnica de Catalunya (UPC) carries out research and
  teaching both in the foundations and in the applications of the
  following areas:"
twitter:title: Automatic Control
twitter:url: "https://www.fib.upc.edu/en/research/departments/automatic-control"
...
-   [Research](/en/research)
    -   [Departments](/en/research/departments)
        -   [Automatic
            Control](/en/research/departments/automatic-control){.active}
        -   [Computer
...
:::: content
::: page_title_no_sub
# Automatic Control {#automatic-control .page_title}
:::
::::
::::::
:::::::
...
[Departments](/en/research/departments) » Automatic Control
:::
::::
::::::
:::::::
...
-   [Automatic
    Control](/en/research/departments/automatic-control){.active-trail
    .active}
-   [Computer
    Architecture](/en/research/departments/computer-architecture)
...
:::: content
::: {#node-16593 .node .node-departament .clearfix}
The Department of Automatic Control (ESAII) of the Universitat
Politècnica de Catalunya (UPC) carries out research and teaching both in
the foundations and in the applications of the following areas:
...
groups](http://esaii.upc.edu/en/recerca-en/research-groups).

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/707)
...
directory.](https://directori.upc.edu/directori/dadesUE.jsp?id=707)
:::
::::
::::::
::::::::
