---
description: The Department of Management (DOE) of the Universitat
  Politècnica de Catalunya (UPC) was created in 1986, as the result of
  merging groups from different knowledge areas that were linked and had
  common synergies. Th eresult is a multidisciplinary department, with
  experts in the fields of industrial engineering, economy, management,
  law, information technologies, architechture,
...
twitter:description: The Department of Management (DOE) of the
  Universitat Politècnica de Catalunya (UPC) was created in 1986, as the
  result of merging groups from different knowledge areas that were
  linked and had
twitter:title: Management
twitter:url: "https://www.fib.upc.edu/en/research/departments/management"
...
-   [Research](/en/research)
    -   [Departments](/en/research/departments)
        ...
        -   [Management](/en/research/departments/management){.active}
...
[Departments](/en/research/departments) » Management
:::
::::
::::::
:::::::
...
-   [Management](/en/research/departments/management){.active-trail
    .active}
-   [Mathematics](/en/research/departments/mathematics)
-   [Physics](/en/research/departments/physics)
-   [Services and Information System
...
:::::::: content
::::::: {#node-16601 .node .node-departament .clearfix}
The Department of Management (DOE) of the Universitat Politècnica de
Catalunya (UPC) was created in 1986, as the result of merging groups
from different knowledge areas that were linked and had common
synergies. Th eresult is a multidisciplinary department, with experts in
the fields of industrial engineering, economy, management, law,
information technologies, architechture, among others. This allows them
to be part in nearly all the schools of the UPC, as well as to
participate in all the degrees currently offered.
...
target="_self"}; however, some others do their research on their own
...
researchers: [futur.upc.edu](http://futur.upc.edu/732)
...
directory.](https://directori.upc.edu/directori/dadesUE.jsp?id=732)
:::::::
::::::::
::::::::::
::::::::::::
