---
description: The Natural Language Processing Group (GPLN) is formed by
  members of the Department of Computer Science, and it also counts on
  regular collaboration of the linguistics research group of the
  University of Barcelona. The group has been recognised as a member of
  the Quality Research Group by the Research and Technology
  Interdepartamental Comission (CIRIT) of the Government of
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: GPLN - Natural Language Processing Group \| FIB - Barcelona
  School of Informatics
twitter:card: summary
twitter:description: The Natural Language Processing Group (GPLN) is
  formed by members of the Department of Computer Science, and it also
  counts on regular collaboration of the linguistics research group of
  the
twitter:title: GPLN - Natural Language Processing Group
twitter:url: "https://www.fib.upc.edu/en/research/resarch-groups/gpln-natural-language-processing-group"
...
-   [Research](/en/research)
    ...
    -   [Research Groups](/en/research/research-groups)
        ...
        -   [GPLN - Natural Language Processing
            Group](/en/research/resarch-groups/gpln-natural-language-processing-group){.active}
...
:::: content
::: page_title_no_sub
# GPLN - Natural Language Processing Group {#gpln---natural-language-processing-group .page_title}
:::
::::
::::::
:::::::
...
Groups](/en/research/research-groups) » GPLN - Natural Language
Processing Group
:::
::::
::::::
...
-   [GNOM - Group of Numerical Optimization and
    Modelling](/en/research/resarch-groups/gnom-group-numerical-optimization-and-modelling)
-   [GPLN - Natural Language Processing
    Group](/en/research/resarch-groups/gpln-natural-language-processing-group){.active-trail
    .active}
-   [GRBIO - Biostatistics and Bioinformatics Research
    Group](/en/research/research-groups/grbio-biostatistics-and-bioinformatics-research-group)
-   [GREC - Knowledge Engineering Research
...
::::::::: content
:::::::: {#node-16737 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The Natural Language Processing Group (GPLN) is formed by members of the
Department of Computer Science, and it also counts on regular
collaboration of the linguistics research group of the University of
Barcelona. The group has been recognised as a member of the Quality
Research Group by the Research and Technology Interdepartamental
Comission (CIRIT) of the Government of Catalonia, and since 1997, it has
been considered as a consolidated group of all Catalonian Research Plan
editions.

The main research areas are:

-   Analysis and desambiguousness processes (morphology, syntaxes,
    semantics)
...
Aplicacions del Llenguatge i la Parla](http://www.talp.upc.edu/)).
:::
::::
:::::

::: field
[ Website ]{.field-label} [ <http://www.cs.upc.edu/research/>
]{.field-items}
:::
...
researchers: [futur.upc.edu](http://futur.upc.edu/GPLN?locale=en)
:::::::
::::::::
:::::::::
:::::::::::
