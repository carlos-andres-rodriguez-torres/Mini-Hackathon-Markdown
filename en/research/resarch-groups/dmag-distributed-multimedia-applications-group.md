---
description: The Distributed Multimedia Applications Group (DMAG) is
  formed by members of the Department of Computer Architecture. The
  current research and development activities deal mainly deal with the
  creation, management and distribution of multimedia content in a
  secure and interoperable way. Research topics include Digital
  management of rights, Metadata interoperability, Multimedia
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: DMAG - Distributed Multimedia Applications Group \| FIB -
  Barcelona School of Informatics
twitter:card: summary
twitter:description: The Distributed Multimedia Applications Group
  (DMAG) is formed by members of the Department of Computer
  Architecture. The current research and development activities deal
  mainly deal with the
twitter:title: DMAG - Distributed Multimedia Applications Group
twitter:url: "https://www.fib.upc.edu/en/research/resarch-groups/dmag-distributed-multimedia-applications-group"
...
-   [Research](/en/research)
    ...
    -   [Research Groups](/en/research/research-groups)
        ...
        -   [DMAG - Distributed Multimedia Applications
            Group](/en/research/resarch-groups/dmag-distributed-multimedia-applications-group){.active}
...
:::: content
::: page_title_no_sub
# DMAG - Distributed Multimedia Applications Group {#dmag---distributed-multimedia-applications-group .page_title}
:::
::::
::::::
:::::::
...
Groups](/en/research/research-groups) » DMAG - Distributed Multimedia
Applications Group
:::
::::
::::::
...
-   [DCCG - Research group on discrete, combinatorial and computational
    geometry](/en/research/resarch-groups/dccg-research-group-discrete-combinatorial-and-computational-geometry)
-   [DMAG - Distributed Multimedia Applications
    Group](/en/research/resarch-groups/dmag-distributed-multimedia-applications-group){.active-trail
    .active}
-   [GESSI - Group of Software and Service
    Engineering](/en/research/resarch-groups/gessi-group-software-and-service-engineering)
-   [GIE - Engineering Informatics
...
::::::::: content
:::::::: {#node-16726 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The Distributed Multimedia Applications Group (DMAG) is formed by
members of the Department of Computer Architecture.

The current research and development activities deal mainly deal with
the creation, management and distribution of multimedia content in a
secure and interoperable way. Research topics include Digital management
of rights, Metadata interoperability, Multimedia search, Security and
privacy and Ontologies and semantics. The main application areas are
content life cycle, E-Health, Online social networks and E-Services. A
key issue in all the previous topics and areas is international
standardisation.
:::
::::
:::::
...
::: field
[ Website ]{.field-label} [ <http://dmag.ac.upc.edu/> ]{.field-items}
:::

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/DMAG?locale=en)
:::::::
::::::::
:::::::::
:::::::::::
