---
description: "The ALgorithms, Bioinformatics, COmplexity and formal
  Methods research group (ALBCOM) is mainly formed by members of the
  Department of Computer Science. The group focuses on algorithmic and
  theoretical aspects related to computational difficulty of
  problem-solving. The main research areas are: Bioinformatics
  Computational complexity theory Design and analysis of algorithms and"
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: ALBCOM - Algorithms, Computational Biology, Complexity and Formal
  Methods \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: The ALgorithms, Bioinformatics, COmplexity and
  formal Methods research group (ALBCOM) is mainly formed by members of
  the Department of Computer Science. The group focuses on algorithmic
  and
twitter:title: ALBCOM - Algorithms, Computational Biology, Complexity
  and Formal
twitter:url: "https://www.fib.upc.edu/en/research/resarch-groups/albcom-algorithms-computational-biology-complexity-and-formal-methods"
...
-   [Research](/en/research)
    ...
    -   [Research Groups](/en/research/research-groups)
        -   [ALBCOM - Algorithms, Computational Biology, Complexity and
            Formal
            Methods](/en/research/resarch-groups/albcom-algorithms-computational-biology-complexity-and-formal-methods){.active}
...
:::: content
::: page_title_no_sub
# ALBCOM - Algorithms, Computational Biology, Complexity and Formal Methods {#albcom---algorithms-computational-biology-complexity-and-formal-methods .page_title}
:::
::::
::::::
:::::::
...
Groups](/en/research/research-groups) » ALBCOM - Algorithms,
Computational Biology, Complexity and Formal Methods
:::
::::
::::::
:::::::
...
-   [ALBCOM - Algorithms, Computational Biology, Complexity and Formal
    Methods](/en/research/resarch-groups/albcom-algorithms-computational-biology-complexity-and-formal-methods){.active-trail
    .active}
-   [ARCO - Architectures and
    Compilers](/en/research/resarch-groups/arco-architectures-and-compilers)
-   [CAP - High Performace Computing
...
::::::::: content
:::::::: {#node-16662 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The ALgorithms, Bioinformatics, COmplexity and formal Methods research
group (ALBCOM) is mainly formed by members of the Department of Computer
Science.

The group focuses on algorithmic and theoretical aspects related to
computational difficulty of problem-solving. The main research areas
are:
...
::: field
[ Website ]{.field-label} [ <http://albcom.cs.upc.edu/> ]{.field-items}
:::

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/ALBCOM?locale=en)
:::::::
::::::::
:::::::::
:::::::::::
