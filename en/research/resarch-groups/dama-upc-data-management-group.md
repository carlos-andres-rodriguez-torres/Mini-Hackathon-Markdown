---
description: The DAta MAnagement research group (DAMA) is formed by
  members of the Department of Computer Architecture. It is member of
  Tecnio since 2005, an initiative from ACCIO (Agency for Innovation and
  Internationalization of Catalan enterprise, belonging to Generalitat
  de Catalunya), it is recognised by the Catalan Government as a
  Consolidated Research Group. The main research topics
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: DAMA-UPC - Data Management Group \| FIB - Barcelona School of
  Informatics
twitter:card: summary
twitter:description: The DAta MAnagement research group (DAMA) is formed
  by members of the Department of Computer Architecture. It is member of
  Tecnio since 2005, an initiative from ACCIO (Agency for Innovation and
twitter:title: DAMA-UPC - Data Management Group
twitter:url: "https://www.fib.upc.edu/en/research/resarch-groups/dama-upc-data-management-group"
...
-   [Research](/en/research)
    ...
    -   [Research Groups](/en/research/research-groups)
        ...
        -   [DAMA-UPC - Data Management
            Group](/en/research/resarch-groups/dama-upc-data-management-group){.active}
...
Groups](/en/research/research-groups) » DAMA-UPC - Data Management Group
:::
::::
::::::
:::::::
...
-   [CNDS - Computer Networks and Distributed
    Systems](/en/research/research-groups/cnds-computer-networks-and-distributed-systems)
-   [DAMA-UPC - Data Management
    Group](/en/research/resarch-groups/dama-upc-data-management-group){.active-trail
    .active}
...
::::::::: content
:::::::: {#node-16672 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The DAta MAnagement research group (DAMA) is formed by members of the
Department of Computer Architecture. It is member of Tecnio since 2005,
an initiative from ACCIO (Agency for Innovation and Internationalization
of Catalan enterprise, belonging to Generalitat de Catalunya), it is
recognised by the Catalan Government as a Consolidated Research Group.

The main research topics of this group are oriented to performance,
exploration and quality in data management, focusing particularly on
large data volumes. We investigate the creation of new data structures,
algorithms, methods and applications in the area of Data Management that
make it easier to manipulate large amounts of data.
:::
::::
:::::

::: field
[ Website ]{.field-label} [ <http://www.dama.upc.edu/en> ]{.field-items}
:::

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/DAMA-UPC?locale=en)
:::::::
::::::::
:::::::::
:::::::::::
