---
description: "The Computer Networks and Distributed Systems research
  group (CNDS) is formed by professors of the Department of Computer
  Architecture. It is divided in two subgroups: the Statistical Analysis
  of Networks and Systems (SANS) and the Distributed Systems Group
  (DSG). The SANS group focuses its research on the capture and
  statistical analysis of data from Internet of Things"
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: CNDS - Computer Networks and Distributed Systems \| FIB -
  Barcelona School of Informatics
twitter:card: summary
twitter:description: "The Computer Networks and Distributed Systems
  research group (CNDS) is formed by professors of the Department of
  Computer Architecture. It is divided in two subgroups: the Statistical
  Analysis of"
twitter:title: CNDS - Computer Networks and Distributed Systems
twitter:url: "https://www.fib.upc.edu/en/research/research-groups/cnds-computer-networks-and-distributed-systems"
...
-   [Research](/en/research)
    ...
    -   [Research Groups](/en/research/research-groups)
        ...
        -   [CNDS - Computer Networks and Distributed
            Systems](/en/research/research-groups/cnds-computer-networks-and-distributed-systems){.active}
...
:::: content
::: page_title_no_sub
# CNDS - Computer Networks and Distributed Systems {#cnds---computer-networks-and-distributed-systems .page_title}
:::
::::
::::::
:::::::
...
Groups](/en/research/research-groups) » CNDS - Computer Networks and
Distributed Systems
:::
::::
::::::
...
-   [CBA - Broadband Communications
    Systems](/en/research/resarch-groups/cba-broadband-communications-systems)
-   [CNDS - Computer Networks and Distributed
    Systems](/en/research/research-groups/cnds-computer-networks-and-distributed-systems){.active-trail
    .active}
-   [DAMA-UPC - Data Management
    Group](/en/research/resarch-groups/dama-upc-data-management-group)
...
::::::::: content
:::::::: {#node-16670 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The Computer Networks and Distributed Systems research group (CNDS) is
formed by professors of the Department of Computer Architecture. It is
divided in two subgroups: the [Statistical Analysis of Networks and
Systems (SANS)](http://sans.ac.upc.edu/) and the [Distributed Systems
Group (DSG)](http://dsg.ac.upc.edu/node/607).

The SANS group focuses its research on the capture and statistical
analysis of data from Internet of Things devices, applied to different
areas such as environmental supervision, smart cities or the analysis of
mobility patterns. On the other hand, the DSG works on large scale and
centralized community networks and community clouds, on economic
oriented distributed systems, particularly on resource allocation
mechanisms for grid and peer-to-peer, on decentralised systems applied
to Ambient Networks and on applications supporting cooperative learning
(CSCL).
:::
::::
:::::
...
::: field
[ Website ]{.field-label} [ <http://research.ac.upc.es/cnds/>
]{.field-items}
:::
...
researchers: [futur.upc.edu](http://futur.upc.edu/CNDS?locale=en)
:::::::
::::::::
:::::::::
:::::::::::
