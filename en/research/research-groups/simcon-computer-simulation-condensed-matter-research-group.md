---
description: The Computer Simulation in Condensed Matter research group
  (SIMCOM) is formed by members of the Department of Physics. \[column
  cols=6 begin=1\]\[/column\] \[column cols=\"6\" end=\"1\"\]Their
  objective is the study of the microscopic properties of liquids and
  solids by computer simulation. This methodology allows a better
  knowledge of the properties of matter at atomic level, basically
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: SIMCON - Computer Simulation in Condensed Matter Research Group
  \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: The Computer Simulation in Condensed Matter
  research group (SIMCOM) is formed by members of the Department of
  Physics. \[column cols=6 begin=1\]\[/column\] \[column cols=\"6\"
  end=\"1\"\]Their objective is the
twitter:title: SIMCON - Computer Simulation in Condensed Matter Research
  Group
twitter:url: "https://www.fib.upc.edu/en/research/research-groups/simcon-computer-simulation-condensed-matter-research-group"
...
-   [Research](/en/research)
    ...
    -   [Research Groups](/en/research/research-groups)
        ...
        -   [SIMCON - Computer Simulation in Condensed Matter Research
            Group](/en/research/research-groups/simcon-computer-simulation-condensed-matter-research-group){.active}
        -   [SOCO - Soft
...
:::: content
::: page_title_no_sub
# SIMCON - Computer Simulation in Condensed Matter Research Group {#simcon---computer-simulation-in-condensed-matter-research-group .page_title}
:::
::::
::::::
:::::::
...
Groups](/en/research/research-groups) » SIMCON - Computer Simulation in
...
-   [MPI - Information Modelling &
    Processing](/en/research/research-groups/mpi-information-modelling-processing)
-   [SIMCON - Computer Simulation in Condensed Matter Research
    Group](/en/research/research-groups/simcon-computer-simulation-condensed-matter-research-group){.active-trail
    .active}
-   [SOCO - Soft
    Computing](/en/research/research-groups/soco-soft-computing)
-   [SUSHITOS - Services for Ubiquitous Social and Humanistic
...
:::::::::::: content
::::::::::: {#node-17304 .node .node-entitat-recerca .clearfix}
:::::::::: content
::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::: field-items
:::::: {.field-item .even}
The Computer Simulation in Condensed Matter research group (SIMCOM) is
formed by members of the Department of Physics.
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
Their objective is the study of the microscopic properties of liquids
and solids by computer simulation. This methodology allows a better
knowledge of the properties of matter at atomic level, basically the
structure and non-electronic transport properties in classic liquids,
the characteristics of crystal defects and structural and thermodynamics
properties in quantum matter.
...
::: field
[ Website ]{.field-label} [ <http://simcon.upc.edu/en> ]{.field-items}
:::

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/SIMCON?locale=en)
::::::::
:::::::::
::::::::::
:::::::::::
