...
description: \[column cols=6 begin=1\]\[/column\] \[column cols=\"6\"
  end=\"1\"\]The Information Modelling & Processing research group (MPI)
  is formed by members from different departments (Computer
  Architecture, Service and Information System Engineering, Automatic
  Control and Statistics and Operations Research), as well as from inLab
  FIB, the Universitat Oberta de Catalunya and the Universitat
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: MPI - Information Modelling & Processing \| FIB - Barcelona
  School of Informatics
twitter:card: summary
twitter:description: \[column cols=6 begin=1\]\[/column\] \[column
  cols=\"6\" end=\"1\"\]The Information Modelling & Processing research
  group (MPI) is formed by members from different departments (Computer
  Architecture, Service
twitter:title: MPI - Information Modelling & Processing
twitter:url: "https://www.fib.upc.edu/en/research/research-groups/mpi-information-modelling-processing"
...
-   [Research](/en/research)
    ...
    -   [Research Groups](/en/research/research-groups)
        ...
        -   [MPI - Information Modelling &
            Processing](/en/research/research-groups/mpi-information-modelling-processing){.active}
...
:::: content
::: page_title_no_sub
# MPI - Information Modelling & Processing {#mpi---information-modelling-processing .page_title}
:::
::::
::::::
:::::::
...
Groups](/en/research/research-groups) » MPI - Information Modelling &
Processing
:::
::::
::::::
...
-   [MD - Discrete
    Mathematics](/en/research/research-groups/md-discrete-mathematics)
-   [MPI - Information Modelling &
    Processing](/en/research/research-groups/mpi-information-modelling-processing){.active-trail
    .active}
-   [SIMCON - Computer Simulation in Condensed Matter Research
    Group](/en/research/research-groups/simcon-computer-simulation-condensed-matter-research-group)
-   [SOCO - Soft
...
:::::::::::: content
::::::::::: {#node-17303 .node .node-entitat-recerca .clearfix}
:::::::::: content
...
Operations Research), as well as from inLab FIB, the Universitat Oberta
de Catalunya and the Universitat Pompeu Fabra.
:::
:::::

The group's activity is focused on research, technology transfer and
teaching related to modelling and processing of information in aspects
such as conceptual modelling, quality of databases, business
intelligence, data mining o engineering services.
...
::: field
[ Website ]{.field-label} [ <http://imp.upc.edu/> ]{.field-items}
:::

## Scientific Production

Take a look at the Website for the scientific production of UPC
researchers: [futur.upc.edu](http://futur.upc.edu/MPI?locale=en)
::::::::::
:::::::::::
::::::::::::
::::::::::::::
