---
description: \[column cols=\"7\" begin=\"1\"\] Bachelor\'s Degree in
  Informatics Engineering Do you have a passion for New Technologies? Do
  you want to learn how to create and innovate by using them? The
  Facultat d\'Informàtica de Barcelona (FIB) is one of the pioneering
  Spanish center which delivers university training in Informatics. You
  can get information about everything that you should know
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Do you want to study a bachelor\'s degree? \| FIB - Barcelona
  School of Informatics
twitter:card: summary
twitter:description: \[column cols=\"7\" begin=\"1\"\] Bachelor\'s
  Degree in Informatics Engineering Do you have a passion for New
  Technologies? Do you want to learn how to create and innovate by using
  them? The Facultat
twitter:title: Do you want to study a bachelor\'s degree?
twitter:url: "https://www.fib.upc.edu/en/studies/bachelors-degrees/do-you-want-study-bachelors-degree"
...
-   [Studies](/en/studies)
    -   [Bachelor\'s degrees](/en/studies/bachelors-degrees)
        -   [Do you want to study a bachelor\'s
            degree?](/en/studies/bachelors-degrees/do-you-want-study-bachelors-degree){.active}
            -   [Access to
                studies](/en/studies/bachelors-degrees/do-you-want-study-bachelors-degree/access-studies)
        -   [Bachelor Degree in Informatics
...
:::: content
::: page_title_no_sub
# Do you want to study a bachelor\'s degree? {#do-you-want-to-study-a-bachelors-degree .page_title}
:::
::::
::::::
:::::::
...
degrees](/en/studies/bachelors-degrees) » Do you want to study a
bachelor\'s degree?
:::
::::
::::::
...
::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::: {#node-16471 .node .node-page .clearfix}
::::::::::::::::::::::::::::::: content
...
::: block-subtitle
Do you have a passion for New Technologies? Do you want to learn how to
create and innovate by using them?
:::

The Facultat d\'Informàtica de Barcelona (FIB) is one of the pioneering
Spanish center which delivers university training in Informatics. You
can get information about everything that you should know concerning the
FIB degree in Informatics Engineering on the website **[I love
bits](/en/ilovebits){target="_blank"}**.\
\

::: {.dexp-animate animate="fadeInLeft"}
[     Degree in Informatics
Engineering](/ca/ilovebits){.dexp-shortcodes-button .btn .btn-link
role="button"}
:::
:::::
...
[![Grau
Bioinformàtica](/sites/fib/files/images/estudis/foto-anna.png)](http://www.ilovebits.fib.upc.edu/ilovebits-en){target="_blank"}
:::
:::::::
...
::: block-subtitle
Do you want to develop intelligent systems capable of understanding data
and learning from them to improve our quality of life?
:::

The Facultat d\'Informàtica de Barcelona, the Escola Tècnica Superior
d\'Enginyeria de Telecomunicació de Barcelona and the Facultat de
Matemàtiques i Estadística offer a 4-year Degree in Data Science and
Engineering that aims to train professionals in analysis and structured
and unstructured data engineering.

::: {.dexp-animate animate="fadeInLeft"}
[     Bachelor Degree in Data Science and
Engineering](/en/studies/bachelors-degrees/bachelor-degree-data-science-and-engineering){.dexp-shortcodes-button
...
The Facultat d\'Informàtica de Barcelona is hte first spannish center
that offers the possibility of studying the IA formation as a
bacherlor\'s degree, master and doctorate, sharing experience, teachers
and internships with other informatic areas.

::: {.dexp-animate animate="fadeInLeft"}
[      Bachelor\'s Degree in Artificial
Intelligence](/ca/estudis/graus/grau-en-intelligencia-artificial){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::
...
::::::: row
::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[![](/sites/fib/files/images/estudis/bioinformaticamidaweb.png)](/en/studies/bachelors-degrees/bachelor-degree-bioinformatics){target="_blank"}
:::

::::: {.col-xs-12 .col-sm-7 .col-md-7 .col-lg-7}
::: block-subtitle
Would you like to use the informatics approach on the study of
biological systems?
:::
...
Bachelor\'s **Degree in Bioinformatics** taught entirely in English. The
degree is managed by FIB-UPC, and lectures are delivered at Campus Nord
(FIB-ETSETB), Mar Campus (UPF), Biology School (UB) and Facultat de
Biociències (UAB).

::: {.dexp-animate animate="fadeInLeft"}
[     Bachelor\'s Degree in
Bioinformatics](/en/studies/bachelors-degrees/bachelor-degree-bioinformatics){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::
:::::::
...
::::: {.col-xs-12 .col-sm-7 .col-md-7 .col-lg-7}
::: block-subtitle
Do you want to obtain both degrees by getting the maximum level in the
field?
:::
...
::: {.dexp-animate animate="fadeInLeft"}
[     Integrated Bachelor Master
Degree](/en/studies/bachelors-degrees/integrated-bachelor-master-degree){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::

::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[![](/sites/fib/files/images/estudis/grau-master-enginyeria-informatica-programa-successiu.png){style="width: 449px; height: 236px;"}](/en/studies/bachelors-degrees/integrated-bachelor-master-degree)
:::
:::::::
