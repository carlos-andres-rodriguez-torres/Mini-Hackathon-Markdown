...
theme-color: "#ffffff"
title: Master in Computational Modelling in Physics, Chemistry and
  Biochemistry \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:title: Master in Computational Modelling in Physics, Chemistry
  and
twitter:url: "https://www.fib.upc.edu/en/studies/masters/other-masters/master-computational-modelling-physics-chemistry-and-biochemistry"
...
-   [Studies](/en/studies)
    ...
    -   [Masters](/en/studies/masters)
        ...
        -   [Other Masters](/en/studies/masters/other-masters)
            -   [Master in Computational Modelling in Physics, Chemistry
                and
                Biochemistry](/en/studies/masters/other-masters/master-computational-modelling-physics-chemistry-and-biochemistry){.active}
            -   [Master in Pure and Applied
                Logic](/en/studies/masters/other-masters/master-pure-and-applied-logic)
...
:::: content
::: page_title_no_sub
# Master in Computational Modelling in Physics, Chemistry and Biochemistry {#master-in-computational-modelling-in-physics-chemistry-and-biochemistry .page_title}
:::
::::
::::::
:::::::
...
[Other Masters](/en/studies/masters/other-masters) » Master in
...
-   [Master in Computational Modelling in Physics, Chemistry and
    Biochemistry](/en/studies/masters/other-masters/master-computational-modelling-physics-chemistry-and-biochemistry){.active-trail
    .active}
-   [Master in Pure and Applied
    Logic](/en/studies/masters/other-masters/master-pure-and-applied-logic)
:::
...
:::::::::::::::::::::::::::::::::: content
::::::::::::::::::::::::::::::::: {#node-16527 .node .node-estudis .node-promoted .clearfix}
:::::::::::::::::::::::::::::::: content
::: {.dexp-animate animate="fadeInLeft"}
This master aims at providing the students a global vision of the
programming and computing tools to tackle the problems related to
Physics, Chemistry and Biochemistry where the structure and properties
of the material at the atomic and molecular level is relevant.

The students will acquire the knowledge needed to decide what simulation
techniques are best suited for each problem, according to the size
(length scale) and depending on the period of time (time scale) in which
the process unfolds.
:::
...
::: {.col-xs-12 .col-sm-9 .col-md-9 .col-lg-9 .field-items}
The master has 60 ECTS credits, distributed into core subjects (21
ECTS), elective subjects (21 ECTS) and the master thesis (18 ECTS).
:::
:::::
...
::: {.col-xs-12 .col-sm-9 .col-md-9 .col-lg-9 .field-items}
[Master in Computational Modelling in Physics, Chemistry and
Biochemistry](https://www.ub.edu/portal/web/chemistry/university-master-s-degrees/-/ensenyament/detallEnsenyament/4382734)
:::
:::::
::::::::::::::::::
:::::::::::::::::::
...
::: box-content
The master has direct access for those students who have completed 240
ECTS in Physics, Chemistry, Biochemistry, Chemical Engineering,
