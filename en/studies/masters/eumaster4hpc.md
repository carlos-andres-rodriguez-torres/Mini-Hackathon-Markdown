...
theme-color: "#ffffff"
title: EUMaster4HPC \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:title: EUMaster4HPC
twitter:url: "https://www.fib.upc.edu/en/studies/masters/eumaster4hpc"
...
::: content
-   [Català]{.language-link .locale-untranslated lang="ca"}
-   [English](/en/studies/masters/eumaster4hpc){.language-link .active
    lang="en"}
...
-   [Studies](/en/studies)
    ...
    -   [Masters](/en/studies/masters)
        ...
        -   [Master in Urban
            ...
            -   [Curriculum](/en/studies/masters/master-urban-mobility/curriculum)
        -   [EUMaster4HPC](/en/studies/masters/eumaster4hpc){.active}
            -   [Curriculum](/en/studies/masters/eumaster4hpc/curriculum)
...
:::: content
::: page_title_no_sub
# EUMaster4HPC {#eumaster4hpc .page_title}
:::
::::
::::::
:::::::
...
-   [Master in Urban
    Mobility](/en/studies/masters/urban-mobility-master)
-   [EUMaster4HPC](/en/studies/masters/eumaster4hpc){.active-trail
    .active}
    -   [Curriculum](/en/studies/masters/eumaster4hpc/curriculum)
-   [Other Masters](/en/studies/masters/other-masters)
:::
...
::::::::::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::::::::::: {#node-23276 .node .node-estudis .node-promoted .clearfix}
::::::::::::::::::::::::::::::::::::::: content
::: {.dexp-animate animate="fadeInLeft"}
UPC is one of the eight awarding universities of the Pan-European High
Performance Computing Pilot Master's programme, "EUMaster4HPC". This
programme brings together major players in HPC education in Europe and
emphasises collaboration across Europe with innovative teaching
paradigms such as co-teaching and strong connections with the industry
and the best specialists in HPC education to develop the most relevant
and up-to-date teaching content. A particular focus on mobility of
students and teachers will enable students to rapidly gain experience
through internships and exposure to European supercomputing centres.\
The study programme will provide a balanced curriculum between the
computer science aspects and other aspects of HPC, available on the
different partners. The students will have the opportunity to do an
internship in an academic laboratory or an industrial group.

EUMaster4HPC brings together major players in HPC education in Europe
and mobilises them to unify existing programs into a common European
curriculum. It leverages experience from various European countries and
HPC communities to generate European added value beyond the potential of
...
::: {.col-xs-12 .col-sm-9 .col-md-9 .col-lg-9 .field-items}
Scholarship from the EUMaster4HPC program to support expenses inherent
to the programme (travel and accommodation). 
:::
:::::
...
::: {.col-xs-12 .col-sm-9 .col-md-9 .col-lg-9 .field-items}
[European Master For High Performance
Computing](https://eumaster4hpc.uni.lu/)
:::
:::::
::::::::::::::::::
:::::::::::::::::::
...
::: box-content
Interest in solving engineering and scientific problems using computers
and High Performance Computing.

Entry Requirements:

-   Bachelor's degree from STEM or equivalent qualification in computer
    science, a relevant scientific or technical field, or mathematics.
-   Knowledge of programming or more than 2 university courses in
    computer science from data structures, algorithms, programming or
    theoretical or technical computer science.
-   Comprehensive training in technical mathematics: algebra, linear
    algebra and probability and statistics,  functional analysis,
    numerics, optimisation, simulation / scientific computing
-   Proficiency in  English of at least CEFR B2
-   Obligation to relocate for the second year of the master to another
    awarding university
...
[![](/sites/fib/files/images/estudis/logo-kth.png)](https://www.kth.se/en){target="_blank"}
:::

::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[![](/sites/fib/files/images/estudis/logo-svizzera-italia-university.png)](https://www.usi.ch/en){target="_blank"}
:::

::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[![](/sites/fib/files/images/estudis/logo-sofia-university.png)](https://www.uni-sofia.bg/eng){target="_blank"}
:::

::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[![](/sites/fib/files/images/estudis/logo-sorbonne-university.png)](https://www.sorbonne-universite.fr/en){target="_blank"}
:::
:::::::

::::::: row
::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[![](/sites/fib/files/images/estudis/logo-fau-university.png)](https://www.fau.de/){target="_blank"}
:::

::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[![Polimi](/sites/fib/files/images/estudis/logo-polimimi-400x100.png)](https://www.polimi.it/en){target="_blank"}
:::
...
::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[![](/sites/fib/files/images/estudis/logo-luxembourg-university.png)](https://www.uni.lu/en/){target="_blank"}
:::
:::::::
:::::::::::::
::::::::::::::
