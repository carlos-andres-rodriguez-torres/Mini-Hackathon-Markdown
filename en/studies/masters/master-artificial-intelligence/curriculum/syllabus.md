---
description: Subjects of the Master in Artificial Intelligence
...
twitter:url: "https://www.fib.upc.edu/en/studies/masters/master-artificial-intelligence/curriculum/syllabus"
    ...
    -   [Masters](/en/studies/masters)
        ...
        -   [Master in Artificial
            ...
            -   [Curriculum](/en/studies/masters/master-artificial-intelligence/curriculum)
                -   [Syllabus](/en/studies/masters/master-artificial-intelligence/curriculum/syllabus){.active}
                -   [Competences](/en/studies/masters/master-artificial-intelligence/curriculum/competences)
                -   [Competences for degree
                    subjects](/en/studies/masters/master-artificial-intelligence/curriculum/competences-degree-subjects)
            -   [Faculty](/en/studies/masters/master-artificial-intelligence/faculty)
...
-   [Syllabus](/en/studies/masters/master-artificial-intelligence/curriculum/syllabus){.active-trail
    .active}
-   [Competences](/en/studies/masters/master-artificial-intelligence/curriculum/competences)
-   [Competences for degree
    subjects](/en/studies/masters/master-artificial-intelligence/curriculum/competences-degree-subjects)
...
:::::::: content
::::::: {#node-16747 .node .node-page .clearfix}
:::::: content
...
**Q1**:September-January **Q2**:February-June
  ...
  --------- ---------------------------------------------------------------- ------------
  CI        [Computational Intelligence](syllabus/CI-MAI)                    Q1
  CV        [Computational Vision](syllabus/CV-MAI)                          Q1
  IHLT      [Introduction to Human Language Technology](syllabus/IHLT-MAI)   Q1
  IMAS      [Introduction to Multiagent Systems](syllabus/IMAS-MAI)          Q1
  IML       [Introduction to Machine Learning](syllabus/IML-MAI)             Q1
  PAR       [Planning and Approximate Reasoning](syllabus/PAR-MAI)           Q1
...
### Data Science and Computational Intelligence
  ...
  Acronym   Complete name                                                        Open 24-25
  --------- -------------------------------------------------------------------- ------------
  ATCI      [Advanced Topics in Computational Intelligence](syllabus/ATCI-MAI)   Q2
  BDA       [Big Data Analytics](syllabus/BDA-MAI)                               Q1
  CN        [Complex Networks](syllabus/CN-MAI)                                  Q2
  DL        [Deep Learning](syllabus/DL-MAI)                                     
  IDADM     [Intelligent Data Analysis and Data Mining](syllabus/IDADM-MAI)      Q1
  MBM       [Minds, Brains and Machines](syllabus/MBM-MAI)                       Q2
...
### Human-Computer Interaction
  ...
  CIR       [Cognitive Interaction with Robots](syllabus/CIR-MAI)        Q1
  HCI       [Human-Computer Interaction](syllabus/HCI-MAI)               Q2
  HLE       [Human Language Engineering](syllabus/HLE-MAI)               Q1

### Knowledge Engineering and Machine Learning

  Acronym   Complete name                                                                Open 24-25
  --------- ---------------------------------------------------------------------------- ------------
  IDSS      [Intelligent Decision Support Systems](syllabus/IDSS-MAI)                    Q1
  PMCDSS    [Personalized Multicriteria Decision Support Systems](syllabus/PMCDSS-MAI)   Q2
  SEL       [Supervised and Experiential Learning](syllabus/SEL-MAI)                     Q2
  URL       [Unsupervised and Reinforcement Learning](syllabus/URL-MAI)                  Q2

### Multi-Agent Systems

  Acronym   Complete name                                               Open 24-25
  --------- ----------------------------------------------------------- ------------
  MASD      [Multiagent System Design](syllabus/MASD-MAI)               Q2
  NDVW      [Normative and Dynamic Virtual Worlds](syllabus/NDVW-MAI)   Q1
  SOAS      [Self Organizing Multiagent Systems](syllabus/SOAS-MAI)     Q2

### Modelling, Reasoning and Problem Solving

  Acronym   Complete name                                               Open 24-25
  --------- ----------------------------------------------------------- ------------
  CPP       [Constraint Processing and Programming](syllabus/CPP-MAI)   Q1
  LAI       [Logics for Artificial Intelligence](syllabus/LAI-MAI)      Q2
  PGM       [Probabilistic Graphical Models](syllabus/PGM-MAI)          

### Hot Topics in AI and Professional Practice

  Acronym   Complete name                                                              Open 24-25
  --------- -------------------------------------------------------------------------- ------------
  AIHC      [Artificial Intelligence in Health Care](syllabus/AIHC-MAI)                Q1
  AIS       [Artificial Intelligence Seminar](syllabus/AIS-MAI)                        Q2
  IDAAB     [Intelligent Data Analysis Applications in Business](syllabus/IDAAB-MAI)   
  ISP       [Intelligent System Project](syllabus/ISP-MAI)                             Q1
  NOLD      Nlp Over Open Linked Data                                                  
  NTR       [New Trends in Robotics](syllabus/NTR-MAI)                                 Q1
  PPAI      [Professional Practice in Artificial Intelligence](syllabus/PPAI-MAI)      Q1, Q2

### Vision, Perception and Robotics. Assistive Technologies

  Acronym   Complete name                                                    Open 24-25
  --------- ---------------------------------------------------------------- ------------
  AHCT      [Assistive and Health-Care Technologies](syllabus/AHCT-MAI)      Q1
  AVPR      [Artificial Vision & Pattern Recognition](syllabus/AVPR-MAI)     Q1
  COR       [Cognitive Robotics](syllabus/COR-MAI)                           Q2
  DLMIA     [Deep Learning for Medical Image Analysis](syllabus/DLMIA-MAI)   Q1
  MLCG      [Machine Learning in Computer Graphics](syllabus/MLCG-MAI)       
  MRS       [Multi-Robot Systems](syllabus/MRS-MAI)                          
  OR        [Object Recognition](syllabus/OR-MAI)                            Q2
...
## Extinct Subjects
  ...
  --------- ---------------------------------------------------------------
  AAV       [Advanced Artificial Vision](syllabus/AAV-MAI)
  AMLT      [Advanced Machine Learning Techniques](syllabus/AMLT-MAI)
  ANLP      [Advanced Natural Language Processing](syllabus/ANLP-MAI)
  CR        [Cooperative Robotics](syllabus/CR-MAI)
  KRE       [Knowledge and Representation Engineering](syllabus/KRE-MAI)
  MCDSS     [Multi-Criteria Decision Support Systems](syllabus/MCDSS-MAI)
:::
::::
:::::
::::::
