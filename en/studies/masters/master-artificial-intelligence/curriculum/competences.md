...
twitter:url: "https://www.fib.upc.edu/en/studies/masters/master-artificial-intelligence/curriculum/competences"
    ...
    -   [Masters](/en/studies/masters)
        ...
        -   [Master in Artificial
            ...
            -   [Curriculum](/en/studies/masters/master-artificial-intelligence/curriculum)
                -   [Syllabus](/en/studies/masters/master-artificial-intelligence/curriculum/syllabus)
                -   [Competences](/en/studies/masters/master-artificial-intelligence/curriculum/competences){.active}
                -   [Competences for degree
                    subjects](/en/studies/masters/master-artificial-intelligence/curriculum/competences-degree-subjects)
            -   [Faculty](/en/studies/masters/master-artificial-intelligence/faculty)
            -   [Academic
...
-   [Syllabus](/en/studies/masters/master-artificial-intelligence/curriculum/syllabus)
-   [Competences](/en/studies/masters/master-artificial-intelligence/curriculum/competences){.active-trail
    .active}
-   [Competences for degree
    subjects](/en/studies/masters/master-artificial-intelligence/curriculum/competences-degree-subjects)
:::
...
:::::::::::: content
::::::::::: {#node-16764 .node .node-page .clearfix}
:::::::::: content
...
-   [**CT1**\
    Capability to know and understand a business organization and the
    science that defines its activity; capability to understand the
    labor rules and the relations between planning, industrial and
    commercial strategies, quality and profit.]{#CT1}

### SUSTAINABILITY AND SOCIAL COMMITMENT

-   [**CT2**\
    Capability to know and understand the complexity of economic and
    social typical phenomena of the welfare society; capability to
    relate welfare with globalization and sustainability; capability to
    use technique, technology, economics and sustainability in a
    balanced and compatible way.]{#CT2}

### TEAMWORK

-   [**CT3**\
    Ability to work as a member of an interdisciplinary team, as a
    normal member or performing direction tasks, in order to develop
    projects with pragmatism and sense of responsibility, making
    commitments taking into account the available resources.]{#CT3}

### INFORMATION LITERACY

-   [**CT4**\
    Capacity for managing the acquisition, the structuring, analysis and
    visualization of data and information in the field of
    specialisation, and for critically assessing the results of this
    management.]{#CT4}

### APPROPIATE ATTITUDE TOWARDS WORK

-   [**CT5**\
    Capability to be motivated for professional development, to meet new
    challenges and for continuous improvement. Capability to work in
    situations with lack of information.]{#CT5}

### REASONING

-   [**CT6**\
    Capability to evaluate and analyze on a reasoned and critical way
    about situations, projects, proposals, reports and
    scientific-technical surveys. Capability to argue the reasons that
    explain or justify such situations, proposals, etc..]{#CT6}

### ANALISIS Y SINTESIS

-   [**CT7**\
    Capability to analyze and solve complex technical problems.]{#CT7}
...
-   [**CG1**\
    Capability to plan, design and implement products, processes,
    services and facilities in all areas of Artificial
    Intelligence.]{#CG1}
-   [**CG2**\
    Capability to lead, plan and supervise multidisciplinary
    teams.]{#CG2}
-   [**CG3**\
    Capacity for modeling, calculation, simulation, development and
    implementation in technology and company engineering centers,
    particularly in research, development and innovation in all areas
    related to Artificial Intelligence.]{#CG3}
-   [**CG4**\
    ...
    technology centers in the area of Artificial Intelligence.]{#CG4}
:::
...
-   [**CEA1**\
    Capability to understand the basic principles of the Multiagent
    Systems operation main techniques , and to know how to use them in
    the environment of an intelligent service or system.]{#CEA1}
-   [**CEA2**\
    Capability to understand the basic operation principles of Planning
    and Approximate Reasoning main techniques, and to know how to use in
    the environment of an intelligent system or service.]{#CEA2}
-   [**CEA3**\
    Capability to understand the basic operation principles of Machine
    Learning main techniques, and to know how to use on the environment
    of an intelligent system or service.]{#CEA3}
-   [**CEA4**\
    Capability to understand the basic operation principles of
    Computational Intelligence main techniques, and to know how to use
    in the environment of an intelligent system or service.]{#CEA4}
-   [**CEA5**\
    Capability to understand the basic operation principles of Natural
    Language Processing main techniques, and to know how to use in the
    environment of an intelligent system or service.]{#CEA5}
-   [**CEA6**\
    Capability to understand the basic operation principles of
    Computational Vision main techniques, and to know how to use in the
    environment of an intelligent system or service.]{#CEA6}
-   [**CEA7**\
    Capability to understand the problems, and the solutions to problems
    in the professional practice of Artificial Intelligence application
    in business and industry environment.]{#CEA7}
-   [**CEA8**\
    Capability to research in new techniques, methodologies,
    architectures, services or systems in the area of ??Artificial
    Intelligence.]{#CEA8}
-   [**CEA9**\
    Capability to understand Multiagent Systems advanced techniques, and
    to know how to design, implement and apply these techniques in the
    development of intelligent applications, services or
    systems.]{#CEA9}
-   [**CEA10**\
    Capability to understand advanced techniques of Human-Computer
    Interaction, and to know how to design, implement and apply these
    techniques in the development of intelligent applications, services
    or systems.]{#CEA10}
-   [**CEA11**\
    Capability to understand the advanced techniques of Computational
    Intelligence, and to know how to design, implement and apply these
    techniques in the development of intelligent applications, services
    or systems.]{#CEA11}
-   [**CEA12**\
    Capability to understand the advanced techniques of Knowledge
    Engineering, Machine Learning and Decision Support Systems, and to
    know how to design, implement and apply these techniques in the
    development of intelligent applications, services or
    systems.]{#CEA12}
-   [**CEA13**\
    Capability to understand advanced techniques of Modeling , Reasoning
    and Problem Solving, and to know how to design, implement and apply
    these techniques in the development of intelligent applications,
    services or systems.]{#CEA13}
-   [**CEA14**\
    Capability to understand the advanced techniques of Vision,
    Perception and Robotics, and to know how to design, implement and
    apply these techniques in the development of intelligent
    applications, services or systems.]{#CEA14}

### PROFESSIONAL

-   [**CEP1**\
    Capability to solve the analysis of information needs from different
    organizations, identifying the uncertainty and variability
    sources.]{#CEP1}
-   [**CEP2**\
    Capability to solve the decision making problems from different
    organizations, integrating intelligent tools.]{#CEP2}
-   [**CEP3**\
    Capacity for applying Artificial Intelligence techniques in
    technological and industrial environments to improve quality and
    productivity.]{#CEP3}
-   [**CEP4**\
    Capability to design, write and report about computer science
    projects in the specific area of ??Artificial Intelligence.]{#CEP4}
-   [**CEP5**\
    Capability to design new tools and new techniques of Artificial
    Intelligence in professional practice.]{#CEP5}
-   [**CEP6**\
    Capability to assimilate and integrate the changing economic, social
    and technological environment to the objectives and procedures of
    informatic work in intelligent systems.]{#CEP6}
-   [**CEP7**\
    Capability to respect the legal rules and deontology in professional
    practice.]{#CEP7}
-   [**CEP8**\
    Capability to respect the surrounding environment and design and
    develop sustainable intelligent systems.]{#CEP8}
:::
:::::::
::::::::
:::::::::
