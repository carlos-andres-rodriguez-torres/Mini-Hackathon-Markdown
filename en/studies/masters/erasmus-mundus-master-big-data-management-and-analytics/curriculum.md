---
description: The Master in Big Data Management and Analytics (BDMA) is
  an Erasmus Mundus progamme of two years. BDMA is a program that covers
  the disciplines of data management and analysis in the field of
  massive data processing or Big Data (BD). To do this, it builds on the
  foundations of Business Intelligence (BI) and complements it with
  transversal competencies. This programme has been
...
twitter:description: The Master in Big Data Management and Analytics
  (BDMA) is an Erasmus Mundus progamme of two years. BDMA is a program
  that covers the disciplines of data management and analysis in the
  field of
twitter:title: Curriculum
twitter:url: "https://www.fib.upc.edu/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/curriculum"
...
-   [Studies](/en/studies)
    ...
    -   [Masters](/en/studies/masters)
        ...
        -   [Erasmus Mundus Master in Big Data Management and
            ...
            -   [Curriculum](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/curriculum){.active}
                -   [Syllabus](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/curriculum/syllabus)
            -   [Exams](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/exams)
            -   [Timetables](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/timetables)
        -   [Master in Urban
...
-   [Curriculum](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/curriculum){.active-trail
    .active}
    -   [Syllabus](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/curriculum/syllabus)
-   [Exams](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/exams)
-   [Timetables](/en/studies/masters/erasmus-mundus-master-big-data-management-and-analytics/timetables)
...
:::::::: content
::::::: {#node-18021 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The Master in Big Data Management and Analytics (BDMA) is an [Erasmus
Mundus](https://ec.europa.eu/programmes/erasmus-plus/opportunities/individuals/students/erasmus-mundus-joint-master-degrees_en) progamme
of two years.

BDMA is a program that covers the disciplines of data management and
analysis in the field of massive data processing or Big Data (BD). To do
this, it builds on the foundations of Business Intelligence (BI) and
complements it with transversal competencies. This programme has been
jointly designed by a consortium of European universities, among which
is the UPC, to provide the student with the necessary skills to be a
specialist in BI and BD.

Being an Erasmus Mundus, BDMA involves mobility. The following graph
outlines the necessary mobility:

![](/sites/fib/files/images/estudis/bdma-pla-estudis-2021-en-br.png)

The first and second semester are compulsory for all students, as well
as the summer school. In the third semester students choose a
specialisation: statistics and deep learning, business process analytics
or decision support. The last semester is intended for the master\'s
thesis.

After completing the programme, students receive a degree from ULB, UPC
and the university of specialization (TU/e, CS or UniPD). You can find
more information on the page: <http://bdma.ulb.ac.be/bdma/>
:::
::::
:::::
::::::
