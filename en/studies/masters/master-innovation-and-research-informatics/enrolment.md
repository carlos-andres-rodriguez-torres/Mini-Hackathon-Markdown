---
description: \[icon class=\'fa fa-info fa fa-2x\'\]In order to enrol in
  the master\'s degree as a new student, first you must process the
  admission to the master\'s degree (pre-enrolment). Check the
  information on admissions at the FIB Masters website.\[/icon\] \[icon
  class=\'fa fa-info-circle fa \'\]The enrolment in the UPC is
  four-monthly, twice per academic year (February and July). \[/icon\]
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Enrolment \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: \[icon class=\'fa fa-info fa fa-2x\'\]In order to
  enrol in the master\'s degree as a new student, first you must process
  the admission to the master\'s degree (pre-enrolment). Check the
  information on
twitter:title: Enrolment
twitter:url: "https://www.fib.upc.edu/en/studies/masters/master-innovation-and-research-informatics/enrolment"
...
-   [Studies](/en/studies)
    ...
    -   [Masters](/en/studies/masters)
        ...
        -   [Master in Innovation and Research in
            ...
            -   [Enrolment](/en/studies/masters/master-innovation-and-research-informatics/enrolment){.active}
                -   [Available
                    places](/en/studies/masters/master-innovation-and-research-informatics/enrolment/available-places)
...
:::: content
::: page_title_no_sub
# Enrolment {#enrolment .page_title}
:::
::::
::::::
:::::::
...
-   [Enrolment](/en/studies/masters/master-innovation-and-research-informatics/enrolment){.active-trail
    .active}
    -   [Available
        places](/en/studies/masters/master-innovation-and-research-informatics/enrolment/available-places)
-   [Curriculum](/en/studies/masters/master-innovation-and-research-informatics/curriculum)
...
:::::::::::::::::::: content
::::::::::::::::::: {#node-16651 .node .node-page .clearfix}
:::::::::::::::::: content
::::::::::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::::::::::: field-items
::::::::::::::: {.field-item .even}
::: {.alert .alert-info}
In order to enrol in the master\'s degree as a new student, first you
must **process the admission to the master\'s degree (pre-enrolment)**.
Check the information on admissions at the **[FIB Masters
website](https://masters.fib.upc.edu/)**.
:::

::: {.alert .alert-info}
The enrolment in the UPC is **four-monthly**, twice per academic year
(February and July).
:::

:::::::::::: {#dexp-accordions-wrapper-1740072925 .panel-group .default}
::::::: {.panel .panel-default}
::: panel-heading
#### [New Students](#dexp-accordion-item-1740072925){.collapsed parent="#dexp-accordions-wrapper-1740072925" toggle="collapse"} {#new-students .panel-title}
:::

::::: {#dexp-accordion-item-1740072925 .panel-collapse .collapse}
:::: panel-body
#### The enrolment is a contract between you and the University. Once enrolled, you must pay the associated fees.

-   As a student, you voluntarily and responsibly exercise your right to
    enroll. **When you enroll, it implies the payment of the established
    public fees in return of the academic services provided**, after the
    surcharges and the bonuses have been applied.
-   **The failure to pay the enrolment fees does not imply its
    cancellation**, but some penalties will be applied for payments made
    after the deadline. 
-   This contract obliges the UPC to provide the planned services, and
    requires you to pay them, and follow and respect the
    [regulations](http://www.upc.edu/sga/es/normativas/NormativasAcademicas/NAGRAMAyPROC),
    as a UPC student.

#### Online enrolment for new students

-   The enrolment of new students at the UPC will be made online via
    [e-Secretaria](https://prisma-nou.upc.edu/apl/home_estudiants.php?idioma=3).
-   The enrolment must be formalized on the assigned day and time.

::: {.alert .alert-info}
### Admission List

[Admission resolution 2024-2025 Spring
semester](/sites/fib/files/documents/estudis/resolucio-miri-2024-2.pdf)
...
Candidates must provide proof of their English proficiency, with at
least a **B2 level** in the [Common European Framework of Reference for
Languages](http://en.wikipedia.org/wiki/Common_European_Framework_of_Reference_for_Languages){target="_blank"}
(or equivalent).
...
-   <div>
    ...
    **Spanish students**, must provide the **original DNI**. **Foreign
    students**, must provide the **original of the ID card or passport
    from your country and NIE, if the Student already has it.** All
    these documents cannot be expired at the enrolment date.

    </div>

-   <div>

    If the enrolment payment has to be **charged directly** to a bank
    account, the document \"**direct charge order**\" is required (the
    document SEPA to be filled can be downloaded from the
    **[e-Secretaria](https://prisma-nou.upc.edu/estudiants/index_en.html){target="_blank"}**).
    It must be signed by the account holder and by the student,
...
-   <div>
    ...
    English knowledge **Certificate** (minimum: B2 of Common European
    Framework of Reference for Languages)

    </div>

-   **Original** of the **homologation of the qualification entitling**
    the applicant to enrol in the master\'s degree course. If the
    qualification is not homologated, the original of the document
    issued by the awarding university or institution or by the competent
    authority for such matters in the issuing country. This document
    must show that the awarded degree has a duration of, at least, three
    years and that the resulting qualification entitles the holder to
    pursue postgraduate studies (master\'s degree studies) in the
    issuing country. If that is not possible, it must indicate the level
    of higher education that the qualification entitles its holder to
    access.

-   **Original** of the **academic certificate** listing the subjects
    taken, the marks earned and the number of credits/hours of each one.
    This certificate must also explain the grading system used. If the
    applicant holds any additional qualifications in the field of the
    master\'s degree other than the one that qualifies him/her to enrol,
    the student  must provide documentary evidence thereof (original).

**Important.** All documents issued outside Spain or in
non-Spanish-speaking countries must be
**[translated](https://www.upc.edu/sga/es/expedientes/LegDoc/LegalTraduccDocExtranj)**
into Spanish or Catalan. Documents issued in countries that do not
belong to the European Higher Education Area must be stamped and
[**legalised**](https://www.upc.edu/sga/es/expedientes/LegDoc/LegalTraduccDocExtranj)
...
When completing the enrolment you will have to choose the courses you
want to take in that semester, and the group you want to attend.
::::
:::::
:::::::
...
:::::: {.panel .panel-default}
::: panel-heading
#### [Other Students](#dexp-accordion-item-1740072925--2){.collapsed parent="#dexp-accordions-wrapper-1740072925" toggle="collapse"} {#other-students .panel-title}
:::

:::: {#dexp-accordion-item-1740072925--2 .panel-collapse .collapse}
::: panel-body
You can check all enrolment information at [Masters Enrolment
administrative
procedure](/en/studies/academic-management/administrative-procedures/masters-enrolment).
:::
::::
::::::
...
## Useful information you can find on the website of the UPC {#useful-information-you-can-find-on-the-website-of-the-upc .block-title}
...
[Registration
fees](http://www.upc.edu/sga/ca/matricula/preus){target="_blank"} and
[payment
condition](http://www.upc.edu/sga/ca/matricula/pagament-de-la-matricula){target="_blank"}
:::::::
::::::::
...
[Check the scholarships you can apply
for](http://www.upc.edu/sga/ca/beques){target="_blank"}
:::::::
::::::::
:::::::::::::::
...
[Solve all doubts about the UPC
card](http://www.upc.edu/identitatdigital/ca/carnetupc){target="_blank"}
:::::::
::::::::
...
[How to get
it](http://www.upc.edu/sga/ca/matricula/assegurances-copia){target="_blank"}
:::::::
::::::::
:::::::::::::::
:::::::::::::::::::::::::::::
...
::::::::::::::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::::::::::::::: {.view .view-tramits .view-id-tramits .view-display-id-block_4 .view-dom-id-36606226cb39fcb452be18e6361db404}
:::::::::::::::::::::::::::::::::::::::::: view-content
::::::::::::::::::::::::::::::::::::::::: {#tramits-block-4 .dexp-grid-items .row}
:::::::: {#node-22534 .node .node-tr-mit .node-teaser .matrícula .col-lg-12 .col-md-12 .col-sm-12 .col-xs-12 .view-mode-teaser .clearfix}
::: {.col-lg-6 .col-md-6 .col-sm-12 .tramit}
[Enrolment and Group
Changes](/en/studies/academic-management/administrative-procedures/enrolment-and-group-changes)
:::
...
:::::::: {#node-18431 .node .node-tr-mit .node-teaser .matrícula .col-lg-12 .col-md-12 .col-sm-12 .col-xs-12 .view-mode-teaser .clearfix}
::: {.col-lg-6 .col-md-6 .col-sm-12 .tramit}
[Masters
Enrolment](/en/studies/academic-management/administrative-procedures/masters-enrolment)
:::
...
:::: field-items
::: {.field-item .even}
-   **Master in Innovation and Research in Informatics (MIRI) \| Master
    in Informatics Engineering (MEI) \| Master in Artificial
    Intelligence (MAI) \| Master in Data Science (MDS)**
    -   Students already enrolled in previous semesters:
        **3 February 2025**
...
:::::::: {#node-18435 .node .node-tr-mit .node-teaser .matrícula .col-lg-12 .col-md-12 .col-sm-12 .col-xs-12 .view-mode-teaser .clearfix}
::: {.col-lg-6 .col-md-6 .col-sm-12 .tramit}
[Pre-enrolment of MAI elective
courses](/en/studies/academic-management/administrative-procedures/pre-enrolment-mai-elective-courses)
:::
...
:::::::::::::::: {#node-21955 .node .node-tr-mit .node-teaser .matrícula .col-lg-12 .col-md-12 .col-sm-12 .col-xs-12 .view-mode-teaser .clearfix}
::: {.col-lg-6 .col-md-6 .col-sm-12 .tramit}
[Pre-enrolment of MDS elective
courses](/en/studies/academic-management/administrative-procedures/pre-enrolment-mds-elective-courses)
:::
...
:::::::: {#node-18329 .node .node-tr-mit .node-teaser .matrícula .col-lg-12 .col-md-12 .col-sm-12 .col-xs-12 .view-mode-teaser .clearfix}
::: {.col-lg-6 .col-md-6 .col-sm-12 .tramit}
[Pre-enrolment of MIRI specialization
courses](/en/studies/academic-management/administrative-procedures/pre-enrolment-miri-specialization-courses)
:::
...
::: view-footer
Online Procedure Face-to-face Procedure
:::
::::::::::::::::::::::::::::::::::::::::::::
:::::::::::::::::::::::::::::::::::::::::::::
:::::::::::::::::::::::::::::::::::::::::::::::
