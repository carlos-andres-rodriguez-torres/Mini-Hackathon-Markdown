---
description: The Barcelona School of Informatics (FIB) of the
  Universitat Politècnica de Catalunya (UPC) is aware of its
  responsibility in the training of professionals from the field of
  informatics engineering and teaching at secondary education and
  vocational training, to Bachelor and master levels.
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: FIB Quality policy and goals \| FIB - Barcelona School of
  Informatics
twitter:card: summary
twitter:description: The Barcelona School of Informatics (FIB) of the
  Universitat Politècnica de Catalunya (UPC) is aware of its
  responsibility in the training of professionals from the field of
  informatics engineering
twitter:title: FIB Quality policy and goals
twitter:url: "https://www.fib.upc.edu/en/fib/quality-system/fib-quality-policy-and-goals"
...
-   [The FIB](/en/fib)
    ...
    -   [Quality system](/en/fib/quality-system)
        -   [Internal Quality Assurance
            System](/en/fib/quality-system/internal-quality-assurance-system)
        -   [FIB Quality policy and
            goals](/en/fib/quality-system/fib-quality-policy-and-goals){.active}
        -   [Qualification
            assessment](/en/fib/quality-system/qualification-assessment)
        -   [Statistical data](/en/fib/quality-system/statistical-data)
:::
...
:::: content
::: page_title_no_sub
# FIB Quality policy and goals {#fib-quality-policy-and-goals .page_title}
:::
::::
::::::
:::::::
...
system](/en/fib/quality-system) » FIB Quality policy and goals
:::
::::
::::::
:::::::
...
-   [Internal Quality Assurance
    System](/en/fib/quality-system/internal-quality-assurance-system)
-   [FIB Quality policy and
    goals](/en/fib/quality-system/fib-quality-policy-and-goals){.active-trail
    .active}
-   [Qualification
    assessment](/en/fib/quality-system/qualification-assessment)
-   [Statistical data](/en/fib/quality-system/statistical-data)
...
:::::::: content
::::::: {#node-21512 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
The Barcelona School of Informatics (FIB) of the Universitat Politècnica
de Catalunya (UPC) is aware of its responsibility in the training of
professionals from the field of informatics engineering and teaching at
secondary education and vocational training, to Bachelor and master
levels. The FIB has the duty to provide its students with the knowledge
and necessary skills both to allow them to succeed when joining the
labour market and to provide them the required basis for, from their
integration into the workforce, achieving the different processes of
continuous training that they will undoubtedly address throughout their
professional career.

On the other hand, belonging to a public university obliges the FIB to
use efficiently and responsibly the resources that the institutions
provide as well as to adjust its training to the needs of its social
environment.

According to its responsibility, the FIB has participated pro-actively
in achieving the goals set by the UPC, which are covered by the
different strategic planning and quality processes addressed by the
institution over the last decades.

The Barcelona School of Informatics FIB of the of the Universitat
Politècnica de Catalunya (UPC) is committed to promoting those
strategies that are necessary to achieve the quality goals detailed
below:

-   Providing training aimed at excellence, guaranteeing a course
    offering in accordance with the needs and expectations of the
    students and society at large.
-   Providing appropriate support to teachers, administrative staff and
    students, so that they can exercise their skills satisfactorily.
-   Determining the quality assurance criteria, establishing continuous
    improvement strategies and carrying out the necessary preventive and
    corrective actions.
-   Establishing and documenting a systematic approach to ensure the
    quality of the processes.
-   Responding to the commitment to satisfy the needs and expectations
    of the different interest groups linked to the school.
-   Encouraging teaching innovation, doctorate training, research
    activity, management and knowledge transfer among FIB staff in
    cooperation with the UPC departments that are close to it, so this
    would lead to an update of the academic task in accordance with the
    evolution of disciplines and the most advanced research.
-   Promoting that its quality policy is available to stakeholders, and
    that it is understood and all of them agree with it.
-   Fostering the involvement of different interest groups in their
    school quality policies.
-   Ensuring that the Internal Quality Assurance System remains in force
    and is monitored and reviewed periodically.

The FIB has developed its own Internal Quality Assurance System (IQAS)
to guarantee the achievement of the goals associated with quality.

The FIB's IQAS has been designed following the guidelines established by
the quality agencies ANECA and AQU as well as the criteria defined by
the UPC within the framework of the AUDIT programme, in compliance with
the principles of legality, publicity, transparency and participation.

The main duties of the FIB's IQAS are:

-   Establishing quality criteria, monitoring the processes defined to
    achieve them and determining continuous improvement strategies.
-   Preparing and updating the different reports related to quality.
-   Facilitating the monitoring of the implemented degrees in order to
    achieve their subsequent accreditation.
-   Reviewing and updating the internal monitoring of the different
    processes associated with the IQAS guidelines on a yearly basis.

For all these reasons, the FIB management undertakes to devote its
technical, economic and human resources to deploy the quality policy and
goals set out in this document, always taking into account its own
competencies.
:::
::::
:::::
