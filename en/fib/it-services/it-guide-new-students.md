...
description: \[column cols=\"5\" begin=\"1\"\]\[title class=\"bigtitle\"
  type=\"h2\"\]Are you new at the FIB?\[/title\]\[/column\] \[column
  cols=\"7\" end=\"1\"\] Let us explain you about those IT services that
  are important to know at the beginning of your studies \[/column\]
  Follow-up the studies raco.fib.upc.edu atenea.upc.edu Students email
  name.surname@estudiantat.upc.edu Computer Labs Where are the computer
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: IT Guide for new students \| FIB - Barcelona School of
  Informatics
twitter:card: summary
twitter:description: \[column cols=\"5\" begin=\"1\"\]\[title
  class=\"bigtitle\" type=\"h2\"\]Are you new at the
  FIB?\[/title\]\[/column\] \[column cols=\"7\" end=\"1\"\] Let us
  explain you about those IT services that are important to know
twitter:title: IT Guide for new students
twitter:url: "https://www.fib.upc.edu/en/fib/it-services/it-guide-new-students"
...
-   [The FIB](/en/fib)
    ...
    -   [IT Services](/en/fib/it-services)
        ...
        -   [Campus Nord Hybrid
            Classrooms](/en/fib/it-services/campus-nord-hybrid-classrooms)
        -   [IT Guide for new
            students](/en/fib/it-services/it-guide-new-students){.active}
        -   [Service catalog](/en/fib/it-services/service-catalog)
...
:::: content
::: page_title_no_sub
# IT Guide for new students {#it-guide-for-new-students .page_title}
:::
::::
::::::
:::::::
...
::::::::::::::::::::::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::::::::::::::::::::::: {#node-20705 .node .node-page .clearfix}
::::::::::::::::::::::::::::::::::::::::::::::::::: content
...
::: block-subtitle
Let us explain you about those IT services that are important to know at
...
:::: card-body
#### [Follow-up the studies](#docencia)
...
::::: {.col-lg-4 .col-md-4 .col-sm-4 .col-xs-12}
:::: card
[![Labs](/sites/fib/files/images/aularis-fib-corona.jpg){.card-img-top}](#labs)

::: card-body
#### [Computer Labs](#labs)

Where are the computer labs, what can you find there, check their
schedules and how they work.
:::
::::
:::::
...
:::: card
[![IT
Systems](/sites/fib/files/images/secundaria/questions-br.png){.card-img-top}](#sistemes)

::: card-body
#### [How to connect to IT resources](#sistemes)
...
::: box-content
El Racó is the FIB Intranet where you can find all the information
regarding your studies. You can find a link in the header of the FIB
website [*https://www.fib.upc.edu*](https://www.fib.upc.edu) or directly
at *<https://raco.fib.upc.edu>.*

**Check out all Raco options!**

**More information at: [el Racó service](/en/fib/it-services/el-raco)**
:::
:::::
::::::
...
::: box-content
The Atenea is the UPC\'s web-based teaching environment. Some FIB
subjects use this environment as a complement to the Racó.\
The URL to access is [*http://atenea.upc.edu*](http://atenea.upc.edu/).
Username and password are the same ones you use to access the Racó.

**More information at: [Atenea service](/en/fib/it-services/atenea)**
:::
:::::
::::::
:::::::::::
...
### Students email {#students-email .box-title}

::: box-content
All students enrolled in the FIB have an institutional email address
with format: []{#DIbeORJfu rel="nofollow"}

where name.surname is the user assigned to access the resources of the
Faculty. The FIB and the UPC will only use your institutional address to
communicate with you. Check periodically for new messages.

**More information at: [Students email
service](/en/fib/it-services/student-email-account)**
:::
:::::
::::::
...
::: box-content
UPC has the GSuite for Education, which let you use Google applications
such as Gmail, Drive, Meet, Calendar \.... These tools help you to
manage your mail, documents, calendar\... and share and store them. It
also enables communication with teachers.

**More information at: [GSuite
service](/en/fib/it-services/g-suite-education)**
:::
:::::
::::::
:::::::::::
...
::: box-content
**App UPC Estudiants **give you useful information to follow up your
studies.

Download UPC Estudiants App at [Google
Play](https://play.google.com/store/apps/details?id=com.upc.estudiants) or [Apple
...
You will find computer labs in the basements of the [**A5, B5 and C6
Campus Nord buildings**](/en/fib/rooms).
...
Labs with PCs: A5S102, A5S104, A5S105, A5S108, A5S109, A5S111 and
A5S113\
Computer labs with a specific environment for subjects that focus on
operating systems: A5S103\
...
-   PCs allow users to connect to the Net and to FIB computers. These
    PCs run Windows and Linux.

<!-- -->

-   Computers in operating system labs have limited access to the
    outside world. Access to these computers is restricted to students
    taking specific subjects that require their use.

**More information at:** 

-   At [Computer Labs](/en/fib/rooms/computer-labs) you will find the
    schedules and a description and distribution of the equipment of
    each laboratory and its availability.
-   You can check [the occupation of
    laboratories](https://raco.fib.upc.edu/ocupacio.jsp) to see which pc
    are free and book them.

[]{#sistemes}

## How to connect to IT resources

Before enrolling, you were sent a message with instructions on how to
access the e-Secretaria and UPC intranets. You can use the same username
and password to access the Racó and all others systems

::: {.alert .alert-info}
  You'll have access to the Racó and to your FIB email approximately 48
hours after enrolling. Server accounts, rooms, etc. will be available
from the first day of class.
:::

The way to connect depends on the computer or system you want to connect
to:

-   **PC:** When you turn on a PC, you will be asked what system you
    want to work with: Windows or Linux. Select the desired option.
    After a moment, the selected system will appear on the screen and
    you will be asked to enter your username and password to connect.
-   **Database servers:** There are several database servers: MySQL,
    Postgres, Oracle, NoSQL and Hadoop. The servers you have access to
    will depend on the subjects you are enrolled in.
-   **Special operating system environment:** The specific way this
    environment works will be determined based on the design of
    practicals.

**More information at: **[Accounts on the PCs and
servers](/en/fib/it-services/accounts-pcs-and-servers)****

::: {.alert .alert-danger}
If you forget your password, you can change it
at [https://identitatdigital.upc.edu/gcredencials](https://identitatdigital.upc.edu/gcredencials?lang=en).
:::

### Storage space

There is a common space for storing files for Windows and Linux systems.
The space allocated to each student is around 3 GB, and it can also be
accessed via the Web or from the Racó

**more information at: [Remote Access to the File
Repository](/en/fib/it-services/remote-access-file-repository)**

### How do I connect remotely

We have summarized all the information that may be useful for you to
study from home. We explain [how you can work as if you were in FIB
Computer labs](/en/fib/it-services/how-work-remotely-students).

### Accessing the Eduroam network

All students have access to the Eduroam network, which allows free
access to the internet inside the campus grounds, using the same
username and password as the rest of services offered by FIB. The
Eduroam network can be accessed using the same credentials from any
other university or library in the world that is also part of the
Eduroam program. You can find more info on how to connect to Eduroam in
this guide
<https://serveistic.upc.edu/ca/wifiupc/documentacio/eduroam-configuration-guide>.

### VPN UPCLink

Some services, such as Aula Virtual, require the use of a VPN in order
to be accessed from your own home computer, laptop or smartphone. You
can find a guide to connect to the UPCLink VPN at
<https://serveistic.upc.edu/ca/upclink/documentacio/myupclink-configuration-guide-english>.
::::::::::::::::::::::::::::::::::::::::::::::::
:::::::::::::::::::::::::::::::::::::::::::::::::
::::::::::::::::::::::::::::::::::::::::::::::::::
:::::::::::::::::::::::::::::::::::::::::::::::::::
