---
description: The mission of the FIB services and its management team is
  to respond effectively to user requests and to continue to meet the
  high standards that characterise them. \[column cols=\"8\"
  begin=\"1\"\] Units that provide exclusive service to the FIB Academic
  office (in Catalan) Institutional Support and External Relations Unit
  (in Catalan) Support units that provide service to the FIB
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Staff \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: The mission of the FIB services and its management
  team is to respond effectively to user requests and to continue to
  meet the high standards that characterise them. \[column cols=\"8\"
  begin=\"1\"\] Units
twitter:title: Staff
twitter:url: "https://www.fib.upc.edu/en/fib/school/staff"
...
-   [Català](/ca/la-fib/la-facultat/personal "Personal"){.language-link
    lang="ca"}
-   [English](/en/fib/school/staff "Staff"){.language-link .active
    lang="en"}
...
-   [The FIB](/en/fib)
    -   [The School](/en/fib/school)
        ...
        -   [Staff](/en/fib/school/staff){.active}
        -   [Awards](/en/fib/school/awards)
        -   [Graduation Ceremony](/en/fib/school/graduation-ceremony)
    -   [Rooms](/en/fib/rooms)
        -   [Computer Labs](/en/fib/rooms/computer-labs)
...
::: breadcrumb
[Home](/en) » [The FIB](/en/fib) » [The School](/en/fib/school) » Staff
:::
::::
::::::
:::::::
...
-   [Location](/en/fib/school/location)
-   [Governance](/en/fib/school/governance)
-   [Staff](/en/fib/school/staff){.active-trail .active}
-   [Awards](/en/fib/school/awards)
-   [Graduation Ceremony](/en/fib/school/graduation-ceremony)
:::
::::
...
::::::::::: content
:::::::::: {#node-16822 .node .node-page .clearfix}
::::::::: content
:::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
::::::: field-items
:::::: {.field-item .even}
The mission of the FIB services and its management team is to respond
effectively to user requests and to continue to meet the high standards
...
-   [Academic
    office](https://utgcntic.upc.edu/ca/estructura/unitat-gestio-estudis-grau-master-fib) (in
    Catalan)
-   [Institutional Support and External Relations
    Unit](https://utgcntic.upc.edu/ca/estructura/unitat-suport-institucional-relacions-externes-fib) (in
    Catalan)
...
-   [ICT
    Unit](https://utgcntic.upc.edu/ca/estructura/unitat-serveis-tic) (in
    Catalan)
-   [Resources and Services
    Unit](https://utgcntic.upc.edu/ca/estructura/unitat-recursos-serveis) (in
    Catalan)
:::

::: {.col-xs-12 .col-sm-4 .col-md-4 .col-lg-4}
[![](/sites/fib/files/images/fib/logo_inlabfib_pet.png){style="width: 229px; height: 80px;"}](https://inlab.fib.upc.edu/en){target="_blank"}

[inLab FIB team](https://inlab.fib.upc.edu/en/comunity/)
:::
:::::
::::::
:::::::
