---
description: FIB professor David López receives the Ramon Llull award at
  the ceremony Premios de la Informática 2024
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: David López Álvarez Awarded the SCIE and BBVA Foundation Research
  Awards 2024 \| FIB - Barcelona School of Informatics
twitter:card: summary_large_image
twitter:description: FIB professor David López receives the Ramon Llull
  award at the ceremony Premios de la Informática 2024
twitter:image: "https://www.fib.upc.edu/sites/fib/files/david_lopez_premios_informatica_scie_bbva_news.jpg"
twitter:title: David López Álvarez Awarded the SCIE and BBVA Foundation
  Research
twitter:url: "https://www.fib.upc.edu/en/fib/school/awards/david-lopez-alvarez-awarded-scie-and-bbva-foundation-research-awards-2024"
...
:::: content
::: page_title_no_sub
# David López Álvarez Awarded the SCIE and BBVA Foundation Research Awards 2024 {#david-lópez-álvarez-awarded-the-scie-and-bbva-foundation-research-awards-2024 .page_title}
:::
::::
::::::
:::::::
...
[Awards](/en/fib/school/awards) » David López Álvarez Awarded the SCIE
and BBVA Foundation Research Awards 2024
:::
::::
::::::
:::::::
...
:::::::::::: content
::::::::::: {#node-24081 .blog_wrap .clearfix}
> FIB professor David López receives the Ramon Llull award at the
> ceremony *Premios de la Informática* 2024
>
> ::: post_meta
...
:::: field-items
::: {.field-item .even}
On October 21, the 2024 edition of ***Premios de Investigación de la
Sociedad Científica Informática de España y la Fundación BBVA ***awards
ceremony took place.

David López Álvarez, a professor in the Computer Architecture
Department, has been awarded the Ramon Llull prize for his outstanding
career in the field of Computer Engineering education. This recognition
has been granted not only for his successes in research and technology
transfer but also for his international influence in developing the
ACM/IEEE Computing Curricula proposal, a key reference for undergraduate
and master's studies in Computer Engineering.

"Computer science students need to be aware of the impact of their work
on society. This can only be achieved through an educational program
that provides an ethical perspective, which goes beyond purely technical
training."

From this perspective, López Álvarez has dedicated his career to
strengthening education in computer engineering, not only from a
technical viewpoint but also from philosophical and humanistic
angles---a significant task for which he has been awarded the Ramon
Llull Prize. His research has focused on analyzing which educational
methods are most suitable for acquiring certain knowledge and skills,
some of which are technical while others are more general, such as
communication, sustainability, critical thinking, and creativity.
...
-   [Featured](#dexp_tab_item_new){toggle="tab"}

::::::::: tab-content
:::::: {#dexp_tab_item_popular .active .tab-pane}
::::: {.view .view-premis-rebuts .view-id-premis_rebuts .view-display-id-populars .popular-post .view-dom-id-ab64ae468ae5a5380cb2cf60dd6c9ada}
:::: view-content
::: item-list
-   :::: {.views-field .views-field-field-pr-imatge}
    ::: field-content
    [![](https://www.fib.upc.edu/sites/fib/files/styles/media_thumbnail/public/wp_20161019_20_25_07_pro-v3-800x559.jpg?itok=GZbSulrQ){width="100"
    height="100"}](/en/fib/school/awards/fiber-jose-angel-casado-perez-awarded-acia-2016-final-project)
    :::
    ::::

    ::: {.views-field .views-field-title}
    [[The fiber José Ángel Casado Pérez, awarded the ACIA 2016 Final
    Project](/en/fib/school/awards/fiber-jose-angel-casado-perez-awarded-acia-2016-final-project)
    ]{.field-content}
    :::

    ::: {.views-field .views-field-created}
    [31 Jan 17]{.field-content}
    :::

-   :::: {.views-field .views-field-field-pr-imatge}
    ::: field-content
    [![](https://www.fib.upc.edu/sites/fib/files/styles/media_thumbnail/public/DonaTIC_1_1.jpg?itok=SvAt1kWI){width="100"
    height="100"}](/en/fib/school/awards/fiber-patricia-sampedro-awared-dona-tic-2016)
    :::
    ::::

    ::: {.views-field .views-field-title}
    [[The fiber Patricia Sampedro awared the Dona TIC
    2016](/en/fib/school/awards/fiber-patricia-sampedro-awared-dona-tic-2016)]{.field-content}
    :::
...
-   :::: {.views-field .views-field-field-pr-imatge}
    ...
    height="100"}](/en/fib/school/awards/empren-upc-yuzz-fib-students-win-2nd-and-3rd-prize)
    :::
    ::::

    ::: {.views-field .views-field-title}
    [[Emprèn UPC-Yuzz, FIB students win 2nd and 3rd
    prize](/en/fib/school/awards/empren-upc-yuzz-fib-students-win-2nd-and-3rd-prize)]{.field-content}
    :::
...
-   :::: {.views-field .views-field-field-pr-imatge}
    ...
    height="100"}](/en/fib/school/awards/professor-mateo-valero-invested-doctor-honoris-causa-universidad-de-granada)
    :::
    ::::
    ...
    Universidad de
    Granada](/en/fib/school/awards/professor-mateo-valero-invested-doctor-honoris-causa-universidad-de-granada)]{.field-content}
    :::
...
-   :::: {.views-field .views-field-field-pr-imatge}
    ...
    height="100"}](/en/fib/school/awards/lidia-montero-has-been-awared-prize-mujer-y-gestion-del-trafico)
    :::
    ::::

    ::: {.views-field .views-field-title}
    [[Lídia Montero, has been awared the prize \"Mujer y Gestión del
    Tráfico\"](/en/fib/school/awards/lidia-montero-has-been-awared-prize-mujer-y-gestion-del-trafico)
    ]{.field-content}
    :::
...
::: {.view .view-premis-rebuts .view-id-premis_rebuts .view-display-id-importants .popular-post .view-dom-id-cf7dc8dafa2d7f58d7cc5d9552624818}
:::
::::
:::::::::
::::::::::
