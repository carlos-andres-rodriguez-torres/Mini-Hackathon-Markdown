---
description: It is located on the first floor of building B6. Ideal for
  meetings, with a video conferencing service available for both the
  university community and for people with no connection to the UPC.
  This room is ready for video conferencing. Capacity Up to 8 people
  Equipment Fixed video conferencing equipment. DVD. Computer 48\" LCD
  Flat screen television to use as a video output, PC
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Conference Room \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: It is located on the first floor of building B6.
  Ideal for meetings, with a video conferencing service available for
  both the university community and for people with no connection to the
  UPC. This
twitter:title: Conference Room
twitter:url: "https://www.fib.upc.edu/en/fib/rooms/presentation-rooms/conference-room"
...
-   [The FIB](/en/fib)
    ...
    -   [Rooms](/en/fib/rooms)
        ...
        -   [Presentation Rooms](/en/fib/rooms/presentation-rooms)
            ...
            -   [Boardroom](/en/fib/rooms/presentation-rooms/boardroom)
            -   [Conference
                Room](/en/fib/rooms/presentation-rooms/conference-room){.active}
        -   [Rector Gabriel Ferraté
            Library](/en/fib/rooms/rector-gabriel-ferrate-library)
...
:::: content
::: page_title_no_sub
# Conference Room {#conference-room .page_title}
:::
::::
::::::
:::::::
...
[Presentation Rooms](/en/fib/rooms/presentation-rooms) » Conference Room
:::
::::
::::::
:::::::
...
-   [Boardroom](/en/fib/rooms/presentation-rooms/boardroom)
-   [Conference
    Room](/en/fib/rooms/presentation-rooms/conference-room){.active-trail
    .active}
:::
::::
::::::
...
:::::::::::: content
::::::::::: {#node-17158 .node .node-sala .node-promoted .clearfix}
:::::::::: content
...
:::: field-items
::: {.field-item .even}
It is located on the first floor of building B6. Ideal for meetings,
with a video conferencing service available for both the university
community and for people with no connection to the UPC.
...
-   Fixed video [conferencing
    equipment](/en/fib/it-services/videoconferencing).
-   DVD.
-   Computer
-   48\" LCD  Flat screen television  to use as a video output, PC and
    laptop.
