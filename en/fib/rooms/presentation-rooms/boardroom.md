---
description: It is located on the first floor of building B6. It is a
  multipurpose room, where you can get on and off tables and distribute
  them according to the event. Capacity Up to 28 people Equipment Bright
  projector maximum resolution 1920 x 1200 pixels that supports full HD
  (1920 x 1080) with motorized projection screen. Personal computer with
  DVD, USB and Internet access. 23-inch
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Boardroom \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: It is located on the first floor of building B6. It
  is a multipurpose room, where you can get on and off tables and
  distribute them according to the event. Capacity Up to 28 people
  Equipment Bright
twitter:title: Boardroom
twitter:url: "https://www.fib.upc.edu/en/fib/rooms/presentation-rooms/boardroom"
...
-   [The FIB](/en/fib)
    ...
    -   [Rooms](/en/fib/rooms)
        ...
        -   [Presentation Rooms](/en/fib/rooms/presentation-rooms)
            -   [Auditorium Manuel Martí
                Recober](/en/fib/rooms/presentation-rooms/auditorium)
            -   [Boardroom](/en/fib/rooms/presentation-rooms/boardroom){.active}
            -   [Conference
                Room](/en/fib/rooms/presentation-rooms/conference-room)
        -   [Rector Gabriel Ferraté
            Library](/en/fib/rooms/rector-gabriel-ferrate-library)
...
:::: content
::: page_title_no_sub
# Boardroom {#boardroom .page_title}
:::
::::
::::::
:::::::
...
[Presentation Rooms](/en/fib/rooms/presentation-rooms) » Boardroom
:::
::::
::::::
:::::::
...
-   [Auditorium Manuel Martí
    Recober](/en/fib/rooms/presentation-rooms/auditorium)
-   [Boardroom](/en/fib/rooms/presentation-rooms/boardroom){.active-trail
    .active}
...
:::::::::::: content
::::::::::: {#node-17157 .node .node-sala .node-promoted .clearfix}
:::::::::: content
...
:::: field-items
::: {.field-item .even}
It is located on the first floor of building B6.   It is a multipurpose
room, where you can get on and off tables and distribute them according
to the event.
...
-   Bright projector maximum resolution 1920 x 1200 pixels that supports
    full HD (1920 x 1080) with motorized projection screen.
-   Personal computer with DVD, USB and Internet access.
-   23-inch flat screen connected to a computer that lets you view the
    notes of a presentation using the projector as an extended desktop.
-   HDMI and VGA for laptops at the multimedia furniture. Additional VGA
