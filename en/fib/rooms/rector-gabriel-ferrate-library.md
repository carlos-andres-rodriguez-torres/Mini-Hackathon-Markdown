---
description: Rector Gabriel Ferraté Library is common to the three
  schools in the North Campus of the UPC where you can find almost all
  the books in the bibliography of the FIB courses, places to study and
  work in group the following timetables. The Rector Gabriel Ferraté
  Library (BRGF) is one of the more important scientific and technical
  libraries in the south of Europe. The following
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Rector Gabriel Ferraté Library \| FIB - Barcelona School of
  Informatics
twitter:card: summary
twitter:description: Rector Gabriel Ferraté Library is common to the
  three schools in the North Campus of the UPC where you can find almost
  all the books in the bibliography of the FIB courses, places to study
  and work
twitter:title: Rector Gabriel Ferraté Library
twitter:url: "https://www.fib.upc.edu/en/fib/rooms/rector-gabriel-ferrate-library"
    ...
    -   [Rooms](/en/fib/rooms)
        ...
        -   [Presentation Rooms](/en/fib/rooms/presentation-rooms)
            ...
            -   [Conference
                Room](/en/fib/rooms/presentation-rooms/conference-room)
        -   [Rector Gabriel Ferraté
            Library](/en/fib/rooms/rector-gabriel-ferrate-library){.active}
...
:::: content
::: page_title_no_sub
# Rector Gabriel Ferraté Library {#rector-gabriel-ferraté-library .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Home](/en) » [The FIB](/en/fib) » [Rooms](/en/fib/rooms) » Rector
...
-   [Presentation Rooms](/en/fib/rooms/presentation-rooms)
-   [Rector Gabriel Ferraté
    Library](/en/fib/rooms/rector-gabriel-ferrate-library){.active-trail
    .active}
:::
::::
::::::
...
:::::::: content
::::::: {#node-17557 .node .node-page .clearfix}
:::::: content
...
Rector Gabriel Ferraté Library is common to the three schools in the
North Campus of the UPC where you can find almost all the books in the
bibliography of the FIB courses, places to study and work in group the
following [**timetables**](http://bibliotecnica.upc.edu/en/horaris).

The Rector Gabriel Ferraté Library (BRGF) is one of the more important
scientific and technical libraries in the south of Europe. The following
ones are some of the most requested services at the BRGF:

-   [**Group work
    rooms**](http://bibliotecnica.upc.edu/en/brgf/serveis/espais#sales-treball-grup-reserva-previa)\
    The BRGF offers to its users 21 group work rooms for collective
    study activities. The rooms are equipped with boards and screens to
    connect laptops and other computers.

<!-- -->

-   [**Library lending
    services**](http://bibliotecnica.upc.edu/en/estudiants/prestec-documents)\
    At the BRGF any type of document can be requested, not only
    belonging to the scientific and technological fields but also to
    humanistic topics. Moreover, the library supplies any document from
    the other libraries of the UPC, and from the rest of the academic
    libraries from Catalonia or from any other part of the world.

<!-- -->

-   [**Laptop and other equipment
    lending**](http://bibliotecnica.upc.edu/en/brgf/serveis/equipaments)\
    At the BRGF the users not only can borrow books or audio-visual
    materials, the library also lends massive used technological
    devices, especially laptop computers.

<!-- -->

-   [**u-win**](http://bibliotecnica.upc.edu/en/brgf/serveis/espais#u-win)\
    u-win is both a physical and a virtual space of the BRGF focused on
    the gaming world and especially on the video game production at the
    UPC.

A wider choice of services of the BRGF can be found on the [website of
the library](http://bibliotecnica.upc.edu/en/brgf){target="_blank"}.
:::
::::
:::::
::::::
