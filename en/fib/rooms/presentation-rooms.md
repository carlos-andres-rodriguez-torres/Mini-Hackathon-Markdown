---
description: "Reservation of a Room You can reserve a room for special
  events (conferences, teaching staff meetings, thesis defences, project
  revisions, etc.) but not for events that are held on a weekly or
  monthly basis. The rooms can be reserved from 8:00 a.m. to 8:30 p.m.
  (7:30 p.m. from 1 June to 30 September). You can make a reservation
  using the following application: Also, you can"
generator: "Drupal 7 (https://www.drupal.org)"
lang: en
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Presentation Rooms \| FIB - Barcelona School of Informatics
twitter:card: summary
twitter:description: Reservation of a Room You can reserve a room for
  special events (conferences, teaching staff meetings, thesis defences,
  project revisions, etc.) but not for events that are held on a weekly
  or
twitter:title: Presentation Rooms
twitter:url: "https://www.fib.upc.edu/en/fib/rooms/presentation-rooms"
...
-   [The FIB](/en/fib)
    ...
    -   [Rooms](/en/fib/rooms)
        ...
        -   [Group work classroom](/en/fib/rooms/group-work-classroom)
        -   [Presentation
            Rooms](/en/fib/rooms/presentation-rooms){.active}
            -   [Auditorium Manuel Martí
                Recober](/en/fib/rooms/presentation-rooms/auditorium)
            -   [Boardroom](/en/fib/rooms/presentation-rooms/boardroom)
            -   [Conference
...
:::: content
::: page_title_no_sub
# Presentation Rooms {#presentation-rooms .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Home](/en) » [The FIB](/en/fib) » [Rooms](/en/fib/rooms) » Presentation
Rooms
:::
::::
::::::
...
-   [Teaching Classrooms](/en/fib/rooms/teaching-classrooms)
-   [Group work classroom](/en/fib/rooms/group-work-classroom)
-   [Presentation Rooms](/en/fib/rooms/presentation-rooms){.active-trail
    .active}
    -   [Auditorium Manuel Martí
        Recober](/en/fib/rooms/presentation-rooms/auditorium)
    -   [Boardroom](/en/fib/rooms/presentation-rooms/boardroom)
...
:::::::::::::::::::::: content
::::::::::::::::::::: {.view .view-sales-de-presentacions .view-id-sales_de_presentacions .view-display-id-block .view-dom-id-02841f27f06ce490857686e5dca6a5de}
:::::::::::::::::::: view-content
::::::::::::::::::: {#sales-de-presentacions-block .dexp-masonry}
::::::: {.dexp-masonry-item .item-w1 .item-h1 index="0"}
:::::: {#node-17156 .node .node-sala .node-promoted .node-teaser .view-mode-teaser .clearfix}
::: estudis-teaser
[Auditorium Manuel Martí
Recober](/en/fib/rooms/presentation-rooms/auditorium){.title .vista-peq}
:::

:::: {.portfolio-item-inner style="background-image: url(https://www.fib.upc.edu/sites/fib/files/actes.jpg)"}
[](/en/fib/rooms/presentation-rooms/auditorium){.link-image}
...
:::::: {#node-17157 .node .node-sala .node-promoted .node-teaser .view-mode-teaser .clearfix}
::: estudis-teaser
[Boardroom](/en/fib/rooms/presentation-rooms/boardroom){.title
.vista-peq}
:::

:::: {.portfolio-item-inner style="background-image: url(https://www.fib.upc.edu/sites/fib/files/sala-juntes.jpg)"}
[](/en/fib/rooms/presentation-rooms/boardroom){.link-image}
...
:::::: {#node-17158 .node .node-sala .node-promoted .node-teaser .view-mode-teaser .clearfix}
::: estudis-teaser
[Conference
Room](/en/fib/rooms/presentation-rooms/conference-room){.title
.vista-peq}
:::

:::: {.portfolio-item-inner style="background-image: url(https://www.fib.upc.edu/sites/fib/files/sala-reunions_0_0.jpg)"}
[](/en/fib/rooms/presentation-rooms/conference-room){.link-image}
...
:::::::: content
::::::: {#node-16949 .node .node-page .clearfix}
:::::: content
...
meetings, thesis defences, project revisions, etc.) but not for events
that are held on a weekly or monthly basis.

The rooms can be reserved from 8:00 a.m. to 8:30 p.m. (7:30 p.m. from 1
...
Also, you can make a reservation by sending an email to the UTGCNTIC
Resources and Services Area ([]{#SIetqQxaP rel="nofollow"}
...
-   Technical requirements:
    -    PC or laptop. In the case of laptop, if you need to book a
        laptop or you will bring your own one
    -    [Videoconferencing
        Service](/en/fib/it-services/videoconferencing){target="_blank"}.
        -    Number of remote connections and number of attendees.
        -    Details of who has established video conferencing (email,
            IP, \...)
    -     [Webconferencing
        service](/en/fib/it-services/web-conferencing){target="_blank"}.
        What platform wil be used.
    -     [Mediafib
        service.](/en/fib/it-services/mediafib-video-files-and-live-events){target="_blank"}
        If you need recording or a live broadcast
    -    
        [AudioConference](/en/fib/it-services/audioconference){target="_blank"}
        If the call is national or international.

*FIB reserves the right to change the reservation priorities for a
meeting of the School Board or the Standing Committee, or any other
institutional event.*

The consumption of food or drinks in the rooms is not allowed (except
water).
:::
::::
:::::
