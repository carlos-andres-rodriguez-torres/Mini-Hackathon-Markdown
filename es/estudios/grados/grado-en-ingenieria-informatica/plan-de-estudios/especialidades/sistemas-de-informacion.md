---
description: Coordinador Profesores de especialidad Competencias
  técnicas Asignaturas Los sistemas de Información dan soporte a las
  operaciones empresariales, la gestión y la toma de decisiones,
  proporcionando a las personas la información que necesitan mediante el
  uso de las tecnologías de la información. Las empresas y, en general,
  cualquier organización, los utilizan como un elemento
generator: "Drupal 7 (https://www.drupal.org)"
lang: es
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Sistemas de Información \| Facultad de Informática de Barcelona
twitter:card: summary
twitter:description: Coordinador Profesores de especialidad Competencias
  técnicas Asignaturas Los sistemas de Información dan soporte a las
  operaciones empresariales, la gestión y la toma de decisiones,
  proporcionando a
twitter:title: Sistemas de Información
twitter:url: "https://www.fib.upc.edu/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/sistemas-de-informacion"
...
::: content
-   [Català](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/sistemes-dinformacio "Sistemes d’Informació"){.language-link
    lang="ca"}
-   [English](/en/studies/bachelors-degrees/bachelor-degree-informatics-engineering/curriculum/specializations/information-systems "Information Systems"){.language-link
    lang="en"}
-   [Español](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/sistemas-de-informacion "Sistemas de Información"){.language-link
    .active lang="es"}
:::
:::::
            ...
            -   [Plan de
                ...
                -   [Especialidades](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades)
                    ...
                    -   [Ingeniería del
                        Software](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/ingenieria-del-software)
                    -   [Sistemas de
                        Información](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/sistemas-de-informacion){.active}
                    -   [Tecnologías de la
                        información](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/tecnologias-de-la-informacion)
                -   [Competencias](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/competencias)
                -   [Competencias por
...
:::: content
::: page_title_no_sub
# Sistemas de Información {#sistemas-de-información .page_title}
:::
::::
::::::
:::::::
...
-   [Ingeniería del
    Software](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/ingenieria-del-software)
-   [Sistemas de
    Información](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/sistemas-de-informacion){.active-trail
    .active}
-   [Tecnologías de la
    información](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/especialidades/tecnologias-de-la-informacion)
:::
...
::::::::::::: content
:::::::::::: {#node-16488 .node .node-page .clearfix}
::::::::::: content
:::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
::::::::: field-items
:::::::: {.field-item .even}
::: {#index .section}
-   [Coordinador](#coordinador){.btn-block}
-   [Profesores de especialidad](#professors){.btn-block}
-   [Competencias técnicas](#TI){.btn-block}
-   [Asignaturas](#assignatures){.btn-block}
:::

Los sistemas de Información dan soporte a las operaciones empresariales,
la gestión y la toma de decisiones, proporcionando a las personas la
información que necesitan mediante el uso de las tecnologías de la
información. Las empresas y, en general, cualquier organización, los
utilizan como un elemento estratégico con el que innovar, competir y
alcanzar sus objetivos en un entorno globalizado. Los sistemas de
información integran personas, procesos, datos y tecnología, y van más
allá de los umbrales de la organización, para colaborar de formas más
eficientes con proveedores, distribuidores y clientes.

La especialidad de Sistemas de Información del Grado en Ingeniería
Informática capacita al estudiante para comprender los procesos
operativos y la gestión que llevan a cabo las personas en las
organizaciones. Asimismo, lo familiariza con los diferentes tipos de
herramientas tecnológicas que se han ido estandarizando recientemente
para construir un sistema de información, desde la gestión de relaciones
con los clientes o la cadena de suministro hasta el comercio electrónico
pasando por la gestión de procesos internos, la inteligencia de negocio
y gestión del conocimiento o la ayuda a la toma de decisiones.

Por lo tanto, el titulado será capaz de actuar de puente entre las
necesidades de gestión y las posibilidades que la tecnología ofrece; es
decir, de analizar los requisitos de la organización y diseñar
soluciones eligiendo, adaptando e integrando las herramientas
disponibles más adecuadas. Igualmente, será capaz de identificar las
oportunidades de mejora de procesos y de introducir innovaciones,
facilitando que la organización utilice sus sistemas de información para
...
Los puestos de trabajo más habituales de una ingeniera informática o de
un ingeniero informático especialista en Sistemas de Información, al
margen de dedicarse a la educación y a la investigación, son muy
diversos, por ejemplo, pueden encontrar:

**Cargos directivos**

-   Director de Sistemas de Información: participa en las decisiones
    estratégicas que afectan a los sistemas de información y asegura la
    comunicación entre el área de tecnología y las áreas de negocio y
    apoyo. Se responsabiliza de los proyectos de implantación de
    aplicaciones, de la puesta en marcha de infraestructura tecnológica,
    del presupuesto y de los recursos humanos de su área.
-   Responsable de Informática: elabora el plan de sistemas de la
    empresa, organiza el departamento de informática (hardware, software
    y recursos humanos), se coordina con el resto de departamentos de la
    empresa y mantiene las relaciones con los proveedores externos. Este
    cargo, normalmente, depende de la dirección de SI.
-   Dirección de Comercio Electrónico (e-Business Manager): se
    responsabiliza de la estrategia, la planificación, la ejecución y el
    control de negocios que se encuentran en Internet.

**Puestos de mando medio o técnico**

-   Analista de negocio (Business Analyst): identifica y analiza las
    necesidades y los nuevos requisitos de la organización, y propone
    soluciones de mejora (BPI) o reingeniería de procesos (BPR) que a
    menudo comprenden cambios en los sistemas de información. Actúa de
    enlace entre los interesados en las soluciones y los equipos
    técnicos que las construyen.
-   Consultor de Sistemas de Información: se encarga del estudio de las
    necesidades funcionales y/o técnicas de la organización, de la
    parametrización y puesta en marcha de sistemas de información y de
    la formación a usuarios. Entre los sistemas de información, podemos
    encontrar: Sistemas de Información Empresarial (ERP, CRM, SCM,
    etc.), Sistemas de Ayuda a la Toma de Decisiones (DSS) y de Business
    Intelligence, Sistemas de Gestión de contenidos (CMS), entre otros.
-   Auditor de Sistemas de Información: evalúa el cumplimiento de
    normas, controles y procedimientos establecidos para los sistemas de
    información. Asegura que se siguen las normativas y los estándares
    de calidad de gestión (COBIT, ITIL) y el cumplimiento de la
    legislación en el marco de las TIC. Asesora la dirección para
    mejorar o conseguir un adecuado control interno en los sistemas de
    información.
-   Responsable de Servicios de Atención a Usuarios: responsable de los
    servicios prestados en los Centro de Atención a Usuarios (CAU) y de
    la gestión y supervisión de los contratos con los proveedores de
    servicios externalizados. Es el responsable de los presupuesto, del
    control de costes y de la calidad de estos servicios.
-   Administrador de base de datos: responsable del diseño lógico y
    físico de las bases de datos de una organización y de garantizar su
    recuperabilidad, su integridad, su seguridad, su disponibilidad y su
    buen rendimiento.

## Coordinador de especialidad {#coordinador}

  Persona                                                  Departamento   Correo electrónico
  -------------------------------------------------------- -------------- -------------------------------
  [Martin Escofet, Carme](https://futur.upc.edu/1002205)   ESSI           []{#eMuhmHtEp rel="nofollow"}

## Profesorado de especialidad {#professors}

  Persona                                                        Departamento   Correo electrónico
  -------------------------------------------------------------- -------------- -------------------------------
  [Alier Forment, Marc](https://futur.upc.edu/1003732)           ESSI           []{#bgoputLGm rel="nofollow"}
  Alsina Jimenez, Joan                                           OE             []{#eaNEULFmG rel="nofollow"}
  Andujar Larios, Agustin                                        OE             []{#vfAPLsNOy rel="nofollow"}
  [Angerri Torredeflot, Xavier](https://futur.upc.edu/1164249)   EIO            []{#eIyJVmRqi rel="nofollow"}
  [Arias Vicente, Marta](https://futur.upc.edu/1119412)          CS             []{#QIRzDTWkP rel="nofollow"}
  [Balcázar Navarro, Jose Luis](https://futur.upc.edu/1000705)   CS             []{#CnQmpSraT rel="nofollow"}
  [Barrabes Naval, Fernando](https://futur.upc.edu/1119409)      OE             []{#KzUcuSqZL rel="nofollow"}
  [Béjar Alonso, Javier](https://futur.upc.edu/1001970)          CS             []{#crgqBioVf rel="nofollow"}
  Beltran Andreu, Jose Luis                                      ESSI           []{#wILNHilAs rel="nofollow"}
  [Cañabate Carmona, Antonio](https://futur.upc.edu/1001855)     OE             []{#KBoTqRyrp rel="nofollow"}
  [Codina Sancho, Esteve](https://futur.upc.edu/1001815)         EIO            []{#ZUTpXODtV rel="nofollow"}
  [Deulofeu Aymar, Joaquim](https://futur.upc.edu/1002242)       OE             []{#tfFYziNdO rel="nofollow"}
  [Ferrer Cancho, Ramon](https://futur.upc.edu/1105672)          CS             []{#AqMikPnJw rel="nofollow"}
  Franquet Fàbregas, Josep                                       EIO            []{#PKfzepHMY rel="nofollow"}
  [Garcia Subirana, Joan](https://futur.upc.edu/1054152)         EIO            []{#OCaYMAiVE rel="nofollow"}
  Gimenez Buendia, Susana                                        OE             []{#vhwcYDdmx rel="nofollow"}
  [Gómez Sebastià, Ignasi](https://futur.upc.edu/1054866)        CS             []{#ByswophlQ rel="nofollow"}
  [Martin Escofet, Carme](https://futur.upc.edu/1002205)         ESSI           []{#RJEofUOmF rel="nofollow"}
  [Mayol Sarroca, Enric](https://futur.upc.edu/1001947)          ESSI           []{#YgETtMAdl rel="nofollow"}
  [Montero Mercadé, Lidia](https://futur.upc.edu/1001530)        EIO            []{#kwCraxEvX rel="nofollow"}
  Morales Garcia, Sergio                                         ESSI           []{#ivrtCXuPT rel="nofollow"}
  Paredes Sigüenza, Sergio                                       ESSI           []{#csgCQvJmA rel="nofollow"}
  Patel, Bhumika Ashvinbhai                                      EIO            []{#VZmkCvtFH rel="nofollow"}
  Ramirez Perez, Inmaculada                                      ESSI           []{#qEgJWdFTX rel="nofollow"}
  Rello Saltor, Manuel                                           ESSI           []{#dVQEmMlNn rel="nofollow"}
  Rubio Quintana, Àlex                                           ESSI           []{#cVRxYSCzQ rel="nofollow"}
  [Sabate Garriga, Ferran](https://futur.upc.edu/1002877)        OE             []{#DYZfHbzJF rel="nofollow"}
  [Sancho Samso, Maria Ribera](https://futur.upc.edu/1000424)    ESSI           []{#XBFzHumWT rel="nofollow"}
  Solà Vilalta, Albert                                           EIO            []{#UPwGnqlMd rel="nofollow"}
  [Teniente Lopez, Ernest](https://futur.upc.edu/1000345)        ESSI           []{#vrBRqNwfk rel="nofollow"}
  Vázquez Álvarez, Iñaki                                         OE             []{#nPmxIwgVE rel="nofollow"}
...
::: item-list
-   [Análisis de Datos y Explotación de la
    Información](../asignaturas/ADEI) (ADEI)
...
-   [Proyecto de Sistemas de Información](../asignaturas/PSI) (PSI)
    ...
    -   Prerrequisito: SIO - Sistemas de Información para Las
        Organitzaciones
    :::
-   [Sistemas de Información para Las
    Organitzaciones](../asignaturas/SIO) (SIO)
...
-   [Administración de Bases de Datos](../asignaturas/ABD) (ABD)
    ...
    -   Prerrequisito: BD - Bases de Datos
    :::
-   [Búsqueda y Análisis de Información Masiva](../asignaturas/CAIM)
    (CAIM)
...
-   [Estrategia Digital en Las Organizaciones](../asignaturas/EDO) (EDO)
    ...
    ::: item-list
    -   Correquisito: NE - Negocio Electrónico
    -   Correquisito: SIO - Sistemas de Información para Las
        Organitzaciones
    :::
...
## Requisitos entre asignaturas {#requisitos-entre-asignaturas .block-title .no-subtitle}

:::::::::::::::::::::::: content
::::::::::::::::::::::: {#dexp-accordions-wrapper-1740674663 .panel-group .default}
:::::: {.panel .panel-default}
::: panel-heading
#### [Prerrequisito](#dexp-accordion-item-1740674663){parent="#dexp-accordions-wrapper-1740674663" toggle="collapse"} {#prerrequisito .panel-title}
:::

:::: {#dexp-accordion-item-1740674663 .panel-collapse .collapse .in}
::: panel-body
Si una asignatura A es prerrequisito de otra asignatura B, quiere decir
que para poder matricularse de la asignatura B es necesario haber
aprobado la asignatura A.
:::
::::
::::::
...
:::::: {.panel .panel-default}
::: panel-heading
#### [Correquisito](#dexp-accordion-item-1740674663--2){.collapsed parent="#dexp-accordions-wrapper-1740674663" toggle="collapse"} {#correquisito .panel-title}
:::

:::: {#dexp-accordion-item-1740674663--2 .panel-collapse .collapse}
::: panel-body
Si una asignatura A es correquisito de otra asignatura B, quiere decir
que para matricularse de la asignatura B es necesario haber aprobado o
estar matriculado de la asignatura A.
:::
::::
::::::
...
:::::: {.panel .panel-default}
::: panel-heading
#### [Precorrequisito](#dexp-accordion-item-1740674663--3){.collapsed parent="#dexp-accordions-wrapper-1740674663" toggle="collapse"} {#precorrequisito .panel-title}
:::

:::: {#dexp-accordion-item-1740674663--3 .panel-collapse .collapse}
::: panel-body
Si una asignatura A es precorrequisito de otra asignatura B, quiere
decir que para matricularse de la asignatura B es necesario haber estado
matriculado (al menos un cuatrimestre antes) de la asignatura A. En el
caso, que haya una cadena de precorrequisitos (A precorrequisito de B, y
B precorrequisito de C), no se podrá matricular de C sin haber aprovado
A.
:::
::::
::::::
...
:::::: {.panel .panel-default}
::: panel-heading
#### [Orrequisito](#dexp-accordion-item-1740674663--4){.collapsed parent="#dexp-accordions-wrapper-1740674663" toggle="collapse"} {#orrequisito .panel-title}
:::

:::: {#dexp-accordion-item-1740674663--4 .panel-collapse .collapse}
::: panel-body
Si dos asignaturas A y B son orrequisitos de otra asignatura C, quiere
decir que para matricularse de la asignatura C es necesario haber
aprobado la asignatura A o la asignatura B.
:::
::::
::::::
...
:::::: {.panel .panel-default}
::: panel-heading
#### [Incompatible](#dexp-accordion-item-1740674663--5){.collapsed parent="#dexp-accordions-wrapper-1740674663" toggle="collapse"} {#incompatible .panel-title}
:::

:::: {#dexp-accordion-item-1740674663--5 .panel-collapse .collapse}
::: panel-body
Si una asignatura A es incompatible con una asignatura B, quiere decir
que no puede matricularse la asignatura A si se tiene superada la
asignatura
B[.]{style="color: rgb(68, 68, 68); font-family: Raleway, Arial, Helvetica, sans-serif; font-size: 14px;"}
:::
::::
::::::
:::::::::::::::::::::::
