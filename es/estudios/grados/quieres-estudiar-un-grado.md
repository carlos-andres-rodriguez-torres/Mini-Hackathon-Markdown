---
description: \[column cols=\"7\" begin=\"1\"\] Grado en Ingeniería
  Informática ¿Te apasionan las Nuevas Tecnologías y quieres aprender
  como crear e innovar con ellas? La Facultad de Informática de
  Barcelona es uno de los centros pionero en el Estado español en
  impartir los estudios universitarios en informática. Te explicamos
  todo lo que hay que saber del Grado en Ingeniería Informática de la
generator: "Drupal 7 (https://www.drupal.org)"
lang: es
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: ¿Quieres estudiar un grado? \| Facultad de Informática de
  Barcelona
twitter:card: summary
twitter:description: \[column cols=\"7\" begin=\"1\"\] Grado en
  Ingeniería Informática ¿Te apasionan las Nuevas Tecnologías y quieres
  aprender como crear e innovar con ellas? La Facultad de Informática de
  Barcelona es uno de
twitter:title: ¿Quieres estudiar un grado?
twitter:url: "https://www.fib.upc.edu/es/estudios/grados/quieres-estudiar-un-grado"
...
::: content
-   [Català](/ca/estudis/graus/vols-estudiar-un-grau "Vols estudiar un grau?"){.language-link
    lang="ca"}
-   [English](/en/studies/bachelors-degrees/do-you-want-study-bachelors-degree "Do you want to study a bachelor's degree?"){.language-link
    lang="en"}
-   [Español](/es/estudios/grados/quieres-estudiar-un-grado " ¿Quieres estudiar un grado?"){.language-link
    .active lang="es"}
:::
:::::
...
-   [Estudios](/es/estudios)
    -   [Grados](/es/estudios/grados)
        -   [¿Quieres estudiar un
            grado?](/es/estudios/grados/quieres-estudiar-un-grado){.active}
            -   [Acceso a los
                estudios](/es/estudios/grados/quieres-estudiar-un-grado/acceso-los-estudios)
        -   [Grado en Ingeniería
...
:::: content
::: page_title_no_sub
# ¿Quieres estudiar un grado? {#quieres-estudiar-un-grado .page_title}
:::
::::
::::::
:::::::
...
::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::: {#node-16470 .node .node-page .clearfix}
::::::::::::::::::::::::::::::: content
...
::: block-subtitle
¿Te apasionan las Nuevas Tecnologías y quieres aprender como crear e
innovar con ellas?
:::

La Facultad de Informática de Barcelona es uno de los centros pionero en
el Estado español en impartir los estudios universitarios en
informática. Te explicamos todo lo que hay que saber del Grado en
Ingeniería Informática de la FIB en **[I love
bits](http://ilovebits.fib.upc.edu){target="_blank"}**.

[Vías de
acceso](/es/estudios/grados/quieres-estudiar-un-grado/acceso-los-estudios)
al Grado en Ingeniería Informática\
\

::: {.dexp-animate animate="fadeInLeft"}
[     Grado en Ingenieria
Informática](/ca/ilovebits){.dexp-shortcodes-button .btn .btn-link
role="button"}
:::
:::::
...
[![Grau
Bioinformàtica](/sites/fib/files/images/estudis/foto-anna.png)](http://www.ilovebits.fib.upc.edu/){target="_blank"}
:::
:::::::
...
::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[![Grau
Bioinformàtica](/sites/fib/files/images/estudis/grau-datascience.png){style="width: 449px; height: 236px;"}](http://dse.upc.edu){target="_blank"}
:::
...
::: block-subtitle
¿Quieres desarrollar sistemas inteligentes capaces de entender los datos
y aprender de ellas para mejorar nuestra calidad de vida?
:::

La Facultat d\'Informàtica de Barcelona, la Escola Tècnica Superior
d\'Enginyeria de Telecomunicació de Barcelona y la Facultat de
Matemàtiques i Estadística, ofrecen un **Grado en Ciencia e Ingeniería
de Datos** de cuatro años que quiere formar profesionales expertos en
análisis e ingeniería de datos estructurados y no estructurados.

[Vías de
acceso](/es/estudios/grados/quieres-estudiar-un-grado/acceso-los-estudios)
al Grado en Ciencia e Ingeniería de Datos

::: {.dexp-animate animate="fadeInLeft"}
[     Grado en Ciencia e Ingeniería de
Datos](/es/estudios/grados/grado-en-ciencia-e-ingenieria-de-datos){.dexp-shortcodes-button
...
La Facultad de Informática de Barcelona es el primer centro español que
ofrece la posibilidad de cursar una formación integral en IA con la
impartición de estudios de grado, máster y doctorado en este ámbito,
compartiendo experiencia, profesorado y prácticas con otros ámbitos de
la informática.

::: {.dexp-animate animate="fadeInLeft"}
[     Grado en Inteligencia
Artificial](/es/estudios/grados/grado-en-inteligencia-artificial){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::
...
::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[ ![Grau Enginyeria
Informàtica](/sites/fib/files/images/imatge-gia.jpg){style="width: 449px; height: 236px;"}](/es/estudios/grados/grado-en-inteligencia-artificial){target="_blank"}
:::
:::::::
...
::::::: row
::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[![](/sites/fib/files/images/estudis/bioinformaticamidaweb.png)](/es/estudios/grados/grado-en-bioinformatica){target="_blank"}
:::

::::: {.col-xs-12 .col-sm-7 .col-md-7 .col-lg-7}
::: block-subtitle
¿Te gustaría aplicar la informática y las tecnologías de la información
en el campo de la biología?
:::

La Universitat Politècnica de Catalunya (UPC·BarcelonaTech), la
Universidad Pompeu Fabra (UPF) y la Universidad de Barcelona (UB)
ofrecen un **Grado en Bioinformática** de cuatro años que se imparte
íntegramente en inglés. El grado está coordinado por la FIB-UPC y las
clases se imparten en el Campus Nord de la Universitat Politècnica de
Catalunya, y también en la Facultad de Biología de la UB, al Campus del
Mar de la UPF y en la Facultad de Biociencias de la UAB (según
optatividad).

[Vías de
acceso](/es/estudios/grados/quieres-estudiar-un-grado/acceso-los-estudios)
al Grado en Bioinformática

::: {.dexp-animate animate="fadeInLeft"}
[     Grado en
Bioinformática](/es/estudios/grados/grado-en-bioinformatica/){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::
:::::::
...
La Facultad de Informática de Barcelona incorpora el programa sucesivo
de Grado y Máster en Ingeniería Informática.

::: {.dexp-animate animate="fadeInLeft"}
[     Grado+Máster en Ingeniería Informática (programa
sucesivo)](/es/estudios/grados/gradomaster-en-ingenieria-informatica-programa-sucesivo){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::

::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[![](/sites/fib/files/images/estudis/grau-master-enginyeria-informatica-programa-successiu.png){style="width: 449px; height: 236px;"}](/es/estudios/grados/gradomaster-en-ingenieria-informatica-programa-sucesivo)
:::
:::::::
