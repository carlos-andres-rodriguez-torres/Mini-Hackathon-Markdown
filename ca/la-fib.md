...
description: \[column cols=\"4\" begin=\"1\"\]\[title class=\"bigtitle
  not-translate\" type=\"h2\"\]Per què la
  FIB?\[/title\]\[/column\]\[column cols=\"8\" end=\"1\"\] La Facultat
  d'Informàtica de Barcelona (FIB) és una de les deu principals
  facultats d'informàtica d'Europa. Disposem dels recursos, els
  professors i l'experiència adequats a l'àmplia oferta de cursos del
  centre \[/column\] La Facultat d'Informàtica
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: La FIB \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[column cols=\"4\" begin=\"1\"\]\[title
  class=\"bigtitle not-translate\" type=\"h2\"\]Per què la
  FIB?\[/title\]\[/column\]\[column cols=\"8\" end=\"1\"\] La Facultat
  d'Informàtica de Barcelona (FIB) és una de les deu
twitter:title: La FIB
twitter:url: "https://www.fib.upc.edu/ca/la-fib"
...
::: content
-   [Català](/ca/la-fib "La FIB"){.language-link .active lang="ca"}
-   [English](/en/fib "The FIB"){.language-link lang="en"}
-   [Español](/es/la-fib "La FIB"){.language-link lang="es"}
:::
:::::
...
::::::::::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::::::::::: {#node-6 .node .node-page .clearfix}
::::::::::::::::::::::::::::::::::::::: content
...
::: block-subtitle
La Facultat d'Informàtica de Barcelona (FIB) és una de les deu
principals facultats d'informàtica d'[Europa]{.mark}. Disposem dels
recursos, els professors i l'experiència adequats a l'àmplia oferta de
cursos del centre
:::
::::
:::::::
...
informàtica de nivell universitari a Espanya i ha encapçalat el progrés
a Catalunya en aquest camp des del 1977. La seva contribució a la
societat es pot veure clarament pel nombre de professionals d'alt nivell
que ha produït, que són requerits per organitzacions que cerquen
innovació i progrés.
...
-   Amplieu els coneixements sobre les últimes tendències en tecnologia
    i informàtica.
-   Completeu la vostra formació amb una estada en una universitat
    estrangera.
-   Feu el treball de fi de màster o les pràctiques en empreses de
    manera remunerada.
-   Estudieu en un entorn internacional.
-   Feu un màster de doble titulació conjuntament amb una universitat
    estrangera.
-   Col·laboreu amb els nombrosos centres de recerca i grups vinculats a
    la FIB.
-   Participeu en les activitats esportives, culturals, de cooperació
    internacional o de lleure organitzades per les associacions
    d'estudiants.
::::
:::::
...
-   Professionals que estan capacitats per dirigir projectes TIC,
    instal·lacions i organitzacions que compleixin la normativa actual
    d'acord amb els criteris de qualitat i de respecte del medi ambient.
-   Emprenedors i investigadors capaços de dur a terme projectes en un
    entorn internacional.
-   Professionals capacitats per implementar les TIC en tot tipus
    d'empreses i organitzacions.
-   Professionals que poden dirigir departaments d'R+D i projectes amb
    un component important de recerca.
-   Índex d'ocupació gairebé del 100 % i retribucions entre les més
    elevades entre tots els titulats universitaris.
::::
:::::
:::::::::

La FIB forma part de la [Universitat Politècnica de Catalunya •
BarcelonaTech](http://www.upc.edu/){target="_blank"}, una institució
pública dedicada a la recerca i a l'educació superior en els camps de
l'arquitectura, la ciència i l'enginyeria. Està situada en el Campus
Nord de la UPC, que té la concentració més alta de recerca i innovació
en TI del sud d'Europa i forma part del [Barcelona Knowledge
Campus](http://bkc.upc.ub.edu/index.php?cont=campus){target="_blank"},
un campus internacional d'excel·lència.
...
::: box-icon
[](/ca/la-fib/la-facultat)
:::

### [La facultat](/ca/la-fib/la-facultat) {#la-facultat .box-title}
::::
:::::
...
### [Espais](/ca/la-fib/espais) {#espais .box-title}
::::
:::::
...
::::: {.dexp-shortcodes-box .hovericon .box-circle .box-center}
::: box-icon
[](/ca/la-fib/serveis-tic)
:::

### [Serveis TIC](/ca/la-fib/serveis-tic) {#serveis-tic .box-title}
...
::::: {.dexp-shortcodes-box .hovericon .box-circle .box-center}
::: box-icon
[](/ca/la-fib/vida-universitaria)
:::

### [Vida Universitària](/ca/la-fib/vida-universitaria) {#vida-universitària .box-title}
...
:::: {.dexp-shortcodes-box .hovericon .box-circle .box-center}
::: box-icon
[](/ca/la-fib/sistema-de-qualitat)
:::

### [Sistema de qualitat](/ca/la-fib/sistema-de-qualitat) {#sistema-de-qualitat .box-title}
::::
:::::
