---
description: FIB Visiona treballar per connectar el talent FIBer que
  busca avançar a la seva carrera professional amb empreses i
  organitzacions punteres d\'arreu del món. Organitza un conjunt
  d\'activitats (presentacions, conferències, estands d\'empreses,
  recollida de currículums i entrevistes, etc.) amb l\'objectiu
  d\'oferir un ampli ventall d\'opcions a l\'hora d\'iniciar-se o
  avançar al món
...
theme-color: "#ffffff"
title: FIB Visiona \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: FIB Visiona treballar per connectar el talent FIBer
  que busca avançar a la seva carrera professional amb empreses i
  organitzacions punteres d\'arreu del món. Organitza un conjunt
  d\'activitats
twitter:title: FIB Visiona
twitter:url: "https://www.fib.upc.edu/ca/empresa/fib-visiona"
...
::: content
-   [Català](/ca/empresa/fib-visiona "FIB Visiona"){.language-link
    .active lang="ca"}
-   [English](/en/companies/fib-visiona "FIB Visiona"){.language-link
    lang="en"}
-   [Español](/es/empresa/fib-visiona "FIB Visiona"){.language-link
    lang="es"}
:::
:::::
...
-   [Empresa](/ca/empresa)
    ...
    -   [Borsa de treball](/ca/empresa/borsa-de-treball)
        ...
        -   [Publicar
            ofertes](/ca/empresa/borsa-de-treball/publicar-ofertes)
    -   [FIB Visiona](/ca/empresa/fib-visiona){.active}
    -   [Patrocinis](/ca/empresa/patrocinis)
...
:::: content
::: page_title_no_sub
# FIB Visiona {#fib-visiona .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Empresa](/ca/empresa) » FIB Visiona
:::
::::
::::::
:::::::
...
::::: {#block-block-17 .block .block-block .dexp-parallax background-width="2861" background-height="1086" background-ratio="1" stellar-background-ratio="1" style="padding:11em 0 11em 0;background-image:url(https://www.fib.upc.edu/sites/fib/files/forumportada.jpg);background-position:top left"}
::: inner
:::
...
-   [Pràctiques en empresa](/ca/empresa/practiques-en-empresa)
-   [Borsa de treball](/ca/empresa/borsa-de-treball)
-   [FIB Visiona](/ca/empresa/fib-visiona){.active-trail .active}
-   [Patrocinis](/ca/empresa/patrocinis)
:::
::::
::::::
...
:::::::: content
::::::: {#node-110 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
FIB Visiona treballar per connectar el talent FIBer que busca avançar a
la seva carrera professional amb empreses i organitzacions punteres
d\'arreu del món. Organitza un conjunt d\'activitats (presentacions,
conferències, estands d\'empreses, recollida de currículums i
entrevistes, etc.) amb l\'objectiu d\'oferir un ampli ventall d\'opcions
a l\'hora d\'iniciar-se o avançar al món laboral.

L\'esdeveniment més destacat organitzat per FIB Visiona, és la fira de
treball que té com a objectiu connectar empreses amb els estudiants i
les estudiantes de les diferents titulacions.\
 

L\'interès d\'aquesta activitat entre les empreses és creixent, ja que
serveix d\'espai de contacte amb els seus futurs professionals. El
mateix es pot dir per els estudiants, que tenen l\'oportunitat així de
contactar directament amb algunes de les millors empreses del sector
informàtic o d\'altres sectors com les telecomunicacions o els serveis,
consultoria, etc.

 

[FIB Visiona](https://fibvisiona.com/){.btn .btn-primary
target="_blank"}
:::
::::
:::::
