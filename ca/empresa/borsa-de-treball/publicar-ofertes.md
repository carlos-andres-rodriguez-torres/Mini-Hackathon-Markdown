---
description: Si l\'oferta que voleu publicar està destinada a estudiants
  de la FIB, us recomanem que reviseu, abans, la normativa de Convenis
  de Cooperació Educativa, per si és més adient oferir-la com a pràctica
  en empresa. Normes bàsiques per omplir el formulari No publicarem
  ofertes Que no siguin de l\'àmbit informàtic. Que exigeixin inversió
  de diners per part dels candidats. D\'empreses
...
twitter:description: Si l\'oferta que voleu publicar està destinada a
  estudiants de la FIB, us recomanem que reviseu, abans, la normativa de
  Convenis de Cooperació Educativa, per si és més adient oferir-la com a
  pràctica
twitter:title: Publicar ofertes
twitter:url: "https://www.fib.upc.edu/ca/empresa/borsa-de-treball/publicar-ofertes"
...
::: content
-   [Català](/ca/empresa/borsa-de-treball/publicar-ofertes "Publicar ofertes"){.language-link
    .active lang="ca"}
-   [English](/en/companies/job-placements/posting-offers "Posting offers"){.language-link
    lang="en"}
-   [Español](/es/empresa/bolsa-de-trabajo/publica-ofertas "Publica ofertas"){.language-link
    lang="es"}
:::
:::::
...
-   [Empresa](/ca/empresa)
    ...
    -   [Borsa de treball](/ca/empresa/borsa-de-treball)
        -   [Llistat
            ofertes](/ca/empresa/borsa-de-treball/llistat-ofertes)
        -   [Publicar
            ofertes](/ca/empresa/borsa-de-treball/publicar-ofertes){.active}
    -   [FIB Visiona](/ca/empresa/fib-visiona)
    -   [Patrocinis](/ca/empresa/patrocinis)
...
::: breadcrumb
[Inici](/ca) » [Empresa](/ca/empresa) » [Borsa de
...
-   [Publicar
    ofertes](/ca/empresa/borsa-de-treball/publicar-ofertes){.active-trail
    .active}
:::
::::
::::::
...
::::::::: content
:::::::: {#node-18089 .node .node-page .clearfix}
::::::: content
:::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
::::: field-items
:::: {.field-item .even}
Si l\'oferta que voleu publicar està destinada a estudiants de la FIB,
us recomanem que reviseu, abans, la normativa de [Convenis de Cooperació
Educativa](/ca/empresa/practiques-en-empresa#InformacioEmpreses), per si
és més adient oferir-la com a **pràctica en empresa. **
...
-   **No publicarem ofertes**
    ...
    -   Que no identifiquin **l\'EMPRESA** **FINAL **i el **LLOC DE
        TREBALL**.
    -   Que continguin **URL**
-   S\'esborraran les adreces web i/o emails que estiguin fora dels seus
    camps específics.

*Aquestes normes poden ser modificades en qualsevol moment sense
necessitat d\'avís previ.*
:::
::::
:::::
::::::
...
::::::::::::::::::::::::::::::: {#block-borsa-treball-borsa-treball-form .block .block-borsa-treball}
::: inner
:::
...
::::::::: {.form-item .form-type-checkboxes .form-item-destinataris}
Destinataris

::::::: {#edit-destinataris .form-checkboxes}
::: {.form-item .form-type-checkbox .form-item-destinataris-EstFIB}
Estudiants FIB
:::

::: {.form-item .form-type-checkbox .form-item-destinataris-RecTit}
Recent titulats
:::

::: {.form-item .form-type-checkbox .form-item-destinataris-Tit+3}
Titulats de fa més de 3 anys
:::

::: {.form-item .form-type-checkbox .form-item-destinataris-TitDoct}
Titulats que volen fer doctorat
:::
:::::::

::: description
Les ofertes destinades a titulats seràn publicades també a la Borsa de
Treball del [FIB Alumni](http://www.fibalumni.net/){target="_blank"}
:::
:::::::::

::: {.form-item .form-type-textfield .form-item-empresa}
Empresa o institució [\*]{.form-required
title="Aquest camp és obligatori."}
:::

::: {.form-item .form-type-textfield .form-item-titol}
Vacant [\*]{.form-required title="Aquest camp és obligatori."}
:::

:::: {.form-item .form-type-textarea .form-item-info}
Informació oferta [\*]{.form-required
title="Aquest camp és obligatori."}
...
::: {.form-item .form-type-textfield .form-item-poblacio}
Localitat
:::

::: {.form-item .form-type-textfield .form-item-jornadalab}
Jornada laboral
:::

:::: {.form-item .form-type-textarea .form-item-requisits}
Requisits
...
::::: {.form-item .form-type-textarea .form-item-perscont}
Persona de contacte
...
::: description
La següent informació només serà accessible pels alumnes de la FIB i
pels membres del [FIB
Alumni](http://www.fibalumni.net/){target="_blank"}
:::
:::::

:::: {.form-item .form-type-textfield .form-item-emailpub}
Email públic [\*]{.form-required title="Aquest camp és obligatori."}
...
:::::: {.form-item .form-type-date-popup .form-item-datacad}
Data de caducitat [\*]{.form-required
title="Aquest camp és obligatori."}

:::: {#edit-datacad .date-padding .clearfix}
::: {.form-item .form-type-textfield .form-item-datacad-date}
Date
:::
::::
