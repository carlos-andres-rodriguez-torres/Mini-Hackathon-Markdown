---
description: "Borsa de pràctiques en empresa La borsa permet a
  l\\'estudiantat: penjar el teu CV i escollir preferències d\\'horari i
  àmbits. veure les ofertes publicades i presentar-ne candidatura. veure
  l\\'estat de les teves candidatures. donar autorització explícita a la
  borsa per la difusió de les teves dades a les empreses registrades a
  l'aplicatiu. Utilització de la borsa L\\'estudiantat no"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Llistat ofertes \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: "Borsa de pràctiques en empresa La borsa permet a
  l\\'estudiantat: penjar el teu CV i escollir preferències d\\'horari i
  àmbits. veure les ofertes publicades i presentar-ne candidatura. veure
  l\\'estat de"
twitter:title: Llistat ofertes
twitter:url: "https://www.fib.upc.edu/ca/empresa/practiques-en-empresa/llistat-ofertes"
...
::: content
-   [Català](/ca/empresa/practiques-en-empresa/llistat-ofertes "Llistat ofertes"){.language-link
    .active lang="ca"}
-   [English](/en/companies/industrial-practices/offers-list "Offers list"){.language-link
    lang="en"}
-   [Español](/es/empresa/practicas-en-empresa/listado-ofertas "Listado ofertas"){.language-link
    lang="es"}
:::
:::::
...
-   [Empresa](/ca/empresa)
    -   [Pràctiques en empresa](/ca/empresa/practiques-en-empresa)
        -   [Llistat
            ofertes](/ca/empresa/practiques-en-empresa/llistat-ofertes){.active}
        -   [Publicar
            ofertes](/ca/empresa/practiques-en-empresa/publicar-ofertes)
...
:::: content
::: page_title_no_sub
# Llistat ofertes {#llistat-ofertes .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Empresa](/ca/empresa) » [Pràctiques en
empresa](/ca/empresa/practiques-en-empresa) » Llistat ofertes
:::
::::
::::::
:::::::
...
-   [Llistat
    ofertes](/ca/empresa/practiques-en-empresa/llistat-ofertes){.active-trail
    .active}
-   [Publicar
    ofertes](/ca/empresa/practiques-en-empresa/publicar-ofertes)
:::
...
:::::::::::::::::: content
::::::::::::::::: {#node-18086 .node .node-page .clearfix}
:::::::::::::::: content
...
-   donar autorització explícita a la borsa per la difusió de les teves
    dades a les empreses registrades a l'aplicatiu.

### Utilització de la borsa

L\'estudiantat no registrat només pot accedir a la informació pública,
consultant la descripció i localitat de les pràctiques publicades. Per
accedir a la resta de funcionalitats de la borsa cal estar registrat.

[Borsa de pràctiques en
empresa](https://borsapractiques.fib.upc.edu/){.dexp-shortcodes-button
.btn .btn .btn-primary .btn-link role="button"}

1.  Per a registrar-te cal que accedeixis a la borsa amb el teu usuari
    UPC i, si compleixes els requisits acadèmics necessaris, ja pots
    començar a fer servir l\'aplicatiu.

2.  Introdueix les teves dades al Perfil d'usuari

    Des de la pestanya \"Editar\" del perfil d'usuari, pots modificar
    les teves dades personals: nom, telèfon, NIF.\
    Has d'informar obligatòriament dels camps Estudis, Àmbit i Jornada.
    També és obligatori annexar el teu CV. **Fins que no omplis aquestes
    dades i annexis un CV el teu perfil no serà visible** per a les
    empreses i no podràs presentar candidatures a cap oferta. Es pot
    omplir voluntàriament el camp d'experiència professional i
    preferències amb informació addicional o comentaris més enllà del
    currículum.\
    \
    La darrera opció dins del perfil d'usuari és l'autorització a la
    difusió de les dades personals i el CV a totes les empreses
    registrades. Només seran visibles per a totes les empreses
    aquells estudiants que hagin donat aquesta autorització. **La no
    autorització fa que només podran veure les dades de l'estudiant les
    empreses a les quals presentis candidatura**.

 

## Preguntes freqüents

:::::::::::: {#dexp-accordions-wrapper-1740064008 .panel-group .default}
::::::: {.panel .panel-default}
::: panel-heading
#### [Quins són els requisits per accedir a la borsa i realitzar pràctiques en empreses?](#dexp-accordion-item-1740064008){.collapsed parent="#dexp-accordions-wrapper-1740064008" toggle="collapse"} {#quins-són-els-requisits-per-accedir-a-la-borsa-i-realitzar-pràctiques-en-empreses .panel-title}
:::

::::: {#dexp-accordion-item-1740064008 .panel-collapse .collapse}
:::: panel-body
L'estudiantat que vulgui participar en una pràctica acadèmica externa ha
de complir:
...
-   Tenir assegurança escolar mentre el conveni sigui vigent.** **En el
    cas de majors de 28 anys, l\'esmentada assegurança haurà de ser
    proporcionada pel propi estudiant.
-   No mantenir una relació contractual amb l\'empresa en que es fan les
    pràctiques.
...
:::::: {.panel .panel-default}
::: panel-heading
#### [M\'he registrat a la Borsa però no veig cap oferta](#dexp-accordion-item-1740064008--2){.collapsed parent="#dexp-accordions-wrapper-1740064008" toggle="collapse"} {#mhe-registrat-a-la-borsa-però-no-veig-cap-oferta .panel-title}
:::

:::: {#dexp-accordion-item-1740064008--2 .panel-collapse .collapse}
::: panel-body
**Fins que no omplis les dades personals i annexis un CV el teu perfil
no seràs visible** per a les empreses i no podràs presentar candidatures
a cap oferta. Trobaràs l\'opció a la icona del menú superior dins
l\'opció \"Perfil\".
:::
::::
::::::
