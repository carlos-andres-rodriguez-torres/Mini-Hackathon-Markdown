---
description: "Borsa de pràctiques en empresa La borsa permet a les
  empreses: crear i publicar ofertes de pràctiques. gestionar, editar i
  cercar les ofertes pròpies. veure les candidatures presentades a les
  vostres ofertes. indicar la candidatura seleccionada, iniciant
  automàticament la gestió del conveni. accedir a la informació de
  l\\'estudiantat que hagi donat autorització explícita a la"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Publicar ofertes \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: "Borsa de pràctiques en empresa La borsa permet a
  les empreses: crear i publicar ofertes de pràctiques. gestionar,
  editar i cercar les ofertes pròpies. veure les candidatures
  presentades a les vostres"
twitter:title: Publicar ofertes
twitter:url: "https://www.fib.upc.edu/ca/empresa/practiques-en-empresa/publicar-ofertes"
...
::: content
-   [Català](/ca/empresa/practiques-en-empresa/publicar-ofertes "Publicar ofertes"){.language-link
    .active lang="ca"}
-   [English](/en/companies/industrial-practices/posting-offers "Posting offers"){.language-link
    lang="en"}
-   [Español](/es/empresa/practicas-en-empresa/publica-ofertas "Publica ofertas"){.language-link
    lang="es"}
:::
:::::
...
-   [Empresa](/ca/empresa)
    -   [Pràctiques en empresa](/ca/empresa/practiques-en-empresa)
        -   [Llistat
            ofertes](/ca/empresa/practiques-en-empresa/llistat-ofertes)
        -   [Publicar
            ofertes](/ca/empresa/practiques-en-empresa/publicar-ofertes){.active}
...
:::: content
::: page_title_no_sub
# Publicar ofertes {#publicar-ofertes .page_title}
:::
::::
::::::
:::::::
...
empresa](/ca/empresa/practiques-en-empresa) » Publicar ofertes
:::
::::
::::::
:::::::
...
-   [Publicar
    ofertes](/ca/empresa/practiques-en-empresa/publicar-ofertes){.active-trail
    .active}
:::
::::
::::::
...
:::::::::::::::: content
::::::::::::::: {#node-18088 .node .node-page .clearfix}
:::::::::::::: content
...
-   indicar la candidatura seleccionada, iniciant automàticament la
    gestió del conveni.
-   accedir a la informació de l\'estudiantat que hagi donat
    autorització explícita a la borsa per la difusió de les seves dades.
...
-   **Si no esteu registrats**:
    1.  Cliqueu l\'enllaç per [registrar-vos a la borsa de pràctiques
        externes](https://borsapractiques.fib.upc.edu/ca/employer/add/company).
    2.  Empleneu les dades obligatòries.
    3.  Rebreu un correu de confirmació de recepció de la sol·licitud
        d\'alta.
    4.  Quan la Facultat faci la validació, rebreu un correu
        de **confirmació d\'alta** amb el nom d\'usuari i la vostra
        contrasenya, a partir d\'aquest moment podreu accedir per
        publicar ofertes.
...
:::::: {.panel .panel-default}
::: panel-heading
#### [Quins tipus d\'ofertes es poden introduir a la borsa de pràctiques?](#dexp-accordion-item-1740063820){.collapsed parent="#ACCORDION_WRAPPER_ID" toggle="collapse"} {#quins-tipus-dofertes-es-poden-introduir-a-la-borsa-de-pràctiques .panel-title}
:::

:::: {#dexp-accordion-item-1740063820 .panel-collapse .collapse}
::: panel-body
Pràctiques en empreses vinculades als estudis de la Facultat i que
estaran regulades per la normativa de [Convenis de Cooperació
Educativa](/ca/empresa/practiques-en-empresa#InformacioEmpreses). Les
ofertes d\'àmbit laboral cal publicar-les a la [Borsa de
Treball](/ca/empresa/borsa-de-treball/publicar-ofertes).
:::
::::
::::::
...
:::::: {.panel .panel-default}
::: panel-heading
#### [Quan publiqui una sol·licitud d\'oferta quin procediment es seguirà per cobrir la plaça?](#dexp-accordion-item-1740063820--2){.collapsed parent="#ACCORDION_WRAPPER_ID" toggle="collapse"} {#quan-publiqui-una-sollicitud-doferta-quin-procediment-es-seguirà-per-cobrir-la-plaça .panel-title}
:::

:::: {#dexp-accordion-item-1740063820--2 .panel-collapse .collapse}
::: panel-body
Un cop validada per la Facultat, l\'oferta es farà pública.
L\'estudiantat interessat s\'anirà apuntant a l\'oferta i podrà
contactar per telèfon i/o correu electrònic amb la persona responsable
de l\'oferta. Alhora l\'empresa també tindrà disponible les dades de
contacte dels/de les estudiants que es presentin a l\'oferta. Així que
un cop s\'hagin avaluat les candidatures, es pot seleccionar la persona
escollida, i iniciar el procediment de formalització del conveni.
:::
::::
::::::
:::::::::::
