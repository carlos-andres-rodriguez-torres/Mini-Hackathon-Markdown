---
description: El Laboratori Social Point es troba ubicat al soterrani de
  l\'aulari A5. Aquest Laboratori s\'ha finançat gràcies a la donació
  que va fer l\'empresa Social Point, que va permetre equipar l\'aula
  A5S104 amb 23 iMacs, quatre adaptadors per a presentacions amb Macs i
  adquirir telèfons i tauletes per tal que els estudiants puguin
  desenvolupar i provar les seves Apps en diferents
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Laboratori Social Point \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El Laboratori Social Point es troba ubicat al
  soterrani de l\'aulari A5. Aquest Laboratori s\'ha finançat gràcies a
  la donació que va fer l\'empresa Social Point, que va permetre equipar
  l\'aula A5S104
twitter:title: Laboratori Social Point
twitter:url: "https://www.fib.upc.edu/ca/empresa/patrocinis/laboratori-social-point"
...
::: content
-   [Català](/ca/empresa/patrocinis/laboratori-social-point "Laboratori Social Point"){.language-link
    .active lang="ca"}
-   [English](/en/companies/sponsorship/social-point-lab "Social Point Lab"){.language-link
    lang="en"}
-   [Español](/es/empresa/patrocinios/laboratorio-social-point "Laboratorio Social Point"){.language-link
    lang="es"}
:::
:::::
...
-   [Empresa](/ca/empresa)
    ...
    -   [Patrocinis](/ca/empresa/patrocinis)
        ...
        -   [Laboratori Social
            Point](/ca/empresa/patrocinis/laboratori-social-point){.active}
-   [La FIB](/ca/la-fib)
...
:::: content
::: page_title_no_sub
# Laboratori Social Point {#laboratori-social-point .page_title}
:::
::::
::::::
:::::::
...
[Patrocinis](/ca/empresa/patrocinis) » Laboratori Social Point
:::
::::
::::::
:::::::
...
-   [Laboratori d\'aplicacions mòbils
    Jedi](/ca/empresa/patrocinis/laboratori-daplicacions-mobils-jedi)
-   [Laboratori Social
    Point](/ca/empresa/patrocinis/laboratori-social-point){.active-trail
    .active}
:::
::::
::::::
...
::::::::: content
:::::::: {#node-16011 .node .node-page .clearfix}
::::::: content
...
Aquest Laboratori s\'ha finançat gràcies a la donació que va fer
l\'empresa [Social Point](http://www.socialpoint.es){target="_blank"},
que va permetre equipar l\'aula A5S104 amb 23 iMacs, quatre adaptadors
per a presentacions amb Macs i adquirir telèfons i tauletes per tal que
els estudiants puguin desenvolupar i provar les seves Apps en diferents
dispositius físics.

Concretament es van adquirit: dos telèfons mòbils iPhone 5, dos iPad
mini,  dos telèfons LG Google Nexus 5 que els estudiants teniu en
préstec a la vostra disposició.\
\
Els equips iMacs compten amb un sistema de triple arrencada, que permet
a l\'estudiant triar el sistema operatiu amb el que vol treballar:
Linux, Windows o Mac OS.

![](/sites/fib/files/images/empresa/socialpoint_aula.jpg)

L\'empresa [Social Point](http://www.socialpoint.es){target="_blank"}
amb seu a Barcelona, va ser fundada per Andrés Bou i Horacio Martos, dos
titulats de la FIB i va començar amb la creació de jocs gratuïts en
línia per a Facebook l\'any 2008.

\
Avui en dia és la tercera companyia més important en el desenvolupament
de jocs a Facebook, amb un abast de més de 50 milions de jugadors a tot
el món cada mes. Fan jocs socials accessibles per a web i mòbil, que
connecten a persones de tot el planeta.\
\
[Aquest Laboratori es va inaugurar el dia 28 d\'octubre de
2014](https://saladepremsa2.upc.edu/al-dia/mes-noticies/la-fib-inaugura-el-laboratori-social-point.html){target="_blank"}
amb la presència rector de la Universitat Politècnica de Catalunya (Dr.
Enric Fosas), la degana de la Facultat d\'informàtica de Barcelona (Sra.
Núria Castell), el director de l\'inLab (Sr. Josep Casanovas) ,el
director tècnic de l\'empresa Social Point (Marc Canaleta), i el mobile
manager de Social Point (Sergi Vélez), que van explicar quines són les
etapes de creació d\'un videojoc.
...
-   [Característiques i localització del Laboratori d\'aplicacions
    mòbils
    Jedi](/ca/la-fib/espais/laboratoris-dinformatica/a5s104-laboratori-social-point)
-   [Com accedir als equips, al vostre repositori de fitxers i conèixer
    el software que hi ha
    instal·lat](https://raco.fib.upc.edu/fitxers/Mac-Doc-Raco.pdf){target="_blank"}**.**
