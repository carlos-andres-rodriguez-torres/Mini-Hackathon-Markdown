---
description: "Si vols venir a estudiar a la Facultat d\\'Informàtica de
  Barcelona com a estudiant d\\'intercanvi o vols cursar una doble
  titulació, has de seguir els passos següents: Mira si existeix
  l\\'acord Sigues nominat per la teva universitat Espera a rebre un
  e-mail amb informació per registrar-te Acredita el nivell d\\'idioma
  Prepara l\\'acord acadèmic Puja tota la documentació requerida a"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Estada acadèmica \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: "Si vols venir a estudiar a la Facultat
  d\\'Informàtica de Barcelona com a estudiant d\\'intercanvi o vols
  cursar una doble titulació, has de seguir els passos següents: Mira si
  existeix l\\'acord Sigues"
twitter:title: Estada acadèmica
twitter:url: "https://www.fib.upc.edu/ca/mobilitat/incoming/estada-academica"
...
::: content
-   [Català](/ca/mobilitat/incoming/estada-academica "Estada acadèmica"){.language-link
    .active lang="ca"}
-   [English](/en/mobility/incoming/academic-stays "Academic stays"){.language-link
    lang="en"}
-   [Español](/es/movilidad/incoming/estancia-academica "Estancia académica"){.language-link
    lang="es"}
:::
:::::
...
-   [Mobilitat](/ca/mobilitat)
    -   [Incoming](/ca/mobilitat/incoming)
        -   [Estada
            acadèmica](/ca/mobilitat/incoming/estada-academica){.active}
        -   [Estada en
            pràctiques](/ca/mobilitat/incoming/estada-en-practiques)
...
:::: content
::: page_title_no_sub
# Estada acadèmica {#estada-acadèmica .page_title}
:::
::::
::::::
:::::::
...
[Incoming](/ca/mobilitat/incoming) » Estada acadèmica
:::
::::
::::::
:::::::
...
-   [Estada
    acadèmica](/ca/mobilitat/incoming/estada-academica){.active-trail
    .active}
...
:::::::::::::::::: content
::::::::::::::::: {#node-16027 .node .node-page .clearfix}
:::::::::::::::: content
::::::::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::::::::: field-items
::::::::::::: {.field-item .even}
Si vols venir a estudiar a la Facultat d\'Informàtica de Barcelona com a
**estudiant d\'intercanvi** o vols cursar **una doble titulació**,  has
de seguir els passos següents:

1.  [Mira si existeix
    l\'acord](/ca/mobilitat/incoming/estada-academica#1)
2.  [Sigues nominat per la teva
    universitat](/ca/mobilitat/incoming/estada-academica#2)
3.  [Espera a rebre un e-mail amb informació per
    registrar-te](/ca/mobilitat/incoming/estada-academica#3)
4.  [Acredita el nivell
    d\'idioma](/ca/mobilitat/incoming/estada-academica#4)
5.  [Prepara l\'acord
    acadèmic](/ca/mobilitat/incoming/estada-academica#5)
6.  [Puja tota la documentació requerida a
    l\'aplicació](/ca/mobilitat/incoming/estada-academica#6)
7.  [Aplicació pendent de
    validar](/ca/mobilitat/incoming/estada-academica#7)
8.  [Espera resposta](/ca/mobilitat/incoming/estada-academica#8)
9.  [Registra\'t als programes
    d\'acollida](/ca/mobilitat/incoming/estada-academica#9)
10. [Matricula\'t](/ca/mobilitat/incoming/estada-academica#10)

 

::: {.alert .alert-info}
### []{#1}1. Mira si existeix l\'acord

Verifica que existeix un acord bilateral signat entre la teva
universitat i la FIB; pots consultar les [universitats
partner](/ca/mobilitat/aliances-internacionals/universitats-partner),
[programes de
mobilitat](/ca/mobilitat/aliances-internacionals/programes-de-mobilitat)
i [dobles titulacions](/ca/mobilitat/dobles-titulacions).
:::

::: {.alert .alert-info}
### []{#2}2. Sigues nominat per la teva universitat
...
El procediment de nominació s'enviarà a totes les institucions sòcies
per correu electrònic a mitjans de març i principis d'octubre. Per a
qualsevol dubte o informació sobre el procediment relacionat amb la
nominació, la teva universitat pot contactar amb []{#rUabqiBxW
rel="nofollow"}
...
::: {.alert .alert-info}
### []{#3}3. Espera a rebre un e-mail amb informació per registrar-te

Una vegada hàgim rebut la teva nominació, rebràs un correu electrònic
amb la informació i la data límit per completar el formulari de
sol·licitud en línia a través de la nostra plataforma.
...
::: {.alert .alert-info}
### []{#4}4. Acredita el nivell d\'idioma

Barcelona és la principal ciutat de Catalunya, una comunitat bilingüe,
així que tant el català com el castellà són llengües oficials a la UPC.
Com a estudiant de mobilitat has de tenir, com a mínim, un nivell
intermedi (B1) de l\'idioma d\'impartició de la titulació en què et
matricularàs. Aquest idioma d\'impartició és:
...
En el cas que la llengua d\'impartició no sigui la teva llengua materna,
caldrà aportar un certificat de nivell.

En el cas de l\'**anglès**, el nivell B1 el podràs acreditar mitjançant
qualsevol dels certificats més habitualment acceptats: TOEFL, IELTS,
TOEIC (4 destresses), FCE, DAAD examen, \...
...
-   El "Diploma de Español como Lengua Extranjera
    ([DELE](http://diplomas.cervantes.es/))", atorgat per l'[Instituto
    Cervantes](http://www.cervantes.es/default.htm).
-   Un certificat del [SIELE
    Global](https://siele.org/web/guest/siele-global){target="_blank"},
    atorgat per la institució SIELE, amb una puntuació que sigui almenys
    equivalent al nivell B1 del CEFR
...
atorgat per l'[Institut Ramon Llull](http://www.llull.cat/).
...
::: {.alert .alert-info}
### []{#5}5. Prepara l\'acord acadèmic

L\'acord acadèmic és el document on quedaran recollides les assignatures
que cursaràs durant la teva estada de mobilitat i que ha de tenir la
teva conformitat, la de la teva universitat i la de la universitat
d\'acollida. Per part de la FIB, la llista d\'assignatures especificades
a la solicitud d\'admissió equival a l\'acord acadèmic. De totes
maneres, en funció del programa en què facis la teva mobilitat és
possible que hagis d\'emplenar un document específic. Consulta la teva
universitat per informar-te\'n, especialment si vols seguir una doble
titulació.

Consulta el llistat de [CURSOS
DISPONIBLES](https://mobility.fib.upc.edu/course_catalogue/) per a
estudiants d\'intercanvi.

-   Hi ha dependències entre assignatures, així que tingues en compte
    els requisits de cada assignatura. Ens hauràs d\'adjuntar un
    expedient de notes per poder verificar aquests requisits.
-   Totes les assignatures tenen un nombre limitat de places per a
    estudiants d\'intercanvi. Les places s\'assignaran seguint l\'ordre
    en el qual **es completi** el procés de sol·licitud.
-   L\'acord acadèmic del **cuatrimestre de primavera** dels estudiants
    amb **estada anual** pot ser modificat d\'acord amb el rendiment
    acadèmic del **cuatrimestre de tardor**, tot seguint la mateixa
    normativa que pels estudiants regulars.
-   Els estudiants de màster poden triar assignatures de diferents
    titulacions mentre compleixin els requisits acadèmics i d\'idioma.
-   Hi ha un màxim de 30 ECTS per matricular en un quadrimestre.
-   Si estàs interessat a realitzar el treball de fi de grau (TFG) o
    treball de fi de màster (TFM) a la FIB, pots escollir entre 18 ECTS
    per al TFG o de 18 a 30 ECTS pels TFM.
    -   [Informació sobre el treball de fi de grau GEI - 18
        ECTS](/ca/estudis/graus/grau-en-enginyeria-informatica/treball-de-fi-de-grau){target="_blank"}
    -   [Informació sobre el treball de fi de grau GCED - 18
        ECTS](https://dse.upc.edu/ca/alumnes-de-grau/treball-fi-de-grau)
    -   [Informació sobre el treball de fi de màster MEI - 30
        ECTS](/ca/estudis/masters/master-en-enginyeria-informatica/treball-de-fi-de-master){target="_blank"}
    -   [Informació sobre el treball de fi de màster MIRI - 30
        ECTS](/ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/treball-de-fi-de-master){target="_blank"}
    -   [Informació sobre el treball de fi de màster MAI - 18
        ECTS](/ca/estudis/masters/master-en-intelligencia-artificial/treball-de-fi-de-master){target="_blank"}
    -   [Informació sobre el treball de fi de màster MDS - 30
        ECTS](/ca/estudis/masters/master-en-ciencia-de-dades/treball-de-fi-de-master)
:::

::: {.alert .alert-info}
### []{#6}6. Puja tota la documentació requerida a l\'aplicació

Abans de tancar l\'aplicació has de pujar en format pdf la documentació
següent:

-   Acreditació del nivell d\'idioma.
-   Expedient de notes oficial (emès per la teva universitat amb tots
    els cursos fets fins ara). Si ets estudiant de Màster adjuntar també
    l\'expedient del Grau.
-   Curriculum Vitae
-   Llista d\'assignatures matriculades actualment.
:::

::: {.alert .alert-info}
### []{#7}7. Aplicació pendent de validar

Un cop tancada l\'aplicació el coordinador de la teva universitat rebrà
un e-mail per tal que validi la informació que has indicat.
:::

::: {.alert .alert-info}
### []{#8}8. Espera resposta

Un cop revisada la documentació t\'enviarem un correu electrònic
informant-te si has estat acceptat o no. A l\'aplicació et podràs
descarregar la carta d\'admissió i l\'acord acadèmic Erasmus+, si és el
cas, degudament signat i segellat.
:::

::: {.alert .alert-info}
### []{#9}9. Registra\'t als programes d\'acollida

La Universitat Politècnica de Catalunya disposa de 2 programes
d\'acollida pels estudiants internacionals d\'intercanvi: la setmana
d\'orientació (Orientation Week) i el Buddy programme Salsa\'m.

La **Orientation Week (OW)** es desenvolupa en 2 dies i inclou una
benvinguda institucional, informació sobre tràmits legals, sessions amb
informació dels principals serveis de la universitat que et poden ajudar
durant la teva estada, un taller lingüístic introductori de llengua i
cultura catalana, així com una visita a un museu de Barcelona i una
activitat esportiva.

Hi ha diverses edicions de la OW abans de l\'inici de classes. Si vols
assistir a alguna de les seves edicions hauràs de registrar-te. Consulta
tota la informació al web del [Gabinet de Relacions Internacionals de la
UPC](https://www.upc.edu/sri/es/estudiantado/movilidad-estudiantes/incomings/prepara-tu-viaje/orientation-week/orientation-week).

El **Buddy programme Salsa\'m** té com a objectiu rebre els estudiants
d\'intercanvi i ajudar-los a adaptar-se a la vida universitària a
Barcelona. Cada participant és assignat a un estudiant local que
proporciona suport acadèmic, cultural i lingüístic. També hi ha
activitats de grup com visites guiades, sortides culturals i sopars
internacionals.
...
[formulari](http://www.upc.edu/slt/ca/formulari/international-students)

Pots veure que es fa en aquest programa a
[Facebook](https://www.facebook.com/salsam.upc/?fref=ts)

Per a qualsevol consulta que tinguis sobre el *Buddy programme* Salsa\'m
pots enviar un correu electrònic a []{#ZtnGDRTEK rel="nofollow"}
:::
