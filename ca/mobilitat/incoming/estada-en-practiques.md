---
description: \[icon class=\"fa fa-building\"\]\[/icon\] S'adreça a
  estudiants que volen fer una estada de recerca en algun dels
  departaments, laboratoris, instituts o grups de recerca de la UPC.
  \[icon class=\"fa fa-warning\"\]\[/icon\] L'estada en pràctiques no és
  compatible amb una estada acadèmica en la qual s'estigui matriculat
  d'assignatures a la UPC. \[icon class=\"fa fa-calendar\"\]\[/icon\] El
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Estada en pràctiques \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[icon class=\"fa fa-building\"\]\[/icon\] S'adreça
  a estudiants que volen fer una estada de recerca en algun dels
  departaments, laboratoris, instituts o grups de recerca de la UPC.
  \[icon class=\"fa
twitter:title: Estada en pràctiques
twitter:url: "https://www.fib.upc.edu/ca/mobilitat/incoming/estada-en-practiques"
...
::: content
-   [Català](/ca/mobilitat/incoming/estada-en-practiques "Estada en pràctiques"){.language-link
    .active lang="ca"}
-   [English](/en/mobility/incoming/research-visit "Research Visit"){.language-link
    lang="en"}
-   [Español](/es/movilidad/incoming/estancia-en-practicas "Estancia en prácticas"){.language-link
    lang="es"}
:::
:::::
...
-   [Mobilitat](/ca/mobilitat)
    -   [Incoming](/ca/mobilitat/incoming)
        -   [Estada acadèmica](/ca/mobilitat/incoming/estada-academica)
        -   [Estada en
            pràctiques](/ca/mobilitat/incoming/estada-en-practiques){.active}
...
:::: content
::: page_title_no_sub
# Estada en pràctiques {#estada-en-pràctiques .page_title}
:::
::::
::::::
:::::::
...
[Incoming](/ca/mobilitat/incoming) » Estada en pràctiques
:::
::::
::::::
:::::::
...
-   [Estada acadèmica](/ca/mobilitat/incoming/estada-academica)
-   [Estada en
    pràctiques](/ca/mobilitat/incoming/estada-en-practiques){.active-trail
    .active}
:::
::::
::::::
...
:::::::::::: content
::::::::::: {#node-19948 .node .node-page .clearfix}
:::::::::: content
::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::: field-items
::::::: {.field-item .even}
S'adreça a estudiants que volen fer una estada de recerca en algun dels
departaments, laboratoris, instituts o grups de recerca de la UPC.

L'estada en pràctiques no és compatible amb una estada acadèmica en la
qual s'estigui matriculat d'assignatures a la UPC.

El període de pràctiques no pot incloure el mes d'agost, atès que la UPC
tanca.

No cal que la FIB tingui un conveni bilateral amb la universitat de la
qual prové l'estudiant que vol fer les pràctiques.

Aquestes pràctiques no són remunerades.

**En cap cas l'estudiant podrà iniciar l'estada sense que la unitat que
l'acull disposi de tota la documentació requerida.**

 

Per gaudir d\'una estada en pràctiques, l\'estudiant ha de seguir els
passos següents:

::: {.alert .alert-info}
### 1. Obtenir una carta d\'invitació

Contactar amb un professor d'algun dels [departaments, laboratoris o
grups de recerca](/ca/recerca) de la FIB per obtenir una carta
d'invitació.
:::
...
Emplenar un *traineeship agreement* (Erasmus+ o el que correspongui),
que s'ha de negociar amb el professor que l'acollirà. Requereix la
signatura de l'estudiant i de la institució d'origen (3 exemplars
originals).
:::
...
Aportar una assegurança d\'accidents, de repatriació i de
responsabilitat civil. La UPC té conveni amb [On
Campus](https://oncampus.es/seguros/oncampus-estudia/), de manera que
els estudiants que vinguin a fer una estada de recerca, si no disposen
de cap assegurança podrien contractar aquesta.
:::
