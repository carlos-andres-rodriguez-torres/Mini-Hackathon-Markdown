---
description: "La doble titulació et permet l'obtenció de dos títols
  universitaris: el de la FIB i el de la universitat amb la qual tinguem
  l\\'acord de doble titulació. La majoria dels acords de doble titulació
  suposen un any d'estudis a l'estranger com a mínim. Cada acord de
  doble titulació fixa els requisits que hauràs de complir per poder
  optar a una d'aquestes places. Quins beneficis"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Dobles titulacions \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: "La doble titulació et permet l'obtenció de dos
  títols universitaris: el de la FIB i el de la universitat amb la qual
  tinguem l\\'acord de doble titulació. La majoria dels acords de doble
  titulació"
twitter:title: Dobles titulacions
twitter:url: "https://www.fib.upc.edu/ca/mobilitat/dobles-titulacions"
...
::: content
-   [Català](/ca/mobilitat/dobles-titulacions "Dobles titulacions"){.language-link
    .active lang="ca"}
-   [English](/en/mobility/double-degrees "Double degrees"){.language-link
    lang="en"}
-   [Español](/es/movilidad/dobles-titulaciones "Dobles Titulaciones"){.language-link
    lang="es"}
:::
:::::
...
-   [Mobilitat](/ca/mobilitat)
    ...
    -   [Outgoing](/ca/mobilitat/outgoing)
        ...
        -   [Estades
            empreses-pràctiques](/ca/mobilitat/outgoing/estades-empreses-practiques)
        -   [Altres estades](/ca/mobilitat/outgoing/altres-estades)
    -   [Dobles titulacions](/ca/mobilitat/dobles-titulacions){.active}
...
:::: content
::: page_title_no_sub
# Dobles titulacions {#dobles-titulacions .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Mobilitat](/ca/mobilitat) » Dobles titulacions
:::
::::
::::::
:::::::
...
-   [Incoming](/ca/mobilitat/incoming)
-   [Outgoing](/ca/mobilitat/outgoing)
-   [Dobles titulacions](/ca/mobilitat/dobles-titulacions){.active-trail
    .active}
-   [Aliances Internacionals](/ca/mobilitat/aliances-internacionals)
:::
::::
...
:::::::: content
::::::: {#node-16538 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
La **doble titulació** et permet l'obtenció de dos títols universitaris:
el de la FIB i el de la universitat amb la qual tinguem l\'acord de
doble titulació. La majoria dels acords de doble titulació suposen un
any d'estudis a l'estranger com a mínim.

Cada acord de doble titulació fixa els requisits que hauràs de complir
per poder optar a una d'aquestes places.

Quins **beneficis** obtenen els estudiants que aconsegueixen una doble
titulació?

-   La formació que reben els permet o bé assolir una nova especialitat
    o bé aprofundir en la que ja tenen.
-   Incrementen notablement el coneixement de l\'altre país: llengua,
    cultura, etc., atès que és una mobilitat llarga (com a mínim un
    any).
-   Des del punt de vista laboral, estan acreditats professionalment en
    dos països diferents el que amplia les seves possibilitats de
    contractació laboral.
-   Es produeix un creixement personal important: increment de la
    capacitat d\'adaptació, ment més oberta, etc.
...
:::::::: {#block-views-doble-titulacio-block-4 .block .block-views}
::: inner
:::

## Màster en Enginyeria Informàtica {#màster-en-enginyeria-informàtica .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_4 .view-dom-id-af3c9d8c98045d8b28771d1f57ac1b6e}
:::: view-content
::: item-list
...
:::::::: {#block-views-doble-titulacio-block-6 .block .block-views}
::: inner
:::

## Màster en Innovació i Recerca en Informàtica {#màster-en-innovació-i-recerca-en-informàtica .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_6 .view-dom-id-fe31a863ab9b1b80fe934915e791c14f}
:::: view-content
::: item-list
...
:::::::: {#block-views-doble-titulacio-block-5 .block .block-views}
::: inner
:::

## Màster en Intel·ligència Artificial {#màster-en-intelligència-artificial .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_5 .view-dom-id-2fee59906354aeec528cce7970bf846f}
:::: view-content
::: item-list
-   #### [Escuela de Posgrado de la Pontificia Universidad Católica de Perú (PUCP)](/ca/mobilitat/dobles-titulacions/escuela-de-posgrado-de-la-pontificia-universidad-catolica-de-peru-pucp)
...
:::::::: {#block-views-doble-titulacio-block-7 .block .block-views}
::: inner
:::

## Màster en Ciència de Dades {#màster-en-ciència-de-dades .block-title .no-subtitle}

:::::: content
::::: {.view .view-doble-titulacio .view-id-doble_titulacio .view-display-id-block_7 .view-dom-id-a2e38437654bad1abbd12ff6230965e9}
:::: view-content
::: item-list
