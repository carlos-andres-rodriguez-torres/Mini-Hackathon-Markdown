---
description: La UPC impulsa un procés participatiu entre l'estudiantat
  perquè pugui proposar, i votar, projectes de millora en les
  infraestructures dels campus per un valor total de 103.000 euros.
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: L'estudiantat de la UPC pot proposar i votar projectes de millora
  en els campus \| Facultat d\'Informàtica de Barcelona
twitter:card: summary_large_image
twitter:description: La UPC impulsa un procés participatiu entre
  l'estudiantat perquè pugui proposar, i votar, projectes de millora en
  les infraestructures dels campus per un valor total de 103.000 euros.
twitter:image: "https://www.fib.upc.edu/sites/fib/files/styles/large/public/pressupostos_participatius_estudiantat_upc.png?itok=IXcvAMEh"
twitter:title: L'estudiantat de la UPC pot proposar i votar projectes de
  millora en
twitter:url: "https://www.fib.upc.edu/ca/noticies/lestudiantat-de-la-upc-pot-proposar-i-votar-projectes-de-millora-en-els-campus"
...
::: content
-   [Català](/ca/noticies/lestudiantat-de-la-upc-pot-proposar-i-votar-projectes-de-millora-en-els-campus "L’estudiantat de la UPC pot proposar i votar projectes de millora en els campus"){.language-link
    .active lang="ca"}
-   [English]{.language-link .locale-untranslated lang="en"}
-   [Español](/es/noticias/el-estudiantado-de-la-upc-puede-proponer-y-votar-proyectos-de-mejora-en-los-campus "El estudiantado de la UPC puede proponer y votar proyectos de mejora en los campus"){.language-link
    lang="es"}
:::
:::::
...
:::: content
::: page_title_no_sub
# L'estudiantat de la UPC pot proposar i votar projectes de millora en els campus {#lestudiantat-de-la-upc-pot-proposar-i-votar-projectes-de-millora-en-els-campus .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Notícies](/ca/noticies) » L'estudiantat de la UPC pot
proposar i votar projectes de millora en els campus
:::
::::
::::::
:::::::
...
:::::::::::: content
::::::::::: {#node-24405 .blog_wrap .node .node-noticia .clearfix}
...
:::: field-items
::: {.field-item .even}
![](https://www.fib.upc.edu/sites/fib/files/styles/large/public/pressupostos_participatius_estudiantat_upc.png?itok=IXcvAMEh){width="480"
height="270"}
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
En el projecte de Pressupostos Participatius aprovat pel Consell de
Govern de la **Universitat Politècnica de Catalunya - BarcelonaTech
(UPC)** hi pot participar l'estudiantat de grau, màster i doctorat de la
UPC i poden formular propostes bé del seu centre docent, bé dels espais
comuns en el cas dels Campus multiescola (Campus Diagonal Nord i Campus
del Baix Llobregat).

**Cada estudiant pot presentar com a màxim dues propostes i, al seu
torn, pot votar dues propostes**. Els projectes es poden presentar a
través de la plataforma [Decidim
UPC](http://decidim.upc.edu/ "http://decidim.upc.edu/").

La iniciativa tindrà diferents fases. La primera, **del 25 de febrer al
31 de març**, consisteix en la **presentació del projecte i la recollida
de propostes**. Un cop oberta la plataforma
[decidim.upc.edu](https://decidim.upc.edu/processes/pressupostos-participatius-2025 "https://decidim.upc.edu/processes/pressupostos-participatius-2025"),
l'estudiantat podrà introduir les propostes. A partir **de l'1 d\'abril
i fins al 15 de juny** **s'avaluarà la viabilitat tècnica i econòmica de
les propostes** pujades a la plataforma i el seu encaix en els projectes
existents.

Finalment, en una última fase, cap al mes d\'octubre, s'obrirà la
plataforma perquè tot l'estudiantat pugui votar les propostes. El
calendari d'execució de les actuacions serà al llarg del 2025.
:::
::::
:::::
::::::
...
::::: {.view .view-noticies .view-id-noticies .view-display-id-recents .popular-post .view-dom-id-d4cdf72960827e3fb7a8269d7ace2bcd}
:::: view-content
::: item-list
-   :::: {.views-field .views-field-field-imatge}
    ...
    height="100"}](/ca/noticies/lestudiantat-de-la-upc-pot-proposar-i-votar-projectes-de-millora-en-els-campus){.active}
    :::
    ::::
    ...
    en els
    campus](/ca/noticies/lestudiantat-de-la-upc-pot-proposar-i-votar-projectes-de-millora-en-els-campus){.active}]{.field-content}
    :::
...
::::: {.view .view-noticies .view-id-noticies .view-display-id-populars .popular-post .view-dom-id-69d47c504bd8496ba3f1792ce56bdeae}
:::: view-content
::: item-list
-   :::: {.views-field .views-field-field-imatge}
    ::: field-content
