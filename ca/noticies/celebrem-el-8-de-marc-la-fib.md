---
description: "La FIB i el Barcelona-ACM-W chapter organitzen la sessió:
  \"Mayday! Mayday! La informàtica necessita dones\""
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Celebrem el 8 de març a la FIB \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary_large_image
twitter:description: "La FIB i el Barcelona-ACM-W chapter organitzen la
  sessió: \"Mayday! Mayday! La informàtica necessita dones\""
twitter:image: "https://www.fib.upc.edu/sites/fib/files/styles/large/public/noticia_conferencia_nuria_castell_8m_2025_470_x_270_px.png?itok=4t3idicK"
twitter:title: Celebrem el 8 de març a la FIB
twitter:url: "https://www.fib.upc.edu/ca/noticies/celebrem-el-8-de-marc-la-fib"
...
::: content
-   [Català](/ca/noticies/celebrem-el-8-de-marc-la-fib "Celebrem el 8 de març a la FIB"){.language-link
    .active lang="ca"}
-   [English](/en/news/lets-celebrate-march-8th-fib "Let’s celebrate March 8th at FIB"){.language-link
    lang="en"}
-   [Español](/es/noticias/celebramos-el-8-de-marzo-en-la-fib "Celebramos el 8 de marzo en la FIB"){.language-link
    lang="es"}
:::
:::::
...
:::: content
::: page_title_no_sub
# Celebrem el 8 de març a la FIB {#celebrem-el-8-de-març-a-la-fib .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Notícies](/ca/noticies) » Celebrem el 8 de març a la FIB
:::
::::
::::::
:::::::
...
:::: field-items
::: {.field-item .even}
![](https://www.fib.upc.edu/sites/fib/files/styles/large/public/noticia_conferencia_nuria_castell_8m_2025_470_x_270_px.png?itok=4t3idicK){width="470"
height="270"}
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
Amb motiu del Dia Internacional de les Dones, la [Facultat
d\'Informàtica de Barcelona (FIB)](/ca) i el [Barcelona-ACM-W
Chapter](https://women.acm.org/chapters/) han organitzat un acte
especial el proper dimarts 5 de març. Aquest esdeveniment té com a
objectiu posar en relleu el paper fonamental de les dones en el camp de
la informàtica i fomentar la reflexió sobre els reptes encara presents
en la lluita per la igualtat de gènere en aquest àmbit.

La jornada s'iniciarà amb la benvinguda de la Vicedegana de la FIB,
Gemma Sesé, i seguirà amb una xerrada central titulada **\"Women in
Computing: hidden & silenced\"**, a càrrec de Núria Castell Ariño.
Aquesta ponència servirà com a punt de partida per a un debat enriquidor
sobre el paper de la dona en aquest sector.

A més, es donarà especial rellevància a la presentació de **l\'**ACM-W
Europe, una iniciativa que promou la participació i la visibilitat de
les dones en l'àmbit de la computació, i a womENcourage@, un
esdeveniment que fomenta la creació de xarxes i la participació de dones
en la comunitat científica i tecnològica.

A continuació, el programa de l'acte:

-   **12:15 h** -- Benvinguda a càrrec de **Gemma Sesé**, Vicedegana de
    la FIB.

-   **12:25 h** -- Xerrada **\"Women in Computing: hidden &
    silenced\"**, per **Núria Castell Ariño, **exdegana de la FIB i
    chair del Barcelona-ACM-W chapter.

-   **12:45 h** -- Debat sobre les dones a la història de la informàtica
    i la situació actual.

-   **12:55 h** -- **Presentació de l\'ACM-W Europe**, destacant la seva
    tasca en la promoció de la participació de les dones en computació.

-   **13:15 h** -- **Presentació de womENcourage@**, amb èmfasi en les
    oportunitats de participació en l\'edició 2025.

-   **13:30 h** -- Torn obert per preguntes i reflexions.

Aquest esdeveniment està obert a tothom i representa una oportunitat
única per a totes les persones interessades en promoure una informàtica
més equitativa i diversa.

L\'acte tindrà lloc el **dimecres 5 de març a les 12.15 h**, a la **Sala
d\'Actes Manuel Martí Recober** de la FIB.

No et perdis aquesta oportunitat per reflexionar i contribuir al debat
sobre el paper de la dona en la tecnologia i la computació.
...
::::: {.view .view-noticies .view-id-noticies .view-display-id-recents .popular-post .view-dom-id-abc58f616b1e5b84172b1484c5501ad4}
:::: view-content
::: item-list
...
-   :::: {.views-field .views-field-field-imatge}
    ...
    height="100"}](/ca/noticies/unite-programa-de-professorat-visitant-2025)
    :::
    ::::

    ::: {.views-field .views-field-title}
    [ [Unite! Programa de Professorat Visitant
    2025](/ca/noticies/unite-programa-de-professorat-visitant-2025)]{.field-content}
    :::
...
-   :::: {.views-field .views-field-field-imatge}
    ...
    height="100"}](/ca/noticies/celebrem-el-8-de-marc-la-fib){.active}
    :::
    ::::

    ::: {.views-field .views-field-title}
    [[Celebrem el 8 de març a la
    FIB](/ca/noticies/celebrem-el-8-de-marc-la-fib){.active}]{.field-content}
    :::
...
::::: {.view .view-noticies .view-id-noticies .view-display-id-populars .popular-post .view-dom-id-69fee268724b2b0d7dbf1ef232bc8fe9}
:::: view-content
::: item-list
-   :::: {.views-field .views-field-field-imatge}
    ::: field-content
