---
description: \[title class=\"bigtitle not-translate\"
  type=\"h2\"\]Atenció\[/title\] Si has de contactar amb nosaltres,
  primer, fes-ho telemàticament. Et deixem les nostres dades de
  contacte. Grau, Màster i Mobilitat Necessites fer una gestió
  relacionada amb Graus, Màsters o Mobilitat? Grau i Màster Mobilitat
  Suport Institucional i Relacions Externes Necessites fer algun conveni
  de cooperació
...
theme-color: "#ffffff"
title: Cita prèvia \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[title class=\"bigtitle not-translate\"
  type=\"h2\"\]Atenció\[/title\] Si has de contactar amb nosaltres,
  primer, fes-ho telemàticament. Et deixem les nostres dades de
  contacte. Grau, Màster i Mobilitat
twitter:title: Cita prèvia
twitter:url: "https://www.fib.upc.edu/ca/cita-previa"
...
::: content
-   [Català](/ca/cita-previa "Cita prèvia"){.language-link .active
    lang="ca"}
-   [English](/en/appointments "Appointments"){.language-link lang="en"}
-   [Español](/es/cita-previa "Cita previa"){.language-link lang="es"}
:::
:::::
...
:::: content
::: page_title_no_sub
# Cita prèvia {#cita-prèvia .page_title}
:::
::::
::::::
:::::::
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::: content
::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {#node-20551 .node .node-page .clearfix}
:::::::::::::::::::::::::::::::::::::::::::::::::::::::: content
...
::: block-subtitle
Si has de contactar amb nosaltres, primer, fes-ho telemàticament. Et
deixem [les nostres dades de contacte](/ca/contact).
:::
::::
:::::::
...
:::: card
[![Card image
cap](/sites/fib/files/images/grau-master-mob-ca2.png){.card-img-top}](#GrauMaster)
...
[Grau i Màster](#GrauMaster){.btn .btn-primary}
[Mobilitat](#Mobilitat){.btn .btn-primary}
:::
::::
:::::
...
:::: card
[![Card image
cap](/sites/fib/files/images/suport-relacions_-_ca.jpg){.card-img-top}](#SuportRelacions)

::: card-body
##### Suport Institucional i Relacions Externes

Necessites fer algun conveni de cooperació educativa o organitzar un
acte a la FIB?

[Ves-hi!](#SuportRelacions){.btn .btn-primary}
:::
::::
:::::
...
:::: card
[![Card image
cap](/sites/fib/files/images/consultesacademiques_-_ca.jpg){.card-img-top}](#ConsultesAcademiques)

::: card-body
##### Consultes acadèmiques

Has de parlar amb un/a vicedegà/vicedegana o el/la cap d\'estudis de la
FIB?

[Ves-hi!](#ConsultesAcademiques){.btn .btn-primary}
:::
::::
:::::
...
### []{#GrauMaster}Gestió dels Estudis de Grau i Màster

L\'atenció al públic és, per defecte, telemàtica. Si cal que
l\'assistència sigui presencial, **és imprescindible demanar cita prèvia
i justificar-ho**.
...
Per demanar cita cal entrar amb el compte de Google de la UPC
([]{#gnhBWqdcb rel="nofollow"}

per a l\'estudiantat o []{#PjwgCKkan rel="nofollow"}

per al PAS i PDI), o amb un compte personal si no ets estudiant o
personal de la Universitat. En cas de no tenir compte Google, envia un
mail a []{#LJgVskAvS rel="nofollow"}
...
:::: card
![Card image
cap](/sites/fib/files/images/cita-previa-g-br.png){.card-img-top}

::: card-body
##### Secretaria acadèmica i graus

-   On: Taulell secretaria acadèmica (planta baixa, edifici B6)
...
-   Atenció per correu electrònic: []{#gcETRJMOB rel="nofollow"}

**Les cites que no especifiquin en la descripció el motiu de la cita
seran anul·lades.**

[Reserva la teva
cita](https://calendar.app.google/QYLvFqVzw6JR4b259){.btn .btn-primary}
:::
::::
:::::
...
::::: card
![Card image
cap](/sites/fib/files/images/cita-previa-m-br.png){.card-img-top}

:::: card-body
##### Màsters

::: {.alert .alert-danger}
** Per recollir el títol, la cita prèvia s\'ha de demanar en l\'apartat
de \"[Secretaria i
Graus](https://calendar.app.google/QYLvFqVzw6JR4b259)\"**
:::
...
-   Atenció per correu electrònic: []{#paLgAvMBF rel="nofollow"}

**Les cites que no especifiquin en la descripció el motiu de la cita
seran anul·lades.**

[Reserva la teva
cita](https://calendar.app.google/8bmAwNq7cD5a4s8h8){.btn .btn-primary}
::::
:::::
::::::
::::::::::

**Per evitar saturar el Servei, preguem que només es demani cita prèvia
en cas que sigui imprescindible l\'atenció presencial i que es respecti
l\'horari seleccionat.**

 

### []{#Mobilitat}Gestió dels estudiants de mobilitat
...
Per demanar cita cal entrar amb el compte de Google de la UPC
([]{#aRGPJNpZn rel="nofollow"}

per a l\'estudiantat o []{#mcezjRYTy rel="nofollow"}

per al PAS i PDI), o amb un compte personal si no ets estudiant o
personal de la Universitat. En cas de no tenir compte Google, envia un
e-mail a []{#qJWmTsjXO rel="nofollow"}
...
:::: card
![Card image
cap](/sites/fib/files/images/mobilitat/cita-previa-mob-ca.png){.card-img-top}
...
-   Quan (en intervals de 10 minuts):
    ...
    -   dimarts, dimecres i divendres de 10 a 13 h

    -   dimecres, de 15.30 a 17 h 

-   Atenció per correu electrònic: []{#CfZcIvSGs rel="nofollow"}

**Les cites que no especifiquin en la descripció el motiu de la cita
seran anul·lades.**

[Reserva la teva
cita](https://calendar.app.google/6zREGuPPzZFSgYct8){.btn .btn-primary}
:::
::::
:::::
...
### []{#SuportRelacions}Suport Institucional i Relacions Externes

Les consultes d\'informació les atendrem per correu electrònic. En cas
de gestions que requereixin presencialitat, **és imprescindible demanar
cita prèvia i justificar-ho**. Si no s\'especifica el motiu de la cita,
s\'anul·larà.
...
Per demanar cita cal entrar amb el compte de Google de la UPC
([]{#wQBZjMhGc rel="nofollow"}

per a l\'estudiantat o []{#yQinJPhLM rel="nofollow"}

per al PAS i PDI), o amb un compte personal si no ets estudiant o
personal de la Universitat. 

En cas de no tenir compte Google, envia un mail a []{#khbpTdnFm
rel="nofollow"}
...
:::: card
![Card image
cap](/sites/fib/files/images/cita-previa-practiques-en-empresa-br.png){.card-img-top}
...
-   Atenció per correu electrònic: []{#xMgLaypjw rel="nofollow"}
    .

**Les cites que no especifiquin en la descripció el motiu de la cita
podran ser anul·lades.**

[Reserva la teva
cita](https://calendar.app.google/sHZM1UV5svYY4w3z8){.btn .btn-primary}
...
:::: card
![Card image
cap](/sites/fib/files/images/cita-previa-institucionals-br.png){.card-img-top}
...
-   Atenció i cita prèvia per correu electrònic: []{#XkELeqacY
    rel="nofollow"}
:::
::::
:::::
...
Per demanar cita cal entrar amb el compte de Google de la UPC
([]{#fsBoUbryd rel="nofollow"}

per a l\'estudiantat o []{#geDJyiAVk rel="nofollow"}

per al PAS i PDI), o amb un compte personal si no ets estudiant o
personal de la Universitat. En cas de no tenir compte Google, envia un
mail a []{#yiopTAaZu rel="nofollow"}
...
:::: card
![Card image
cap](/sites/fib/files/images/cita-previa-capestudis-ca-br.png){.card-img-top}
...
-   Atenció per correu electrònic: []{#mQZJCvKNz rel="nofollow"}

**Les cites que no especifiquin en la descripció el motiu de la cita
podran ser anul·lades.**

[Reserva la teva
cita](https://calendar.app.google/Rw9vAGLXSjrrSeKRA){.btn .btn-primary}
:::
::::
:::::
...
:::: card
![Card image
cap](/sites/fib/files/images/capestudisfi-ca.png){.card-img-top}
...
-   On: en línia via GMeet o presencial (edifici B6, 2a planta)
-   Quan:
    -   dimarts de 16 a 18 h (GMeet o presencial, en intervals de 15
        minuts)
    -   dijous de 12 a 14 h (GMeet o presencial, en intervals de 15
        minuts)
-   Atenció per correu electrònic: []{#uiUsHzdTI rel="nofollow"}

Demana la teva cita enviant un correu a []{#mjeyVsYwP rel="nofollow"}
...
:::: card
![Card image
cap](/sites/fib/files/images/cita-previa-postgrau-ca.png){.card-img-top}

::: card-body
##### Postgrau (vicedeganat)

-   On: en línia via GMeet o presencial (edifici B6, 2a planta) o per
    email
-   Quan:
    -   dilluns de 12 a 13:30 h (en intervals de 20 minuts)
-   Atenció per correu electrònic: []{#lGmhTEbte rel="nofollow"}

**Les cites que no especifiquin en la descripció el motiu de la cita
podran ser anul·lades.**

[Reserva la teva
cita](https://calendar.app.google/tePtggLjXVA6kSu78){.btn .btn-primary}
:::
::::
:::::
...
:::: card
![Card image
cap](/sites/fib/files/images/fib/cita-previa-internacionals-ca.png){.card-img-top}
...
-   Atenció per correu electrònic: []{#VZtazpDbh rel="nofollow"}

**Les cites que no especifiquin en la descripció el motiu de la cita
podran ser anul·lades.**

[Reserva la teva
cita](https://calendar.google.com/calendar/u/0/selfsched?sstoken=UU10ejMtRXlGb205fGRlZmF1bHR8M2NkZmIwZTM1ZTg1YzAwMWYwMTg0ZTQ0MTM0YzRjNjc){.btn
.btn-primary}
:::
::::
:::::
