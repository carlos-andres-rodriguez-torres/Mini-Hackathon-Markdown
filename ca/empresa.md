---
description: "Creem coneixement per ajudar la societat a avançar amb
  iniciatives innovadores i hem contribuït de forma significativa al
  desenvolupament de les Tecnologies de la Informació del nostre país.
  La col·laboració entre les organitzacions, les institucions i les
  empreses, i la FIB, permet apropar interessos i compartir projectes,
  amb el valor afegit de: Garantir que els estudiants"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Empresa \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Creem coneixement per ajudar la societat a avançar
  amb iniciatives innovadores i hem contribuït de forma significativa al
  desenvolupament de les Tecnologies de la Informació del nostre país.
  La
twitter:title: Empresa
twitter:url: "https://www.fib.upc.edu/ca/empresa"
...
::: content
-   [Català](/ca/empresa "Empresa"){.language-link .active lang="ca"}
-   [English](/en/companies "Companies"){.language-link lang="en"}
-   [Español](/es/empresa "Empresa"){.language-link lang="es"}
:::
:::::
...
:::::: {#block-block-13 .block .block-block .dexp-animate animate="fadeInUp" style="padding:6em  0 8em 0;background-image:url(https://www.fib.upc.edu/sites/fib/files/banner-empresa.jpg);background-position:top left"}
::: inner
:::

:::: {.content .container}
::: {.title .text-right .spec-title}
## Conèixer les necessitats de les empreses permet preparar més eficientment els professionals en les competències que la societat necessita
...
:::::::: content
::::::: {#node-7 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
Creem coneixement per ajudar la societat a avançar amb iniciatives
innovadores i hem contribuït de forma significativa al desenvolupament
de les Tecnologies de la Informació del nostre país.

La col·laboració entre les organitzacions, les institucions i les
empreses, i la FIB, permet apropar interessos i compartir projectes, amb
el valor afegit de: 

-   Garantir que els estudiants de la FIB tinguin un vincle directe amb
    les empreses del sector de les Tecnologies de la Informació que
    confien en nosaltres.
-   Formar estudiants per a l\'adquisició de les competències
    professionals que necessiten les organitzacions.
-   Construir conjuntament projectes de recerca i innovació en les
    nostres àrees d\'expertesa.
-   Possibilitar l\'accés a xarxes nacionals i europees.
-   Construir una imatge social de prestigi a través de l\'aliança
    universitat-empresa.
...
::::::::::::::::::::::: {#block-block-14 .block .block-block .title}
::: inner
:::
...
### Integració en el món laboral {#integració-en-el-món-laboral .box-title}

::: box-content
-   [Pràctiques Acadèmiques
    Externes](/ca/empresa/practiques-en-empresa): l\'objectiu és
    completar la formació rebuda a la Universitat amb l\'experiència
    professional dins de l\'àmbit empresarial.
-   [FIB Visiona](/ca/empresa/fib-visiona){target="_blank"}: fira
    d\'empreses organitzat per l\'estudiantat de la FIB que serveix de
    nexe, i punt de trobada, entre les empreses i els seus futurs
    professionals.
-   [Borsa de treball.](/ca/empresa/borsa-de-treball)
-   [Programa inLab
    Talent.](http://inlab.fib.upc.edu/programa-de-formacio-talent){target="_blank"}
:::
:::::
::::::
...
### Accions formatives {#accions-formatives .box-title}

::: box-content
-   Seminaris d\'empresa: conjunt de seminaris de curta durada impartits
    per professionals d\'empreses de primer nivell en el sector de la
    informàtica, les telecomunicacions i els serveis.
:::
:::::
::::::
:::::::::::
...
### Networking {#networking .box-title}

::: box-content
-   Participació en associacions que promouen projectes i relacions
    entre empreses com el Cluster per a la Innovació.
-   Participació anual a
    la [Festibity](http://www.festibity.com/){target="_blank"}, gran
    festa de les Tecnologies de la Informació, organitzada per [FIB
    Alumni.](http://www.fibalumni.net/){target="_blank"}
:::
:::::
::::::
...
### Patrocinis i acords de mecenatge {#patrocinis-i-acords-de-mecenatge .box-title}
...
::::::::::::::: {#block-block-16 .block .block-block style="text-align:center;padding:2em 0 2em 0"}
::: inner
:::
...
[![](/sites/fib/files/images/empresa/fibalumni-logo-peque.jpg)](https://www.fibalumni.net/)
:::
...
::::: row
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
[![](/sites/fib/files/images/empresa/logo-vector-seidor.jpg)](https://www.seidor.es/content/seidorweb/es.html)
:::
