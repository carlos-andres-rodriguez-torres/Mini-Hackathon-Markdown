...
theme-color: "#ffffff"
title: BSC-CNS - Barcelona SuperComputing Center \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:title: BSC-CNS - Barcelona SuperComputing Center
twitter:url: "https://www.fib.upc.edu/ca/recerca/centres-de-recerca/bsc-cns-barcelona-supercomputing-center"
...
::: content
-   [Català](/ca/recerca/centres-de-recerca/bsc-cns-barcelona-supercomputing-center "BSC-CNS - Barcelona SuperComputing Center"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-centers/bsc-cns-barcelona-supercomputing-center "BSC-CNS - Barcelona Supercomputing Center"){.language-link
    lang="en"}
-   [Español](/es/investigacion/centros-de-investigacion/bsc-cns-barcelona-supercomputing-center "BSC-CNS - Barcelona Supercomputing Center"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Centres de Recerca](/ca/recerca/centres-de-recerca)
        -   [BSC-CNS - Barcelona SuperComputing
            Center](/ca/recerca/centres-de-recerca/bsc-cns-barcelona-supercomputing-center){.active}
...
:::: content
::: page_title_no_sub
# BSC-CNS - Barcelona SuperComputing Center {#bsc-cns---barcelona-supercomputing-center .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/centres-de-recerca) » BSC-CNS - Barcelona
...
-   [BSC-CNS - Barcelona SuperComputing
    Center](/ca/recerca/centres-de-recerca/bsc-cns-barcelona-supercomputing-center){.active-trail
    .active}
-   [CCABA -- Centre de Comunicacions Avançades de Banda
    Ampla](/ca/recerca/centres-de-recerca/ccaba-centre-de-comunicacions-avancades-de-banda-ampla)
-   [CEBIM - Centre de Biotecnologia
...
:::::::::::: content
::::::::::: {#node-16346 .node .node-entitat-recerca .clearfix}
:::::::::: content
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
Des de la seva creació el 2005, el BSC ha desenvolupat un paper actiu en
la promoció de HPC a Espanya i Europa com una eina essencial per a la
competitivitat internacional en ciència i enginyeria. El centre gestiona
la Xarxa Espanyola de Supercomputació (RES), i és membre d\'allotjament
de l\'Associació per a la Computació Avançada a Europa iniciativa
(PRACE). Participa activament en les principals iniciatives de HPC
europeus, en estreta cooperació amb altres centres de supercomputació
europeus.
:::
:::::

Amb una plantilla de més de 400 experts i professionals de R + D, BSC ha
tingut èxit en l\'atracció de talent, i la seva investigació es centra
en quatre camps: Ciències de la Computació, Ciències Biològiques,
Ciències de la Terra i aplicacions informàtiques en Ciència i
Enginyeria.

La majoria de les línies d\'investigació del BSC es desenvolupen en el
marc dels programes de finançament de la recerca de la Unió Europea, i
el centre també realitza investigació bàsica i aplicada en col·laboració
amb empreses líders com IBM, Microsoft, Intel, Nvidia, Repsol i
Iberdrola. La qualitat de la seva investigació ha estat reconegut pel
govern espanyol amb la subvenció d\'Excel·lència Severo Ochoa Centre de
la ciència d\'avantguarda espanyola.
::::::
:::::::
::::::::

::: field
[ Web ]{.field-label} [ [www.bsc.es](http://www.bsc.es/) ]{.field-items}
:::
::::::::::
:::::::::::
::::::::::::
