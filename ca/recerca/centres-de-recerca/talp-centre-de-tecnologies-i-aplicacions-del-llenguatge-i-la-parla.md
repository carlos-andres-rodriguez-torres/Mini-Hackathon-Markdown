...
theme-color: "#ffffff"
title: TALP - Centre de Tecnologies i Aplicacions del Llenguatge i la
  Parla \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:title: TALP - Centre de Tecnologies i Aplicacions del Llenguatge
  i la Parla
twitter:url: "https://www.fib.upc.edu/ca/recerca/centres-de-recerca/talp-centre-de-tecnologies-i-aplicacions-del-llenguatge-i-la-parla"
...
::: content
-   [Català](/ca/recerca/centres-de-recerca/talp-centre-de-tecnologies-i-aplicacions-del-llenguatge-i-la-parla "TALP - Centre de Tecnologies i Aplicacions del Llenguatge i la Parla"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-centers/talp-center-language-and-speech-technologies-and-applications "TALP - Center for Language and Speech Technologies and Applications"){.language-link
    lang="en"}
-   [Español](/es/investigacion/centros-de-investigacion/talp-centro-de-tecnologias-y-aplicaciones-del-lenguaje-y-el-habla "TALP - Centro de Tecnologias y Aplicaciones del Lenguaje y el Habla"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Centres de Recerca](/ca/recerca/centres-de-recerca)
        ...
        -   [TALP - Centre de Tecnologies i Aplicacions del Llenguatge i
            la
            Parla](/ca/recerca/centres-de-recerca/talp-centre-de-tecnologies-i-aplicacions-del-llenguatge-i-la-parla){.active}
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
...
:::: content
::: page_title_no_sub
# TALP - Centre de Tecnologies i Aplicacions del Llenguatge i la Parla {#talp---centre-de-tecnologies-i-aplicacions-del-llenguatge-i-la-parla .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/centres-de-recerca) » TALP - Centre de Tecnologies
...
-   [TALP - Centre de Tecnologies i Aplicacions del Llenguatge i la
    Parla](/ca/recerca/centres-de-recerca/talp-centre-de-tecnologies-i-aplicacions-del-llenguatge-i-la-parla){.active-trail
    .active}
:::
::::
::::::
...
:::::::::::: content
::::::::::: {#node-16341 .node .node-entitat-recerca .clearfix}
:::::::::: content
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
El Centre per a la parla i llenguatge de Tecnologies i Aplicacions
(TALP) és un centre de recerca interdepartamental específica de la
Universitat Politècnica de Catalunya (UPC).

L\'abast tecnològic del Centre TALP és el processat automàtic de
llenguatge natural, tant escrit com parlat. El seu objectiu és ajudar a
superar les barreres de l\'idioma per millorar l\'accés als sistemes
d\'informació centrades en la investigació i el desenvolupament en
l\'àrea de processament del llenguatge humà.
:::
:::::

El centre es compon de dos grups de recerca: El Grup de Tractament de la
Parla en el Departament de Teoria del Senyal i Comunicació i el Grup de
Processament del Llenguatge Natural al Departament de Software. Tots dos
gaudeixen de la condició de Grup de Recerca Consolidat, conferida pel
Govern català.
::::::
:::::::
::::::::
...
::: field
[ Web ]{.field-label} [ [www.talp.upc.edu/](http://www.talp.upc.edu/)
]{.field-items}
:::
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/TALP)
::::::::::
:::::::::::
::::::::::::
::::::::::::::
