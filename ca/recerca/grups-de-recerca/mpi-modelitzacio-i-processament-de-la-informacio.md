...
description: \[column cols=6 begin=1\]\[/column\] \[column cols=\"6\"
  end=\"1\"\]El grup de recerca en Modelització i Processament de la
  Informació (MPI) està format per membres dels departaments
  d\'Arquitectura de Computadors, d\'Enginyeria de Serveis i Sistemes
  d\'Informació, d\'Enginyeria de Sistemes, Automàtica i Informàtica
  Industrial i d\'Estadística i Investigació Operativa, així con de
  l\'inLab
...
theme-color: "#ffffff"
title: MPI - Modelització i Processament de la Informació \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[column cols=6 begin=1\]\[/column\] \[column
  cols=\"6\" end=\"1\"\]El grup de recerca en Modelització i
  Processament de la Informació (MPI) està format per membres dels
  departaments d\'Arquitectura de
twitter:title: MPI - Modelització i Processament de la Informació
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/mpi-modelitzacio-i-processament-de-la-informacio"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/mpi-modelitzacio-i-processament-de-la-informacio "MPI - Modelització i Processament de la Informació"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/mpi-information-modelling-processing "MPI - Information Modelling & Processing"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/mpi-modelizacion-y-procesamiento-de-la-informacion "MPI - Modelización y Procesamiento de la Información"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [MPI - Modelització i Processament de la
            Informació](/ca/recerca/grups-de-recerca/mpi-modelitzacio-i-processament-de-la-informacio){.active}
...
:::: content
::: page_title_no_sub
# MPI - Modelització i Processament de la Informació {#mpi---modelització-i-processament-de-la-informació .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » MPI - Modelització i
...
-   [MD - Matemàtica
    Discreta](/ca/recerca/grups-de-recerca/md-matematica-discreta)
-   [MPI - Modelització i Processament de la
    Informació](/ca/recerca/grups-de-recerca/mpi-modelitzacio-i-processament-de-la-informacio){.active-trail
    .active}
...
:::::::::::: content
::::::::::: {#node-16330 .node .node-entitat-recerca .clearfix}
:::::::::: content
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
El grup de recerca en Modelització i Processament de la Informació (MPI)
està format per membres dels departaments d\'Arquitectura de
Computadors, d\'Enginyeria de Serveis i Sistemes d\'Informació,
d\'Enginyeria de Sistemes, Automàtica i Informàtica Industrial i
d\'Estadística i Investigació Operativa, així con de l\'inLab FIB, de la
Universitat Oberta de Catalunya i de la Universitat Pompeu Fabra.
:::
:::::

L\'activitat del grup se centra en la investigació, la transferència
tecnològica i la formació en temes lligats a la modelització i el
processament de la informació, com ara la modelització conceptual, la
qualitat de les dades, la intel·ligència del negoci, la mineria de dades
o l\'enginyeria de serveis.
...
::: field
[ Web ]{.field-label} [ <http://imp.upc.edu/> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/MPI)
::::::::::
:::::::::::
::::::::::::
::::::::::::::
