---
description: El grup d\'Enginyeria del Software i dels Serveis (GESSI)
  està format per membres del departament d\'Enginyeria de Serveis i
  Sistemes d\'Informació. El treball d\'aquest grup està centrat en
  diversos aspectes de l\'enginyeria del software, amb un particular
  èmfasi en l\'enginyeria de requisits, la qualitat del software,
  l\'arquitectura del software, la informàtica orientada als
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: GESSI - Grup d\'Enginyeria del Software i dels Serveis \|
  Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup d\'Enginyeria del Software i dels Serveis
  (GESSI) està format per membres del departament d\'Enginyeria de
  Serveis i Sistemes d\'Informació. El treball d\'aquest grup està
  centrat en diversos
twitter:title: GESSI - Grup d\'Enginyeria del Software i dels Serveis
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/gessi-grup-denginyeria-del-software-i-dels-serveis"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/gessi-grup-denginyeria-del-software-i-dels-serveis "GESSI - Grup d'Enginyeria del Software i dels Serveis"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/gessi-group-software-and-service-engineering "GESSI - Group of Software and Service Engineering"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/gessi-grupo-de-ingenieria-del-software-y-de-los-servicios "GESSI - Grupo de Ingeniería del Software y de los Servicios"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [GESSI - Grup d\'Enginyeria del Software i dels
            Serveis](/ca/recerca/grups-de-recerca/gessi-grup-denginyeria-del-software-i-dels-serveis){.active}
...
:::: content
::: page_title_no_sub
# GESSI - Grup d\'Enginyeria del Software i dels Serveis {#gessi---grup-denginyeria-del-software-i-dels-serveis .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » GESSI - Grup d\'Enginyeria del
...
-   [DMAG - Grup d\'Aplicacions Multimèdia
    Distribuïdes](/ca/recerca/grups-de-recerca/dmag-grup-daplicacions-multimedia-distribuides)
-   [GESSI - Grup d\'Enginyeria del Software i dels
    Serveis](/ca/recerca/grups-de-recerca/gessi-grup-denginyeria-del-software-i-dels-serveis){.active-trail
    .active}
-   [GIE - Grup d\'Informàtica en
    l\'Enginyeria](/ca/recerca/grups-de-recerca/gie-grup-dinformatica-en-lenginyeria)
-   [GNOM - Grup d\'Optimització Numèrica i
...
::::::::: content
:::::::: {#node-16328 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
El grup d\'Enginyeria del Software i dels Serveis (GESSI) està format
per membres del departament d\'Enginyeria de Serveis i Sistemes
d\'Informació.

El treball d\'aquest grup està centrat en diversos aspectes de
l\'enginyeria del software, amb un particular èmfasi en l\'enginyeria de
requisits, la qualitat del software, l\'arquitectura del software, la
informàtica orientada als serveis, el software de codi obert, la
modelització del software i la recerca empírica.
:::
::::
:::::

::: field
[ Web ]{.field-label} [ <http://www.essi.upc.edu/~gessi/>
]{.field-items}
:::
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/GESSI)
:::::::
::::::::
:::::::::
:::::::::::
