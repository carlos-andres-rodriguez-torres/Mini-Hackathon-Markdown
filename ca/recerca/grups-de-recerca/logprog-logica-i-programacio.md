---
description: "El grup de recerca en Lògica i Programació (LOGPROG) està
  format per membres del departament de Ciències de la Computació. El
  grup focalitza la seva recerca en el camp de lògica i la informàtica
  teòrica bàsica. Les principals línies de recerca són: Lògica a la
  informàtica Complexitat computacional Resolució de problemes amb
  restriccions Tècniques de programació avançada"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: LOGPROG - Lògica i Programació \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: El grup de recerca en Lògica i Programació
  (LOGPROG) està format per membres del departament de Ciències de la
  Computació. El grup focalitza la seva recerca en el camp de lògica i
  la informàtica
twitter:title: LOGPROG - Lògica i Programació
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/logprog-logica-i-programacio"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/logprog-logica-i-programacio "LOGPROG - Lògica i Programació"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/logprog-logic-and-programming "LOGPROG - Logic and Programming"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/logprog-logica-y-programacion "LOGPROG - Lógica y Programación"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [LOGPROG - Lògica i
            Programació](/ca/recerca/grups-de-recerca/logprog-logica-i-programacio){.active}
        -   [MD - Matemàtica
...
:::: content
::: page_title_no_sub
# LOGPROG - Lògica i Programació {#logprog---lògica-i-programació .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » LOGPROG - Lògica i Programació
:::
::::
::::::
:::::::
...
-   [LARCA - Laboratori d´Algorísmia Relacional, Complexitat i
    Aprenentatge](/ca/recerca/grups-de-recerca/larca-laboratori-dalgorismia-relacional-complexitat-i-aprenentatge)
-   [LOGPROG - Lògica i
    Programació](/ca/recerca/grups-de-recerca/logprog-logica-i-programacio){.active-trail
    .active}
-   [MD - Matemàtica
    Discreta](/ca/recerca/grups-de-recerca/md-matematica-discreta)
-   [MPI - Modelització i Processament de la
...
:::::::: content
::::::: {#node-16322 .node .node-entitat-recerca .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
El grup de recerca en Lògica i Programació (LOGPROG) està format per
membres del departament de Ciències de la Computació.
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/LOGPROG)
::::::
:::::::
::::::::
::::::::::
