---
description: El grup de recerca en Geometria Computacional, Combinatoria
  i Discreta (DCCG) està format per membres del departament de
  Matemàtiques. La seva àrea principal d\'actuació és la geometria
  computacional, disciplina a cavall entre les matemàtiques i la
  informàtica teòrica. El seu objectiu principal és el disseny i
  l\'anàlisi d\'algorismes per a la solució eficient de problemes
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: DCCG - Geometria computacional, combinatoria i discreta \|
  Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de recerca en Geometria Computacional,
  Combinatoria i Discreta (DCCG) està format per membres del departament
  de Matemàtiques. La seva àrea principal d\'actuació és la geometria
  computacional,
twitter:title: DCCG - Geometria computacional, combinatoria i discreta
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/dccg-geometria-computacional-combinatoria-i-discreta"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/dccg-geometria-computacional-combinatoria-i-discreta "DCCG - Geometria computacional, combinatoria i discreta"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/dccg-research-group-discrete-combinatorial-and-computational-geometry "DCCG - Research group on discrete, combinatorial and computational geometry"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/dccg-grupo-de-investigacion-en-geometria-computacional-combinatoria-y-discreta "DCCG - Grupo de investigación en geometría computacional, combinatoria y discreta"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [DCCG - Geometria computacional, combinatoria i
            discreta](/ca/recerca/grups-de-recerca/dccg-geometria-computacional-combinatoria-i-discreta){.active}
...
:::: content
::: page_title_no_sub
# DCCG - Geometria computacional, combinatoria i discreta {#dccg---geometria-computacional-combinatoria-i-discreta .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » DCCG - Geometria computacional,
...
-   [DAMA-UPC - Data Management
    Group](/ca/recerca/grups-de-recerca/dama-upc-data-management-group)
-   [DCCG - Geometria computacional, combinatoria i
    discreta](/ca/recerca/grups-de-recerca/dccg-geometria-computacional-combinatoria-i-discreta){.active-trail
    .active}
-   [DMAG - Grup d\'Aplicacions Multimèdia
    Distribuïdes](/ca/recerca/grups-de-recerca/dmag-grup-daplicacions-multimedia-distribuides)
-   [GESSI - Grup d\'Enginyeria del Software i dels
...
::::::::: content
:::::::: {#node-16326 .node .node-entitat-recerca .clearfix}
::::::: content
...
El grup de recerca en Geometria Computacional, Combinatoria i Discreta
(DCCG) està format per membres del departament de Matemàtiques.

La seva àrea principal d\'actuació és la geometria computacional,
disciplina a cavall entre les matemàtiques i la informàtica teòrica. El
seu objectiu principal és el disseny i l\'anàlisi d\'algorismes per a la
solució eficient de problemes geomètrics. Algunes de les àrees de
recerca són:
...
::: field
[ Web ]{.field-label} [ <http://dccg.upc.edu/> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/DCCG)
:::::::
::::::::
:::::::::
:::::::::::
