---
description: El grup de recerca Comunicacions de Banda Ampla (CBA) està
  format per membres del departament d\'Arquitectura de Computadors i ha
  estat reconegut com a grup consolidat de recerca pel Govern de la
  Generalitat de Catalunya des de l\'any 2005 en totes les edicions del
...
theme-color: "#ffffff"
title: CBA - Sistemes de Comunicacions de Banda Ampla \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de recerca Comunicacions de Banda Ampla
  (CBA) està format per membres del departament d\'Arquitectura de
  Computadors i ha estat reconegut com a grup consolidat de recerca pel
  Govern de la
twitter:title: CBA - Sistemes de Comunicacions de Banda Ampla
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/cba-sistemes-de-comunicacions-de-banda-ampla"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/cba-sistemes-de-comunicacions-de-banda-ampla "CBA - Sistemes de Comunicacions de Banda Ampla"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/cba-broadband-communications-systems "CBA - Broadband Communications Systems"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/cba-sistemas-de-comunicaciones-de-banda-ancha "CBA - Sistemas de Comunicaciones de Banda Ancha"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [CBA - Sistemes de Comunicacions de Banda
            Ampla](/ca/recerca/grups-de-recerca/cba-sistemes-de-comunicacions-de-banda-ampla){.active}
...
:::: content
::: page_title_no_sub
# CBA - Sistemes de Comunicacions de Banda Ampla {#cba---sistemes-de-comunicacions-de-banda-ampla .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » CBA - Sistemes de Comunicacions
de Banda Ampla
:::
::::
::::::
...
-   [CAP - Computació d\'Altes
    Prestacions](/ca/recerca/grups-de-recerca/cap-computacio-daltes-prestacions)
-   [CBA - Sistemes de Comunicacions de Banda
    Ampla](/ca/recerca/grups-de-recerca/cba-sistemes-de-comunicacions-de-banda-ampla){.active-trail
    .active}
-   [CNDS - Xarxes de Computadors i Sistemes
    Distribuïts](/ca/recerca/grups-de-recerca/cnds-xarxes-de-computadors-i-sistemes-distribuits)
-   [DAMA-UPC - Data Management
...
:::::::::::: content
::::::::::: {#node-16333 .node .node-entitat-recerca .clearfix}
:::::::::: content
::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::: field-items
:::::: {.field-item .even}
El grup de recerca Comunicacions de Banda Ampla (CBA) està format per
membres del departament d\'Arquitectura de Computadors i ha estat
reconegut com a grup consolidat de recerca pel Govern de la Generalitat
de Catalunya des de l\'any 2005 en totes les edicions del Pla de Recerca
de Catalunya.
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
La majoria dels temas analitzats per aquest grup estan fortament
relacionats amb les xarxes, serveis i aplicacions de banda ampla,
commutació, desenvolupament i eficiència de protocols, modelització de
tràfic, polítiques de gestió dels recursos de xarxa, assignació d\'ample
de banda, control del tràfic i congestió, estratègies d\'encaminament,
connexió i gestió de xarxes, convergència de xarxes òptiques i IP,
qualitat del servei dels protocols de gestió i transport.
...
::: field
[ Web ]{.field-label} [ [www.cba.upc.edu/](http://www.cba.upc.edu/)
]{.field-items}
:::
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/CBA)
::::::::
:::::::::
::::::::::
:::::::::::
