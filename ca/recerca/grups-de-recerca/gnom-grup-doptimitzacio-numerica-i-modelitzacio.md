...
description: \[column cols=6 begin=1\]\[/column\] \[column cols=\"6\"
  end=\"1\"\]El grup d\'Optimització Numèrica i Modelització (GNOM) està
  format per membres del departament d\'Estadística i Investigació
  Operativa i del departament de Matemàtiques. Ha sigut reconegut com a
...
theme-color: "#ffffff"
title: GNOM - Grup d\'Optimització Numèrica i Modelització \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[column cols=6 begin=1\]\[/column\] \[column
  cols=\"6\" end=\"1\"\]El grup d\'Optimització Numèrica i Modelització
  (GNOM) està format per membres del departament d\'Estadística i
  Investigació Operativa i del
twitter:title: GNOM - Grup d\'Optimització Numèrica i Modelització
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/gnom-grup-doptimitzacio-numerica-i-modelitzacio"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/gnom-grup-doptimitzacio-numerica-i-modelitzacio "GNOM - Grup d'Optimització Numèrica i Modelització"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/gnom-group-numerical-optimization-and-modelling "GNOM - Group of Numerical Optimization and Modelling"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/gnom-grupo-de-optimizacion-numerica-y-modelizacion "GNOM - Grupo de Optimización Numérica y Modelización"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [GNOM - Grup d\'Optimització Numèrica i
            Modelització](/ca/recerca/grups-de-recerca/gnom-grup-doptimitzacio-numerica-i-modelitzacio){.active}
...
:::: content
::: page_title_no_sub
# GNOM - Grup d\'Optimització Numèrica i Modelització {#gnom---grup-doptimització-numèrica-i-modelització .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » GNOM - Grup d\'Optimització
Numèrica i Modelització
:::
::::
::::::
:::::::
...
-   [GIE - Grup d\'Informàtica en
    l\'Enginyeria](/ca/recerca/grups-de-recerca/gie-grup-dinformatica-en-lenginyeria)
-   [GNOM - Grup d\'Optimització Numèrica i
    Modelització](/ca/recerca/grups-de-recerca/gnom-grup-doptimitzacio-numerica-i-modelitzacio){.active-trail
    .active}
-   [GPLN - Grup de Processament del Llenguatge
    Natural](/ca/recerca/grups-de-recerca/gpln-grup-de-processament-del-llenguatge-natural)
-   [GRBIO - Grup de Recerca en Bioestadística i
...
:::::::::::: content
::::::::::: {#node-16316 .node .node-entitat-recerca .clearfix}
:::::::::: content
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
El grup d\'Optimització Numèrica i Modelització (GNOM) està format per
membres del departament d\'Estadística i Investigació Operativa i del
departament de Matemàtiques. Ha sigut reconegut com a grup de recerca
consolidat per la Generalitat de Catalunya.

El grup treballa principalment en mètodes d\'optimització numèrica i en
la modelització matemàtica de la programació de qualsevol problema que
es pugui resoldre mitjançant l\'optimització, amb especial èmfasi en
l\'energia, la protecció estadística de les dades i la cadena de
suministrament.
:::
:::::
::::::
...
::: field
[ Web ]{.field-label} [ <http://gnom.upc.edu/en> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/GNOM)
::::::::::
:::::::::::
::::::::::::
::::::::::::::
