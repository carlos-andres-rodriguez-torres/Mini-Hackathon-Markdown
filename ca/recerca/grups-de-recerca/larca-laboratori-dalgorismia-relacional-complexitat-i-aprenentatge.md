---
description: El grup d\'Algorísmia Relacional, Complexitat i
  Aprenentatge (LARCA) està format per membres del departament de
  Ciències de la Computació. El seu objectiu és la resolució de
  problemes a partir d\'una aproximació basada en sòlids principis
  matemàtics, fent servir eines de modelització i tècniques basades en
  l\'algorísmia, la complexitat computacional, la teoria d\'autòmates,
  la
...
theme-color: "#ffffff"
title: LARCA - Laboratori d´Algorísmia Relacional, Complexitat i
  Aprenentatge \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup d\'Algorísmia Relacional, Complexitat i
  Aprenentatge (LARCA) està format per membres del departament de
  Ciències de la Computació. El seu objectiu és la resolució de
  problemes a partir d\'una
twitter:title: LARCA - Laboratori d´Algorísmia Relacional, Complexitat i
  Aprenentatge
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/larca-laboratori-dalgorismia-relacional-complexitat-i-aprenentatge"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/larca-laboratori-dalgorismia-relacional-complexitat-i-aprenentatge "LARCA - Laboratori d´Algorísmia Relacional, Complexitat i Aprenentatge"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/larca-relational-algorithmics-complexity-and-learning-laboratory "LARCA - Relational Algorithmics, Complexity and Learning Laboratory "){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/larca-laboratorio-algoritmica-relacional-complejidad-y-aprendizaje "LARCA -Laboratorio Algoritmica Relacional, Complejidad y Aprendizaje"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [LARCA - Laboratori d´Algorísmia Relacional, Complexitat i
            Aprenentatge](/ca/recerca/grups-de-recerca/larca-laboratori-dalgorismia-relacional-complexitat-i-aprenentatge){.active}
        -   [LOGPROG - Lògica i
...
:::: content
::: page_title_no_sub
# LARCA - Laboratori d´Algorísmia Relacional, Complexitat i Aprenentatge {#larca---laboratori-dalgorísmia-relacional-complexitat-i-aprenentatge .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » LARCA - Laboratori d´Algorísmia
...
-   [KEMLG - Grup d´Enginyeria del Coneixement i Aprenentatge
    Automàtic](/ca/recerca/grups-de-recerca/kemlg-grup-denginyeria-del-coneixement-i-aprenentatge-automatic)
-   [LARCA - Laboratori d´Algorísmia Relacional, Complexitat i
    Aprenentatge](/ca/recerca/grups-de-recerca/larca-laboratori-dalgorismia-relacional-complexitat-i-aprenentatge){.active-trail
    .active}
-   [LOGPROG - Lògica i
    Programació](/ca/recerca/grups-de-recerca/logprog-logica-i-programacio)
-   [MD - Matemàtica
...
::::::::: content
:::::::: {#node-16337 .node .node-entitat-recerca .clearfix}
::::::: content
...
El grup d\'Algorísmia Relacional, Complexitat i Aprenentatge (LARCA)
està format per membres del departament de Ciències de la Computació.

El seu objectiu és la resolució de problemes a partir d\'una aproximació
basada en sòlids principis matemàtics, fent servir eines de modelització
i tècniques basades en l\'algorísmia, la complexitat computacional, la
teoria d\'autòmates, la lògica, la matemàtica discreta, l\'estadística i
els sistemes dinàmics.. Les principals línies de recerca són:
...
::: field
[ Web ]{.field-label} [ <http://recerca.upc.edu/larca/en>
]{.field-items}
:::
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/LARCA)
:::::::
::::::::
:::::::::
:::::::::::
