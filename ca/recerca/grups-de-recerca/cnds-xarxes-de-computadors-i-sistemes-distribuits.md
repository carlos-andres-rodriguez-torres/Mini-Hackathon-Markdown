---
description: "El grup de Xarxes de Computadors i Sistemes Distribuïts
  està format per professors del departament d\\'Arquitectura de
  Computadors. Es composa de dos subgrups: el Statistical Analysis of
  Networks and Systems (SANS) i el Distributed Systems Group (DSG). El
  SANS focalitza la seva recerca en la captació i analisi estadístic de
  dades de dispositius de la internet de les coses i la"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: CNDS - Xarxes de Computadors i Sistemes Distribuïts \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: "El grup de Xarxes de Computadors i Sistemes
  Distribuïts està format per professors del departament d\\'Arquitectura
  de Computadors. Es composa de dos subgrups: el Statistical Analysis of
  Networks and"
twitter:title: CNDS - Xarxes de Computadors i Sistemes Distribuïts
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/cnds-xarxes-de-computadors-i-sistemes-distribuits"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/cnds-xarxes-de-computadors-i-sistemes-distribuits "CNDS - Xarxes de Computadors i Sistemes Distribuïts"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/cnds-computer-networks-and-distributed-systems "CNDS - Computer Networks and Distributed Systems"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/cnds-redes-de-computadores-y-sistemas-distribuidos "CNDS - Redes de Computadores y Sistemas Distribuidos"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [CNDS - Xarxes de Computadors i Sistemes
            Distribuïts](/ca/recerca/grups-de-recerca/cnds-xarxes-de-computadors-i-sistemes-distribuits){.active}
...
:::: content
::: page_title_no_sub
# CNDS - Xarxes de Computadors i Sistemes Distribuïts {#cnds---xarxes-de-computadors-i-sistemes-distribuïts .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » CNDS - Xarxes de Computadors i
...
-   [CBA - Sistemes de Comunicacions de Banda
    Ampla](/ca/recerca/grups-de-recerca/cba-sistemes-de-comunicacions-de-banda-ampla)
-   [CNDS - Xarxes de Computadors i Sistemes
    Distribuïts](/ca/recerca/grups-de-recerca/cnds-xarxes-de-computadors-i-sistemes-distribuits){.active-trail
    .active}
-   [DAMA-UPC - Data Management
    Group](/ca/recerca/grups-de-recerca/dama-upc-data-management-group)
-   [DCCG - Geometria computacional, combinatoria i
...
::::::::: content
:::::::: {#node-16319 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
El grup de Xarxes de Computadors i Sistemes Distribuïts està format per
professors del departament d\'Arquitectura de Computadors. Es composa de
dos subgrups: el [Statistical Analysis of Networks and Systems
(SANS)](http://sans.ac.upc.edu/) i el [Distributed Systems Group
(DSG)](http://dsg.ac.upc.edu).

El SANS focalitza la seva recerca en la captació i analisi estadístic de
dades de dispositius de la internet de les coses i la seva aplicació a
diferents àrees com per exemple la supervisió mediambiental, les ciutats
intel·ligents o l\'anàlisi de models de mobilitat. Per la seva banda, el
DSG treballa en xarxes i núvols comunitaris de gran escala, sistemes
distribuïts orientats a l\'economia, particularment en mecanismes
d\'assignació de recursos pel grid o P2P, sistemes descentralitzats
aplicats a xarxes ambientals i aplicatius de suport a l\'aprenentatge
cooperatiu
...
::: field
[ Web ]{.field-label} [ <http://research.ac.upc.es/cnds/>
]{.field-items}
:::
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/CNDS)
:::::::
::::::::
:::::::::
:::::::::::
