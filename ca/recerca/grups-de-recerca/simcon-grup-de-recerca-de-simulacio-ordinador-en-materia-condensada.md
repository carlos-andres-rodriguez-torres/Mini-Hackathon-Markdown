---
description: El grup de Simulació per Ordinador en Matèria Condensada
  (SIMCOM) està format per membres del departament de Física. \[column
  cols=6 begin=1\]\[/column\] \[column cols=\"6\" end=\"1\"\]El seu
  objectiu és l\'estudi de les propietats microscòpiques de líquids i
  sòlids mitjançant simulació per computador.
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: SIMCON - Grup de Recerca de Simulació per Ordinador en Matèria
  Condensada \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de Simulació per Ordinador en Matèria
  Condensada (SIMCOM) està format per membres del departament de Física.
  \[column cols=6 begin=1\]\[/column\] \[column cols=\"6\" end=\"1\"\]El
  seu objectiu és
twitter:title: SIMCON - Grup de Recerca de Simulació per Ordinador en
  Matèria
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/simcon-grup-de-recerca-de-simulacio-ordinador-en-materia-condensada"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/simcon-grup-de-recerca-de-simulacio-ordinador-en-materia-condensada "SIMCON - Grup de Recerca de  Simulació per Ordinador en Matèria Condensada"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/simcon-computer-simulation-condensed-matter-research-group "SIMCON - Computer Simulation in Condensed Matter Research Group"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/simcon-grupo-de-investigacion-de-simulacion-por-ordenador-en-materia-condensada "SIMCON - Grupo de Investigación de Simulación por Ordenador en Materia Condensada"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [SIMCON - Grup de Recerca de Simulació per Ordinador en
            Matèria
            Condensada](/ca/recerca/grups-de-recerca/simcon-grup-de-recerca-de-simulacio-ordinador-en-materia-condensada){.active}
        -   [SOCO - Soft
...
:::: content
::: page_title_no_sub
# SIMCON - Grup de Recerca de Simulació per Ordinador en Matèria Condensada {#simcon---grup-de-recerca-de-simulació-per-ordinador-en-matèria-condensada .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » SIMCON - Grup de Recerca de
...
-   [SIMCON - Grup de Recerca de Simulació per Ordinador en Matèria
    Condensada](/ca/recerca/grups-de-recerca/simcon-grup-de-recerca-de-simulacio-ordinador-en-materia-condensada){.active-trail
    .active}
-   [SOCO - Soft
    Computing](/ca/recerca/grups-de-recerca/soco-soft-computing)
...
:::::::::::: content
::::::::::: {#node-16320 .node .node-entitat-recerca .clearfix}
:::::::::: content
::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::: field-items
:::::: {.field-item .even}
El grup de Simulació per Ordinador en Matèria Condensada (SIMCOM) està
format per membres del departament de Física.
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
El seu objectiu és l\'estudi de les propietats microscòpiques de líquids
i sòlids mitjançant simulació per computador. Aquesta metodologia permet
una millor comprensió de les propietats de la matèria a nivell atòmic,
bàsicament les propietats d\'estructura i transport no elèctric en
sòlids i líquids clàssics, les característiques dels defectes en
cristals i les propietats estructurals i termodinàmiques en la matèria
quàntica.
...
::: field
[ Web ]{.field-label} [ <http://simcon.upc.edu/en> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/SIMCON)
::::::::
:::::::::
::::::::::
:::::::::::
