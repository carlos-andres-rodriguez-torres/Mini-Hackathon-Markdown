---
description: El grup de recerca d\'Algorísmia, Bioinformàtica,
  Complexitat i Mètodes formals (ALBCOM) està format majoritàriament per
  membres del departament de Ciències de la Computació. \[column
  cols=\"6\" begin=\"1\"\]\[/column\] \[column cols=\"6\" end=\"1\"\]El
  grup focalitza la seva recerca en l\'algorísmia i els aspectes teòrics
  relatius a la complexitat computacional de la resolució de problemes.
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: ALBCOM - Algorismia, Bioinformàtica, Complexitat i Mètodes
  Formals \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de recerca d\'Algorísmia, Bioinformàtica,
  Complexitat i Mètodes formals (ALBCOM) està format majoritàriament per
  membres del departament de Ciències de la Computació. \[column
  cols=\"6\"
twitter:title: ALBCOM - Algorismia, Bioinformàtica, Complexitat i
  Mètodes Formals
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/albcom-algorismia-bioinformatica-complexitat-i-metodes-formals"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/albcom-algorismia-bioinformatica-complexitat-i-metodes-formals "ALBCOM - Algorismia, Bioinformàtica, Complexitat i Mètodes Formals"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/albcom-algorithms-computational-biology-complexity-and-formal-methods "ALBCOM - Algorithms, Computational Biology, Complexity and Formal Methods"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/albcom-algorismia-bioinformatica-complejidad-y-metodos-formales "ALBCOM - Algorismia, Bioinformática, Complejidad y Métodos Formales"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [ALBCOM - Algorismia, Bioinformàtica, Complexitat i Mètodes
            Formals](/ca/recerca/grups-de-recerca/albcom-algorismia-bioinformatica-complexitat-i-metodes-formals){.active}
...
:::: content
::: page_title_no_sub
# ALBCOM - Algorismia, Bioinformàtica, Complexitat i Mètodes Formals {#albcom---algorismia-bioinformàtica-complexitat-i-mètodes-formals .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » ALBCOM - Algorismia,
...
-   [ARCO - Arquitectures i
    Compiladors](/ca/recerca/grups-de-recerca/arco-arquitectures-i-compiladors)
-   [ALBCOM - Algorismia, Bioinformàtica, Complexitat i Mètodes
    Formals](/ca/recerca/grups-de-recerca/albcom-algorismia-bioinformatica-complexitat-i-metodes-formals){.active-trail
    .active}
-   [CAP - Computació d\'Altes
    Prestacions](/ca/recerca/grups-de-recerca/cap-computacio-daltes-prestacions)
-   [CBA - Sistemes de Comunicacions de Banda
...
::::::::::::::: content
:::::::::::::: {#node-16327 .node .node-entitat-recerca .clearfix}
::::::::::::: content
:::::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
::::::::::: field-items
:::::: {.field-item .even}
El grup de recerca d\'Algorísmia, Bioinformàtica, Complexitat i Mètodes
formals (ALBCOM) està format majoritàriament per membres del departament
...
::: {.col-xs-12 .col-sm-6 .col-md-6 .col-lg-6}
El grup focalitza la seva recerca en l\'algorísmia i els aspectes
teòrics relatius a la complexitat computacional de la resolució de
problemes. Les principals línies de recerca són:
...
::::: {.field .field-name-field-er-descripcio .field-type-text-long .field-label-hidden}
:::: field-items
::: {.field-item .even}
 
:::
...
::: field
[ Web ]{.field-label} [ <http://albcom.cs.upc.edu/> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/ALBCOM)
:::::::::::
::::::::::::
:::::::::::::
::::::::::::::
