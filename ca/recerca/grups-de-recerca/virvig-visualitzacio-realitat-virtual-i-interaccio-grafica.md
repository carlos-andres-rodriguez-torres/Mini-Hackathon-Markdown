---
description: El grup de recerca en Visualització, Realitat Virtual i
  Interacció Gràfica (ViRVIG) està format per membres dels departaments
  de Ciències de la Computació i de Matemàtiques. La seva recerca
  s\'inscriu dins la temàtica de la informàtica gràfica i es focalitza
  en la modelització, la visualització i la interacció gràfica avançada
  i la seva aplicació a la realitat virtual. Les
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: ViRVIG - Visualització, Realitat Virtual i Interacció Gràfica \|
  Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de recerca en Visualització, Realitat
  Virtual i Interacció Gràfica (ViRVIG) està format per membres dels
  departaments de Ciències de la Computació i de Matemàtiques. La seva
  recerca s\'inscriu
twitter:title: ViRVIG - Visualització, Realitat Virtual i Interacció
  Gràfica
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/virvig-visualitzacio-realitat-virtual-i-interaccio-grafica"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/virvig-visualitzacio-realitat-virtual-i-interaccio-grafica "ViRVIG - Visualització, Realitat Virtual i Interacció Gràfica"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/virvig-visualisation-virtual-reality-and-graphic-interaction-research-group "ViRVIG - Visualisation, Virtual Reality and Graphic Interaction Research Group"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/virvig-visualizacion-realidad-virtual-e-interaccion-grafica "ViRVIG - Visualización, Realidad Virtual e Interacción Gráfica"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [ViRVIG - Visualització, Realitat Virtual i Interacció
            Gràfica](/ca/recerca/grups-de-recerca/virvig-visualitzacio-realitat-virtual-i-interaccio-grafica){.active}
    -   [inLab FIB](/ca/recerca/inlab-fib)
-   [Empresa](/ca/empresa)
...
:::: content
::: page_title_no_sub
# ViRVIG - Visualització, Realitat Virtual i Interacció Gràfica {#virvig---visualització-realitat-virtual-i-interacció-gràfica .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » ViRVIG - Visualització,
Realitat Virtual i Interacció Gràfica
:::
::::
::::::
:::::::
...
-   [VIS - Visió Artificial i Sistemes
    Intel.ligents](/ca/recerca/grups-de-recerca/vis-visio-artificial-i-sistemes-intelligents)
-   [ViRVIG - Visualització, Realitat Virtual i Interacció
    Gràfica](/ca/recerca/grups-de-recerca/virvig-visualitzacio-realitat-virtual-i-interaccio-grafica){.active-trail
    .active}
:::
::::
::::::
...
:::::::: content
::::::: {#node-16306 .node .node-entitat-recerca .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
El grup de recerca en Visualització, Realitat Virtual i Interacció
Gràfica (ViRVIG) està format per membres dels departaments de Ciències
de la Computació i de Matemàtiques.

La seva recerca s\'inscriu dins la temàtica de la informàtica gràfica i
es focalitza en la modelització, la visualització i la interacció
gràfica avançada i la seva aplicació a la realitat virtual. Les àrees
principals dela seva recerca són:
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/ViRVIG)
::::::
:::::::
::::::::
::::::::::
