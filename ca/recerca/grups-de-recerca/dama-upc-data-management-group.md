...
description: \[column cols=6 begin=1\]\[/column\] \[column cols=\"6\"
  end=\"1\"\]El grup de recerca DAta MAnagement (DAMA) està format per
  membres del departament d\'Arquitectura de Computadors. Membre des de
  2005 de Tecnio, una iniciativa d\'ACCIO (Agència per la Innovació i la
  Internacionalització de les empreses catalanes, de la Generalitat de
  Catalunya), està reconegut pel Govern català com a grup
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: DAMA-UPC - Data Management Group \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: \[column cols=6 begin=1\]\[/column\] \[column
  cols=\"6\" end=\"1\"\]El grup de recerca DAta MAnagement (DAMA) està
  format per membres del departament d\'Arquitectura de Computadors.
  Membre des de 2005 de
twitter:title: DAMA-UPC - Data Management Group
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/dama-upc-data-management-group"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/dama-upc-data-management-group "DAMA-UPC - Data Management Group"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/dama-upc-data-management-group "DAMA-UPC - Data Management Group"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/dama-upc-data-management-group "DAMA-UPC - Data Management Group"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [DAMA-UPC - Data Management
            Group](/ca/recerca/grups-de-recerca/dama-upc-data-management-group){.active}
...
:::: content
::: page_title_no_sub
# DAMA-UPC - Data Management Group {#dama-upc---data-management-group .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » DAMA-UPC - Data Management
Group
:::
::::
::::::
...
-   [CNDS - Xarxes de Computadors i Sistemes
    Distribuïts](/ca/recerca/grups-de-recerca/cnds-xarxes-de-computadors-i-sistemes-distribuits)
-   [DAMA-UPC - Data Management
    Group](/ca/recerca/grups-de-recerca/dama-upc-data-management-group){.active-trail
    .active}
-   [DCCG - Geometria computacional, combinatoria i
    discreta](/ca/recerca/grups-de-recerca/dccg-geometria-computacional-combinatoria-i-discreta)
-   [DMAG - Grup d\'Aplicacions Multimèdia
...
:::::::::::: content
::::::::::: {#node-16345 .node .node-entitat-recerca .clearfix}
:::::::::: content
...
departament d\'Arquitectura de Computadors. Membre des de 2005 de
Tecnio, una iniciativa d\'ACCIO (Agència per la Innovació i la
Internacionalització de les empreses catalanes, de la Generalitat de
Catalunya), està reconegut pel Govern català com a grup de recerca
consolidat.

Les principals àrees de recerca d\'aquest grup d\'orienten cap al
rendiment, l\'exploració i la qualitat en la gestió de dades,
centrant-se principalment en grans volums de dades. Investiguen en la
creació de noves estructures de dades, algorismes, mètodes i aplicacions
en l\'àrea de la gestió de dades per fer més senzilla la manipulació de
...
::: field
[ Web ]{.field-label} [ <http://www.dama.upc.edu/en> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/DAMA-UPC)
::::::::::
:::::::::::
::::::::::::
::::::::::::::
