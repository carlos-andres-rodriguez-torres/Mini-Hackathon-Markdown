---
description: El grup d\'Enginyeria del Coneixement i Aprenentatge
  Automàtic (KEMLG) està format per membres del departament de Ciències
  de la Computació. El seu objectiu és l\'anàlisi, disseny,
  implementació i aplicació de nombroses tècniques i metodologies
  d\'intel·ligència artificial per donar suport al funcionament o a
  l\'anàlisi del comportament de sistemes i dominis complexos del món
  real.
...
theme-color: "#ffffff"
title: KEMLG - Grup d´Enginyeria del Coneixement i Aprenentatge
  Automàtic \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup d\'Enginyeria del Coneixement i
  Aprenentatge Automàtic (KEMLG) està format per membres del departament
  de Ciències de la Computació. El seu objectiu és l\'anàlisi, disseny,
  implementació i
twitter:title: KEMLG - Grup d´Enginyeria del Coneixement i Aprenentatge
  Automàtic
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/kemlg-grup-denginyeria-del-coneixement-i-aprenentatge-automatic"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/kemlg-grup-denginyeria-del-coneixement-i-aprenentatge-automatic "KEMLG - Grup d´Enginyeria del Coneixement i Aprenentatge Automàtic"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/kemlg-knowledge-engineering-and-machine-learning-group "KEMLG - Knowledge Engineering and Machine Learning Group "){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/kemlg-grupo-de-ingenieria-del-conocimiento-y-aprendizaje-automatico "KEMLG - Grupo de Ingeniería del Conocimiento y Aprendizaje Automático"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [KEMLG - Grup d´Enginyeria del Coneixement i Aprenentatge
            Automàtic](/ca/recerca/grups-de-recerca/kemlg-grup-denginyeria-del-coneixement-i-aprenentatge-automatic){.active}
...
:::: content
::: page_title_no_sub
# KEMLG - Grup d´Enginyeria del Coneixement i Aprenentatge Automàtic {#kemlg---grup-denginyeria-del-coneixement-i-aprenentatge-automàtic .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » KEMLG - Grup d´Enginyeria del
...
-   [GRINS - Grup de Robòtica Intel·ligent i
    Sistemes](/ca/recerca/grups-de-recerca/grins-grup-de-robotica-intelligent-i-sistemes)
-   [KEMLG - Grup d´Enginyeria del Coneixement i Aprenentatge
    Automàtic](/ca/recerca/grups-de-recerca/kemlg-grup-denginyeria-del-coneixement-i-aprenentatge-automatic){.active-trail
    .active}
-   [LARCA - Laboratori d´Algorísmia Relacional, Complexitat i
    Aprenentatge](/ca/recerca/grups-de-recerca/larca-laboratori-dalgorismia-relacional-complexitat-i-aprenentatge)
-   [LOGPROG - Lògica i
...
::::::::: content
:::::::: {#node-16324 .node .node-entitat-recerca .clearfix}
::::::: content
...
El grup d\'Enginyeria del Coneixement i Aprenentatge Automàtic (KEMLG)
està format per membres del departament de Ciències de la Computació.

El seu objectiu és l\'anàlisi, disseny, implementació i aplicació de
nombroses tècniques i metodologies d\'intel·ligència artificial per
donar suport al funcionament o a l\'anàlisi del comportament de sistemes
i dominis complexos del món real. Les principals línies de recerca són:

-   Dispositius d\'ajuda i entorn intel·ligent
-   Sistemes intel·ligents de suport a la presa de decisions i sistemes
    de recomanació
-   Mineria de dades i descobriment de coneixement
-   Comerç electrònic, web semàntic i sistemes intel·ligents distribuïts
-   Institucions electròniques, teoria de les organitzacions i sistemes
    multiagents
...
dominis, incloent àrees d\'aplicació com medicina i salut, sistemes i
processos mediambientals, i sistemes socials i basats en Internet en els
entorns empresarial i industrial.
:::
::::
:::::

::: field
[ Web ]{.field-label} [ <http://kemlg.upc.edu/en/> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/KEMLG)
:::::::
::::::::
:::::::::
:::::::::::
