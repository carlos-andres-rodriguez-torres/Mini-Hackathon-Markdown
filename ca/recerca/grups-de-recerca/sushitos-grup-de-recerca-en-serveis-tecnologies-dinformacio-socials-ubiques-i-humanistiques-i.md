---
description: El grup de recerca en Serveis per a Tecnologies de la
  Informació Socilas, Ubiqües i Humanes i Codi Obert (SUSHITOS) està
  format per membres dels departaments d\'Arquitectura de Computadors i
  d\'Enginyeria de Serveis i Sistemes d\'Informació. L\'objectiu
  principal del grup és avançar en les tecnologies de la informació
  aplicades a l\'educació (e-learning, aprenentatge per
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: SUSHITOS - Serveis per a tecnologies d\'informació socials,
  ubiqües i humanístiques, i per a software lliure \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de recerca en Serveis per a Tecnologies de
  la Informació Socilas, Ubiqües i Humanes i Codi Obert (SUSHITOS) està
  format per membres dels departaments d\'Arquitectura de Computadors i
twitter:title: SUSHITOS - Serveis per a tecnologies d\'informació
  socials, ubiqües i
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/sushitos-grup-de-recerca-en-serveis-tecnologies-dinformacio-socials-ubiques-i-humanistiques-i"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/sushitos-grup-de-recerca-en-serveis-tecnologies-dinformacio-socials-ubiques-i-humanistiques-i "SUSHITOS - Serveis per a tecnologies d'informació socials, ubiqües i humanístiques, i per a software lliure"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/sushitos-services-ubiquitous-social-and-humanistic-information-technologies-and-open-source-research-group "SUSHITOS - Services for Ubiquitous Social and Humanistic Information Technologies and Open Source Research Group"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/sushitos-servicios-para-tecnologias-de-informacion-sociales-ubicuas-y-humanisticas-y-para-el-software-libre "SUSHITOS - Servicios para tecnologías de información sociales, ubicuas y humanísticas, y para el software libre"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [SUSHITOS - Serveis per a tecnologies d\'informació socials,
            ...
            lliure](/ca/recerca/grups-de-recerca/sushitos-grup-de-recerca-en-serveis-tecnologies-dinformacio-socials-ubiques-i-humanistiques-i){.active}
...
:::: content
::: page_title_no_sub
# SUSHITOS - Serveis per a tecnologies d\'informació socials, ubiqües i humanístiques, i per a software lliure {#sushitos---serveis-per-a-tecnologies-dinformació-socials-ubiqües-i-humanístiques-i-per-a-software-lliure .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Recerca](/ca/recerca) » [Grups de
Recerca](/ca/recerca/grups-de-recerca) » SUSHITOS - Serveis per a
tecnologies d\'informació socials, ubiqües i humanístiques, i per a
software lliure
:::
::::
::::::
...
-   [SOCO - Soft
    Computing](/ca/recerca/grups-de-recerca/soco-soft-computing)
-   [SUSHITOS - Serveis per a tecnologies d\'informació socials, ubiqües
    i humanístiques, i per a software
    lliure](/ca/recerca/grups-de-recerca/sushitos-grup-de-recerca-en-serveis-tecnologies-dinformacio-socials-ubiques-i-humanistiques-i){.active-trail
    .active}
-   [VIS - Visió Artificial i Sistemes
    Intel.ligents](/ca/recerca/grups-de-recerca/vis-visio-artificial-i-sistemes-intelligents)
-   [ViRVIG - Visualització, Realitat Virtual i Interacció
...
::::::::: content
:::::::: {#node-16310 .node .node-entitat-recerca .clearfix}
::::::: content
...
El grup de recerca en Serveis per a Tecnologies de la Informació
Socilas, Ubiqües i Humanes i Codi Obert (SUSHITOS) està format per
membres dels departaments d\'Arquitectura de Computadors i d\'Enginyeria
de Serveis i Sistemes d\'Informació.

L\'objectiu principal del grup és avançar en les tecnologies de la
informació aplicades a l\'educació (e-learning, aprenentatge per
dispositius mòbils, continguts digitals, interoperabilitat d\'eines
d\'aprenentatge, learning analytics), sistemes d\'informació pel
patrimoni, software com a servei i desenvolupament sostenible.
:::
::::
:::::

::: field
[ Web ]{.field-label} [ <http://sushitos.upc.edu/en> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/SUSHITOS)
:::::::
::::::::
:::::::::
:::::::::::
