---
description: El grup de Recerca en Bioinformàtica i Bioestadística és un
  grup interdisciplinari en el que participen membres del departament
  d\'Estadística i Investigació Operativa, de la Universitat de
  Barcelona i d\'altres institucions i entitats de l\'àmbit de les
...
theme-color: "#ffffff"
title: GRBIO - Grup de Recerca en Bioestadística i Bioinformàtica \|
  Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de Recerca en Bioinformàtica i
  Bioestadística és un grup interdisciplinari en el que participen
  membres del departament d\'Estadística i Investigació Operativa, de la
  Universitat de Barcelona
twitter:title: GRBIO - Grup de Recerca en Bioestadística i
  Bioinformàtica
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/grbio-grup-de-recerca-en-bioestadistica-i-bioinformatica"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/grbio-grup-de-recerca-en-bioestadistica-i-bioinformatica "GRBIO - Grup de Recerca en Bioestadística i Bioinformàtica"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/grbio-biostatistics-and-bioinformatics-research-group "GRBIO - Biostatistics and Bioinformatics Research Group"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/grbio-grupo-de-investigacion-en-bioestadistica-y-bioinformatica "GRBIO - Grupo de Investigación en Bioestadística y Bioinformática"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [GRBIO - Grup de Recerca en Bioestadística i
            Bioinformàtica](/ca/recerca/grups-de-recerca/grbio-grup-de-recerca-en-bioestadistica-i-bioinformatica){.active}
...
:::: content
::: page_title_no_sub
# GRBIO - Grup de Recerca en Bioestadística i Bioinformàtica {#grbio---grup-de-recerca-en-bioestadística-i-bioinformàtica .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » GRBIO - Grup de Recerca en
...
-   [GPLN - Grup de Processament del Llenguatge
    Natural](/ca/recerca/grups-de-recerca/gpln-grup-de-processament-del-llenguatge-natural)
-   [GRBIO - Grup de Recerca en Bioestadística i
    Bioinformàtica](/ca/recerca/grups-de-recerca/grbio-grup-de-recerca-en-bioestadistica-i-bioinformatica){.active-trail
    .active}
-   [GREC - Grup de Recerca en Enginyeria del
    Coneixement](/ca/recerca/grups-de-recerca/grec-grup-de-recerca-en-enginyeria-del-coneixement)
-   [GRINS - Grup de Robòtica Intel·ligent i
...
::::::::: content
:::::::: {#node-16321 .node .node-entitat-recerca .clearfix}
::::::: content
...
interdisciplinari en el que participen membres del departament
d\'Estadística i Investigació Operativa, de la Universitat de Barcelona
i d\'altres institucions i entitats de l\'àmbit de les Ciències de la
Vida i la Salut.

Els seus temes de recerca es poden agrupar en tres grans àrees:

-   Assajos clínics: aportacions metodològiques en les fases de disseny
    i modelat estadístic
-   Anàlisi integrativa de dades òmiques: mètodes estadístics
    multivariants i de \"machine learning\"
-   Desenvolupament d\'eines estadístiques i informàtiques per
    l\'explotació dels resultats de la recerca biomèdica.

Altres temes en els que treballen són l\'anàlisi i representació de
dades multivariants, l\'anàlisi de dades de supervivència amb censura en
un interval, l\'optimització del disseny de fàrmacs amb simulació i la
resolució de problemes aplicats en camps com VIH/SIDA, oncologia,
...
::: field
[ Web ]{.field-label} [ <https://grbio.upc.edu/en> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/GRBIO)
:::::::
::::::::
:::::::::
:::::::::::
