...
description: \[column cols=6 begin=1\]\[/column\] \[column cols=\"6\"
  end=\"1\"\]\[/column\] El grup de Visió Artificial i Sistemes
  Intel·ligents (VIS) està format per membres del departament
  d\'Enginyeria de Sistemes, Automàtica i Informàtica Industrial i de
  l\'Institut de Robòtica i Informàtica Industrial (IRI). L\'objectiu
  principal del grup és la recerca bàsica i aplicada al desenvolupament
  de
...
theme-color: "#ffffff"
title: VIS - Visió Artificial i Sistemes Intel.ligents \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[column cols=6 begin=1\]\[/column\] \[column
  cols=\"6\" end=\"1\"\]\[/column\] El grup de Visió Artificial i
  Sistemes Intel·ligents (VIS) està format per membres del departament
  d\'Enginyeria de Sistemes,
twitter:title: VIS - Visió Artificial i Sistemes Intel.ligents
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/vis-visio-artificial-i-sistemes-intelligents"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/vis-visio-artificial-i-sistemes-intelligents "VIS - Visió Artificial i Sistemes Intel.ligents"){.language-link
    .active lang="ca"}
-   [English](/en/research/research-groups/vis-vision-and-intelligent-systems "VIS - Vision and Intelligent Systems"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/vis-vision-artificial-y-sistemas-inteligentes "VIS - Visión Artificial y Sistemas Inteligentes"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [VIS - Visió Artificial i Sistemes
            Intel.ligents](/ca/recerca/grups-de-recerca/vis-visio-artificial-i-sistemes-intelligents){.active}
...
:::: content
::: page_title_no_sub
# VIS - Visió Artificial i Sistemes Intel.ligents {#vis---visió-artificial-i-sistemes-intel.ligents .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » VIS - Visió Artificial i
...
-   [SUSHITOS - Serveis per a tecnologies d\'informació socials, ubiqües
    ...
    lliure](/ca/recerca/grups-de-recerca/sushitos-grup-de-recerca-en-serveis-tecnologies-dinformacio-socials-ubiques-i-humanistiques-i)
-   [VIS - Visió Artificial i Sistemes
    Intel.ligents](/ca/recerca/grups-de-recerca/vis-visio-artificial-i-sistemes-intelligents){.active-trail
    .active}
-   [ViRVIG - Visualització, Realitat Virtual i Interacció
    Gràfica](/ca/recerca/grups-de-recerca/virvig-visualitzacio-realitat-virtual-i-interaccio-grafica)
:::
...
:::::::::::: content
::::::::::: {#node-16313 .node .node-entitat-recerca .clearfix}
:::::::::: content
...
El grup de Visió Artificial i Sistemes Intel·ligents (VIS) està format
per membres del departament d\'Enginyeria de Sistemes, Automàtica i
Informàtica Industrial i de l\'Institut de Robòtica i Informàtica
Industrial (IRI).

L\'objectiu principal del grup és la recerca bàsica i aplicada al
desenvolupament de sistemes intel·ligents capaços d\'interactuar amb el
món de manera autònoma i ubiqua. Aquests sistemes intel·ligents hauran
de percebre, raonar, planificar, actuar i aprendre de l\'experiència
prèvia. El Grup treballa activament en temes com ara la segmentació i
l\'etiquetatge robust d\'imatges en color, el reconeixement de formes,
l\'aprenentatge i reconeixement d\'objectes invariant a les condicions
d\'il·luminació i del punt de vista, el seguiment d\'objectes i
persones, la biomètrica, el processament i l\'anàlisi d\'imatges
mèdiques per a l\'ajuda a la diagnosi, l\'anàlisi de documents, la
navegació de robots mòbils, l\'autolocalització i la construcció de
mapes concurrent, el control de sistemes de retroalimentació visual o la
...
::: field
[ Web ]{.field-label} [ <http://vis.upc.edu/> ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/VIS)
::::::::::
:::::::::::
::::::::::::
::::::::::::::
