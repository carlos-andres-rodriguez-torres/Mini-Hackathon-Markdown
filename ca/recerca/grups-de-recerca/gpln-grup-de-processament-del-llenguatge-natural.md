---
description: El grup de Processament del Llenguatge Natural (GPLN) està
  format per membres del departament de Ciències de la Computació, tot i
  que compta amb la col·laboració asidua de grups de recerca en
  lingüística de la Universitat de Barcelona. El grup va ser reconegut
  com a integrant del Grup d\'Investigació de Qualitat per la Comissió
...
theme-color: "#ffffff"
title: GPLN - Grup de Processament del Llenguatge Natural \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El grup de Processament del Llenguatge Natural
  (GPLN) està format per membres del departament de Ciències de la
  Computació, tot i que compta amb la col·laboració asidua de grups de
  recerca en
twitter:title: GPLN - Grup de Processament del Llenguatge Natural
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/gpln-grup-de-processament-del-llenguatge-natural"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/gpln-grup-de-processament-del-llenguatge-natural "GPLN - Grup de Processament del Llenguatge Natural"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/gpln-natural-language-processing-group "GPLN - Natural Language Processing Group"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/gpln-grupo-de-procesamiento-del-lenguaje-natural "GPLN - Grupo de Procesamiento del Lenguaje Natural"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        ...
        -   [GPLN - Grup de Processament del Llenguatge
            Natural](/ca/recerca/grups-de-recerca/gpln-grup-de-processament-del-llenguatge-natural){.active}
...
:::: content
::: page_title_no_sub
# GPLN - Grup de Processament del Llenguatge Natural {#gpln---grup-de-processament-del-llenguatge-natural .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » GPLN - Grup de Processament del
Llenguatge Natural
:::
::::
::::::
...
-   [GNOM - Grup d\'Optimització Numèrica i
    Modelització](/ca/recerca/grups-de-recerca/gnom-grup-doptimitzacio-numerica-i-modelitzacio)
-   [GPLN - Grup de Processament del Llenguatge
    Natural](/ca/recerca/grups-de-recerca/gpln-grup-de-processament-del-llenguatge-natural){.active-trail
    .active}
-   [GRBIO - Grup de Recerca en Bioestadística i
    Bioinformàtica](/ca/recerca/grups-de-recerca/grbio-grup-de-recerca-en-bioestadistica-i-bioinformatica)
-   [GREC - Grup de Recerca en Enginyeria del
...
:::::::::::::: content
::::::::::::: {#node-16335 .node .node-entitat-recerca .clearfix}
:::::::::::: content
::::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::::: field-items
:::::::: {.field-item .even}
El grup de Processament del Llenguatge Natural (GPLN) està format per
membres del departament de Ciències de la Computació, tot i que compta
amb la col·laboració asidua de grups de recerca en lingüística de la
Universitat de Barcelona. El grup va ser reconegut com a integrant del
Grup d\'Investigació de Qualitat per la Comissió Interdepartamental de
Recerca i Tecnologia (CIRIT) de la Generalitat de Catalunya, i des del
1997, com a grup de recerca consolidat a totes les edicions del Pla de
...
-   Processos bàsics d\'anàlisi i desambiguació del llenguatge
    (morfològics, sintàctics, semàntics)
...
En 1999, el GPLN el grup de recerca GPS, del departament de Teoria del
Senyal i Comunicacions es van associar per crear el grup de recerca
[TALP (Tecnologia i Aplicacions del Llenguatge i la
Parla](http://www.talp.upc.edu/)).
:::
:::::
::::::
:::::::
...
::: field
[ Web ]{.field-label} [ <http://www.cs.upc.edu/research/>
]{.field-items}
:::
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/GPLN)
::::::::::
:::::::::::
::::::::::::
:::::::::::::
