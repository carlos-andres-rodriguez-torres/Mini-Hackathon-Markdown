---
description: El grup de recerca Architectures and Compilers (ARCO) està
  format per membres del departament d\'Arquitectura de Computadors de
  la UPC, membres del departament de Ciències de la Computació de la URV
  i col·laboradors externs de la indústria. La recerca del grup està
  centrada en microarquitectures i compiladors per futurs processadors,
  tenint en consideració la tecnologia
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: ARCO - Arquitectures i Compiladors \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: El grup de recerca Architectures and Compilers
  (ARCO) està format per membres del departament d\'Arquitectura de
  Computadors de la UPC, membres del departament de Ciències de la
  Computació de la URV i
twitter:title: ARCO - Arquitectures i Compiladors
twitter:url: "https://www.fib.upc.edu/ca/recerca/grups-de-recerca/arco-arquitectures-i-compiladors"
...
::: content
-   [Català](/ca/recerca/grups-de-recerca/arco-arquitectures-i-compiladors "ARCO - Arquitectures i Compiladors"){.language-link
    .active lang="ca"}
-   [English](/en/research/resarch-groups/arco-architectures-and-compilers "ARCO - Architectures and Compilers"){.language-link
    lang="en"}
-   [Español](/es/investigacion/grupos-de-investigacion/arco-microarquitectura-y-compiladores "ARCO - Microarquitectura y Compiladores"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [Grups de Recerca](/ca/recerca/grups-de-recerca)
        -   [ARCO - Arquitectures i
            Compiladors](/ca/recerca/grups-de-recerca/arco-arquitectures-i-compiladors){.active}
...
:::: content
::: page_title_no_sub
# ARCO - Arquitectures i Compiladors {#arco---arquitectures-i-compiladors .page_title}
:::
::::
::::::
:::::::
...
Recerca](/ca/recerca/grups-de-recerca) » ARCO - Arquitectures i
Compiladors
:::
::::
::::::
...
-   [ARCO - Arquitectures i
    Compiladors](/ca/recerca/grups-de-recerca/arco-arquitectures-i-compiladors){.active-trail
    .active}
-   [ALBCOM - Algorismia, Bioinformàtica, Complexitat i Mètodes
    Formals](/ca/recerca/grups-de-recerca/albcom-algorismia-bioinformatica-complexitat-i-metodes-formals)
-   [CAP - Computació d\'Altes
...
::::::::: content
:::::::: {#node-16312 .node .node-entitat-recerca .clearfix}
::::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
El grup de recerca Architectures and Compilers (ARCO) està format per
membres del departament d\'Arquitectura de Computadors de la UPC,
membres del departament de Ciències de la Computació de la URV i
col·laboradors externs de la indústria. La recerca del grup està
centrada en microarquitectures i compiladors per futurs processadors,
tenint en consideració la tecnologia sugjacent. L\'objectiu principal és
l\'augment del rendiment, la millora de la fiabilitat i la reducció de
la disipació d\'energia dels futurs processadors.
:::
::::
:::::
...
::: field
[ Web ]{.field-label} [
[arco.e.ac.upc.edu/wiki](http://arco.e.ac.upc.edu/wiki) ]{.field-items}
:::

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/ARCO)
:::::::
::::::::
:::::::::
:::::::::::
