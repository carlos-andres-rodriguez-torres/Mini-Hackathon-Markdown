---
description: "El Departament d\\'Enginyeria de Sistemes, Automàtica i
  Informàtica Industrial (ESAII) de la Universitat Politècnica de
  Catalunya (UPC) impulsa la recerca i la docència tant els aspectes
  bàsics com els d\\'aplicació dels àmbits següents: Robòtica Dins del
  camp de la robòtica es treballa en la incorporació de sensors i
  sistemes de percepció per al desenvolupament d\\'estratègies de"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Enginyeria de Sistemes, Automàtica i Informàtica Industrial \|
  Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El Departament d\'Enginyeria de Sistemes,
  Automàtica i Informàtica Industrial (ESAII) de la Universitat
  Politècnica de Catalunya (UPC) impulsa la recerca i la docència tant
  els aspectes bàsics com els
twitter:title: Enginyeria de Sistemes, Automàtica i Informàtica
  Industrial
twitter:url: "https://www.fib.upc.edu/ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-industrial"
...
::: content
-   [Català](/ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-industrial "Enginyeria de Sistemes, Automàtica i Informàtica Industrial"){.language-link
    .active lang="ca"}
-   [English](/en/research/departments/automatic-control "Automatic Control"){.language-link
    lang="en"}
-   [Español](/es/investigacion/departamentos/ingenieria-de-sistemas-automatica-e-informatica-industrial "Ingeniería de Sistemas, Automática e Informática Industrial"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    -   [Departaments](/ca/recerca/departaments)
        ...
        -   [Enginyeria de Sistemes, Automàtica i Informàtica
            Industrial](/ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-industrial){.active}
...
:::: content
::: page_title_no_sub
# Enginyeria de Sistemes, Automàtica i Informàtica Industrial {#enginyeria-de-sistemes-automàtica-i-informàtica-industrial .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Recerca](/ca/recerca) »
[Departaments](/ca/recerca/departaments) » Enginyeria de Sistemes,
...
-   [Enginyeria de Serveis i Sistemes
    d\'Informació](/ca/recerca/departaments/enginyeria-de-serveis-i-sistemes-dinformacio)
-   [Enginyeria de Sistemes, Automàtica i Informàtica
    Industrial](/ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-industrial){.active-trail
    .active}
-   [Estadistica i Investigacio
    Operativa](/ca/recerca/departaments/estadistica-i-investigacio-operativa)
-   [Física](/ca/recerca/departaments/fisica)
...
:::: content
::: {#node-16082 .node .node-departament .clearfix}
El Departament d\'Enginyeria de Sistemes, Automàtica i Informàtica
Industrial (ESAII) de la Universitat Politècnica de Catalunya (UPC)
impulsa la recerca i la docència tant els aspectes bàsics com els
d\'aplicació dels àmbits següents:

-   **Robòtica**\
    Dins del camp de la robòtica es treballa en la incorporació de
    sensors i sistemes de percepció per al desenvolupament
    d\'estratègies de control i aplicacions més eficients, més
    intel·ligents o més fiables; en els camps de la robòtica industrial;
    la robòtica mèdica i la robòtica submarina.
-   **Senyals i sistemes biomèdics**\
    El treball en aquesta línia de recerca es realitza en els següents
    temes: estudi dels senyals biomèdics per a la identificació de
    diverses patologies, disseny i desenvolupament de sistemes
    automàtics d\'ajuda al diagnòstic clínic i en la utilització de
    tècniques de modelització i simulació per a la caracterització del
    comportament biològic.
-   **Sistemes avançats de control**\
    Els objectius principals d\'aquesta línia de recerca abasten des del
    desenvolupament de noves tècniques per a la supervisió i diagnòstic
    de falles en temps real, fins el disseny de controladors avançats,
    sistemes de control distribuït i sistemes de control intel·ligent.
-   **Visió per ordinador**\
    Dins de la línia de visió per ordinador es treballa en l\'estudi i
    el desenvolupament d\'algoritmes especialitzats en el tractament
    d\'imatges en temps real per aplicacions industrials específiques i
    el desenvolupament de sistemes de percepció visual.

El departament realitza la seva investigació i transferència de
tecnologia mitjançant els seus [grups de
recerca](http://esaii.upc.edu/ca/recerca/grups-de-recerca).

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
...
[Consulta els càrrecs i membres del departament al directori
UPC.](https://directori.upc.edu/directori/dadesUE.jsp?id=707)
:::
::::
::::::
::::::::
