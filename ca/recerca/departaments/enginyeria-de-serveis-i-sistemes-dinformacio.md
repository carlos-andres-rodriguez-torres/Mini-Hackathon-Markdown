---
description: El Departament d\'Enginyeria de Serveis i Sistemes
  d\'Informació (ESSI) de la Universitat Politècnica de Catalunya (UPC)
  és interdisciplinari, agrupant per una banda la ciència, gestió i
  enginyeria dels serveis (Service Science, Management and Engineering,
  SSME) i per l\'altra les disciplines informàtiques dels sistemes
  d\'informació i tecnologia de la informació. El departament
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Enginyeria de Serveis i Sistemes d\'Informació \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El Departament d\'Enginyeria de Serveis i Sistemes
  d\'Informació (ESSI) de la Universitat Politècnica de Catalunya (UPC)
  és interdisciplinari, agrupant per una banda la ciència, gestió i
  enginyeria
twitter:title: Enginyeria de Serveis i Sistemes d\'Informació
twitter:url: "https://www.fib.upc.edu/ca/recerca/departaments/enginyeria-de-serveis-i-sistemes-dinformacio"
...
::: content
-   [Català](/ca/recerca/departaments/enginyeria-de-serveis-i-sistemes-dinformacio "Enginyeria de Serveis i Sistemes d'Informació"){.language-link
    .active lang="ca"}
-   [English](/en/research/departments/services-and-information-system-engineering "Services and Information System Engineering"){.language-link
    lang="en"}
-   [Español](/es/investigacion/departamentos/ingenieria-de-servicios-y-sistemas-de-informacion "Ingeniería de Servicios y Sistemas de Información"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    -   [Departaments](/ca/recerca/departaments)
        ...
        -   [Enginyeria de Serveis i Sistemes
            d\'Informació](/ca/recerca/departaments/enginyeria-de-serveis-i-sistemes-dinformacio){.active}
...
:::: content
::: page_title_no_sub
# Enginyeria de Serveis i Sistemes d\'Informació {#enginyeria-de-serveis-i-sistemes-dinformació .page_title}
:::
::::
::::::
:::::::
...
[Departaments](/ca/recerca/departaments) » Enginyeria de Serveis i
...
-   [Ciències de la
    Computació](/ca/recerca/departaments/ciencies-de-la-computacio)
-   [Enginyeria de Serveis i Sistemes
    d\'Informació](/ca/recerca/departaments/enginyeria-de-serveis-i-sistemes-dinformacio){.active-trail
    .active}
-   [Enginyeria de Sistemes, Automàtica i Informàtica
    Industrial](/ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-industrial)
-   [Estadistica i Investigacio
...
:::: content
::: {#node-16080 .node .node-departament .clearfix}
El Departament d\'Enginyeria de Serveis i Sistemes d\'Informació (ESSI)
de la Universitat Politècnica de Catalunya (UPC) és interdisciplinari,
agrupant per una banda la ciència, gestió i enginyeria dels serveis
(Service Science, Management and Engineering, SSME) i per l\'altra les
disciplines informàtiques dels sistemes d\'informació i tecnologia de la
informació. El departament posa l\'èmfasi en la part que és comuna a
aquestes disciplines.

Les línies de recerca actuals del departament es desenvolupen a través
dels seus [grups de
recerca](http://www.essi.upc.edu/ca/recerca/grups-de-recerca).
...
UPC.](https://directori.upc.edu/directori/dadesUE.jsp?id=747)
:::
::::
::::::
::::::::
