---
description: El 8 d\'octubre de 2015 es va constituir el Departament de
  Física (DFIS) de la Universitat Politècnica de Catalunya (UPC), fruit
  de la fusió dels anteriors Departaments de Física Aplicada (DFA) i
  Física i Enginyeria Nuclear (DFEN) i els professors de l\'àmbit de
  l\'enginyeria aeroespacial dels campus de Castelldefels i Terrassa. El
  DFIS aplega doncs personal docent i investigador
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Física \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El 8 d\'octubre de 2015 es va constituir el
  Departament de Física (DFIS) de la Universitat Politècnica de
  Catalunya (UPC), fruit de la fusió dels anteriors Departaments de
  Física Aplicada (DFA) i
twitter:title: Física
twitter:url: "https://www.fib.upc.edu/ca/recerca/departaments/fisica"
...
::: content
-   [Català](/ca/recerca/departaments/fisica "Física"){.language-link
    .active lang="ca"}
-   [English](/en/research/departments/physics "Physics"){.language-link
    lang="en"}
-   [Español](/es/investigacion/departamentos/fisica "Física"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    -   [Departaments](/ca/recerca/departaments)
        ...
        -   [Física](/ca/recerca/departaments/fisica){.active}
...
[Departaments](/ca/recerca/departaments) » Física
:::
::::
::::::
:::::::
...
-   [Estadistica i Investigacio
    Operativa](/ca/recerca/departaments/estadistica-i-investigacio-operativa)
-   [Física](/ca/recerca/departaments/fisica){.active-trail .active}
-   [Matemàtiques](/ca/recerca/departaments/matematiques)
-   [Organització
    d\'Empreses](/ca/recerca/departaments/organitzacio-dempreses)
:::
...
:::: content
::: {#node-16086 .node .node-departament .clearfix}
El 8 d\'octubre de 2015 es va constituir el Departament de Física (DFIS)
de la Universitat Politècnica de Catalunya (UPC), fruit de la fusió dels
anteriors Departaments de Física Aplicada (DFA) i Física i Enginyeria
Nuclear (DFEN) i els professors de l\'àmbit de l\'enginyeria
aeroespacial dels campus de Castelldefels i Terrassa.
...
recerca](http://fisica.upc.edu/ca/recerca/grups-de-recerca){.external
target="_blank"}.

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/748)
...
UPC.](https://directori.upc.edu/directori/dadesUE.jsp?id=748)
:::
::::
::::::
::::::::
