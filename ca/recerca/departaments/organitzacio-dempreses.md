---
description: El Departament d'Organització d'Empreses (DOE) de la
  Universitat Politècnica de Catalunya (UPC) es va crear l'any 1986 com
  a resultat de la reorganització de diferents grups d'àrees de
  coneixement vinculades i amb sinergies comunes. El resultat és un
  departament multidisciplinar, amb experts en les àrees de
  l\'enginyeria industrial, economia, ciències empresarials, dret,
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Organització d\'Empreses \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El Departament d'Organització d'Empreses (DOE) de
  la Universitat Politècnica de Catalunya (UPC) es va crear l'any 1986
  com a resultat de la reorganització de diferents grups d'àrees de
  coneixement
twitter:title: Organització d\'Empreses
twitter:url: "https://www.fib.upc.edu/ca/recerca/departaments/organitzacio-dempreses"
...
::: content
-   [Català](/ca/recerca/departaments/organitzacio-dempreses "Organització d'Empreses"){.language-link
    .active lang="ca"}
-   [English](/en/research/departments/management "Management"){.language-link
    lang="en"}
-   [Español](/es/investigacion/departamentos/organizacion-de-empresas "Organización de Empresas"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    -   [Departaments](/ca/recerca/departaments)
        ...
        -   [Organització
            d\'Empreses](/ca/recerca/departaments/organitzacio-dempreses){.active}
    -   [Centres de Recerca](/ca/recerca/centres-de-recerca)
...
:::: content
::: page_title_no_sub
# Organització d\'Empreses {#organització-dempreses .page_title}
:::
::::
::::::
:::::::
...
[Departaments](/ca/recerca/departaments) » Organització d\'Empreses
:::
::::
::::::
:::::::
...
-   [Matemàtiques](/ca/recerca/departaments/matematiques)
-   [Organització
    d\'Empreses](/ca/recerca/departaments/organitzacio-dempreses){.active-trail
    .active}
:::
::::
::::::
...
:::::::: content
::::::: {#node-16085 .node .node-departament .clearfix}
El Departament d'Organització d'Empreses (DOE) de la Universitat
Politècnica de Catalunya (UPC) es va crear l'any 1986 com a resultat de
la reorganització de diferents grups d'àrees de coneixement vinculades i
amb sinergies comunes. El resultat és un departament multidisciplinar,
amb experts en les àrees de l\'enginyeria industrial, economia, ciències
empresarials, dret, informàtica, arquitectura tècnica, entre d'altres.
Aquest fet ens permet està presents en quasi totes les escoles i
facultats de la UPC i participar en totes les titulacions que actualment
s\'imparteixen.
...
Els investigadors del Departament d\'Organització d\'Empreses,
participen majoritàriament en grups com
[EOLI](http://eprints.upc.edu/producciocientifica/grup/176387),
[GIOPACT](http://eprints.upc.edu/producciocientifica/grup/176470),
GREDIC, LEAN MRG,
[CUDU](http://eprints.upc.edu/producciocientifica/grup/9668774){.external-link
target="_self"} i
[OPE](http://eprints.upc.edu/producciocientifica/grup/10954555){.external-link
target="_self"}, tanmateix, d\'altres treballen de manera més
individualitzada.
...
UPC.](https://directori.upc.edu/directori/dadesUE.jsp?id=732)
:::::::
::::::::
::::::::::
::::::::::::
