---
description: "El Departament de Ciències de la Computació (CS) de la
  Universitat Politècnica de Catalunya (UPC) imparteix docència i
  fomenta la recerca en nombroses temàtiques relacionades amb la
  informàtica bàsica i les seves aplicacions: Algorísmia, Programació,
  Gràfics per Computador, Intel.ligència Artificial, Teoria de la
  Computació, Aprenentatge Automàtic, Processament del Llenguatge"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Ciències de la Computació \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: El Departament de Ciències de la Computació (CS) de
  la Universitat Politècnica de Catalunya (UPC) imparteix docència i
  fomenta la recerca en nombroses temàtiques relacionades amb la
  informàtica
twitter:title: Ciències de la Computació
twitter:url: "https://www.fib.upc.edu/ca/recerca/departaments/ciencies-de-la-computacio"
...
::: content
-   [Català](/ca/recerca/departaments/ciencies-de-la-computacio "Ciències de la Computació"){.language-link
    .active lang="ca"}
-   [English](/en/research/departments/computer-science "Computer Science"){.language-link
    lang="en"}
-   [Español](/es/investigacion/departamentos/ciencias-de-la-computacion "Ciencias de la Computación"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    -   [Departaments](/ca/recerca/departaments)
        ...
        -   [Ciències de la
            Computació](/ca/recerca/departaments/ciencies-de-la-computacio){.active}
...
:::: content
::: page_title_no_sub
# Ciències de la Computació {#ciències-de-la-computació .page_title}
:::
::::
::::::
:::::::
...
[Departaments](/ca/recerca/departaments) » Ciències de la Computació
:::
::::
::::::
:::::::
...
-   [Arquitectura de
    Computadors](/ca/recerca/departaments/arquitectura-de-computadors)
-   [Ciències de la
    Computació](/ca/recerca/departaments/ciencies-de-la-computacio){.active-trail
    .active}
-   [Enginyeria de Serveis i Sistemes
    d\'Informació](/ca/recerca/departaments/enginyeria-de-serveis-i-sistemes-dinformacio)
-   [Enginyeria de Sistemes, Automàtica i Informàtica
...
::::::: content
:::::: {#node-16084 .node .node-departament .clearfix}
<div>

El Departament de Ciències de la Computació (CS) de la Universitat
Politècnica de Catalunya (UPC) imparteix docència i fomenta la recerca
en nombroses temàtiques relacionades amb la informàtica bàsica i les
seves aplicacions: Algorísmia, Programació, Gràfics per Computador,
Intel.ligència Artificial, Teoria de la Computació, Aprenentatge
Automàtic, Processament del Llenguatge Natural\....El nucli de les seves
activitats docents es concentra en els programes de grau i màster de la
Facultat d\'Informàtica de Barcelona, però ltambé imparteix classes a
altres escoles de la UPC:
...
La recerca desenvolupada al departament s\'organitza en diversos [grups
de recerca](http://www.cs.upc.edu/research/), que cobreixen diferents
disciplines del camp de les ciències de la computació. Té una presència
activa en les principals conferències de l\'àmbit i una intensa
participació en projectes públics i industrials, així com en la creació
d\'spin-offs.
...
de la UPC: [futur.upc.edu](http://futur.upc.edu/723)
...
UPC.](https://directori.upc.edu/directori/dadesUE.jsp?id=723)
::::::
:::::::
:::::::::
:::::::::::
