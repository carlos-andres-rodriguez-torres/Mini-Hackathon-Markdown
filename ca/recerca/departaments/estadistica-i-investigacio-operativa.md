---
description: El Departament d\'Estadística i Investigació Operativa
  (DEIO) de la Universitat Politècnica de Catalunya (UPC) impulsa la
  recerca i la docència en àmbits molt diversos, com ara l\'enginyeria
  industrial, el desenvolupament d\'interfícies intel·ligents i sistemes
  automàtics de processament de dades, l\'optimització i simulació de
  fluxos en xarxes i aplicacions de tot l\'anterior. El
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Estadística i Investigació Operativa \| Facultat d\'Informàtica
  de Barcelona
twitter:card: summary
twitter:description: El Departament d\'Estadística i Investigació
  Operativa (DEIO) de la Universitat Politècnica de Catalunya (UPC)
  impulsa la recerca i la docència en àmbits molt diversos, com ara
  l\'enginyeria
twitter:title: Estadística i Investigació Operativa
twitter:url: "https://www.fib.upc.edu/ca/recerca/departaments/estadistica-i-investigacio-operativa"
...
::: content
-   [Català](/ca/recerca/departaments/estadistica-i-investigacio-operativa "Estadística i Investigació Operativa"){.language-link
    .active lang="ca"}
-   [English](/en/research/departments/statistics-and-operations-research "Statistics and Operations Research"){.language-link
    lang="en"}
-   [Español](/es/investigacion/departamentos/estadistica-e-investigacion-operativa "Estadística e Investigación Operativa"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    -   [Departaments](/ca/recerca/departaments)
        ...
        -   [Estadistica i Investigacio
            Operativa](/ca/recerca/departaments/estadistica-i-investigacio-operativa){.active}
...
:::: content
::: page_title_no_sub
# Estadística i Investigació Operativa {#estadística-i-investigació-operativa .page_title}
:::
::::
::::::
:::::::
...
[Departaments](/ca/recerca/departaments) » Estadistica i Investigacio
Operativa
:::
::::
::::::
...
-   [Enginyeria de Sistemes, Automàtica i Informàtica
    Industrial](/ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-industrial)
-   [Estadistica i Investigacio
    Operativa](/ca/recerca/departaments/estadistica-i-investigacio-operativa){.active-trail
    .active}
-   [Física](/ca/recerca/departaments/fisica)
-   [Matemàtiques](/ca/recerca/departaments/matematiques)
-   [Organització
...
:::: content
::: {#node-16083 .node .node-departament .clearfix}
El Departament d\'Estadística i Investigació Operativa (DEIO) de la
Universitat Politècnica de Catalunya (UPC) impulsa la recerca i la
docència en àmbits molt diversos, com ara l\'enginyeria industrial, el
desenvolupament d\'interfícies intel·ligents i sistemes automàtics de
processament de dades, l\'optimització i simulació de fluxos en xarxes i
aplicacions de tot l\'anterior.

El departament realitza la seva investigació i transferència de
tecnologia mitjançant els seus [grups de
recerca](http://www.eio.upc.edu/ca/recerca/grups-de-recerca-1){.external
target="_blank"}.

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca
de la UPC: [futur.upc.edu](http://futur.upc.edu/715)
...
UPC.](https://directori.upc.edu/directori/dadesUE.jsp?id=715)
:::
::::
::::::
::::::::
