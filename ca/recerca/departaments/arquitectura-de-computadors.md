---
description: El Departament d\'Arquitectura de Computadors (DAC) de la
  Universitat Politècnica de Catalunya (UPC) imparteix docència i
  fomenta la recerca en temàtiques relacionades amb els àmbits
  d\'Arquitectura de Computadors, Xarxes de Computadors i Sistemes
  Operatius. La recerca desenvolupada al DAC s\'organitza en diversos
  grups de recerca. La seva producció científica es publica a les
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Arquitectura de Computadors \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: El Departament d\'Arquitectura de Computadors (DAC)
  de la Universitat Politècnica de Catalunya (UPC) imparteix docència i
  fomenta la recerca en temàtiques relacionades amb els àmbits
  d\'Arquitectura de
twitter:title: Arquitectura de Computadors
twitter:url: "https://www.fib.upc.edu/ca/recerca/departaments/arquitectura-de-computadors"
...
::: content
-   [Català](/ca/recerca/departaments/arquitectura-de-computadors "Arquitectura de Computadors"){.language-link
    .active lang="ca"}
-   [English](/en/research/departments/computer-architecture "Computer Architecture"){.language-link
    lang="en"}
-   [Español](/es/investigacion/departamentos/arquitectura-de-computadores "Arquitectura de Computadores"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    -   [Departaments](/ca/recerca/departaments)
        -   [Arquitectura de
            Computadors](/ca/recerca/departaments/arquitectura-de-computadors){.active}
        -   [Ciències de la
...
:::: content
::: page_title_no_sub
# Arquitectura de Computadors {#arquitectura-de-computadors .page_title}
:::
::::
::::::
:::::::
...
[Departaments](/ca/recerca/departaments) » Arquitectura de Computadors
:::
::::
::::::
:::::::
...
-   [Arquitectura de
    Computadors](/ca/recerca/departaments/arquitectura-de-computadors){.active-trail
    .active}
-   [Ciències de la
    Computació](/ca/recerca/departaments/ciencies-de-la-computacio)
-   [Enginyeria de Serveis i Sistemes
...
:::: content
::: {#node-16081 .node .node-departament .clearfix}
...
en temàtiques relacionades amb els àmbits d\'Arquitectura de
Computadors, Xarxes de Computadors i Sistemes Operatius.\
La recerca desenvolupada al DAC s\'organitza en diversos [grups de
recerca](http://www.ac.upc.edu/ca/recerca/grups-de-recerca). La seva
producció científica es publica a les conferències i revistes més
importants de la seva àrea de coneixement.
...
UPC.](https://directori.upc.edu/directori/dadesUE.jsp?id=701)
:::
::::
::::::
::::::::
