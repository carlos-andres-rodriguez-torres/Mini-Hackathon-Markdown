---
description: \[column cols=\"8\" begin=\"1\"\] L\'inLab FIB és un
  laboratori d'innovació i recerca de la Facultat d'Informàtica de
  Barcelona de la UPC especialitzat en el desenvolupament de projectes
  R+D+i multidisciplinars en l\'àmbit de les Tecnologies de la
  Informació i de les Comunicacions.\[/column\]\[column cols=\"4\"
  end=\"1\"\]\[/column\] La finalitat d'aquesta tasca és doble. D'una
  banda, innovar i
...
theme-color: "#ffffff"
title: inLab FIB \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[column cols=\"8\" begin=\"1\"\] L\'inLab FIB és
  un laboratori d'innovació i recerca de la Facultat d'Informàtica de
  Barcelona de la UPC especialitzat en el desenvolupament de projectes
  R+D+i
twitter:title: inLab FIB
twitter:url: "https://www.fib.upc.edu/ca/recerca/inlab-fib"
...
::: content
-   [Català](/ca/recerca/inlab-fib "inLab FIB"){.language-link .active
    lang="ca"}
-   [English](/en/research/inlab-fib "inLab FIB"){.language-link
    lang="en"}
-   [Español](/es/investigacion/inlab-fib "inLab FIB"){.language-link
    lang="es"}
:::
:::::
...
-   [Recerca](/ca/recerca)
    ...
    -   [inLab FIB](/ca/recerca/inlab-fib){.active}
-   [Empresa](/ca/empresa)
...
:::: content
::: page_title_no_sub
# inLab FIB {#inlab-fib .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Recerca](/ca/recerca) » inLab FIB
:::
::::
::::::
:::::::
...
-   [Centres de Recerca](/ca/recerca/centres-de-recerca)
-   [Grups de Recerca](/ca/recerca/grups-de-recerca)
-   [inLab FIB](/ca/recerca/inlab-fib){.active-trail .active}
:::
::::
::::::
:::::::
...
:::::::::::::: content
::::::::::::: {#node-16812 .node .node-page .clearfix}
:::::::::::: content
...
L\'[inLab FIB](http://inlab.fib.upc.edu){target="_blank"} és un
laboratori d'innovació i recerca de la Facultat d'Informàtica de
Barcelona de la UPC especialitzat en el desenvolupament de projectes
R+D+i multidisciplinars en l\'àmbit de les Tecnologies de la Informació
i de les Comunicacions.
:::

::: {.col-xs-12 .col-sm-4 .col-md-4 .col-lg-4}
[![](/sites/fib/files/images/fib/logo_inlabfib_pet.png)](http://inlab.fib.upc.edu){target="_blank"}
:::
:::::
...
institucions públiques puguin proporcionar millors serveis a la
societat. De l'altra, el desenvolupament del talent humà dels estudiants
de la FIB en el marc d'un programa de formació integral, el programa
Talent, que complementa la seva formació estrictament acadèmica. 

L'inLab FIB té el reconeixement de centre TECNIO, acreditació que atorga
[ACCIÓ](https://www.accio.gencat.cat/ca/inici/), l'Agència per la
Competitivitat de l'Empresa de la Generalitat de Catalunya, des del
2019. 
...
Les [àrees d\'expertesa de l\'inLab
FIB](https://inlab.fib.upc.edu/ca/arees-expertesa){target="_blank"},
són la Ciència de les Dades i el Big Data; la Mobilitat Intel·ligent;
l'Enginyeria del Coneixement i dels Serveis; la Ciberseguretat; la
Simulació i l'Optimització; i els Entorns TIC de Suport a
l'Aprenentatge.
:::
...
innovadors](http://inlab.fib.upc.edu/ca/projectes){target="_blank"} que
incorpora la formació com objectiu, dins del Programa Talent. Els
estudiants s'integren a equips formats per personal tècnic (PAS) i
professors amb àmplia experiència.

L\'objectiu d\'aquesta formació  és aconseguir, mitjançant les
pràctiques curriculars o extracurriculars dels estudiants, una formació
integral de l\'alumne que complementi la que obté amb el seguiment
ordinari dels estudis.

La [participació de les
empreses](https://inlab.fib.upc.edu/ca/programa-talent#talent-empreses){target="_blank"}
en aquest programa s\'articula a través de l\'esponsorització i
col·laboració en projectes formatius específics orientats a la formació
