...
theme-color: "#ffffff"
title: Crea Proposta de notícia \| Facultat d\'Informàtica de Barcelona
...
::: content
-   [Català](/ca/node/add/proposta-de-noticia){.language-link .active
    lang="ca"}
-   [English](/en/node/add/proposta-de-noticia){.language-link
    lang="en"}
-   [Español](/es/node/add/proposta-de-noticia){.language-link
    lang="es"}
:::
:::::
...
:::: content
::: page_title_no_sub
# Crea Proposta de notícia {#crea-proposta-de-notícia .page_title}
:::
::::
::::::
:::::::
...
::: breadcrumb
[Inici](/ca) » [Afegeix contingut](/ca/node/add) » Proposta de notícia
:::
::::
::::::
:::::::
...
# Crea Proposta de notícia {#page-title .title}
...
Titular [\*]{.form-required title="Aquest camp és obligatori."}
:::

::::::::::: {#edit-field-taxonomia-de-tematica .field-type-taxonomy-term-reference .field-name-field-taxonomia-de-tematica .field-widget-options-buttons .form-wrapper}
:::::::::: {.form-item .form-type-checkboxes .form-item-field-taxonomia-de-tematica-und}
Categoria [\*]{.form-required title="Aquest camp és obligatori."}

:::::::: {#edit-field-taxonomia-de-tematica-und .form-checkboxes}
::: {.form-item .form-type-checkbox .form-item-field-taxonomia-de-tematica-und-61}
Notícies UPC
:::

::: {.form-item .form-type-checkbox .form-item-field-taxonomia-de-tematica-und-8}
Notícies FIB
:::

::: {.form-item .form-type-checkbox .form-item-field-taxonomia-de-tematica-und-15}
Beques
:::

::: {.form-item .form-type-checkbox .form-item-field-taxonomia-de-tematica-und-10}
Conferències
:::

::: {.form-item .form-type-checkbox .form-item-field-taxonomia-de-tematica-und-9}
Concursos
:::
::::::::
...
::::::: {#edit-field-proposta-resum .field-type-text-long .field-name-field-proposta-resum .field-widget-text-textarea .form-wrapper}
:::::: {#field-proposta-resum-add-more-wrapper}
::::: {.form-item .form-type-textarea .form-item-field-proposta-resum-und-0-value}
Resum [\*]{.form-required title="Aquest camp és obligatori."}

::: {.form-textarea-wrapper .resizable}
:::

::: description
Aquest text apareixerà a les pantalles de la FIB, i en el text de la
notícia a la portada.
:::
:::::
::::::
:::::::

:::::::::::: {#edit-body .field-type-text-with-summary .field-name-body .field-widget-text-textarea-with-summary .form-wrapper}
::::::::::: {#body-add-more-wrapper}
:::::::::: text-format-wrapper
::: text-summary-wrapper
:::

:::: {.form-item .form-type-textarea .form-item-body-und-0-value}
Contingut [\*]{.form-required title="Aquest camp és obligatori."}
...
editor](javascript:void(0);){#switch_edit-body-und-0-value
.ckeditor_links style="display:none"
onclick="javascript:Drupal.ckeditorToggle(['edit-body-und-0-value','edit-body-und-0-summary'],'Switch to plain text editor','Switch to rich text editor');"}

:::::: fieldset-wrapper
::: {#edit-body-und-0-format-help .filter-help .form-wrapper}
[Més informació sobre els formats de
text](/ca/filter/tips){target="_blank"}
:::

:::: {#edit-body-und-0-format-guidelines .filter-guidelines .form-wrapper}
::: {.filter-guidelines-item .filter-guidelines-plain_text}
### Plain text

-   Etiquetes HTML permeses: \<a\> \<em\> \<strong\> \<cite\>
...
::::: {#edit-field-title .field-type-text .field-name-field-title .field-widget-text-textfield .form-wrapper}
:::: {#field-title-add-more-wrapper}
::: {.form-item .form-type-textfield .form-item-field-title-und-0-value}
Title
:::
::::
:::::

:::::: {#edit-field-summary .field-type-text-long .field-name-field-summary .field-widget-text-textarea .form-wrapper}
::::: {#field-summary-add-more-wrapper}
:::: {.form-item .form-type-textarea .form-item-field-summary-und-0-value}
Summary
...
:::::::::::: {#edit-field-content .field-type-text-with-summary .field-name-field-content .field-widget-text-textarea-with-summary .form-wrapper}
::::::::::: {#field-content-add-more-wrapper}
:::::::::: text-format-wrapper
::: text-summary-wrapper
:::

:::: {.form-item .form-type-textarea .form-item-field-content-und-0-value}
Content
...
[Switch to plain text
editor](javascript:void(0);){#switch_edit-field-content-und-0-value
.ckeditor_links style="display:none"
onclick="javascript:Drupal.ckeditorToggle(['edit-field-content-und-0-value','edit-field-content-und-0-summary'],'Switch to plain text editor','Switch to rich text editor');"}

:::::: fieldset-wrapper
::: {#edit-field-content-und-0-format-help .filter-help .form-wrapper}
[Més informació sobre els formats de
text](/ca/filter/tips){target="_blank"}
:::

:::: {#edit-field-content-und-0-format-guidelines .filter-guidelines .form-wrapper}
::: {.filter-guidelines-item .filter-guidelines-plain_text}
### Plain text
...
::::: {#edit-field-t-tulo .field-type-text .field-name-field-t-tulo .field-widget-text-textfield .form-wrapper}
:::: {#field-t-tulo-add-more-wrapper}
::: {.form-item .form-type-textfield .form-item-field-t-tulo-und-0-value}
Título
:::
::::
:::::

:::::: {#edit-field-resumen .field-type-text-long .field-name-field-resumen .field-widget-text-textarea .form-wrapper}
::::: {#field-resumen-add-more-wrapper}
:::: {.form-item .form-type-textarea .form-item-field-resumen-und-0-value}
Resumen
...
:::::::::::: {#edit-field-contenido .field-type-text-with-summary .field-name-field-contenido .field-widget-text-textarea-with-summary .form-wrapper}
::::::::::: {#field-contenido-add-more-wrapper}
:::::::::: text-format-wrapper
::: text-summary-wrapper
:::

:::: {.form-item .form-type-textarea .form-item-field-contenido-und-0-value}
Contenido
...
[Switch to plain text
editor](javascript:void(0);){#switch_edit-field-contenido-und-0-value
.ckeditor_links style="display:none"
onclick="javascript:Drupal.ckeditorToggle(['edit-field-contenido-und-0-value','edit-field-contenido-und-0-summary'],'Switch to plain text editor','Switch to rich text editor');"}

:::::: fieldset-wrapper
::: {#edit-field-contenido-und-0-format-help .filter-help .form-wrapper}
[Més informació sobre els formats de
text](/ca/filter/tips){target="_blank"}
:::

:::: {#edit-field-contenido-und-0-format-guidelines .filter-guidelines .form-wrapper}
::: {.filter-guidelines-item .filter-guidelines-plain_text}
### Plain text
...
:::::::: {#edit-field-image .field-type-image .field-name-field-image .field-widget-image-image .form-wrapper}
::::::: {#edit-field-image-und-0-ajax-wrapper}
:::::: {.form-item .form-type-managed-file .form-item-field-image-und-0}
Imatge [\*]{.form-required title="Aquest camp és obligatori."}
...
::: description
L\'imatge es mostrarà a mida 480x270 si podeu proporcionar imatges amb
aquesta proporció molt millor. Gràcies\
Els fitxers han de ser de menys de **512 KB**.\
...
:::::: {#edit-field-contacte-e-mail .field-type-text .field-name-field-contacte-e-mail .field-widget-text-textfield .form-wrapper}
::::: {#field-contacte-e-mail-add-more-wrapper}
:::: {.form-item .form-type-textfield .form-item-field-contacte-e-mail-und-0-value}
E-mail [\*]{.form-required title="Aquest camp és obligatori."}

::: description
Deixa\'ns el teu correu per si ens hem de posar en contacte amb tu.
Gràcies.
:::
::::
:::::
...
## Pestanyes verticals {#pestanyes-verticals .element-invisible}
