...
description: "Comissió d\\'Avaluació Curricular d\\'Assignatures
  Obligatòries de 2n i 3r del grau en Bioinformàtica Aquesta comissió
  actua en l'àmbit de l'avaluació del rendiment acadèmic en la fase
  corresponent de l'estudiantat del grau en Bioinformàtica. Composició
  d\\'aquesta comissió: El cap o la cap d\\'Estudis del grau El cap o la
...
theme-color: "#ffffff"
title: CACOBBI \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Comissió d\'Avaluació Curricular d\'Assignatures
  Obligatòries de 2n i 3r del grau en Bioinformàtica Aquesta comissió
  actua en l'àmbit de l'avaluació del rendiment acadèmic en la fase
  corresponent de
twitter:title: CACOBBI
twitter:url: "https://www.fib.upc.edu/ca/la-fib/la-facultat/govern/cacobbi"
...
::: content
-   [Català](/ca/la-fib/la-facultat/govern/cacobbi){.language-link
    .active lang="ca"}
...
-   [La FIB](/ca/la-fib)
    -   [La Facultat](/ca/la-fib/la-facultat)
        ...
        -   [Govern](/ca/la-fib/la-facultat/govern)
            ...
            -   [CACOBBI](/ca/la-fib/la-facultat/govern/cacobbi){.active}
...
[Govern](/ca/la-fib/la-facultat/govern) » CACOBBI
:::
::::
::::::
:::::::
...
-   [CACFBBI](/ca/la-fib/la-facultat/govern/cacfbbi)
-   [CACFIBBI](/ca/la-fib/la-facultat/govern/cacfibbi)
-   [CACOBBI](/ca/la-fib/la-facultat/govern/cacobbi){.active-trail
    .active}
-   [CCABBI](/ca/la-fib/la-facultat/govern/ccabbi)
:::
::::
...
:::::::: content
::::::: {#node-24118 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
## Comissió d\'Avaluació Curricular d\'Assignatures Obligatòries de 2n i 3r del grau en Bioinformàtica

Aquesta comissió actua en l'àmbit de l'avaluació del rendiment acadèmic
en la fase corresponent de l'estudiantat del grau en Bioinformàtica.
...
-   Programació Aplicada III (AP3)
-   Bioestadística i Anàlisi de Dades (BDA)
-   Bases de Dades (BD)
-   Matemàtica Discreta i Optimització (DMO)
-   Genètica i Genòmica (GG)
-   Algorismes en Biologia (AB)
-   Visualització de Dades (DV)
-   Biologia de Sistemes i Xarxes (NSB)
-   Fisiologia i Neurobiologia (PN)
-   Models Estadístics i Processos Estocàstics (SMSP)
-   Algorismes i Estructures de Dades (ADS)
-   Biofísica (BP)
-   Genòmica Computacional (CG)
-   Genètica de Poblacions i Evolució Molecular (PGME)
-   Aprenentatge Estadístic (SL)
-   Computació d\'Alt Rendiment (HPC)
-   Aprenentatge Automàtic (ML)
-   Tècniques Òmiques (OT)
-   Filogenòmica i Genòmica Comparativa (PCG)
-   Bioinformàtica Estructural (SB)
:::
::::
:::::
::::::
