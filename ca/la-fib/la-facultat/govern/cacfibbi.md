...
description: "Comissió d\\'Avaluació Curricular de la Fase Inicial del
  grau en Bioinformàtica Aquesta comissió actua en l\\'àmbit de
  l\\'avaluació del rendiment acadèmic en la Fase Inicial de
  l'estudiantat del grau en Bioinformàtica (BBI). Composició d\\'aquesta
  comissió: El cap o la cap d\\'Estudis del grau El cap o la cap de la
  Unitat de Gestió d\\'Estudis de Grau i Màster de la FIB o la persona
  que"
...
theme-color: "#ffffff"
title: CACFIBBI \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Comissió d\'Avaluació Curricular de la Fase Inicial
  del grau en Bioinformàtica Aquesta comissió actua en l\'àmbit de
  l\'avaluació del rendiment acadèmic en la Fase Inicial de
  l'estudiantat del grau en
twitter:title: CACFIBBI
twitter:url: "https://www.fib.upc.edu/ca/la-fib/la-facultat/govern/cacfibbi"
...
::: content
-   [Català](/ca/la-fib/la-facultat/govern/cacfibbi "CACFIBBI"){.language-link
    .active lang="ca"}
-   [English]{.language-link .locale-untranslated lang="en"}
-   [Español](/es/la-fib/la-facultad/gobierno/cacfibbi "CACFIBBI"){.language-link
    lang="es"}
:::
:::::
...
-   [La FIB](/ca/la-fib)
    -   [La Facultat](/ca/la-fib/la-facultat)
        ...
        -   [Govern](/ca/la-fib/la-facultat/govern)
            ...
            -   [CACFIBBI](/ca/la-fib/la-facultat/govern/cacfibbi){.active}
...
[Govern](/ca/la-fib/la-facultat/govern) » CACFIBBI
:::
::::
::::::
:::::::
...
-   [Sessions](/ca/la-fib/la-facultat/govern/sessions)
-   [CACFBBI](/ca/la-fib/la-facultat/govern/cacfbbi)
-   [CACFIBBI](/ca/la-fib/la-facultat/govern/cacfibbi){.active-trail
    .active}
-   [CACOBBI](/ca/la-fib/la-facultat/govern/cacobbi)
-   [CCABBI](/ca/la-fib/la-facultat/govern/ccabbi)
:::
...
:::::::: content
::::::: {#node-24117 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
## Comissió d\'Avaluació Curricular de la Fase Inicial del grau en Bioinformàtica

Aquesta comissió actua en l\'àmbit de l\'avaluació del rendiment
acadèmic en la Fase Inicial de l'estudiantat del grau en Bioinformàtica
(BBI).

Composició d\'aquesta comissió:

1.  El cap o la cap d\'Estudis del grau
...
3.  El professorat responsable de les assignatures del bloc. 
4.  Un representant de l\'estudiantat nomenat pel cap o la cap d'Estudis
    del grau a proposta de la Comissió de Coordinació Acadèmica del BBI
    (CCABBI) entre els delegats de les assignatures de 2n que hagi
    superat la fase inicial.

## Composició 

-   **Cap d\'Estudis:** Marta Casanellas
...
Responsables de les assignatures que hi ha a continuació o en la persona
en qui delegui.

-   Àlgebra (ALG)
-   Programació Aplicada I (AP1)
-   Biologia Cel·lular (CB)
-   Introducció a la Bioinformàtica (IB)
-   Fisicoquímica i Química Orgànica (POC)
-   Programació Aplicada II (AP2)
-   Bioquímica (BC)
-   Càlcul (CAL)
-   Arquitectura de Computadors i Sistemes Operatius (CAOS)
-   Biologia Molecular (MB)
:::
::::
:::::
::::::
