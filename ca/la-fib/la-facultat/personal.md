---
description: La gestió i els serveis interns de la FIB dins de l\'entorn
  de la Unitat Transversal de Gestió de l\'àmbit TIC al Campus Nord
  (UTGCNTIC) tenen com a missió respondre amb polivalència davant de les
  demandes dels usuaris i de mantenir els estàndars de qualitat en el
  servei.
...
theme-color: "#ffffff"
title: Personal \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: La gestió i els serveis interns de la FIB dins de
  l\'entorn de la Unitat Transversal de Gestió de l\'àmbit TIC al Campus
  Nord (UTGCNTIC) tenen com a missió respondre amb polivalència davant
  de les
twitter:title: Personal
twitter:url: "https://www.fib.upc.edu/ca/la-fib/la-facultat/personal"
...
::: content
-   [Català](/ca/la-fib/la-facultat/personal "Personal"){.language-link
    .active lang="ca"}
-   [English](/en/fib/school/staff "Staff"){.language-link lang="en"}
-   [Español](/es/la-fib/la-facultad/personal "Personal"){.language-link
    lang="es"}
:::
:::::
...
-   [La FIB](/ca/la-fib)
    -   [La Facultat](/ca/la-fib/la-facultat)
        ...
        -   [Personal](/ca/la-fib/la-facultat/personal){.active}
        -   [Premis i
            Reconeixements](/ca/la-fib/la-facultat/premis-i-reconeixements)
        -   [Actes Acadèmics](/ca/la-fib/la-facultat/actes-academics)
        -   [Publicacions](/ca/la-fib/la-facultat/publicacions)
...
Facultat](/ca/la-fib/la-facultat) » Personal
:::
::::
::::::
:::::::
...
-   [On som?](/ca/la-fib/la-facultat/som)
-   [Govern](/ca/la-fib/la-facultat/govern)
-   [Personal](/ca/la-fib/la-facultat/personal){.active-trail .active}
-   [Premis i
    Reconeixements](/ca/la-fib/la-facultat/premis-i-reconeixements)
-   [Actes Acadèmics](/ca/la-fib/la-facultat/actes-academics)
-   [Publicacions](/ca/la-fib/la-facultat/publicacions)
...
::::::::::: content
:::::::::: {#node-96 .node .node-page .clearfix}
::::::::: content
:::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
::::::: field-items
:::::: {.field-item .even}
La gestió i els serveis interns de la FIB dins de l\'entorn de la
[Unitat Transversal de Gestió de l\'àmbit TIC al Campus
Nord](https://utgcntic.upc.edu/ca) (UTGCNTIC) tenen com a missió
respondre amb polivalència davant de les demandes dels usuaris i de
mantenir els estàndars de qualitat en el servei.

::::: row
::: {.col-xs-12 .col-sm-8 .col-md-8 .col-lg-8}
[![](/sites/fib/files/images/fib/serveis-tic/utgcntic-positiu-p3005.png){style="width: 300px; height: 80px;"}](https://utgcntic.upc.edu/ca)

**Unitats que donen servei exclusiu a la FIB**

-   [Unitat de Gestió d\'estudis de grau i màster
    FIB](https://utgcntic.upc.edu/ca/estructura/unitat-gestio-estudis-grau-master-fib)
-   [Unitat de Suport institucional i relacions externes
    FIB](https://utgcntic.upc.edu/ca/estructura/unitat-suport-institucional-relacions-externes-fib)

**Unitats transversals que donen servei a la FIB i a altres unitats
acadèmiques i de recerca de la UTG**

-   [Unitat de Serveis
    TIC](https://utgcntic.upc.edu/ca/estructura/unitat-serveis-tic) 
-   [Unitat de Recursos i
    serveis](https://utgcntic.upc.edu/ca/estructura/unitat-recursos-serveis)
:::

::: {.col-xs-12 .col-sm-4 .col-md-4 .col-lg-4}
[![](/sites/fib/files/images/fib/logo_inlabfib_pet.png){style="height: 80px; width: 229px;"}](http://inlab.fib.upc.edu){target="_blank"}

[Personal inLab
FIB](https://inlab.fib.upc.edu/comunitat/#Equip_Comunitat)
:::
:::::
::::::
:::::::
