---
description: Actes de graduació \[column cols=\"8\" begin=\"1\"\] La
  Facultat organitza anualment els actes de graduació dels i de les
  estudiants que cada curs finalitzen els seus estudis de grau o màster.
  La cerimònia consisteix en un acte solemne, que presideix el degà de
  la FIB, en què intervé un/a conferenciant i es demana a algun/a
  estudiant que participi com a representant de la promoció
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Actes Acadèmics \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Actes de graduació \[column cols=\"8\"
  begin=\"1\"\] La Facultat organitza anualment els actes de graduació
  dels i de les estudiants que cada curs finalitzen els seus estudis de
  grau o màster. La cerimònia
twitter:title: Actes Acadèmics
twitter:url: "https://www.fib.upc.edu/ca/la-fib/la-facultat/actes-academics"
...
::: content
-   [Català](/ca/la-fib/la-facultat/actes-academics "Actes Acadèmics"){.language-link
    .active lang="ca"}
-   [English](/en/fib/school/graduation-ceremony "Graduation Ceremony"){.language-link
    lang="en"}
-   [Español](/es/la-fib/la-facultad/actos-academicos "Actos Académicos"){.language-link
    lang="es"}
:::
:::::
...
-   [La FIB](/ca/la-fib)
    -   [La Facultat](/ca/la-fib/la-facultat)
        ...
        -   [Premis i
            Reconeixements](/ca/la-fib/la-facultat/premis-i-reconeixements)
        -   [Actes
            Acadèmics](/ca/la-fib/la-facultat/actes-academics){.active}
        -   [Publicacions](/ca/la-fib/la-facultat/publicacions)
...
:::: content
::: page_title_no_sub
# Actes Acadèmics {#actes-acadèmics .page_title}
:::
::::
::::::
:::::::
...
Facultat](/ca/la-fib/la-facultat) » Actes Acadèmics
:::
::::
::::::
:::::::
...
::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::: {#node-17827 .node .node-page .clearfix}
::::::::::::::::::::::::::: content
...
La cerimònia consisteix en un acte solemne, que presideix el degà de la
FIB, en què intervé un/a conferenciant i es demana a algun/a estudiant
que participi com a representant de la promoció que es gradua o titula.
L\'estudiantat assistent rep, com a record, un diploma simbòlic emès per
la Facultat, que commemora la finalització dels seus estudis. 
...
:::: {.node .node-esdeveniment .node-teaser .contextual-links-region .view-mode-teaser .clearfix}
### Acte de graduació del Grau en Enginyeria Informàtica 2024

-     **Divendres 15 i 22 de novembre (a escollir) **

-     18h a 20h

-     Auditori Vèrtex, Campus Nord UPC

-    Període d\'inscripció: **del 21 d\'octubre al 3 de novembre de 2024
    mitjançant l\'aplicació
    [Apunta\'t](https://apuntat.utgcntic.upc.edu/) **\
    *(la inscripció per a cada sessió es tancarà un cop s'arribi al
    límit de l'aforament de la sala)*

-    Nombre màxim d'acompanyants: 2

-    Import de l\'entrada:
    -   Estudiantat i PDI/PTGAS: 0 €
    -   Acompanyants: 8 €

-    **Requisits d\'inscripció a l\'acte**:

    -   Haver obtingut el títol del GEI en el curs 2023-2024, o bé,
    -   Tenir ja tots els crèdits matriculats per acabar la carrera en
        el curs 2023-2024, o
    -   Tenir pendent de reconèixer els crèdits de mobilitat i/o
        convenis de pràctiques acadèmiques per acabar el grau, o
    -   Tenir només pendent d\'acreditar la Tercera Llengua\
        **Important**:\
        Si has acabat els estudis, però tens pagaments pendents, no
        t\'hi pots inscriure\
        Si tens crèdits matriculats el curs 2024-2025, et correspon
        participar en l\'acte de graduació del l\'any 2025.

::: {.alert .alert-info}
**Entrega de premis**\
El premi al millor expedient del GEI es lliurarà en l\'acte del dia 15
de novembre i el premi FIB Alumni al millor TFG es lliurarà en l\'acte
del dia 22 de novembre. Si us plau, tingues-ho en compte en el moment de
fer la inscripció en cas de tenir opcions d\'optar a algun d\'aquests
premis. 
:::

Contacta amb []{#CaXOzGufN rel="nofollow"}
...
### [Abans de l\'acte](#abans) {#abans-de-lacte .box-title}
...
### [Durant l\'acte](#durant) {#durant-lacte .box-title}
...
### [Després de l\'acte](#despres) {#després-de-lacte .box-title}
...
### []{#abans}Abans de l\'acte

::: {.alert .alert-info}
#### **Qui pot participar**

-   S\'informarà prèviament a totes aquelles persones que compleixin el
    requisits per participar de l\'Acte. La comunicació es farà per
    email al correu d'estudiant UPC.
-   En el cas de no rebre el missatge, però penseu que reuniu els
    requisits per participar-hi, s'ha de contactar amb []{#CTgpQhNJv
    rel="nofollow"}
    \
     
...
-   La inscripció s\'ha de fer a través de l\'aplicació
    [**Apunta\'t**](https://apuntat.utgcntic.upc.edu/). L\'estudiantat
    haurà d\'omplir les seves dades i també les dels i de les
    acompanyants.
-   L'aplicació només mostrarà l\'esdeveniment a l\'estudiantat que
    compleixi els requisits, i per tant, es podrà inscriure.
-   En el cas de mobilitat reduïda o necessitats especials es pot
    indicar a la mateixa aplicació.\
     

#### **Acompanyants**

-   L\'assistència d\'acompanyants dependrà de l\'aforament de què
    disposem, i s\'infomarà a la mateixa inscripció.
-   Durant el període d'inscripció a l'acte, es podran fer canvis en el
    nom dels acompanyants a la mateixa aplicació
    [**Apunta\'t**](https://apuntat.utgcntic.upc.edu/).

#### **Pagament **

-   L\'import de l\'entrada s\'indicarà en la informació del propi acte.
-   En el moment de fer la inscripció dels acompanyants, s\'haurà de fer
    el pagament a través de l\'aplicació
    [**Apunta\'t**](https://apuntat.utgcntic.upc.edu/), mitjançant
    targeta bancària.
-   Els menors de fins a 3 anys i que no ocupin un seient durant l\'Acte
    de Graduació, no han de comprar entrada.\
     

#### **[]{#politica-devolucio}Política de devolucions**

En cas d\'anul·lació de l\'entrada, per sol·licitar la devolució de
l\'import, es farà des de la mateixa aplicació
[**Apunta\'t**](https://apuntat.utgcntic.upc.edu/) mentre estigui obert
el període d'inscripció. L\'import es retornarà a través de la mateixa
targeta bancària amb que s\'ha fet la compra.
...
-   No es demana vestuari específic però per regla general els
    assistents van vestits de manera elegant i cuidada. 

   
:::

### []{#durant}Durant l\'acte

::: {.alert .alert-info}
L\'acte té una durada aproximada de dues hores que pot variar segons el
nombre d\'assistents.\
 

#### **Arribada**

-   L\'estudiantat que ha confirmat assistència serà convocat via email
    com a màxim un dia abans de l'acte. 
-   Per agilitzar el procés de registre, es recomana tenir preparada
    l'entrada (impresa en paper, o descarregada al mòbil).\
     

#### **On seuran els i les estudiants**

-   Una vegada tancat el període d\'inscripció, s'assignarà un seient a
    cada estudiant titulat/ada. Es podrà consultar el lloc assignat 24
    hores abans de l'acte a la mateixa aplicació
    [**Apunta\'t**](https://apuntat.utgcntic.upc.edu/) i en el moment de
    fer el registre el dia de l\'acte.

#### **On seuran els i les acompanyants**

-   Les persones acompanyants seuran als espais reservats a tal efecte.
    No tindràn un seient assignat.\
     

#### **Desenvolupament de l\'acte**

-   Quan accediu a la sala, trobareu al vostre seient la beca (banda) de
    la FIB que us haureu de posar abans de seure. 
-   S\'inicia l\'acte amb els parlaments de les personalitats.
-   A continuació es procedeix a lliurar les distincions als millors
    expedients i altres acreditacions.
-   Després us cridaran per ordre alfabètic i pujareu a l\'escenari en
    ordre de crida pel costat dret mirant l'escenari i us dirigireu a la
    personalitat que us hagin assignat, que us lliurarà  un
    **diploma\***. Us girareu cap el públic i esperareu a que el
    fotògraf us facin la foto de grup. Després tornareu als vostres
    seients baixant de l\'escenari pel costat contrari al que heu
    pujat. 
-   Finalitza l'acte amb unes paraules de cloenda del rector o la
    persona en qui delegui.\
     

***\* El diploma que es lliura no té cap validesa legal i en cap cas
substitueix el títol oficial. El títol oficial s\'ha de sol·licitar
via**
[**e-secretaria**](/ca/estudis/secretaria/tramits/sollicitud-del-titol-i-suplement-europeu-al-titol){rel="noopener nofollow noreferrer"
target="_blank"}.*
...
-   La Facultat d\'Informàtica de Barcelona podrà utilitzar la imatge de
    tots els assistents a l\'acte. L\'assistència comporta l\'acceptació
    de l\'ús de la imatge.\
     
:::

### []{#despres}Després de l\'acte

::: {.alert .alert-info}
#### **Imatges de l\'acte**

-   Uns dies després de l\'acte, l'estudiant rebrà un correu electrònic
    amb les instruccions per poder consultar i descarregar les
    fotografies oficials realitzades durant l\'esdeveniment.\
     

#### **Photocall **

-   S\'intentarà habilitar una zona de photocall per tal que pugueu
    fer-vos fotos amb els vostres companys i companyes.\
    Si les pugeu a les xarxes socials, mencioneu-nos (@fib.upc) i les
    compartirem al perfil de la FIB.
:::
