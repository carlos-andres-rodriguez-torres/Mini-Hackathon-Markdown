---
description: La Biblioteca Rector Gabriel Ferraté (BRGF) és un espai
  comú a les tres escoles del Campus Nord de la UPC on hi podeu trobar
  practicament tots els llibres de la bibliografia de les assignatures
  de la FIB, uns espais per estudiar i per treballar en grup en els
  seguents horaris. La BRGF és una de les biblioteques més importants
  del sud d'Europa en els camps científics i
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Biblioteca Rector Gabriel Ferraté \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: La Biblioteca Rector Gabriel Ferraté (BRGF) és un
  espai comú a les tres escoles del Campus Nord de la UPC on hi podeu
  trobar practicament tots els llibres de la bibliografia de les
  assignatures de la
twitter:title: Biblioteca Rector Gabriel Ferraté
twitter:url: "https://www.fib.upc.edu/ca/la-fib/espais/biblioteca-rector-gabriel-ferrate"
...
::: content
-   [Català](/ca/la-fib/espais/biblioteca-rector-gabriel-ferrate "Biblioteca Rector Gabriel Ferraté"){.language-link
    .active lang="ca"}
-   [English](/en/fib/rooms/rector-gabriel-ferrate-library "Rector Gabriel Ferraté Library"){.language-link
    lang="en"}
-   [Español](/es/la-fib/espacios/biblioteca-rector-gabriel-ferrate "Biblioteca Rector Gabriel Ferraté"){.language-link
    lang="es"}
:::
:::::
...
-   [La FIB](/ca/la-fib)
    ...
    -   [Espais](/ca/la-fib/espais)
        ...
        -   [Biblioteca Rector Gabriel
            Ferraté](/ca/la-fib/espais/biblioteca-rector-gabriel-ferrate){.active}
...
:::: content
::: page_title_no_sub
# Biblioteca Rector Gabriel Ferraté {#biblioteca-rector-gabriel-ferraté .page_title}
:::
::::
::::::
:::::::
...
-   [Biblioteca Rector Gabriel
    Ferraté](/ca/la-fib/espais/biblioteca-rector-gabriel-ferrate){.active-trail
    .active}
:::
::::
::::::
...
:::::::: content
::::::: {#node-17519 .node .node-page .clearfix}
:::::: content
...
escoles del Campus Nord de la UPC on hi podeu trobar practicament tots
els llibres de la bibliografia de les assignatures de la FIB,  uns
espais per estudiar i per treballar en grup en els seguents
[**horaris**](http://bibliotecnica.upc.edu/horaris).

La BRGF és una de les biblioteques més importants del sud d'Europa en
els camps científics i tecnològics que li són propis i que té com a
principals serveis els que es detallen a continuació.

-   [**Sales de treball en
    grup**](http://bibliotecnica.upc.edu/brgf/serveis/espais#sales-treball-grup-reserva-previa)\
    La BRGF posa a disposició dels seus usuaris 21 sales per a l\'estudi
    o pel treball col·lectiu. Són sales equipades amb pissarres i
    pantalles on connectar els ordinadors de treball.

<!-- -->

-   [**Préstec de
    documents**](http://bibliotecnica.upc.edu/estudiants/prestec-documents)\
    A la BRGF es poden demanar en préstec tot tipus de documents tant
    científico-tècnics com de col·leccions humanistes. A més, des de la
    mateixa biblioteca es pot accedir al préstec de documents de la
    resta de biblioteques de la UPC i als de les altres universitats
    catalanes i internacionals.

<!-- -->

-   [**Préstec de portàtils i altres
    equipaments**](http://bibliotecnica.upc.edu/brgf/serveis/equipaments)\
    A la BRGF no es presten només llibres i documents audiovisuals sinó
    també equipaments tecnològics d'ús massiu per part dels estudiants,
    especialment ordinadors portàtils.

<!-- -->

-   [**u-win**](http://bibliotecnica.upc.edu/brgf/serveis/espais#u-win)\
    u-win és un espai físic i virtual dedicat al món del
    videojoc\"\>u-win és un espai físic i virtual de la BRGF que està
    dedicat al món dels videojocs, especialment els produïts a la UPC.

Una oferta molt més àmplia de serveis de la BRGF es pot consultar des de
[la pàgina web de la
biblioteca](http://bibliotecnica.upc.edu/brgf){target="_blank"}.
:::
::::
:::::
::::::
