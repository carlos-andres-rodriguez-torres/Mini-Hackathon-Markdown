---
description: Sala situada a a planta 1 de l\'edifici B6. Ideal per fer
  reunions i amb un servei de videoconferència disponible tant per la
  comunitat universitària com per persones sense vinculació amb la UPC.
  Aquesta sala està preparada per fer videoconferències. Capacitat 8
  persones Equipament Equip fix de videoconferencia. Reproductor de DVD.
  Ordinador. Televisor de pantalla plana LCD de
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Sala de reunions \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Sala situada a a planta 1 de l\'edifici B6. Ideal
  per fer reunions i amb un servei de videoconferència disponible tant
  per la comunitat universitària com per persones sense vinculació amb
  la UPC.
twitter:title: Sala de reunions
twitter:url: "https://www.fib.upc.edu/ca/la-fib/espais/sales-de-presentacions/sala-de-reunions"
...
::: content
-   [Català](/ca/la-fib/espais/sales-de-presentacions/sala-de-reunions "Sala de reunions"){.language-link
    .active lang="ca"}
-   [English](/en/fib/rooms/presentation-rooms/conference-room "Conference Room"){.language-link
    lang="en"}
-   [Español](/es/la-fib/espacios/salas-de-presentaciones/sala-de-reuniones "Sala de reuniones"){.language-link
    lang="es"}
:::
:::::
...
-   [La FIB](/ca/la-fib)
    ...
    -   [Espais](/ca/la-fib/espais)
        ...
        -   [Sales de
            ...
            -   [Sala de
                reunions](/ca/la-fib/espais/sales-de-presentacions/sala-de-reunions){.active}
        -   [Biblioteca Rector Gabriel
            Ferraté](/ca/la-fib/espais/biblioteca-rector-gabriel-ferrate)
...
:::: content
::: page_title_no_sub
# Sala de reunions {#sala-de-reunions .page_title}
:::
::::
::::::
:::::::
...
-   [Sala de
    juntes](/ca/la-fib/espais/sales-de-presentacions/sala-de-juntes)
-   [Sala de
    reunions](/ca/la-fib/espais/sales-de-presentacions/sala-de-reunions){.active-trail
    .active}
:::
::::
::::::
...
:::::::::::: content
::::::::::: {#node-16353 .node .node-sala .node-promoted .clearfix}
:::::::::: content
::::: {.field .field-name-field-imatge .field-type-image .field-label-hidden}
:::: field-items
::: {.field-item .even}
![](https://www.fib.upc.edu/sites/fib/files/sala-reunions_0_0.jpg){width="1701"
height="426"}
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
Sala situada a a planta 1 de l\'edifici B6. Ideal per fer reunions i amb
un servei de videoconferència disponible tant per la comunitat
universitària com per persones sense vinculació amb la UPC.

Aquesta sala està preparada per fer videoconferències.
...
-   Equip fix de
    [videoconferencia](/ca/la-fib/serveis-tic/videoconferencia).
-   Reproductor de DVD.
-   Ordinador.
-   Televisor de pantalla plana LCD de 48'' per utilitzar com a element
    de sortida de la videoconferència, ordinador i portàtil.
...
::: {#horari2433b6664aefff2bd2cc0c7db29f8ce6 .taula_url_horari}
:::
::::::::::
:::::::::::
::::::::::::
