---
description: "Aquesta sala està situada a la planta 0 de l\\'edifici B6.
  Es ideal per fer conferències, seminaris i presentacions. Està
  preparada per donar el servei MediaFib de gravació i emisió
  d\\'esdeveniments. Capacitat 87 persones Equipament Videoprojector
  lluminós resolució WUXGA 1920x1200, amb pantalla de projecció
  motoritzada, panoràmica i relació d\\'aspecte 16:10. Ordinador
  personal"
...
theme-color: "#ffffff"
title: Sala d\'actes Manuel Martí Recober \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: Aquesta sala està situada a la planta 0 de
  l\'edifici B6. Es ideal per fer conferències, seminaris i
  presentacions. Està preparada per donar el servei MediaFib de gravació
  i emisió d\'esdeveniments.
twitter:title: Sala d\'actes Manuel Martí Recober
twitter:url: "https://www.fib.upc.edu/ca/la-fib/espais/sales-de-presentacions/sala-dactes"
...
::: content
-   [Català](/ca/la-fib/espais/sales-de-presentacions/sala-dactes "Sala d'actes Manuel Martí Recober"){.language-link
    .active lang="ca"}
-   [English](/en/fib/rooms/presentation-rooms/auditorium "Auditorium Manuel Martí Recober"){.language-link
    lang="en"}
-   [Español](/es/la-fib/espacios/salas-de-presentaciones/sala-de-actos "Sala de actos Manuel Martí Recober"){.language-link
    lang="es"}
:::
:::::
    ...
    -   [Espais](/ca/la-fib/espais)
        ...
        -   [Sales de
            ...
            -   [Sala d\'actes Manuel Martí
                Recober](/ca/la-fib/espais/sales-de-presentacions/sala-dactes){.active}
            -   [Sala de
...
:::: content
::: page_title_no_sub
# Sala d\'actes Manuel Martí Recober {#sala-dactes-manuel-martí-recober .page_title}
:::
::::
::::::
:::::::
...
-   [Sala d\'actes Manuel Martí
    Recober](/ca/la-fib/espais/sales-de-presentacions/sala-dactes){.active-trail
    .active}
-   [Sala de
    juntes](/ca/la-fib/espais/sales-de-presentacions/sala-de-juntes)
-   [Sala de
...
:::::::::::: content
::::::::::: {#node-16351 .node .node-sala .node-promoted .clearfix}
:::::::::: content
::::: {.field .field-name-field-imatge .field-type-image .field-label-hidden}
:::: field-items
::: {.field-item .even}
![](https://www.fib.upc.edu/sites/fib/files/actes.jpg){width="1701"
height="426"}
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
Aquesta sala està situada a la planta 0 de l\'edifici B6. Es ideal per
fer conferències, seminaris i presentacions. Està preparada per donar el
servei
[MediaFib](/ca/la-fib/serveis-tic/mediafib-arxius-de-video-i-esdeveniments-en-directe)
de gravació i emisió d\'esdeveniments.
...
-   Videoprojector lluminós resolució WUXGA 1920x1200, amb pantalla de
    projecció motoritzada, panoràmica i relació d\'aspecte 16:10.
-   Ordinador personal amb DVD, connexions USB, accés a Internet i
    capacitat per fer Skype o videoconferències web amb les càmeres de
    la sala.
-   Taula presidencial amb 6 cadires, microfonia, 2 monitors laterals,
    connexions HDMI i VGA+audio per a portàtils. Botonera que facilita
    la interacció del ponent amb el control audiovisual de la sala.
-   Wifi.
-   Sistema audiovisual amb càmeres (presidència i públic) que permet la
    realització i fer PiP (composició de la presentació i la imatge del
    ponent).
-   Sistema de gravació local i emissió per streaming a Youtube.
-   Microfonia sense fils de mà i solapa.
-   Diferents escenes d\'il·luminació (cinema, presentació, conferencia,
    \...).
:::
::::
:::::

::: {#horaric75ff0800e3e9050e21de528a3b4d127 .taula_url_horari}
:::
::::::::::
:::::::::::
::::::::::::
