---
description: Aquesta sala està situada a la planta 1 de l\'edifici B6.
  És una sala polivalent, on es poden posar i treure taules i
  distribuir-les segons l\'esdeveniment. Capacitat 28 persones
  aproximadament. Equipament Videoprojector lluminós resolució màxima
  1920 x 1200 píxels que admet FullHD (1920 x 1080), amb pantalla de
  projecció motoritzada. Ordinador personal amb DVD, connexions USB i
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Sala de juntes \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Aquesta sala està situada a la planta 1 de
  l\'edifici B6. És una sala polivalent, on es poden posar i treure
  taules i distribuir-les segons l\'esdeveniment. Capacitat 28 persones
  aproximadament.
twitter:title: Sala de juntes
twitter:url: "https://www.fib.upc.edu/ca/la-fib/espais/sales-de-presentacions/sala-de-juntes"
...
::: content
-   [Català](/ca/la-fib/espais/sales-de-presentacions/sala-de-juntes "Sala de juntes"){.language-link
    .active lang="ca"}
-   [English](/en/fib/rooms/presentation-rooms/boardroom "Boardroom"){.language-link
    lang="en"}
-   [Español](/es/la-fib/espacios/salas-de-presentaciones/sala-de-juntas "Sala de juntas"){.language-link
    lang="es"}
:::
:::::
...
-   [La FIB](/ca/la-fib)
    ...
    -   [Espais](/ca/la-fib/espais)
        ...
        -   [Sales de
            ...
            -   [Sala de
                juntes](/ca/la-fib/espais/sales-de-presentacions/sala-de-juntes){.active}
            -   [Sala de
...
:::: content
::: page_title_no_sub
# Sala de juntes {#sala-de-juntes .page_title}
:::
::::
::::::
:::::::
...
-   [Sala d\'actes Manuel Martí
    Recober](/ca/la-fib/espais/sales-de-presentacions/sala-dactes)
-   [Sala de
    juntes](/ca/la-fib/espais/sales-de-presentacions/sala-de-juntes){.active-trail
    .active}
-   [Sala de
    reunions](/ca/la-fib/espais/sales-de-presentacions/sala-de-reunions)
:::
...
:::::::::::: content
::::::::::: {#node-16352 .node .node-sala .node-promoted .clearfix}
:::::::::: content
::::: {.field .field-name-field-imatge .field-type-image .field-label-hidden}
:::: field-items
::: {.field-item .even}
![](https://www.fib.upc.edu/sites/fib/files/sala-juntes.jpg){width="1701"
height="426"}
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
Aquesta sala està situada a la planta 1 de l\'edifici B6. És una sala
polivalent, on es poden posar i treure taules i distribuir-les segons
l\'esdeveniment.

**Capacitat**

28 persones aproximadament.

**Equipament**

-   Videoprojector lluminós resolució màxima 1920 x 1200 píxels que
    admet FullHD (1920 x 1080), amb pantalla de projecció motoritzada.
-   Ordinador personal amb DVD, connexions USB i accés a Internet.
-   Pantalla plana de 23 polsades connectada a l\'ordinador que permet
    veure les notes d\'una presentació usant el projector com a
    escriptori estès.
-   Connexió HDMI i VGA per a portàtils en el moble multimedia. Connexió
    VGA addicional al lateral esquerra de la sala.
-   Wifi.
:::
::::
:::::

::: {#horaribef5e12257d4a201b23361a4cb61c053 .taula_url_horari}
:::
::::::::::
:::::::::::
::::::::::::
