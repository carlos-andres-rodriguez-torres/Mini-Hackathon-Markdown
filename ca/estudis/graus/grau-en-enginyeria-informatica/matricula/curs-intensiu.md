---
description: La facultat ofereix un curs intensiu gratuït de repàs de
  Física i Matemàtiques durant el mes de juliol amb un nombre limitat de
  places. El curs es desenvoluparà durant cinc dies, amb dues hores de
  Física i tres hores de Matemàtiques diàries. L\'objectiu del curs és
  repassar i reforçar alguns aspectes d\'aquestes matèries importants
  per al seguiment dels estudis de grau en
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Curs intensiu \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: La facultat ofereix un curs intensiu gratuït de
  repàs de Física i Matemàtiques durant el mes de juliol amb un nombre
  limitat de places. El curs es desenvoluparà durant cinc dies, amb dues
  hores de
twitter:title: Curs intensiu
twitter:url: "https://www.fib.upc.edu/ca/estudis/graus/grau-en-enginyeria-informatica/matricula/curs-intensiu"
    ...
    -   [Graus](/ca/estudis/graus)
        ...
        -   [Grau en Enginyeria
            ...
            -   [Matrícula](/ca/estudis/graus/grau-en-enginyeria-informatica/matricula)
                -   [Curs
                    intensiu](/ca/estudis/graus/grau-en-enginyeria-informatica/matricula/curs-intensiu){.active}
                -   [Places
                    lliures](/ca/estudis/graus/grau-en-enginyeria-informatica/matricula/places-lliures)
            -   [Pla
...
:::: content
::: page_title_no_sub
# Curs intensiu {#curs-intensiu .page_title}
:::
::::
::::::
:::::::
...
-   [Curs
    intensiu](/ca/estudis/graus/grau-en-enginyeria-informatica/matricula/curs-intensiu){.active-trail
    .active}
-   [Places
    lliures](/ca/estudis/graus/grau-en-enginyeria-informatica/matricula/places-lliures)
:::
...
:::::::::::::::::: content
::::::::::::::::: {#node-17608 .node .node-page .clearfix}
:::::::::::::::: content
::::::::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::::::::::::: field-items
::::::::::::: {.field-item .even}
La facultat ofereix un curs intensiu gratuït de repàs de Física i
Matemàtiques durant el mes de juliol amb un nombre limitat de places. El
curs es desenvoluparà durant cinc dies, amb dues hores de Física i tres
hores de Matemàtiques diàries.\
\
L\'objectiu del curs és repassar i reforçar alguns aspectes d\'aquestes
matèries importants per al seguiment dels estudis de grau en Enginyeria
Informàtica.

:::::::::::: {#dexp-accordions-wrapper-1740088464 .panel-group .default}
:::::: {.panel .panel-default}
::: panel-heading
#### [Programa de Física](#dexp-accordion-item-1740088464){.collapsed parent="#dexp-accordions-wrapper-1740088464" toggle="collapse"} {#programa-de-física .panel-title}
:::

:::: {#dexp-accordion-item-1740088464 .panel-collapse .collapse}
::: panel-body
1.  Introducció a les interaccions elèctriques: força, camp i potencial
    elèctric, intensitat de corrent.
2.  Conceptes bàsics de conducció de corrent: llei d'Ohm, resistència,
    cas d'un fil recte.
3.  Circuits de corrent continu. Lleis de Kirchhoff. Circuit equivalent
    de Thévenin. Aplicacions.
4.  Introducció a l'Electrònica de l'Estat Sòlid: estructura
    electrònica, semiconductors intrínsecs i extrínsecs, dopatge.
...
::::::: {.panel .panel-default}
::: panel-heading
#### [Programa de Matemàtiques](#dexp-accordion-item-1740088464--2){.collapsed parent="#dexp-accordions-wrapper-1740088464" toggle="collapse"} {#programa-de-matemàtiques .panel-title}
:::

::::: {#dexp-accordion-item-1740088464--2 .panel-collapse .collapse}
:::: panel-body
1.  Les assignatures obligatòries de matemàtiques al GEI; l\'assignatura
    de FM (primer quadrimestre) i les matemàtiques al batxillerat.
2.  El mètode deductiu, l\'argumentació. Enunciats, proposicions i
    inferències.
3.  Enunciats simples i compostos (llenguatge natural). La negació, la
    conjunció i el bicondicional.
4.  Diferents disjuncions i diferents condicionals. La disjunció
    inclusiva i el condicional filònic.
5.  Conceptes de condició necessària i condició suficient.
6.  El càlcul proposicional formal: llenguatge, fórmules ben
    construïdes, tautologies, contradiccions i fórmules contingents.
7.  Proposicions equivalents, equivalències importants.
8.  Insuficiència de la lògica de proposicions, lògica de predicats.
    Quantificadors.
9.  Llenguatge del càlcul de predicats. Variables lliures.
10. Demostracions proposicionals. Prova directa i per reducció a
    l\'absurd, raonament per casos.
11. La implicació. Tècniques per a demostrar que un enunciat implica un
    altre (demostració directa, per contrarecíproc, per reducció a
    l\'absurd).
12. Equivalència de dues o més proposicions.
13. Raonaments amb quantificadors.
14. Visió intuïtiva dels conjunts. Comparació entre la grandària de dos
    conjunts.
15. Conjunts infinits numerables i no numerables. Mètode de la diagonal
    de Cantor per provar que l\'interval real \[0,1\] no és numerable.

El curs està dirigit principalment a estudiants de nou accés amb algunes
mancances en aquestes matèries i que estiguin disposats a assistir a les
classes i seguir les directrius dels professors del curs.

### Edició 2024

::: {style="border-style: solid; border-width: 2px; border-color: #21C2F8; padding: 9px 9px;"}
La **inscripció** al curs es farà **fins al 24 de juliol de 2024 a les
12 h** a través del formulari que trobaràs a la pàgina
web [matrícula](/ca/estudis/graus/grau-en-enginyeria-informatica/matricula)
a l\'apartat \'Estudiants de nou ingrés a primer curs\'. Entra, posa el
teu DNI al formulari i t\'indicarà dia i hora de matrícula. A més et
preguntarà si et vols inscriure al curs intensiu. Les places són
limitades.

-   **Dates de realització del curs:** Del 2 al 6 de setembre de 2024
-   **Horari:** de 9.00 a 14.00 h.
-   **Lloc:** aula A4204 del** **Campus Nord de la UPC
:::

Us adjuntem uns tests de Matemàtiques i Física amb continguts de
batxillerat per a que pugueu avaluar la necessitat de fer aquest curs.

-   [Enunciat Test de
    Física](/sites/fib/files/documents/estudis/curs-intensiu-autotest-fisica.pdf)
    (30.4 KB)
-   [Enunciat Test de
    Matemàtiques](/sites/fib/files/documents/estudis/curs-intensiu-autotest-mates.pdf)
    (75.5 KB)
-   [Solucions Test de
    Física](/sites/fib/files/documents/estudis/curs-intensiu-autotest-fisica-solucions.pdf)
    (8.4 KB)
-   [Solucions Test de
    Matemàtiques](/sites/fib/files/documents/estudis/curs-intensiu-autotest-mates-solucions.pdf)
    (70.1 KB)
