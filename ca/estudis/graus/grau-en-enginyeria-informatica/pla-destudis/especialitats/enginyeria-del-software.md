...
description: Coordinador Professorat d\'especialitat Competències
  tècniques Assignatures Capacita per participar en projectes de
  desenvolupament, manteniment i avaluació de serveis i sistemes
  software de natura diversa. La participació pot ser amb diversos rols,
  com director de projecte, analista, expert de domini, enginyer de
  requisits, arquitecte del software, administrador de bases de
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Enginyeria del Software \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Coordinador Professorat d\'especialitat
  Competències tècniques Assignatures Capacita per participar en
  projectes de desenvolupament, manteniment i avaluació de serveis i
  sistemes software de natura
twitter:title: Enginyeria del Software
twitter:url: "https://www.fib.upc.edu/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/enginyeria-del-software"
            ...
            -   [Pla
                ...
                -   [Especialitats](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats)
                    ...
                    -   [Enginyeria de
                        Computadors](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/enginyeria-de-computadors)
                    -   [Enginyeria del
                        Software](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/enginyeria-del-software){.active}
                    -   [Sistemes
                        d'Informació](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/sistemes-dinformacio)
                    -   [Tecnologies de la
                        informació](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/tecnologies-de-la-informacio)
...
:::: content
::: page_title_no_sub
# Enginyeria del Software {#enginyeria-del-software .page_title}
:::
::::
::::::
:::::::
...
-   [Enginyeria de
    Computadors](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/enginyeria-de-computadors)
-   [Enginyeria del
    Software](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/enginyeria-del-software){.active-trail
    .active}
-   [Sistemes
    d'Informació](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/especialitats/sistemes-dinformacio)
-   [Tecnologies de la
...
::::::::::::::: content
:::::::::::::: {#node-3031 .node .node-page .clearfix}
::::::::::::: content
...
Capacita per participar en projectes de desenvolupament, manteniment i
avaluació de serveis i sistemes software de natura diversa. La
participació pot ser amb diversos rols, com director de projecte,
analista, expert de domini, enginyer de requisits, arquitecte del
software, administrador de bases de dades, i un llarg etcètera. Els
projectes poden ser de complexitat arbitrària (per exemple, involucrant
equips de diversos països), de criticitat màxima (amb responsabilitats
que poden fins i tot fer dependre vides humanes del seu correcte
funcionament) i de natura tècnica diversa (sistemes basats en serveis,
sistemes web, sistemes en temps real, sistemes encastats, sistemes
empresarials, etc.). Com a tret diferencial, capacita per assegurar que
aquests projectes compliran criteris de qualitat reconeguts i actuals en
la disciplina; seran desenvolupats amb rigor màxim i usant coneixement
molt divers; i tindran cura d'aspectes socials com ara la
sostenibilitat, la gestió òptima de recursos i la privacitat.
...
El software continua sent una part nuclear dels sistemes informàtics. A
més, en els darrers anys ha passat a ser la part fonamental dels serveis
que s\'ofereixen a persones i a organitzacions. De fet, es parla
actualment de software com a servei (\"software as a service\"). El
sector dels serveis, en sentit ampli, és l\'element central de les
economies desenvolupades, i el sector de major creixement econòmic, i
avui dia es fa difícil parlar de serveis sense parlar del software que,
en la major part dels casos, els sustenta.\
Per aquest motiu, un/a Enginyer/a Informàtic/a especialista en
Enginyeria del Software té sortides molt diverses en la societat actual.
L'especialitat capacita per ocupar llocs de responsabilitat en:

-   Desenvolupament de serveis i sistemes software aplicant els mètodes,
    les tècniques i les eines de l\'enginyeria del software i,
    concretament, els que són més actuals.
-   Qualsevol dels rols professionals habituals associats a la
    disciplina: enginyer de requisits, arquitecte del software,
    administrador de bases de dades, etc.
-   Avaluació de les organitzacions pel que fa als processos
    d\'enginyeria del software, així com el disseny i la implantació de
    plans de millora de la gestió i de la qualitat.

::: {.alert .alert-info}
**Coordinador de peticions director/ponent de TFG i TFM: Carles Farré
([]{#CtyeQvGPX rel="nofollow"}**
...
## Coordinador d\'especialitat {#coordinador}
  ...
  ----------------------------------------------------------- -------------- -------------------------------
  [Franch Gutiérrez, Xavier](https://futur.upc.edu/1000296)   ESSI           []{#XmhkvbPDq rel="nofollow"}

## Professorat d\'especialitat {#professors}

  Persona                                                              Departamento   Correo electrónico
  -------------------------------------------------------------------- -------------- -------------------------------
  [Abello Gamazo, Alberto](https://futur.upc.edu/1003711)              ESSI           []{#LsQFJDrlC rel="nofollow"}
  [Alier Forment, Marc](https://futur.upc.edu/1003732)                 ESSI           []{#LrjEIYcad rel="nofollow"}
  Asenjo Carvajal, Víctor                                              ESSI           []{#ECvjtNUxT rel="nofollow"}
  [Ayala Martinez, Claudia Patricia](https://futur.upc.edu/1106701)    ESSI           []{#YvHUgePdu rel="nofollow"}
  [Béjar Alonso, Javier](https://futur.upc.edu/1001970)                CS             []{#teciCDpKo rel="nofollow"}
  Beltran Andreu, Jose Luis                                            ESSI           []{#JrYocVuQG rel="nofollow"}
  [Burgués Illa, Xavier](https://futur.upc.edu/1000602)                ESSI           []{#PlcTSACmx rel="nofollow"}
  Catot Bragós, Carlota                                                ESSI           []{#vMTzjiRpJ rel="nofollow"}
  [Costal Costa, Dolors](https://futur.upc.edu/1000445)                ESSI           []{#yiAPEvJKI rel="nofollow"}
  [Delgado Pin, Jordi](https://futur.upc.edu/1002732)                  CS             []{#qmpwtTcxB rel="nofollow"}
  Duran Manzano, Pau                                                   ESSI           []{#XzoGEyCfr rel="nofollow"}
  [Escudero Bakx, Gerard](https://futur.upc.edu/1003059)               CS             []{#bAMaHxovU rel="nofollow"}
  [Farre Tost, Carles](https://futur.upc.edu/1002901)                  ESSI           []{#FcGrAezip rel="nofollow"}
  [Fonseca Casas, Pau](https://futur.upc.edu/1003388)                  EIO            []{#PXUwZeNKS rel="nofollow"}
  [Franch Gutiérrez, Xavier](https://futur.upc.edu/1000296)            ESSI           []{#fdszacmPB rel="nofollow"}
  García Carrasco, Víctor                                              EIO            []{#ISHDjLlpM rel="nofollow"}
  [Garcia Subirana, Joan](https://futur.upc.edu/1054152)               EIO            []{#LFCeEufPJ rel="nofollow"}
  [Gil Gomez, Marisa](https://futur.upc.edu/1000177)                   AC             []{#QMxoVqmbB rel="nofollow"}
  [Gómez Seoane, Cristina](https://futur.upc.edu/1002544)              ESSI           []{#DiHzJWufw rel="nofollow"}
  [Lapuente Ferran, Raimon](https://futur.upc.edu/1055350)             ESSI           []{#zdAgHTnBU rel="nofollow"}
  [Martínez Fernández, Silverio Juan](https://futur.upc.edu/1152237)   ESSI           []{#DokdvLTAz rel="nofollow"}
  Martínez Martínez, Matías Sebastián                                  ESSI           []{#PSOXVUEob rel="nofollow"}
  Maynou Yelamos, Marc                                                 ESSI           []{#rNyXCOMdz rel="nofollow"}
  Morales Garcia, Sergio                                               ESSI           []{#YyPGZKJHN rel="nofollow"}
  Motger de la Encarnacion, Quim                                       ESSI           []{#gvbhSXMKw rel="nofollow"}
  [Oriol Hilari, Marc](https://futur.upc.edu/1054670)                  ESSI           []{#wuGiXBmHy rel="nofollow"}
  Paredes Sigüenza, Sergio                                             ESSI           []{#SdqhjHTFz rel="nofollow"}
  Picornell Alandete, Vicent                                           ESSI           []{#mAQwKUnqZ rel="nofollow"}
  Pinto Gil, Albert                                                    ESSI           []{#gBOZqPaYt rel="nofollow"}
  [Queralt Calafat, Anna](https://futur.upc.edu/1004203)               ESSI           []{#QdLvegtcM rel="nofollow"}
  Ramirez Perez, Inmaculada                                            ESSI           []{#oJAgLvkfS rel="nofollow"}
  Rello Saltor, Manuel                                                 ESSI           []{#CNjAlroug rel="nofollow"}
  [Renom Vilaro, Albert](https://futur.upc.edu/1002894)                ESSI           []{#PgVQeauEt rel="nofollow"}
  [Romero Moral, Oscar](https://futur.upc.edu/1004787)                 ESSI           []{#JEHqwfDxl rel="nofollow"}
  Rubio Quintana, Àlex                                                 ESSI           []{#hWjILbdef rel="nofollow"}
  [Sancho Samso, Maria Ribera](https://futur.upc.edu/1000424)          ESSI           []{#sHrQLCKuf rel="nofollow"}
  [Teniente Lopez, Ernest](https://futur.upc.edu/1000345)              ESSI           []{#ZbKCuetFc rel="nofollow"}
...
-   [**CES1**\
    Desenvolupar, mantenir i avaluar serveis i sistemes software que
    satisfacin tots els requisits de l\'usuari, que es comportin de
    forma fiable i eficient, que tinguin un desenvolupament i un
    manteniment assequible i que compleixin normes de qualitat aplicant
    les teories, els principis, els mètodes i les pràctiques
    d\'Enginyeria del Software.]{#CES1}
    -   [**CES1.1**\
        Desenvolupar, mantenir i avaluar sistemes i serveis software
        complexos i/o crítics.]{#CES1_1}
    -   [**CES1.2**\
        Donar solució a problemes d\'integració en funció de les
        estratègies, dels estàndards i de les tecnologies
        disponibles.]{#CES1_2}
    -   [**CES1.3**\
        Identificar, avaluar i gestionar els riscos potencials associats
        a la construcció de software que es poguessin
        presentar.]{#CES1_3}
    -   [**CES1.4**\
        Desenvolupar, mantenir i avaluar serveis i aplicacions
        distribuïdes amb suport de xarxa.]{#CES1_4}
    -   [**CES1.5**\
        Especificar, dissenyar, implementar i avaluar bases de
        dades.]{#CES1_5}
    -   [**CES1.6**\
        Administrar bases de dades (CIS4.3)]{#CES1_6}
    -   [**CES1.7**\
        Controlar la qualitat i dissenyar proves en la producció de
        software.]{#CES1_7}
    -   [**CES1.8**\
        Desenvolupar, mantenir i avaluar sistemes de control i de temps
        real.]{#CES1_8}
    -   [**CES1.9**\
        Demostrar comprensió en la gestió i govern dels sistemes
        software.]{#CES1_9}
-   [**CES2**\
    Valorar les necessitats del client i especificar els requisits
    software per a satisfer aquestes necessitats, reconciliant objectius
    en conflicte mitjançant la cerca de compromisos acceptables, dintre
    de les limitacions derivades del cost, del temps, de l\'existència
    de sistemes ja desenvolupats i de les organitzacions.]{#CES2}
    -   [**CES2.1**\
        Definir i gestionar els requisits d\'un sistema
        software.]{#CES2_1}
    -   [**CES2.2**\
        Dissenyar solucions apropiades en un o més dominis d\'aplicació,
        utilitzant mètodes d\'enginyeria del software que integrin
        aspectes ètics, socials, legals i econòmics.]{#CES2_2}
-   [**CES3**\
    Identificar i analitzar problemes; dissenyar, desenvolupar,
    implementar, verificar i documentar solucions software sobre la base
    d\'un coneixement adient de les teories, dels models i de les
    tècniques actuals.]{#CES3}
    -   [**CES3.1**\
        Desenvolupar serveis i aplicacions multimèdia.]{#CES3_1}
    -   [**CES3.2**\
        Dissenyar i gestionar un magatzem de dades (data
        warehouse).]{#CES3_2}
:::
...
::: item-list
-   [Arquitectura del Software](../assignatures/AS) (AS)

    ::: item-list
    -   Prerequisit: IES - Introducció a l\'Enginyeria del Software
    :::
-   [Aplicacions i Serveis Web](../assignatures/ASW) (ASW)

    ::: item-list
    -   Prerequisit: AS - Arquitectura del Software
    :::
-   [Disseny de Bases de Dades](../assignatures/DBD) (DBD)

    ::: item-list
    -   Prerequisit: BD - Bases de Dades
    -   Precorequisit: IES - Introducció a l\'Enginyeria del Software
    :::
-   [Enginyeria de Requisits](../assignatures/ER) (ER)

    ::: item-list
    -   Prerequisit: EEE - Empresa i Entorn Econòmic
    -   Prerequisit: IES - Introducció a l\'Enginyeria del Software
    :::
-   [Gestió de Projectes de Software](../assignatures/GPS) (GPS)

    ::: item-list
    -   Prerequisit: EEE - Empresa i Entorn Econòmic
    -   Prerequisit: IES - Introducció a l\'Enginyeria del Software
    :::
-   [Projecte d\'Enginyeria del Software](../assignatures/PES) (PES)

    ::: item-list
    -   Prerequisit: AS - Arquitectura del Software
    -   Prerequisit: ER - Enginyeria de Requisits
    -   Prerequisit: GPS - Gestió de Projectes de Software
    :::
:::
...
::: item-list
-   [Conceptes Avançats de Programació](../assignatures/CAP) (CAP)

    ::: item-list
    -   Prerequisit: IES - Introducció a l\'Enginyeria del Software
    -   Prerequisit: PROP - Projectes de Programació
    :::
-   [Conceptes per a Bases de Dades
    Especialitzades](../assignatures/CBDE) (CBDE)

    ::: item-list
    -   Prerequisit: BD - Bases de Dades
    -   Precorequisit: IES - Introducció a l\'Enginyeria del Software
    :::
-   [Conceptes de Sistemes d\'Informació](../assignatures/CSI) (CSI)

    ::: item-list
    -   Prerequisit: BD - Bases de Dades
    -   Prerequisit: EEE - Empresa i Entorn Econòmic
    :::
-   [Enginyeria del Coneixement i Sistemes Distribuïts
    Intel·ligents](../assignatures/ECSDI) (ECSDI)

    ::: item-list
    -   Prerequisit: AS - Arquitectura del Software
    :::
-   [Simulació](../assignatures/SIM) (SIM)

    ::: item-list
    -   Prerequisit: PE - Probabilitat i Estadística
    :::
-   [Sistemes Operatius per a Aplicacions
    Distribuïdes](../assignatures/SOAD) (SOAD)

    ::: item-list
    -   Precorequisit: PAR - Paral·lelisme
    -   Prerequisit: SO - Sistemes Operatius
    :::
:::

\
\
![](/sites/fib/files/images/estudis/requisits_espe_engsoft_ca.png)
::::::::::
:::::::::::
::::::::::::
:::::::::::::
