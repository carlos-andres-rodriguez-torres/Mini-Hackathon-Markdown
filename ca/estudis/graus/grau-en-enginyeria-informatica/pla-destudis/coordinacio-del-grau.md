---
description: "Per realitzar una adequada gestió del pla d'estudis de
  Grau en Enginyeria Informàtica de la FIB, s'han definit diversos
  models de coordinació establerts a diferents nivells: Coordinació
  (responsable) d'assignatura Coordinació horitzontal (de curs)
  Coordinació vertical (de matèria i d'especialitat) Coordinació
  transversal Coordinació d\\'assignatura Existeix un coordinador per a"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Coordinació del Grau \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: "Per realitzar una adequada gestió del pla
  d'estudis de Grau en Enginyeria Informàtica de la FIB, s'han definit
  diversos models de coordinació establerts a diferents nivells:
  Coordinació (responsable)"
twitter:title: Coordinació del Grau
twitter:url: "https://www.fib.upc.edu/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/coordinacio-del-grau"
...
::: content
-   [Català](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/coordinacio-del-grau "Coordinació del Grau"){.language-link
    .active lang="ca"}
-   [English]{.language-link .locale-untranslated lang="en"}
-   [Español](/es/estudios/grados/grado-en-ingenieria-informatica/plan-de-estudios/coordinacion-del-grado "Coordinación del Grado"){.language-link
    lang="es"}
:::
:::::
        ...
        -   [Grau en Enginyeria
            ...
            -   [Pla
                ...
                -   [Mapes
                    competencials](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/mapes-competencials)
                -   [Coordinació del
                    Grau](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/coordinacio-del-grau){.active}
            -   [Professorat](/ca/estudis/graus/grau-en-enginyeria-informatica/professorat)
            -   [Normativa
                acadèmica](/ca/estudis/graus/grau-en-enginyeria-informatica/normativa-academica)
            -   [Treball de Fi de
...
:::: content
::: page_title_no_sub
# Coordinació del Grau {#coordinació-del-grau .page_title}
:::
::::
::::::
:::::::
...
-   [Mapes
    competencials](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/mapes-competencials)
-   [Coordinació del
    Grau](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/coordinacio-del-grau){.active-trail
    .active}
:::
::::
::::::
...
::::::::: content
:::::::: {#node-17990 .node .node-page .clearfix}
::::::: content
:::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
::::: field-items
:::: {.field-item .even}
Per realitzar una adequada gestió del pla d'estudis de Grau en
Enginyeria Informàtica de la FIB, s'han definit diversos models de
coordinació establerts a diferents nivells: 

-   [Coordinació (responsable) d'assignatura](#coordinacio-assignatura)
-   [Coordinació horitzontal (de curs)](#coordinacio-horitzontal)
-   [Coordinació vertical (de matèria i
    d'especialitat)](#coordinacio-vertical)
-   [Coordinació transversal](#coordinacio-transversal)

## []{#coordinacio-assignatura}Coordinació d\'assignatura

Existeix un coordinador per a cada assignatura, el nom del qual es pot
consultar a la guia docent de cada assignatura.

[Funcions del responsable
d\'assignatura](/sites/fib/files/documents/estudis/coordinaciograu-normativaprofessoratresponsable.pdf) (69.1
KB)

## []{#coordinacio-horitzontal}Coordinació horitzontal

Per gestionar que la càrrega de les distintes assignatures que pot
matricular un estudiant estigui repartida d'una manera uniforme all
llarg del curs, s'ha definit la coordinació horitzontal. Les
assignatures considerades en cada curs i el nom del seu coordinador
horitzontal són:
...
-   La coordinació horitzontal de **cada especialitat** la realitza el
    coordinador vertical d\'especialitat

[Funcions del coordinador
horitzontal](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/funcions-dels-coordinadors#Coord-horitzontal)

## []{#coordinacio-vertical}Coordinació vertical

Convé que les assignatures de la mateixa matèria que treballen el mateix
conjunt de competències es coordinin entre si, per a la qual cosa
existeix la figura del coordinador de matèria. En el cas de les
assignatures obligatòries, aquesta coordinació es denomina **coordinació
vertical de matèria**; en el cas dels crèdits de tecnologia específica,
es denomina **coordinació vertical d\'especialitat**.\
\
Els coordinadors de matèria i d'especialitat es reuneixen periòdicament
(presencialment o virtual) amb els professors de la matèria/especialitat
per garantir que les competències assignades a la matèria/especialitat
estiguin ben repartides i es treballin de forma apropiada entre les
assignatures. També elaboren un informe anual per al cap d'estudis de la
FIB, coordinador responsable de tot el pla d'estudis.\
\
S'han definit 5 matèries distintes en el conjunt d'assignatures
obligatòries del pla d'estudis. Les assignatures de cada matèria i el
nom del seu coordinador es detallen a continuació:
...
[Funcions del coordinador vertical de
matèria](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/funcions-dels-coordinadors#CoordV-materia)

Pel que fa als crèdits de tecnologia específica, s'han agrupat en cinc
especialitats, cada una amb un coordinador responsable de distribuir-ne
les competències de forma adequada entre les seves assignatures:
...
-   ​Especialitat: **Enginyeria de Computadors**
    ...
    -   Assignatures complementàries: CASO, PDS, STR, CPD, PCA, VLSI,
        PAP
...
[Funcions del coordinador vertical
d\'especialitat](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/funcions-dels-coordinadors#CoordV-especialitat)

## []{#coordinacio-transversal}Coordinació transversal

Finalment, les competències transversals mereixen una coordinació a
part, que es denomina coordinació transversal. La FIB ha definit 9
competències transversals: les 7 competències comunes de la UPC més dues
competències pròpies. Citem a continuació el nom del coordinador de cada
una de les competències transversals:
...
[Funcions del coordinador
transversal](/ca/estudis/graus/grau-en-enginyeria-informatica/pla-destudis/funcions-dels-coordinadors#Coord-Transversal)

Els coordinadors transversals es reuneixen periòdicament per elaborar
estratègies conjuntes per treballar les competències transversals en les
diferents assignatures del pla d'estudis. Fermín Sánchez, adjunt al degà
en Innovació supervisa les reunions que tenen lloc un cop al mes. 

Els coordinadors de matèria, d'especialitat i transversals es reuneixen
un cop l'any amb els dos caps d'estudis i el adjunt al degà en
Innovació. El responsable final de la coordinació és el cap d'estudis de
la FIB.

Els diferents coordinadors del pla d'estudis són responsables de
proporcionar a la Comissió de Qualitat de la FIB tota la informació que
necessita per realitzar la seva feina.
