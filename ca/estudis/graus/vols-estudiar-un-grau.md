---
description: \[column cols=\"7\" begin=\"1\"\] Grau en Enginyeria
  Informàtica T\'apassionen les Noves Tecnologies i vols aprendre com
  crear i innovar amb elles? La Facultat d\'Informàtica de Barcelona és
  un dels centres pioner a l'Estat espanyol en impartir els estudis
  universitaris en informàtica. T\'expliquem tot el què cal saber del
  Grau en Enginyeria Informàtica de la FIB a la web I love bits.
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Vols estudiar un grau? \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: \[column cols=\"7\" begin=\"1\"\] Grau en
  Enginyeria Informàtica T\'apassionen les Noves Tecnologies i vols
  aprendre com crear i innovar amb elles? La Facultat d\'Informàtica de
  Barcelona és un dels centres
twitter:title: Vols estudiar un grau?
twitter:url: "https://www.fib.upc.edu/ca/estudis/graus/vols-estudiar-un-grau"
...
-   [Estudis](/ca/estudis)
    -   [Graus](/ca/estudis/graus)
        -   [Vols estudiar un
            grau?](/ca/estudis/graus/vols-estudiar-un-grau){.active}
            -   [Accés als
                estudis](/ca/estudis/graus/vols-estudiar-un-grau/acces-als-estudis)
        -   [Grau en Enginyeria
...
:::: content
::: page_title_no_sub
# Vols estudiar un grau? {#vols-estudiar-un-grau .page_title}
:::
::::
::::::
:::::::
...
::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::: {#node-8 .node .node-page .clearfix}
::::::::::::::::::::::::::::::: content
...
::: block-subtitle
T\'apassionen les Noves Tecnologies i vols aprendre com crear i innovar
amb elles?
:::

La Facultat d\'Informàtica de Barcelona és un dels centres pioner a
l'Estat espanyol en impartir els estudis universitaris en informàtica.
T\'expliquem tot el què cal saber del Grau en Enginyeria Informàtica de
la FIB a la web **[I love
bits](http://ilovebits.fib.upc.edu){target="_blank"}**.

[Vies
d\'accés](/ca/estudis/graus/vols-estudiar-un-grau/acces-als-estudis) al
Grau en Enginyeria Informàtica.

::: {.dexp-animate animate="fadeInLeft"}
[     Grau en Enginyeria
Informàtica](/ca/estudis/graus/grau-en-enginyeria-informatica){.dexp-shortcodes-button
...
[![Grau Enginyeria
Informàtica](/sites/fib/files/images/estudis/foto-anna.png)](http://www.ilovebits.fib.upc.edu/){target="_blank"}
:::
:::::::
...
[![](/sites/fib/files/images/estudis/grau-datascience.png)](http://dse.upc.edu)
:::
...
La Facultat d\'Informàtica de Barcelona, l\'Escola Tècnica Superior
d\'Enginyeria de Telecomunicació de Barcelona i la Facultat de
Matemàtiques i Estadística ofereixen un **Grau en Ciència i Enginyeria
de Dades **de quatre anys que vol formar professionals experts en
anàlisi i enginyeria de dades estructurades i no estructurades.
...
::: {.dexp-animate animate="fadeInLeft"}
[ Grau en Ciència i Enginyeria de
Dades](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::
:::::::
...
impartició d'estudis de grau, màster i doctorat en aquest àmbit,
...
::: {.dexp-animate animate="fadeInLeft"}
[     Grau en Intel·ligència
Artificial](/ca/estudis/graus/grau-en-intelligencia-artificial){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::
...
::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[ ![Grau Enginyeria
Informàtica](/sites/fib/files/images/imatge-gia.jpg){style="width: 449px; height: 236px;"}](/ca/estudis/graus/grau-en-intelligencia-artificial){target="_blank"}
:::
:::::::
...
::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[![Grau
Bioinformàtica](/sites/fib/files/images/estudis/bioinformaticamidaweb.png)](/ca/estudis/graus/grau-en-bioinformatica){target="_blank"}
:::

::::: {.col-xs-12 .col-sm-7 .col-md-7 .col-lg-7}
::: block-subtitle
T\'agradaria aplicar la informàtica i les tecnologies de la informació
en el camp de la biologia?
:::

La Universitat Politècnica de Catalunya (UPC·BarcelonaTech), la
Universitat Pompeu Fabra (UPF) i la Universitat de Barcelona (UB)
ofereixen un **Grau en Bioinformàtica** de quatre anys que s\'imparteix
íntegrament en anglès. El grau és coordinat per la FIB-UPC i les classes
s\'imparteixen al Campus Nord de la Universitat Politècnica de
Catalunya, i també a la Facultat de Biologia de la UB, al Campus del Mar
de la UPF i a la Facultat de Biociències de la UAB (segons optativitat).
...
::: {.dexp-animate animate="fadeInLeft"}
[     Grau en
Bioinformàtica](/ca/estudis/graus/grau-en-bioinformatica){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::
:::::::
...
La Facultat d\'Informàtica de Barcelona incorpora el programa successiu
de Grau i Màster en Enginyeria Informàtica.
...
::: {.dexp-animate animate="fadeInLeft"}
[     Grau+Màster en Enginyeria Informàtica (programa
successiu)](/ca/estudis/graus/graumaster-en-enginyeria-informatica-programa-successiu){.dexp-shortcodes-button
.btn .btn-link role="button"}
:::
:::::

::: {.col-xs-12 .col-sm-5 .col-md-5 .col-lg-5}
[![](/sites/fib/files/images/estudis/grau-master-enginyeria-informatica-programa-successiu.png){style="width: 449px; height: 236px;"}](/ca/estudis/graus/graumaster-en-enginyeria-informatica-programa-successiu)
:::
:::::::
