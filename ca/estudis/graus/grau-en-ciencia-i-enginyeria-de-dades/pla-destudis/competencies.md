...
twitter:url: "https://www.fib.upc.edu/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/pla-destudis/competencies"
    ...
    -   [Graus](/ca/estudis/graus)
        ...
        -   [Grau en Ciència i Enginyeria de
            ...
            -   [Pla
                ...
                -   [Assignatures](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/pla-destudis/assignatures)
                -   [Competències](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/pla-destudis/competencies){.active}
                -   [Competències per
                    assignatura](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/pla-destudis/competencies-assignatura)
            -   [Professorat](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/professorat)
            -   [Normativa acadèmica i
...
-   [Assignatures](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/pla-destudis/assignatures)
-   [Competències](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/pla-destudis/competencies){.active-trail
    .active}
-   [Competències per
    assignatura](/ca/estudis/graus/grau-en-ciencia-i-enginyeria-de-dades/pla-destudis/competencies-assignatura)
:::
...
:::::::::::: content
::::::::::: {#node-17383 .node .node-page .clearfix}
:::::::::: content
...
-   [**CG1**\
    Concebre sistemes computacionals que integren dades de procedències
    i formes molt diverses, construeixen amb ells models matemàtics,
    raonen sobre aquests models i actuen en conseqüència, aprenent de
    l\'experiència.]{#CG1}
-   [**CG2**\
    Elegir i aplicar els mètodes i tècniques més adequats a un problema
    definit per dades que representin un repte pel seu volum, velocitat,
    varietat o heterogeneïtat, inclosos mètodes informàtics, matemàtics,
    estadístics i de processament del senyal.]{#CG2}
-   [**CG3**\
    Treballar en equips i projectes multidisciplinaris relacionats amb
    el processat i explotació de dades complexes, interactuant
    fluidament amb enginyers i professionals d\'altres
    disciplines.]{#CG3}
-   [**CG4**\
    Identificar oportunitats per a aplicacions innovadores orientades a
    dades en entorns tecnològics en contínua evolució.]{#CG4}
-   [**CG5**\
    Poder recórrer a coneixements fonamentals i metodologies de treball
    sòlides adquirits durant els estudis per adaptar-se als nous
    escenaris tecnològics del futur.]{#CG5}
:::
...
-   [**CE1**\
    Utilitzar amb destresa els conceptes i mètodes matemàtics subjacents
    els problemes de la ciència i l\'enginyeria de les dades.]{#CE1}
-   [**CE2**\
    Ser capaç de programar solucions a problemes d\'enginyeria:
    Dissenyar solucions algorítmiques eficients a un problema
    computacional donat, implementar-les en forma de programari robust,
    estructurat i mantenible, i comprovar la validesa de la
    solució.]{#CE2}
-   [**CE3**\
    Analitzar fenòmens complexos mitjançant la probabilitat i
    l\'estadística, i plantejar models d\'aquests tipus en situacions
    concretes. Formular i resoldre problemes d\'optimització
    matemàtica.]{#CE3}
-   [**CE4**\
    Utilitzar els sistemes de computació actuals, inclosos els sistemes
    d\'alt rendiment, per al procés de grans volums de dades des del
    coneixement de la seva estructura, funcionament i
    particularitats.]{#CE4}
-   [**CE5**\
    Dissenyar i aplicar tècniques de processat de senyal, triant entre
    diferents eines tecnològiques, incloses les de visió artificial, de
    reconeixement del llenguatge parlat i de tractament de dades
    multimèdia.]{#CE5}
-   [**CE6**\
    Construir o utilitzar sistemes de processat i comprensió del
    llenguatge escrit, integrant-lo en altres sistemes dirigits per les
    dades. Dissenyar sistemes de recerca d\'informació textual o
    hipertextual i d\'anàlisi de xarxes socials.]{#CE6}
-   [**CE7**\
    Demostrar coneixement i capacitat d\'aplicació de les eines
    necessàries per a l\'emmagatzematge, el processament i l\'accés a
    les dades.]{#CE7}
-   [**CE8**\
    Capacitat de triar i emprar tècniques de modelització estadística i
    anàlisi de dades, avaluant la qualitat dels models, validant-los i
    interpretant-los.]{#CE8}
-   [**CE9**\
    Capacitat de triar i emprar una varietat de tècniques
    d\'aprenentatge automàtic i construir sistemes que les utilitzin per
    a la presa de decisions, fins i tot de forma autònoma.]{#CE9}
-   [**CE10**\
    Visualització d\'informació per facilitar l\'exploració i anàlisi de
    dades, inclosa l\'elecció de la representació adequada d\'aquests i
    l\'ús de tècniques de reducció de dimensionalitat.]{#CE10}
-   [**CE11**\
    Dins el context corporatiu, entendre el procés d\'innovació, ser
    capaç de proposar models i plans de negoci basats en explotació de
    les dades, analitzar-ne la viabilitat i ser capaç de comunicar-los
    de manera convincent.]{#CE11}
-   [**CE12**\
    Aplicar les pràctiques del \"project management\" en la gestió
    integral del projecte d\'enginyeria d\'explotació de dades que
    l\'alumne ha de realitzar, en les àrees d\'abast, temps, econòmica i
    riscos.]{#CE12}
-   [**CE13**\
    (Treball de final de grau) Planificar i concebre i dur a terme
    projectes de naturalesa professional en l\'àmbit de l\'enginyeria de
    les dades, ne la posada en marxa, la seva millora contínua i
    valorant el seu impacte econòmic i social. Defensar el projecte
    desenvolupat davant un tribunal universitari.]{#CE13}
:::
:::::::
::::::::
:::::::::
