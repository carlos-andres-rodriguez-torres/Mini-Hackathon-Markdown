...
description: Avaluació curricular Totes les assignatures del pla
  d'estudis estan organitzades en blocs curriculars. Quan un estudiant o
  una estudiant ha cursat totes les assignatures d\'un determinat bloc
  curricular es realitza l'avaluació curricular del bloc per a aquell
  estudiant o aquella estudiant. La responsabilitat d'aquesta avaluació
  és de la Comissió d'Avaluació Curricular (una
...
twitter:url: "https://www.fib.upc.edu/ca/estudis/graus/grau-en-bioinformatica/normativa-academica"
...
::: content
-   [Català](/ca/estudis/graus/grau-en-bioinformatica/normativa-academica "Normativa acadèmica"){.language-link
    .active lang="ca"}
-   [English](/en/studies/bachelors-degrees/bachelor-degree-bioinformatics/academic-regulations "Academic Regulations"){.language-link
    lang="en"}
-   [Español](/es/estudios/grados/grado-en-bioinformatica/normativa-academica "Normativa Académica"){.language-link
    lang="es"}
:::
:::::
...
-   [Estudis](/ca/estudis)
    -   [Graus](/ca/estudis/graus)
        ...
        -   [Grau en
            ...
            -   [Exàmens](/ca/estudis/graus/grau-en-bioinformatica/examens)
            -   [Normativa
                acadèmica](/ca/estudis/graus/grau-en-bioinformatica/normativa-academica){.active}
        -   [Grau+Màster en Enginyeria Informàtica (programa
...
-   [Exàmens](/ca/estudis/graus/grau-en-bioinformatica/examens)
-   [Normativa
    acadèmica](/ca/estudis/graus/grau-en-bioinformatica/normativa-academica){.active-trail
    .active}
:::
::::
::::::
...
:::::::: content
::::::: {#node-24028 .node .node-page .clearfix}
:::::: content
...
Curricular (una Comissió diferent per a cada bloc). És aquesta Comissió
qui decideix si l'estudiant o la estudiant ha superat o no el bloc.

#### **Blocs curriculars**

El grau en Bioinformàtica s\'organitza en tres blocs curriculars:

-   **Fase Inicial**: Està format per les 10 assignatures obligatòries
    que constitueixen els dos primers quadrimestres de la titulació
    (ALG, AP1, CB, IB, POC, AP2, BC, CAL, CAOS i MB).
-   **Obligatòries de 2n i 3r**: Està format per les assignatures
    obligatòries de la titulació que es cursen durant 2n i 3r (AP3, BDA,
    DB, DMO, GG, AB, DV, NSB, PN, SMSP, ADS, BP, CG, PGME, SL, HPC, ML,
    OT, PCG i SB).
-   **Avaluació Final**: Està format per totes les assignatures no
    incloses en els blocs anteriors. En formen part les assignatures
    optatives, Ètica i Comunicació Científica (ECS) i el Treball de Fi
    de Grau (TFG).
...
La comissió d\'un bloc es reuneix quan hi hagi estudiantat que hagi
cursat totes les assignatures del bloc.

#### **Aspectes particulars de l\'avaluació de la Fase Inicial**

-   Requisit necessari per tal que l'estudiant pugui ser considerat per
    superar l'avaluació curricular de les assignatures obligatòries o
    bàsiques de la fase inicial:
    -   tenir totes les notes ≥ 3.5 i nota mitjana del bloc ≥ 5
-   Requisit suficient per superar l'avaluació curricular de les
    assignatures obligatòries de la fase inicial (sempre i quan no es
    donin altres circumstàncies negatives):
    -   tenir una nota mitjana del bloc ≥ 5 i com a molt 2 assignatures
        suspeses, ambdues amb nota ≥ 4.5, o bé
    -   tenir una nota mitjana del bloc ≥ 6 i com a molt 1 assignatura
        suspesa, amb nota ≥ 4

#### **Aspectes particulars de l\'avaluació de les Obligatòries de 2n i 3r**

-   Requisit necessari per tal que l'estudiant pugui ser considerat per
    superar l'avaluació curricular de les assignatures obligatòries de
    2n i 3r:
    -   tenir totes les notes ≥ 4 i nota mitjana del bloc ≥ 5
-   Requisit suficient per superar l'avaluació curricular de les
    assignatures obligatòries de 2n i 3r (sempre i quan no es donin
    altres circumstàncies negatives):
    -   tenir una nota mitjana del bloc ≥ 6 i com a molt 2 assignatures
        suspeses, ambdues amb nota ≥ 4.5, o bé
    -   tenir una nota mitjana del bloc ≥ 5 i com a molt 1 assignatura
        suspesa, amb nota ≥ 4.5
:::
::::
:::::
::::::
