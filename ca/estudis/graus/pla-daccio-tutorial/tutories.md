---
description: Els tutors són professors voluntaris vinculats a la FIB que
  fan un seguiment del progrés dels estudiants que els són assignats.
  \[column cols=\"8\" begin=\"1\"\]Tot estudiant del Grau en Enginyeria
  Informàtica pot sol·licitar que se li assigni un professor tutor a
  través d'una aplicació accessible des del Racó. En el cas dels
  estudiants del Grau de Ciència i Enginyeria de Dades
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Tutories \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Els tutors són professors voluntaris vinculats a la
  FIB que fan un seguiment del progrés dels estudiants que els són
  assignats. \[column cols=\"8\" begin=\"1\"\]Tot estudiant del Grau en
  Enginyeria
twitter:title: Tutories
twitter:url: "https://www.fib.upc.edu/ca/estudis/graus/pla-daccio-tutorial/tutories"
...
::: content
-   [Català](/ca/estudis/graus/pla-daccio-tutorial/tutories){.language-link
    .active lang="ca"}
    ...
    -   [Graus](/ca/estudis/graus)
        ...
        -   [Pla d\'acció
            ...
            -   [Mentories entre
                ...
                -   [Horaris](/ca/estudis/graus/pla-daccio-tutorial/mentories-entre-iguals/horaris)
            -   [Tutories](/ca/estudis/graus/pla-daccio-tutorial/tutories){.active}
        -   [Guia
            d\'acollida](/ca/estudis/graus/guia-dacollida-estudiantat-de-grau)
...
-   [Mentories entre
    iguals](/ca/estudis/graus/pla-daccio-tutorial/mentories-entre-iguals)
-   [Tutories](/ca/estudis/graus/pla-daccio-tutorial/tutories){.active-trail
    .active}
:::
::::
::::::
...
::::::::::::::: content
:::::::::::::: {#node-18755 .node .node-page .clearfix}
::::::::::::: content
:::::::::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
::::::::::: field-items
:::::::::: {.field-item .even}
::: block-subtitle
Els tutors són professors voluntaris vinculats a la FIB que fan un
seguiment del progrés dels estudiants que els són assignats.
:::

::::: row
::: {.col-xs-12 .col-sm-8 .col-md-8 .col-lg-8}
Tot estudiant del Grau en Enginyeria Informàtica pot **sol·licitar** que
se li assigni un professor tutor a través d'una aplicació accessible des
del Racó. En el cas dels estudiants del Grau de Ciència i Enginyeria de
Dades hauran de sol·licitar un tutor enviant un correu electrònic a
[]{#uJOnDMLor rel="nofollow"}

.

En principi els tutors s'assignen per un curs acadèmic. Les **funcions**
del tutor són informar, orientar, aconsellar i animar els estudiants
tutoritzats amb l'**objectiu** de millorar del seu rendiment acadèmic.

Contribueixen a **identificar** els aspectes acadèmics i extra-acadèmics
que incideixen negativament en el l'aprenentatge de l'estudiant
tutoritzat per tal de corregir-los i potenciar-ne les capacitats.
:::
...
d\'obtenir resultats poc satisfactoris, pugui posar-hi remei el més
aviat possible. Per què això sigui possible, els tutors programen un
mínim de dues sessions presencials per quadrimestre amb cada tutoritzat
i en fan un seguiment continuat.

També s\'assigna un professor tutor a l\'estudiantat:

-   amb necessitats educatives especials ([Oficina
    d'Inclusió](https://inclusio.upc.edu/ca/docencia))
-   que pertany al col·lectiu d'esportistes d'alt rendiment ([servei
    d\'esports](https://www.upc.edu/esports/ca/competicions/tutoresport-upc))
-   que es troba en situacions acadèmiques excepcionals ([quadrimestre
    de
    gràcia](/ca/estudis/secretaria/tramits/quadrimestre-addicional-continuitat-destudis),
    [valor petit del paràmetre
    alfa](/ca/estudis/secretaria/tramits/parametre-alfa))
:::
:::::
::::::::::
