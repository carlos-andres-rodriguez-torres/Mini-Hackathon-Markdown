---
description: "Preinscripció El procés de preinscripció es formalitza a
  través del portal d\\'accés a la Universitat
  (https://accesuniversitat.gencat.cat). L\\'assignació de places es farà
  segons la nota d\\'accés, és a dir, la nota mitjana de l\\'expedient
  acadèmic, independentment de quan s\\'hagi tancat l\\'expedient dels
  estudis universitaris que donin accés a l\\'especialitat de màster que
  se"
...
theme-color: "#ffffff"
title: Requisits d\'accés i preinscripció \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: "Preinscripció El procés de preinscripció es
  formalitza a través del portal d\\'accés a la Universitat
  (https://accesuniversitat.gencat.cat). L\\'assignació de places es farà
  segons la nota d\\'accés, és a"
twitter:title: Requisits d\'accés i preinscripció
twitter:url: "https://www.fib.upc.edu/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/requisits-dacces-i-preinscripcio"
...
::: content
-   [Català](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/requisits-dacces-i-preinscripcio "Requisits d'accés i preinscripció"){.language-link
    .active lang="ca"}
-   [English]{.language-link .locale-untranslated lang="en"}
-   [Español](/es/estudios/masteres/master-en-formacion-del-profesorado-de-educacion-secundaria/requisitos-de-acceso-y-preinscripcion "Requisitos de acceso y preinscripción"){.language-link
    lang="es"}
:::
:::::
    ...
    -   [Màsters](/ca/estudis/masters)
        ...
        -   [Màster en Formació del Professorat d\'Educació
            ...
            -   [Direcció i
                professorat](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/direccio-i-professorat)
            -   [Requisits d\'accés i
                preinscripció](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/requisits-dacces-i-preinscripcio){.active}
            -   [Pla
...
:::: content
::: page_title_no_sub
# Requisits d\'accés i preinscripció {#requisits-daccés-i-preinscripció .page_title}
:::
::::
::::::
:::::::
...
-   [Direcció i
    professorat](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/direccio-i-professorat)
-   [Requisits d\'accés i
    preinscripció](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/requisits-dacces-i-preinscripcio){.active-trail
    .active}
-   [Pla
    d\'estudis](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/pla-destudis)
-   [Matrícula](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria/matricula)
...
:::::::::::::::: content
::::::::::::::: {#node-18084 .node .node-page .clearfix}
:::::::::::::: content
...
El **procés de preinscripció** es formalitza a través del portal
d\'accés a la Universitat
([https://accesuniversitat.gencat.cat](https://accesuniversitat.gencat.cat/)).

L\'**assignació de places** es farà segons la nota d\'accés, és a dir,
la nota mitjana de l\'expedient acadèmic, independentment de quan
s\'hagi tancat l\'expedient dels estudis universitaris que donin accés a
l\'especialitat de màster que se sol·licita.

La preinscripció es fa separadament per Tecnologia i Formació
Professional.
...
::: box-icon
[](https://universitats.gencat.cat/ca/estudis-universitaris/tipus-estudis-universitaris/masters-universitaris/master-formacio-professorat/#bloc1)
:::

### [Més informació del màster](https://universitats.gencat.cat/ca/estudis-universitaris/tipus-estudis-universitaris/masters-universitaris/master-formacio-professorat/#bloc1) {#més-informació-del-màster .box-title}
::::
:::::
...
:::: {.dexp-shortcodes-box .hovericon .box-circle .box-center}
::: box-icon
[](https://universitats.gencat.cat/ca/estudis-universitaris/tipus-estudis-universitaris/masters-universitaris/master-formacio-professorat/#bloc2)
:::

### [Tràmit de preinscripció](https://universitats.gencat.cat/ca/estudis-universitaris/tipus-estudis-universitaris/masters-universitaris/master-formacio-professorat/#bloc2) {#tràmit-de-preinscripció .box-title}
::::
:::::
:::::::::
...
extracomunitari que faculti al país expenedor del títol per a l\'accés
als ensenyaments de màster.

Per accedir a les diferents especialitats del màster, caldrà estar en
possessió d\'una **titulació concordant o idònia amb l\'especialitat
docent **d\'acord amb les resolucions del Departament d\'Educació per a
l\'accés a la borsa d\'interins.

-   **[Relació de titulacions i
    especialitats docent](https://aplicacions.ensenyament.gencat.cat/pls/apex/f?p=2011014:19)**.
-   [Correspondències entre les especialitats ESO-batxillerat/Formació
    professional i els estudis universitaris
    cursats](https://aplicacions.ensenyament.gencat.cat/pls/apex/f?p=2011914:28)

#### **Tercera llengua**

1.  Certificat del nivell B1 (o superior) d'una tercera llengua (anglès,
    francès, italià o alemany).
2.  **Si ets estudiant estranger,** has d'acreditar, com a mínim, el
    nivell B1 d'una de les dues llengües oficials de Catalunya (català o
    castellà). També has de tenir en compte que en finalitzar el màster
    hauràs d\'assolir un nivell de suficiència B2 de castellà o de
    català.

Trobaràs tota la [informació sobre els certificats i les acreditacions
de llengües oficials i
estrangeres](https://universitats.gencat.cat/ca/estudis-universitaris/tipus-estudis-universitaris/masters-universitaris/master-formacio-professorat/#bloc3)
necessàries a la web de la generalitat.

En el cas de no disposar de cap dels certificats esmentats a l\'enllaç
anterior, el **Servei de Llengües de la UPC** t\'explica [com obtenir-lo
a través de les escoles
d\'idiomes](https://www.upc.edu/slt/ca/certifica/master-secundaria).
:::::::::::
::::::::::::
:::::::::::::
::::::::::::::
