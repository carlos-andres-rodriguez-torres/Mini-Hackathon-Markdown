---
description: Assignatures del Master in Innovation and Research in
  Informatics
...
twitter:url: "https://www.fib.upc.edu/ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/pla-destudis/assignatures"
...
::: content
-   [Català](/ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/pla-destudis/assignatures "Assignatures"){.language-link
    .active lang="ca"}
-   [English](/en/studies/masters/master-innovation-and-research-informatics/curriculum/syllabus "Syllabus"){.language-link
    lang="en"}
-   [Español](/es/estudios/masteres/master-en-innovacion-e-investigacion-en-informatica/plan-de-estudios/asignaturas "Asignaturas"){.language-link
    lang="es"}
:::
:::::
    ...
    -   [Màsters](/ca/estudis/masters)
        ...
        -   [Màster en Innovació i Recerca en
            ...
            -   [Pla
                ...
                -   [Assignatures](/ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/pla-destudis/assignatures){.active}
...
-   [Assignatures](/ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/pla-destudis/assignatures){.active-trail
    .active}
-   [Especialitats](/ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/pla-destudis/especialitats)
-   [Competències](/ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/pla-destudis/competencies)
-   [Competències per
...
:::::::: content
::::::: {#node-63 .node .node-page .clearfix}
:::::: content
...
**Q1**:setembre-gener **Q2**:febrer-juny
  ...
  Acrònim   Nom complet                                                                                      Obert 24-25
  --------- ------------------------------------------------------------------------------------------------ -------------
  AMMM      [Mètodes Algorísmics per a Models Matemàtics](assignatures/AMMM-MIRI)                            Q1, Q2
  CPDS      [Concurrència, Paral·lelisme i Sistemes Distribuïts](assignatures/CPDS-MIRI)                     Q1
  SMDE      [Modelatge Estadístic i Disseny d\'Experiments](assignatures/SMDE-MIRI)                          Q1, Q2
  TMIRI     [Tècniques i Metodologia de la Innovació i la Recerca en Informàtica](assignatures/TMIRI-MIRI)   Q1, Q2
                                                                                                             
  SIRI      [Seminaris d\'Innovació i Recerca en Informàtica](assignatures/SIRI-MIRI)                        Q1, Q2
...
### Computació Avançada
  ...
  Acrònim   Nom complet                                                    Obert 24-25
  --------- -------------------------------------------------------------- -------------
  ADS       [Estructures de Dades Avançades](assignatures/ADS-MIRI)        Q2
  CC        [Complexitat Computacional](assignatures/CC-MIRI)              Q2
  CPS       [Resolució de Problemes Combinatoris](assignatures/CPS-MIRI)   Q2
  RA        [Algorismes Aleatoris](assignatures/RA-MIRI)                   Q1

  : Assignatures obligatòries d\'especialitat

  Acrònim   Nom complet                                                  Obert 24-25
  --------- ------------------------------------------------------------ -------------
  ADM       [Algorísmia per a Mineria de Dades](assignatures/ADM-MIRI)   Q2
  AGT       [Teoria de Jocs Algorísmica](assignatures/AGT-MIRI)          Q2
  AVLSI     [Algorismes per a VLSI](assignatures/AVLSI-MIRI)             Q1
  CSN       [Xarxes Socials i Complexes](assignatures/CSN-MIRI)          Q1
...
### Gràfics i Realitat Virtual
  ...
  Acrònim   Nom complet                                                                 Obert 24-25
  --------- --------------------------------------------------------------------------- -------------
  A3DM      [Modelat Avançat en 3d](assignatures/A3DM-MIRI)                             Q2
  FRR       [Representació Realista d\'Alta Velocitat](assignatures/FRR-MIRI)           Q2
  GTCG      [Eines Geomètriques per a Gràfics per Computador](assignatures/GTCG-MIRI)   Q1
  VAR       [Realitat Virtual i Augmentada](assignatures/VAR-MIRI)                      Q1

  : Assignatures obligatòries d\'especialitat

  Acrònim   Nom complet                                                                 Obert 24-25
  --------- --------------------------------------------------------------------------- -------------
  CA        [Animació per Computador](assignatures/CA-MIRI)                             Q1
  GPR       [Processat en Geometria](assignatures/GPR-MIRI)                             Q1
  SRGGE     [Renderització Escalable en Gràfics i Videojocs](assignatures/SRGGE-MIRI)   Q2
  SV        [Visualització Científica](assignatures/SV-MIRI)                            Q1
...
### Xarxes de Computadors i Sistemes Distribuïts
  ...
  Acrònim   Nom complet                                                                           Obert 24-25
  --------- ------------------------------------------------------------------------------------- -------------
  CNANM     [Arquitectura de Xarxes de Computadors i Gestió de Xarxes](assignatures/CNANM-MIRI)   Q1
  SANS      [Anàlisi Estadística de Xarxes i Sistemes](assignatures/SANS-MIRI)                    Q1
  SNM       [Modelatge Estocàstic de Xarxes](assignatures/SNM-MIRI)                               Q1
  TOML      [Temes Sobre Optimització i Aprenentatge Automàtic](assignatures/TOML-MIRI)           Q2

  : Assignatures obligatòries d\'especialitat

  Acrònim   Nom complet                                                                  Obert 24-25
  --------- ---------------------------------------------------------------------------- -------------
  CCBDA     [Computació al Núvol i Anàlisi de Dades Massives](assignatures/CCBDA-MIRI)   Q2
  DS        [Sistemes Descentralitzats](assignatures/DS-MIRI)                            Q2
  FINE      [Xarxes d\'Internet del Futur](assignatures/FINE-MIRI)                       Q1
  IAS       [Aplicacions i Seguretat en Internet](assignatures/IAS-MIRI)                 Q1
...
### Ciència de les Dades
  ...
  --------- ------------------------------------------------------------------------------- -------------
  ADM       [Algorísmia per a Mineria de Dades](assignatures/ADM-MIRI)                      Q2
  AHLT      [Tecnologies Avançades del Llenguatge Humà](assignatures/AHLT-MAI)              Q2
  BDM       [Administració de Dades Massives](assignatures/BDM-MIRI)                        Q2
  BSG       [Bioinformàtica i Genètica Estadística](assignatures/BSG-MDS)                   Q1
  IRRS      [Recuperació de la Informació i Sistemes Recomanadors](assignatures/IRRS-MDS)   Q1
  VBP       [Viabilitat de Projectes Empresarials](assignatures/VBP-MIRI)                   Q2
...
### Computació d\'Altes Prestacions
  ...
  Acrònim   Nom complet                                                 Obert 24-25
  --------- ----------------------------------------------------------- -------------
  MA        [Arquitectura de Multiprocessadors](assignatures/MA-MIRI)   Q2
  OS        [Sistemes Operatius](assignatures/OS-MIRI)                  Q1
  PA        [Arquitectura del Processador](assignatures/PA-MIRI)        Q1

  : Assignatures obligatòries d\'especialitat

  Acrònim   Nom complet                                                                  Obert 24-25
  --------- ---------------------------------------------------------------------------- -------------
  APA       [Arquitectura Avançada del Processador](assignatures/APA-MIRI)               Q2
  CHPC      [Compiladors per Computadors d\'Altes Prestacions](assignatures/CHPC-MIRI)   Q1
  NCD       [Disseny de Circuits Nanoelectrònics](assignatures/NCD-MIRI)                 Q1
  PD        [Disseny del Processador](assignatures/PD-MIRI)                              Q2
  PPTM      [Eines i Models de Programació Paral·lela](assignatures/PPTM-MIRI)           Q2
  SA        [Arquitectura de Supercomputadors](assignatures/SA-MIRI)                     Q1
  SCA       [Supercomputació per Aplicacions Exigents](assignatures/SCA-MIRI)            Q1
...
## Optativa
  ...
  Acrònim   Nom complet                                                                 Obert 24-25
  --------- --------------------------------------------------------------------------- -------------
  I2P       [Projecte d\'Innovació Interdisciplinari](assignatures/I2P-MIRI)            Q2
  I2RM3     Introducció a la Recerca                                                    Q1, Q2
  I2RM6     Introducció a la Recerca                                                    Q1, Q2
  MLOPS     [Sistemes d\'Aprenentatge Automàtic en Producció](assignatures/MLOPS-MDS)   Q1
...
## Assignatures no vigents
  ...
  Acrònim   Nom complet
  --------- ------------------------------------------------------------------------------------------------
  ADSDB     [Algorismes, Estructures de Dades i Bases de Dades](assignatures/ADSDB-MIRI)
  AM        [Modelatge Avançat](assignatures/AM-MIRI)
  ANLP      [Processament Avançat del Llenguatge Natural](assignatures/ANLP-MIRI)
  ASE       [Enginyeria del Software Avançada](assignatures/ASE-MIRI)
  ASM       [Modelat Estadístic Avançat](assignatures/ASM-MIRI)
  BIP       [Projecte d\'Intel·ligència Empresarial](assignatures/BIP-MIRI)
  BSG       [Bioinformàtica i Genètica Estadística](assignatures/BSG-MIRI)
  CLC       [Cloud Computing](assignatures/CLC-MIRI)
  CN        [Xarxes de Computadors](assignatures/CN-MIRI)
  DAKD      [Anàlisi de Dades i Descobriment de Coneixement](assignatures/DAKD-MIRI)
  DEWS      [Disseny i Avaluació de Sistemes Basats en la Web](assignatures/DEWS-MIRI)
  DW        [Data Warehousing](assignatures/DW-MIRI)
  EA        [Elements d\'Animació](assignatures/EA-MIRI)
  EB        [E-Business](assignatures/EB-MIRI)
  GP        [Processament Geomètric](assignatures/GP-MIRI)
  INM       [Introducció al Modelatge de Xarxes](assignatures/INM-MIRI)
  IR        [Recuperació de la Informació](assignatures/IR-MIRI)
  KMLMM     [Aprenentatge Automàtic Basat en Kernel i Modelat Multivariant](assignatures/KMLMM-MIRI)
  MGTN      [Mecanismes i Teoria de Jocs en Xarxes](assignatures/MGTN-MIRI)
  ML        [Aprenentatge Automàtic](assignatures/ML-MIRI)
  MVA       [Anàlisi Multivariant](assignatures/MVA-MIRI)
  OD        [Open Data](assignatures/OD-MIRI)
  OTDM      [Tècniques d\'Optimització per a la Mineria de Dades](assignatures/OTDM-MIRI)
  RES       [Enginyeria de Requisits pels Serveis](assignatures/RES-MIRI)
  RRMM      [Representació en Temps Real de Models Massius](assignatures/RRMM-MIRI)
  SEAIT     [Aspectes Socials i Ambientals de Les Tecnologies de la Informació](assignatures/SEAIT-MIRI)
  SIBIT     [Innovació en Els Serveis Basada en Les Tecnologies de la Informació](assignatures/SIBIT-MIRI)
  SM        [Gestió de Serveis](assignatures/SM-MIRI)
  SNLP      [Processament Estadístic del Llenguatge Natural](assignatures/SNLP-MIRI)
  SOA       [Arquitectura Orientada als Serveis](assignatures/SOA-MIRI)
  SOBI      [Bussiness Intelligence Orientada als Serveis](assignatures/SOBI-MIRI)
  VV        [Visualització del Volum](assignatures/VV-MIRI)
  WS        [Serveis Web](assignatures/WS-MIRI)
:::
::::
:::::
::::::
