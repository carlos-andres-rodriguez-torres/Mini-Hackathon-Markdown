...
twitter:url: "https://www.fib.upc.edu/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/competencies"
...
::: content
-   [Català](/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/competencies "Competències"){.language-link
    .active lang="ca"}
-   [English](/en/studies/masters/master-informatics-engineering/curriculum/competences "Competences"){.language-link
    lang="en"}
-   [Español](/es/estudios/masteres/master-en-ingenieria-informatica/plan-de-estudios/competencias "Competencias"){.language-link
    lang="es"}
:::
:::::
    ...
    -   [Màsters](/ca/estudis/masters)
        ...
        -   [Màster en Enginyeria
            ...
            -   [Pla
                ...
                -   [Assignatures](/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/assignatures)
                -   [Competències](/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/competencies){.active}
                -   [Competències per
                    assignatura](/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/competencies-assignatura)
            -   [Professorat](/ca/estudis/masters/master-en-enginyeria-informatica/professorat)
            -   [Normativa
...
-   [Assignatures](/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/assignatures)
-   [Competències](/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/competencies){.active-trail
    .active}
-   [Competències per
    assignatura](/ca/estudis/masters/master-en-enginyeria-informatica/pla-destudis/competencies-assignatura)
:::
...
:::::::::::: content
::::::::::: {#node-7226 .node .node-page .clearfix}
:::::::::: content
...
-   [**CG1**\
    Capacitat per a projectar, calcular, i dissenyar productes,
    processos i instal·lacions en tots els àmbits de l\'Enginyeria
    Informàtica]{#CG1}
-   [**CG2**\
    Capacitat per a la direcció d\'obres i instal·lacions de sistemes
    informàtics, acomplint la normativa vigent i assegurant la qualitat
    del servei.]{#CG2}
-   [**CG3**\
    Capacitat per a dirigir, planificar i supervisar equips
    multidisciplinaris.]{#CG3}
-   [**CG4**\
    Capacitat pel modelat matemàtic, càlcul i simulació en centres
    ...
    amb l\'Enginyeria en Informàtica.]{#CG4}
-   [**CG5**\
    Capacitat per a l\'elaboració, planificació estratègica, direcció,
    coordinació i gestió tècnica i econòmica de projectes en tots els
    àmbits de l\'Enginyeria en Informàtica seguint criteris de qualitat
    i mediambientals]{#CG5}
-   [**CG6**\
    Capacitat per a la direcció general, direcció tècnica i direcció de
    projectes de recerca, desenvolupament i innovació en empreses i
    centres tecnològics, en l\'àmbit de l\'Enginyeria en
    Informàtica.]{#CG6}
-   [**CG7**\
    Capacitat per a la posada en marxa, direcció i gestió de processos
    de fabricació d\'equips informàtics, amb garantia de la seguretat
    per a les persones i béns, la qualitat final dels productes i la
    seva homologació]{#CG7}
-   [**CG8**\
    Capacitat per a l\'aplicació dels coneixements adquirits i de
    resoldre problemes en entorns nous o poc coneguts dins de contexts
    més amplis i multidisciplinaris, essent capaços d\'integrar aquests
    coneixements.]{#CG8}
-   [**CG9**\
    Capacitat per a comprendre i aplicar la responsabilitat ètica, la
    legislació i la deontologia professional de l\'activitat de la
    professió d\'Enginyer en Informàtica]{#CG9}
-   [**CG10**\
    Capacitat per a aplicar els principis de l\'economia i de la gestió
    de recursos humans i projectes, així com la legislació, regulació i
    normalització de la Informàtica]{#CG10}
:::
...
-   [**CDG1**\
    Capacitat per a la integració de tecnologies, aplicacions, serveis i
    sistemes propis de l\'Enginyeria Informàtica, amb caràcter
    generalista, i en contextos més amplis i multidisciplinaris.]{#CDG1}
-   [**CDG2**\
    Capacitat per a la planificació estratègica, elaboració, direcció,
    coordinació, y gestió tècnica i econòmica en els àmbits de
    l\'enginyeria informàtica relacionats, entre d\'altres, amb:
    sistemes, aplicacions, serveis, xarxes, infraestructures o
    instal·lacions informàtiques i centres o factories de
    desenvolupament de software, respectant l\'adequat compliment dels
    criteris de qualitat i mediambientals i en entorns de treball
    multidisciplinaris.]{#CDG2}
-   [**CDG3**\
    Capacitat per a la direcció de projectes de recerca, desenvolupament
    i innovació, en empreses i centres tecnològics, amb garantia per la
    seguretat de les persones i béns, la qualitat final dels productes i
    la seva homologació.]{#CDG3}

### ESPECÍFIQUES

-   [**CTE1**\
    Capacitat per a modelar, dissenyar, definir l\'arquitectura,
    implantar, gestionar, operar, administrar i mantenir aplicacions,
    xarxes, sistemes, serveis i continguts informàtics.]{#CTE1}
-   [**CTE2**\
    Capacitat de comprendre i saber aplicar el funcionament i
    organització d\'Internet, les tecnologies i protocols de xarxes de
    nova generació, els models de components, software intermedi i
    serveis.]{#CTE2}
-   [**CTE3**\
    Capacitat per a assegurar, gestionar, auditar i certificar la
    qualitat dels desenvolupaments, processos, sistemes, serveis,
    aplicacions i productes informàtics.]{#CTE3}
-   [**CTE4**\
    Capacitat per a dissenyar, desenvolupar, gestionar i avaluar
    mecanismes de certificació i garantia de seguretat en el tractament
    i accés a la informació en un sistema de processament local o
    distribuït.]{#CTE4}
-   [**CTE5**\
    Capacitat per a analitzar les necessitats d\'informació que es
    plantegen en un entorn i portar a terme en totes les seves etapes el
    procés de construcció d\'un sistema d\'informació.]{#CTE5}
-   [**CTE6**\
    Capacitat per a dissenyar i avaluar sistemes operatius i servidors,
    i aplicacions i sistemes basats en computació distribuïda.]{#CTE6}
-   [**CTE7**\
    Capacitat per a comprendre i poder aplicar coneixements avançats de
    computació d\'altes prestacions i mètodes numèrics o computacionals
    a problemes d\'enginyeria.]{#CTE7}
-   [**CTE8**\
    Capacitat de dissenyar i desenvolupar sistemes, aplicacions i
    serveis informàtics en sistemes encastats i ubics.]{#CTE8}
-   [**CTE9**\
    Capatitat per a aplicar mètodes matemàtics, estadístics i
    d\'intel·ligència artificial per a modelar, dissenyar i desenvolupar
    aplicacions, serveis, sistemes intel·ligents i sistemes basats en el
    coneixement.]{#CTE9}
-   [**CTE10**\
    Capacitat per a utilitzar i desenvolupar metodologies, mètodes,
    tècniques, programes d\'ús específic, normes i estàndards de
    computació gràfica.]{#CTE10}
-   [**CTE11**\
    Capacitat per a conceptualitzar, dissenyar, desenvolupar i avaluar
    la interacció persona-ordinador de productes, sistemes, aplicacions
    i serveis informàtics.]{#CTE11}
-   [**CTE12**\
    Capacitat per a la creació i explotació d\'entorns virtuals, i per a
    la creació, gestió i distribució de continguts multimèdia.]{#CTE12}
:::
:::::::
::::::::
:::::::::
