...
:::: content
::: page_title_no_sub
# Master en Ciberseguretat {#master-en-ciberseguretat .page_title}
:::
::::
::::::
:::::::
...
-   [Màster en Intel·ligència
    Artificial](/ca/estudis/masters/master-en-intelligencia-artificial)
-   [Master en
    Ciberseguretat](/ca/estudis/masters/master-en-ciberseguretat){.active-trail
    .active}
-   [Màster en Formació del Professorat d\'Educació
    Secundària](/ca/estudis/masters/master-en-formacio-del-professorat-deducacio-secundaria-obligatoria-i-batxillerat-formacio-professional-i-ensenyament)
-   [Erasmus Mundus Master in Big Data Management and
...
::::::::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::::::::: {#node-20181 .node .node-estudis .clearfix}
::::::::::::::::::::::::::::::::::::: content
::: {.dexp-animate animate="fadeInLeft"}
Aquest màster té com a finalitat formar a experts en el disseny,
implementació i gestió de la seguretat tant de les infraestructures i
les comunicacions de l'actual món digital, com de les aplicacions i
serveis que s'ofereixen sobre elles.

*L'enfocament dels estudis és eminentment pràctic*, considerant-se
el *màster de tipologia professionalitzadora*. Els titulats del Màster
Universitari en Ciberseguretat de la UPC obtindran les competències i
habilitats per analitzar riscos i vulnerabilitats en sistemes TIC
complexos, dissenyar els sistemes TIC (tant des d'un punt de vista
d'arquitectura com de software) pensant en la prevenció de la seguretat
(security by design), detectar els atacs que no s'hagin pogut evitar i
donar la resposta més ràpida i eficient possible.
...
::: {.col-xs-12 .col-sm-9 .col-md-9 .col-lg-9 .field-items}
[Master\'s degree in
Cybersecurity](https://cybersecurity.masters.upc.edu/)
:::
:::::
::::::::::::::::::

:::::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[](https://www.fib.upc.edu/sites/fib/files/documents/estudis/diptic-informatiu-mcs-en-br.pdf)

::::: {.field .field-name-field-imatge-diptic .field-type-image .field-label-hidden}
:::: field-items
::: {.field-item .even}
![Diptic informatiu Master en Ciberseguretat (en
anglès)](https://www.fib.upc.edu/sites/fib/files/images/estudis/diptic-informatiu-mcs-en.jpg "Diptic informatiu Master en Ciberseguretat (en anglès)"){width="248"
height="306"}
:::
::::
:::::
...
::: box-content
El perfil d'entrada del màster s'orienta a titulats universitaris de
l'àmbit TIC, i a d'altres professionals amb titulacions afins amb una
dilatada experiència en empreses del sector.
:::
:::::
::::::
:::::::
...
Virgili](/sites/fib/files/images/estudis/logo-fib-150x250.jpg)](/ca){target="_blank"}
:::

::: {.col-xs-12 .col-sm-3 .col-md-3 .col-lg-3}
[![Universitat Politècnica de Catalunya -
BarchelonaTech](/sites/fib/files/images/estudis/logo-telecos-150x250.jpg)](https://telecos.upc.edu/ca){target="_blank"}
:::
...
::::::::::: content
:::::::::: {.view .view-index-visual .view-id-index_visual .view-display-id-extra .view-dom-id-2e361b2167a3c34ce07bbea9b27f7d94}
::::::::: view-content
