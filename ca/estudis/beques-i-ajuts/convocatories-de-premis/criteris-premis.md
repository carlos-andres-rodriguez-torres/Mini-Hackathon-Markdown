---
description: "A aquests premis opten tots els estudiants que compleixin
  amb els requisits. La mateixa Facultat decideix els guanyador dels
  premis a partir de les dades que poseeix i aplicant els criteris
  descrits a continuació. Premi NTT DATA al millor expedient de la Fase
  Inicial del GEI Els criteris que han de satisfer els estudiants que
  opten al millor expedient de la Fase Inicial són:"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Criteris premis \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: A aquests premis opten tots els estudiants que
  compleixin amb els requisits. La mateixa Facultat decideix els
  guanyador dels premis a partir de les dades que poseeix i aplicant els
  criteris descrits
twitter:title: Criteris premis
twitter:url: "https://www.fib.upc.edu/ca/estudis/beques-i-ajuts/convocatories-de-premis/criteris-premis"
...
::: content
-   [Català](/ca/estudis/beques-i-ajuts/convocatories-de-premis/criteris-premis){.language-link
    .active lang="ca"}
...
-   [Estudis](/ca/estudis)
    ...
    -   [Beques i Ajuts](/ca/estudis/beques-i-ajuts)
        -   [Convocatòries de
            premis](/ca/estudis/beques-i-ajuts/convocatories-de-premis)
            -   [Criteris
                premis](/ca/estudis/beques-i-ajuts/convocatories-de-premis/criteris-premis){.active}
...
:::: content
::: page_title_no_sub
# Criteris premis {#criteris-premis .page_title}
:::
::::
::::::
:::::::
...
Ajuts](/ca/estudis/beques-i-ajuts) » [Convocatòries de
premis](/ca/estudis/beques-i-ajuts/convocatories-de-premis) » Criteris
premis
:::
::::
::::::
...
:::::::: content
::::::: {#node-18682 .node .node-page .clearfix}
:::::: content
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
A aquests premis opten tots els estudiants que compleixin amb els
requisits. La mateixa Facultat decideix els guanyador dels premis a
partir de les dades que poseeix i aplicant els criteris descrits a
continuació.

## []{#criteri-FI-GEI}Premi NTT DATA al millor expedient de la Fase Inicial del GEI

Els **criteris **que han de satisfer els estudiants que opten al millor
expedient de la Fase Inicial són:

-   Estar cursant el Grau en Enginyeria Informàtica
-   Haver superat totes les assignatures de la fase inicial del GEI en
    un any, sense convalidacions ni assimilacions.

## []{#criteri-equador-GEI}Premi FIB Alumni al millor expedient de pas de l\'equador del GEI 

Els **criteris **que han de satisfer els estudiants que opten al premi
al millor expedient de pas de l\'equador del GEI són:

-   Estar cursant el Grau en Enginyeria Informàtica
-   Haver iniciat els estudis a la FIB dos cursos enrere
-   Haver aprovat en primera convocatòria, sense convalidacions ni
    assimilacions, les assignatures:
    -   1r quadrimestre (F, FM, IC, PRO1)
    -   2n quadrimestre (EC, M1, M2, PRO2)
    -   3r quadrimestre (BD, CI, EDA, PE, SO)
    -   4rt quadrimestre (AC, EEE, IDI, IES, XC)
:::
::::
:::::
::::::
