---
description: Si has estat admés/a per realitzar un semestre o tot un
  curs d\'intercanvi a la FIB hauràs de formalitzar la matrícula a la
...
theme-color: "#ffffff"
title: Matrícula Incoming (1a matrícula) \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: Si has estat admés/a per realitzar un semestre o
  tot un curs d\'intercanvi a la FIB hauràs de formalitzar la matrícula
  a la sessió de benvinguda.
twitter:title: Matrícula Incoming (1a matrícula)
twitter:url: "https://www.fib.upc.edu/ca/estudis/secretaria/tramits/matricula-incoming-1a-matricula"
...
::: content
-   [Català](/ca/estudis/secretaria/tramits/matricula-incoming-1a-matricula "Matrícula Incoming (1a matrícula)"){.language-link
    .active lang="ca"}
-   [English](/en/studies/academic-management/administrative-procedures/incoming-enrolment-1st-time "Incoming enrolment (1st time)"){.language-link
    lang="en"}
-   [Español](/es/estudios/secretaria/tramites/matricula-incoming-1a-matricula "Matrícula Incoming (1ª matrícula)"){.language-link
    lang="es"}
:::
:::::
    ...
    -   [Secretaria](/ca/estudis/secretaria)
        -   [Tràmits](/ca/estudis/secretaria/tramits)
            ...
            -   [Matrícula Incoming (1a
                matrícula)](/ca/estudis/secretaria/tramits/matricula-incoming-1a-matricula){.active}
            -   [Matrícula
...
:::: content
::: page_title_no_sub
# Matrícula Incoming (1a matrícula) {#matrícula-incoming-1a-matrícula .page_title}
:::
::::
::::::
:::::::
...
[Secretaria](/ca/estudis/secretaria) »
[Tràmits](/ca/estudis/secretaria/tramits) » Matrícula Incoming (1a
matrícula)
:::
::::
::::::
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: content
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {#node-16043 .node .node-tr-mit .clearfix}
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: row
:::::: {.col-lg-9 .col-md-9 .col-sm-12}
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
Si has estat admés/a per realitzar un semestre o tot un curs
d\'intercanvi a la FIB hauràs de formalitzar la matrícula a la sessió de
benvinguda.
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
Estudiantat d\'intercanvi que s\'ha de matricular per primera vegada a
la FIB.
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
Documentació obligatòria a pujar a  la [plataforma de
mobilitat](https://mobility.fib.upc.edu/) abans de la Welcome session:

-   Acord acadèmic degudament signat (només en cas que la teva
    universitat pertanyi a un país de fora del programa Erasmus+ o bé si
    la teva universitat no està connectada a la plataforma Erasmus
    Without Papers)
-   Una fotocòpia de la matrícula realitzada a la teva universitat
    d\'origen, on consti que estàs matriculat durant el període
    d\'intercanvi.
-   Una fotocòpia del teu passaport o del carnet d\'identitat.
-   Assegurança que tingui les cobertures següents: Assistència
    sanitària (incloses les proves diagnòstiques i intervencions
    quirúrgiques), cobertura per accidents en el país de destinació i
    repatriació en cas de defunció. En cas de no disposar ja d\'una
    assegurança, la UPC té conveni amb
    [OnCampus](http://oncampus.es/en/seguros/oncampus-estudia/) i
    ofereix una assegurança molt completa per a tota l\'estada a un preu
    força econòmic (La Targeta Sanitària Europea no és suficient, ja que
    no té totes les cobertures requerides).
:::
::::
:::::
::::::
