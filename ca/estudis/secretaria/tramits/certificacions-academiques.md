---
description: "Es sol·licita a l\\'e-Secretaria i s\\'obtindrà màxim en 4
  dies hàbils. Si tens accés a l\\'e-Secretaria, Inicia sessió: Utilitza
  les teves credencials d\\'accés a les Intranets de la UPC. Cerca el
  tràmit: Al menú esquerre Certificats Tria el certificat: Indica el
  tipus de certificat que necessites (per exemple, Certificat acadèmic
  personal). Completa les dades: Especifica l\\'idioma i"
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Certificacions acadèmiques \| Facultat d\'Informàtica de
  Barcelona
twitter:card: summary
twitter:description: "Es sol·licita a l\\'e-Secretaria i s\\'obtindrà
  màxim en 4 dies hàbils. Si tens accés a l\\'e-Secretaria, Inicia
  sessió: Utilitza les teves credencials d\\'accés a les Intranets de la
  UPC. Cerca el tràmit:"
twitter:title: Certificacions acadèmiques
twitter:url: "https://www.fib.upc.edu/ca/estudis/secretaria/tramits/certificacions-academiques"
...
::: content
-   [Català](/ca/estudis/secretaria/tramits/certificacions-academiques "Certificacions acadèmiques"){.language-link
    .active lang="ca"}
-   [English]{.language-link .locale-untranslated lang="en"}
-   [Español](/es/estudios/secretaria/tramites/certificaciones-academicas "Certificaciones académicas"){.language-link
    lang="es"}
:::
:::::
...
-   [Estudis](/ca/estudis)
    ...
    -   [Secretaria](/ca/estudis/secretaria)
        -   [Tràmits](/ca/estudis/secretaria/tramits)
            ...
            -   [Certificacions
                acadèmiques](/ca/estudis/secretaria/tramits/certificacions-academiques){.active}
...
:::: content
::: page_title_no_sub
# Certificacions acadèmiques {#certificacions-acadèmiques .page_title}
:::
::::
::::::
:::::::
...
[Secretaria](/ca/estudis/secretaria) »
[Tràmits](/ca/estudis/secretaria/tramits) » Certificacions acadèmiques
:::
::::
::::::
:::::::
...
:::::::::::::::::::::::::::::::::::::::::::::::: content
::::::::::::::::::::::::::::::::::::::::::::::: {#node-15974 .node .node-tr-mit .clearfix}
:::::::::::::::::::::::::::::::::::::::::::::: row
...
::: {.field-item .even}
Es sol·licita a
l\'[e-Secretaria](https://prisma-nou.upc.edu/estudiants){target="_blank"}
i s\'obtindrà màxim en 4 dies hàbils.

[Si tens accés a l\'e-Secretaria, ]{.underline}

1.  **Inicia sessió**: Utilitza les teves credencials d\'accés a les
    Intranets de la UPC.
2.  **Cerca el** **tràmit:** Al menú esquerre *Certificats*
3.  **Tria el certificat**: Indica el tipus de certificat que necessites
    (per exemple, Certificat acadèmic personal).
4.  **Completa les dades**: Especifica l\'idioma i el mètode de
    pagament.
5.  **Paga les taxes**: Realitza el pagament en línia a través de la
    e-Secretaria.
    1.  En el menú *Matrícula*, escollir l\'opció *Impresos i
        pagaments*.
    2.  Seleccionar el darrer imprès de \"Certificació acadèmica\" i
        prémer el logo de la targeta de crèdit o de la *Línia Oberta* de
        *La Caixa.*
    3.  Escollir una de les dues opcions del llistat i s\'obrirà una
        pàgina on confirmar el pagament directament amb l\'entitat
        bancària. Trobareu més informació per realitzar el pagament en
        línia en el document [d\'instruccions per fer el pagament per
        l\'e-Secretaria*.*](https://www.upc.edu/sga/ca/matricula/pagament-de-la-matricula/visa-mastercard-linea-oberta)

[Si no tens accés a la e-Secretària]{.underline},

1.  **Envia un correu**: escriu a []{#MmFXoOZxk rel="nofollow"}
...
-   **Legalització**. Per tal que els documents acadèmics originals
    tinguin efectes a l'estranger és necessari dur a terme la
    legalització.

 

La **legalització de documents** acadèmics originals que han de tenir
efectes a l'estranger és un procés convingut amb caràcter internacional
que requereix prèviament el reconeixement de signatures per part de les
autoritats espanyoles corresponents. En el cas concret dels certificats
acadèmics oficials d'estudis conduents a l'obtenció dels títols,
expedits i signats per càrrecs acadèmics de les unitats acadèmiques de
la UPC (centres docents, departaments i instituts universitaris de
recerca) s\'ha de demanar el certificat per legalitzar. 
:::
::::
:::::
::::::
...
:::: field-items
::: {.field-item .even}
Persones titulades o que estiguin cursant (o hagin cursat) estudis a la
FIB.
:::
::::
:::::
