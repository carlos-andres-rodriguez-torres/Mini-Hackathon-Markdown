---
description: La normativa acadèmica de graus de la UPC contempla la
  possibilitat de reconèixer fins a 6 ECTS optatius per activitats
  d\'extensió universitària, 4.1.6. Reconeixement de crèdits per
  activitats d'extensió universitària. D'aquestes activitats, per a
  l\'estudiantat de grau, hi ha ofertades per a tota la UPC Veure
  l\'annex 1; i també n\'hi ha d\' específiques acordades per la FIB. A
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Reconeixement de crèdits optatius per activitats universitàries
  \| Facultat d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: La normativa acadèmica de graus de la UPC contempla
  la possibilitat de reconèixer fins a 6 ECTS optatius per activitats
  d\'extensió universitària, 4.1.6. Reconeixement de crèdits per
  activitats
twitter:title: Reconeixement de crèdits optatius per activitats
  universitàries
twitter:url: "https://www.fib.upc.edu/ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries"
...
::: content
-   [Català](/ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries "Reconeixement de crèdits optatius per activitats universitàries"){.language-link
    .active lang="ca"}
-   [English]{.language-link .locale-untranslated lang="en"}
-   [Español](/es/estudios/secretaria/tramites/reconocimiento-de-creditos-optativos-por-actividades-de-extension-universitaria "Reconocimiento de créditos optativos por actividades de extensión universitaria"){.language-link
    lang="es"}
:::
:::::
    ...
    -   [Secretaria](/ca/estudis/secretaria)
        -   [Tràmits](/ca/estudis/secretaria/tramits)
            ...
            -   [Reconeixement de crèdits optatius per activitats
                universitàries](/ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries){.active}
...
:::: content
::: page_title_no_sub
# Reconeixement de crèdits optatius per activitats universitàries {#reconeixement-de-crèdits-optatius-per-activitats-universitàries .page_title}
:::
::::
::::::
:::::::
...
[Secretaria](/ca/estudis/secretaria) »
[Tràmits](/ca/estudis/secretaria/tramits) » Reconeixement de crèdits
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::: content
::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {#node-16364 .node .node-tr-mit .clearfix}
:::::::::::::::::::::::::::::::::::::::::::::::::::::::: row
...
reconèixer fins a 6 ECTS optatius** per activitats d\'extensió
universitària, [4.1.6. Reconeixement de crèdits per activitats
d'extensió
universitària](https://www.upc.edu/sga/ca/normatives/NormativesAcademiques).

D'aquestes activitats, per a l\'**estudiantat de grau**, hi ha ofertades
per a tota la UPC [Veure l\'annex
1](https://www.upc.edu/sga/ca/normatives/ReconeixementCredits);  i també
n\'hi ha d\' [específiques acordades per la
FIB](/sites/fib/files/documents/acord_cp2023.08.03-reconeixment_academic_activitats_especifiques_fib.pdf).

A la seva [e-Secretaria](https://prisma-nou.upc.edu/estudiants),
l\'estudiantat pot consultar el llistat de totes les activitats que han
realitzat simultàniament als estudis de grau.

### Com fer el reconeixement d\'aquests ECTS optatius?

1.  Obtenir un certificat acreditatiu de l\'activitat. En el cas que
    l\'organització de l\'activitat faciliti la informació directament a
    la secretaria de la FIB, no cal aportar el certificat.
2.  Realitzar la petició de reconeixement via [Seu electrònica \>
    Reconeixement de crèdits optatius per activitats
    universitàries](https://seuelectronica.upc.edu/ca/Tramits/Sol-licitud_incorporacio_credits_extensio_universitaria) durant
    el període corresponent **(novembre/abril)**.
3.  Tramitació per part de la secretaria de la FIB per autoritzar els
    crèdits.

**Important**. Els crèdits dels reconeixements no es matriculen.

4.  Després de la darrera matrícula, l\'estudiantat podrà seleccionar a
    **e-Secretaria \> Expedient \> Reconeixement d\'activitats** quines
    de les activitats realitzades vol que **s'incorporin** al seu
    expedient de grau.

**Important**. Aquesta acció no es pot desfer un cop afegides les
activitats.

5.  Realitzar el pagament de les taxes des de la seva **e-Secretaria \>
    Impresos i pagaments**.

###  

### Reconeixement de crèdits d'idiomes

El reconeixement de crèdits d\'idiomes només es pot fer mitjançant
certificat oficial d\'idiomes. [Consulta els certificats oficials
d\'idiomes](https://www.upc.edu/slt/ca/cursos-i-certificats/certifica/taulacertificats). 

Per tramitar-ho, has de fer una sol·licitud a través de la [Seu
electrònica \> Reconeixement de crèdits optatius per activitats
universitàries](https://seuelectronica.upc.edu/ca/Tramits/Sol-licitud_incorporacio_credits_extensio_universitaria),** **on
podràs adjuntar el **certificat** i** **també hauràs **d\'indicar els
crèdits a reconèixer en el tràmit.**

Si el certificat oficial de **B2 o superior**, que s\'ha utilitzat per
assolir la competència en una tercera llengua, s\'ha** obtingut durant**
els estudis de grau, també, es pot fer servir per al reconeixement de
**4 ECTS** (6 ECTS en cas de certificats d\'anglès, francès, alemany o
italià dels nivells del MECRL de les Universitats Catalanes, IOC i
EOI), en aquest cas:

1.  No s\'ha de tornar a enviar el certificat per la seu electrònica.

2.  S\'ha de fer una sol·licitud a través de la **e-Secretaria \>
    altres**, [després de la última matrícula del grau]{.underline} i en
    els períodes establerts, (novembre/abril), sol·licitant el nombre de
    crèdits optatius, que es volen reconèixer.

Es pot trobar més informació sobre el reconeixement de crèdits per
idiomes al [web del Servei de Llengües i Terminologies
(SLT-UPC)](https://www.upc.edu/slt/ca/cursos-i-certificats/certifica/reconeixement-credits). 

::: {.alert .alert-danger}
  Abans de sol·licitar aquest reconeixement s\'ha d\'haver [acreditat la
competència de la tercera
llengua](/ca/estudis/secretaria/tramits/acreditacio-competencia-generica-en-3a-llengua).
Aquestes activitats s'hauran d\'haver fet simultàniament als estudis i
el reconeixement s'ha de sol·licitar un cop feta la última matrícula del
grau.
:::
::::
:::::
...
[Sede Electrónica
UPC](https://seuelectronica.upc.edu/ca/Tramits/Sol-licitud_incorporacio_credits_extensio_universitaria){.dexp-shortcodes-button
...
::: {.field-item .even}
[Reconeixement de
crèdits](https://www.upc.edu/sga/ca/normatives/ReconeixementCredits)
