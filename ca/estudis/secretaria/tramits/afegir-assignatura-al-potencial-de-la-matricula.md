---
description: Les excepcions a les condicions de matriculació dels
  estudiants de la Fase Inicial així com als estudiants de fora de la
  Fase Inicial (canvi de prerequisits i correquisits) es faran en el
  període establert a través de l\'e-Secretaria a l\'instància \"Poder
  matricular assignatures\". Pel que fa als estudis de màster, les
  assignatures que no formen part del propi pla d\'estudis o
generator: "Drupal 7 (https://www.drupal.org)"
lang: ca
msapplication-TileColor: "#2b5797"
msapplication-TileImage: /mstile-144x144.png
theme-color: "#ffffff"
title: Afegir assignatura al potencial de la matrícula \| Facultat
  d\'Informàtica de Barcelona
twitter:card: summary
twitter:description: Les excepcions a les condicions de matriculació
  dels estudiants de la Fase Inicial així com als estudiants de fora de
  la Fase Inicial (canvi de prerequisits i correquisits) es faran en el
  període
twitter:title: Afegir assignatura al potencial de la matrícula
twitter:url: "https://www.fib.upc.edu/ca/estudis/secretaria/tramits/afegir-assignatura-al-potencial-de-la-matricula"
...
::: content
-   [Català](/ca/estudis/secretaria/tramits/afegir-assignatura-al-potencial-de-la-matricula "Afegir assignatura al potencial de la matrícula"){.language-link
    .active lang="ca"}
-   [English]{.language-link .locale-untranslated lang="en"}
-   [Español](/es/estudios/secretaria/tramites/anadir-asignatura-al-potencial-de-la-matricula "Añadir asignatura al potencial de la matrícula"){.language-link
    lang="es"}
:::
:::::
    ...
    -   [Secretaria](/ca/estudis/secretaria)
        -   [Tràmits](/ca/estudis/secretaria/tramits)
            ...
            -   [Afegir assignatura al potencial de la
                matrícula](/ca/estudis/secretaria/tramits/afegir-assignatura-al-potencial-de-la-matricula){.active}
            -   [Certificacions
...
:::: content
::: page_title_no_sub
# Afegir assignatura al potencial de la matrícula {#afegir-assignatura-al-potencial-de-la-matrícula .page_title}
:::
::::
::::::
:::::::
...
[Secretaria](/ca/estudis/secretaria) »
[Tràmits](/ca/estudis/secretaria/tramits) » Afegir assignatura al
...
:::::::::::::::::::::::::::::::::::::::::::::::::::: content
::::::::::::::::::::::::::::::::::::::::::::::::::: {#node-36 .node .node-tr-mit .clearfix}
:::::::::::::::::::::::::::::::::::::::::::::::::: row
:::::: {.col-lg-9 .col-md-9 .col-sm-12}
::::: {.field .field-name-body .field-type-text-with-summary .field-label-hidden}
:::: field-items
::: {.field-item .even}
-   Les excepcions a les condicions de matriculació dels estudiants de
    la Fase Inicial així com als estudiants de fora de la Fase Inicial
    (canvi de prerequisits i correquisits) es faran en el període
    establert a través de
    l\'[e-Secretaria](https://prisma-nou.upc.edu/estudiants/) a
    l\'instància \"*Poder matricular assignatures*\".

<!-- -->

-   Pel que fa als **estudis de màster**, les assignatures que no formen
    part del propi pla d\'estudis o especialitat s\'han de sol·licitar
    durant el període establert de [Modificació de Matricula i Canvi de
    Grup](/ca/estudis/secretaria/tramits/modificacio-de-matricula-i-canvi-de-grup).
:::
::::
:::::
...
:::: field-items
::: {.field-item .even}
-   Estudiants de grau i màster que vulguin afegir assignatures al seu
...
:::: field-items
::: {.field-item .even}
-   [Normativa de matrícula del
    GEI](/ca/estudis/graus/grau-en-enginyeria-informatica/normativa-academica#matricula)
:::
::::
:::::
::::::
